...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/ef/cefvlo3lilaxklpxjl77nrse4y6eg5s3yhfo7djjt4gfg3vraabd.py
...
triton_poi_fused_add_mul_sigmoid_tanh_13 = async_compile.triton('triton_poi_fused_add_mul_sigmoid_tanh_13', '''
import triton
...
@pointwise(size_hints=[65536], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_sigmoid_tanh_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_mul_sigmoid_tanh_13(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 65536
