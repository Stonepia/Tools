...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/de/cdejjfpi5cmvnqu3ruc3grwpv57y7f3apfbhfafzpmz7y7fjtgl6.py
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*fp16', 2: 'fp64', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_div_masked_fill_repeat_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
