...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/hv/chv6jggp2zvhcfmyn7bi4lpi5be5ppmtlridlvwt36wph277mbdi.py
# Source Nodes: [contiguous_12, cross_entropy], Original ATen: [aten._log_softmax, aten.clone]
# contiguous_12 => clone_48
# cross_entropy => amax_12, convert_element_type_102, convert_element_type_103, exp_12, log, sub_38, sub_39, sum_13
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__log_softmax_clone_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
