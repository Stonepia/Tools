...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/3k/c3k5pkzhr6milad2kxsk3npnp2k4tkygnhykj7ijoxrypngt5sny.py
...
# relu_1 => relu_1
# relu_2 => relu_2
triton_poi_fused__native_batch_norm_legit_functional__to_copy_convolution_relu_12 = async_compile.triton('triton_poi_fused__native_batch_norm_legit_functional__to_copy_convolution_relu_12', '''
import triton
...
@pointwise(size_hints=[32768], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*bf16', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_functional__to_copy_convolution_relu_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]})
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional__to_copy_convolution_relu_12(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 19200
