...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/tr/ctrkb2nnjuvnophzjwj36rig5nzzg2zcggi2nxjhl5e4zazc3nz6.py
# Source Nodes: [getattr_getattr_l__mod___stages___0___blocks___1___token_mixer_pool, group_norm_3], Original ATen: [aten.avg_pool2d, aten.native_group_norm]
# getattr_getattr_l__mod___stages___0___blocks___1___token_mixer_pool => avg_pool2d_1
# group_norm_3 => convert_element_type_14, var_mean_3
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_avg_pool2d_native_group_norm_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_avg_pool2d_native_group_norm_13(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        r1 = rindex % 56
        r5 = rindex
        tmp80 = tl.load(in_ptr1 + (r5 + (75264*x0)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp81 = tl.load(in_ptr0 + (r5 + (75264*x0)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp83 = tl.load(in_ptr2 + ((24*x6) + (r5 // 3136)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp0 = (-1) + r2
        ...
        tmp9 = tmp7 & tmp8
        tmp10 = tmp5 & tmp9
        tmp11 = tl.load(in_ptr0 + ((-57) + r5 + (75264*x0)), rmask & tmp10 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp16 = tmp14 & tmp15
        tmp17 = tmp5 & tmp16
        tmp18 = tl.load(in_ptr0 + ((-56) + r5 + (75264*x0)), rmask & tmp17 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp24 = tmp22 & tmp23
        tmp25 = tmp5 & tmp24
        tmp26 = tl.load(in_ptr0 + ((-55) + r5 + (75264*x0)), rmask & tmp25 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp32 = tmp30 & tmp31
        tmp33 = tmp32 & tmp9
        tmp34 = tl.load(in_ptr0 + ((-1) + r5 + (75264*x0)), rmask & tmp33 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp35 = tl.where(tmp33, tmp34, 0.0)
        tmp36 = tmp35 + tmp28
        tmp37 = tmp32 & tmp16
        tmp38 = tl.load(in_ptr0 + (r5 + (75264*x0)), rmask & tmp37 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp39 = tl.where(tmp37, tmp38, 0.0)
        tmp40 = tmp39 + tmp36
        tmp41 = tmp32 & tmp24
        tmp42 = tl.load(in_ptr0 + (1 + r5 + (75264*x0)), rmask & tmp41 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp48 = tmp46 & tmp47
        tmp49 = tmp48 & tmp9
        tmp50 = tl.load(in_ptr0 + (55 + r5 + (75264*x0)), rmask & tmp49 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp51 = tl.where(tmp49, tmp50, 0.0)
        tmp52 = tmp51 + tmp44
        tmp53 = tmp48 & tmp16
        tmp54 = tl.load(in_ptr0 + (56 + r5 + (75264*x0)), rmask & tmp53 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp55 = tl.where(tmp53, tmp54, 0.0)
        tmp56 = tmp55 + tmp52
        tmp57 = tmp48 & tmp24
        tmp58 = tl.load(in_ptr0 + (57 + r5 + (75264*x0)), rmask & tmp57 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r5 = rindex
        tmp91 = tl.load(in_ptr1 + (r5 + (75264*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp92 = tl.load(out_ptr0 + (r5 + (75264*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp93 = tl.load(in_ptr0 + (r5 + (75264*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp95 = tl.load(in_ptr2 + ((24*x6) + (r5 // 3136)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp94 = tmp92 - tmp93
        tmp96 = tmp94 * tmp95
        tmp97 = tmp91 + tmp96
