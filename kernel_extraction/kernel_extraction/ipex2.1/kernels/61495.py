...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/tv/ctvfar6hfmz4jsfknqu5wdkyna53kaek7jm6o3ma24xzndzq3clu.py
# Source Nodes: [add_8, add_9, l__mod___encoder_block_0_layer__1__dropout, l__mod___encoder_block_1_layer_0_self_attention_q, mean_2, mul_12, mul_13, pow_4, rsqrt_2], Original ATen: [aten.add, aten.mean, aten.mul, aten.native_dropout, aten.pow, aten.rsqrt, aten.view]
# add_8 => add_10
# add_9 => add_11
