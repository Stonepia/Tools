...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/y7/cy7xigeximjquhjtys34vxg6bnfjw2bitcqykgegwwbca7uilsaq.py
# Source Nodes: [add_4, add_5, clamp, l__self___block_0_layer_0_dropout, l__self___embed_tokens, mean_1, mul_5, mul_6, neg, pow_2, rsqrt_1, to_5, to_6, where_1], Original ATen: [aten._to_copy, aten.add, aten.clamp, aten.clone, aten.embedding, aten.mean, aten.mul, aten.neg, aten.pow, aten.rsqrt, aten.scalar_tensor, aten.where]
# add_4 => add_6
# add_5 => add_7
...
triton_per_fused__to_copy_add_clamp_clone_embedding_mean_mul_neg_pow_rsqrt_scalar_tensor_where_6 = async_compile.triton('triton_per_fused__to_copy_add_clamp_clone_embedding_mean_mul_neg_pow_rsqrt_scalar_tensor_where_6', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*fp16', 2: '*fp16', 3: '*i1', 4: '*fp16', 5: '*fp16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clamp_clone_embedding_mean_mul_neg_pow_rsqrt_scalar_tensor_where_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__to_copy_add_clamp_clone_embedding_mean_mul_neg_pow_rsqrt_scalar_tensor_where_6(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, rnumel):
    xnumel = 2048
