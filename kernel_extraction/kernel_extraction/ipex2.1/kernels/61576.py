...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/t5/ct5z2dti6qspziqjntojz26hgpk5lf5g4lldpj5dgv2rz5pb6sjf.py
...
# l__mod___features_denseblock3_denselayer18_norm1 => add_147, convert_element_type_221, mul_220, mul_221, sub_73
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_74', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
