...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/bn/cbnldkuucmt2zccyodkmmmg6e2nwulr62swxywellkadzyf6onhb.py
# Source Nodes: [getattr_l__self___features___4___conv_1_1, getattr_l__self___features___4___conv_1_2], Original ATen: [aten._native_batch_norm_legit_no_training, aten.hardtanh]
# getattr_l__self___features___4___conv_1_1 => add_22, mul_31, mul_32, sub_10
# getattr_l__self___features___4___conv_1_2 => clamp_max_7, clamp_min_7, convert_element_type_60
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_hardtanh_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
