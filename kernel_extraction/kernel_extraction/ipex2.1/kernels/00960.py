...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/ob/coboei5gnbjwqz7s7exhop6rt5yt5hjsd4gxg7umbodb2c7xtdle.py
...
def triton_poi_fused_6(out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tmp0 < tmp5
    tmp7 = 5.2386894822120667e-08
    tmp8 = -3.3032847568392754e-09
    tmp9 = tl.where(tmp6, tmp7, tmp8)
    tmp10 = -6.73594513500575e-12
    tmp11 = tl.where(tmp4, tmp10, tmp9)
    tmp12 = tl.full([1], 4, tl.int64)
    tmp13 = tmp0 < tmp12
    tmp14 = tl.full([1], 5, tl.int64)
    tmp15 = tmp0 < tmp14
    tmp16 = -8.86757334228605e-11
    tmp17 = 1.318767317570746e-10
    tmp18 = tl.where(tmp15, tmp16, tmp17)
    tmp19 = 6.6356733441352844e-09
