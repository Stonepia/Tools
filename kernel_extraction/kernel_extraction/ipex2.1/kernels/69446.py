...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/pr/cprt3nvdqash6gka7dmo5fbix4riwqey5kzb7qrbzxz4okvokdv2.py
...
def triton_poi_fused_add_mul_sub_16(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp7 = tl.load(in_out_ptr0 + (y0 + (96*x2) + (301056*y1)), xmask, eviction_policy='evict_last')
