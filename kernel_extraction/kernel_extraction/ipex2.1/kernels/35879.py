...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/ca/ccaqf2sew427x2xcxphi6bvaznkbwj7nbyriclvfuhpnbffw7cgu.py
# Source Nodes: [add, getattr_l__self___blocks___0___norm2], Original ATen: [aten.add, aten.native_layer_norm]
# add => add_3
# getattr_l__self___blocks___0___norm2 => add_4, add_5, clone_3, convert_element_type_11, convert_element_type_12, mul_4, mul_5, rsqrt_1, sub_1, var_mean_1
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_native_layer_norm_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_native_layer_norm_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (384*x3)), tmp23, rmask & xmask)
''')
