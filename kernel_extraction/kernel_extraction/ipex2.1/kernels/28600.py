...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/au/caurp4u4u6m2iwxw7t4n5rvuof2s5yqyyt3smmz4iab6xtmduaai.py
...
@pointwise(size_hints=[134217728], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_mul_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
