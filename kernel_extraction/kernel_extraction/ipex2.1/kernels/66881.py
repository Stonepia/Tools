...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/6d/c6dt4qshvtmgdyyieak327f5l6f22cefohbkerexd3mcdykwipiy.py
...
@pointwise(size_hints=[131072], filename=__file__, meta={'signature': {0: '*i64', 1: '*i64', 2: '*bf16', 3: '*bf16', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
