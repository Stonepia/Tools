...
# Original file: ./XGLMForCausalLM__94_forward_279.26/XGLMForCausalLM__94_forward_279.26_2.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/xb/cxbqlk6eky7mezlq7g56gsizhhl57mrekyauzatbske43zz4nwba.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*i64', 2: '*bf16', 3: '*i64', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_clone_copy_new_zeros_nll_loss_forward_select_scatter_slice_slice_scatter_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 6), equal_to_1=())]}
)
@triton.jit
