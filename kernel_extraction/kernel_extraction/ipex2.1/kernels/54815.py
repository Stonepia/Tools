...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/3y/c3ym4vzp3ufk6j32dpdnovabifxnrgczsxupwodibnbe5crol6cf.py
...
# where => where_1
triton_poi_fused__to_copy_full_like_where_10 = async_compile.triton('triton_poi_fused__to_copy_full_like_where_10', '''
import triton
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_full_like_where_10', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused__to_copy_full_like_where_10(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 3158016
