...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/3n/c3ndqylpzvsdwsd627yvxfehsosxsrfnld6o23w3fozqh4qwk4sj.py
# Source Nodes: [scaled_dot_product_attention_6], Original ATen: [aten._softmax]
# scaled_dot_product_attention_6 => amax_6, convert_element_type_268, convert_element_type_269, div_6, exp_6, sub_50, sum_7
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_51', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
