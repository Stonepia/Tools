...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/k7/ck7xomflipkalzzjtyqrctubd47np6dyszedq4zi7fx775w37orh.py
...
def triton_poi_fused_clone_19(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 81920)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (80*x2) + (3840*x3) + (245760*x1)), None)
