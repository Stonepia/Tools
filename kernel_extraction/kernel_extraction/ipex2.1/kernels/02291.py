...
# Original file: ./OPTForCausalLM__46_forward_143.10/OPTForCausalLM__46_forward_143.10_3.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/ba/cbaedulixrssefkolmmntydg3encmed7fsrucnmjlmbr2d6b2pee.py
# Source Nodes: [add_1, dropout_1, l__self___final_layer_norm, reshape_1], Original ATen: [aten.add, aten.native_dropout, aten.native_layer_norm, aten.view]
# add_1 => add_3
