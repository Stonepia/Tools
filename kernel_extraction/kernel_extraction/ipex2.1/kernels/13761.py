...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/sr/csru7nqwbmoqeqcyosth2gqdymzkp7znhlj6bbmekhncxcrw3brz.py
# Source Nodes: [cat_3430, softmax_855], Original ATen: [aten._softmax, aten.cat]
# cat_3430 => cat_3425
# softmax_855 => amax_855, convert_element_type_1710, convert_element_type_1711, div_855, exp_855, sub_855, sum_856
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: '*fp16', 7: '*fp16', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_cat_880', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 8), equal_to_1=())]}
)
@triton.jit
