...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/nu/cnuinhb72gpbf4cypgtpwc45dr6wjuayxtl7hokoe4iqqqcmsytc.py
# Source Nodes: [setitem_91], Original ATen: [aten.slice_scatter]
# setitem_91 => slice_scatter_40, slice_scatter_41
triton_poi_fused_slice_scatter_73 = async_compile.triton('triton_poi_fused_slice_scatter_73', '''
import triton
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_slice_scatter_73', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
def triton_poi_fused_slice_scatter_73(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 3182400
