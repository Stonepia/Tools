...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/jf/cjfd4iqjg6majiwh2x3jaswsbfwmrvdgmiqe2ya2jivtxpaooaub.py
# Source Nodes: [add_4, add_5, l__mod___encoder_block_0_layer_0_dropout, l__mod___encoder_block_0_layer__1__dense_relu_dense_wi, l__mod___encoder_dropout, mean_1, mul_5, mul_6, pow_2, rsqrt_1, to_5, to_6], Original ATen: [aten._to_copy, aten.add, aten.mean, aten.mul, aten.native_dropout, aten.pow, aten.rsqrt, aten.view]
# add_4 => add_6
# add_5 => add_7
