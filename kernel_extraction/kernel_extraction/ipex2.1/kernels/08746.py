...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/fl/cflvzrkcrph5xxd4nbz5222cdbtkelacspkfibvzrbj3ikv4o6bu.py
...
# layer_norm_8 => add_28, add_29, convert_element_type_30, convert_element_type_31, mul_33, mul_34, rsqrt_8, sub_12, var_mean_8
...
def triton_per_fused_add_clone_native_layer_norm_24(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel):
    ...
    tmp3 = tl.load(in_ptr2 + (r3 + (256*x5)), rmask & xmask, other=0.0).to(tl.float32)
    tmp5 = tl.load(in_ptr3 + (r3 + (256*x5)), rmask & xmask, other=0.0).to(tl.float32)
    tmp7 = tl.load(in_out_ptr0 + (r3 + (256*x5)), rmask & xmask, other=0.0).to(tl.float32)
    ...
    tl.store(out_ptr2 + (r3 + (256*x5)), tmp39, rmask & xmask)
''')
