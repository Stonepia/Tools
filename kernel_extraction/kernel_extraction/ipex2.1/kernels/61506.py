...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/lc/clcgoypjertt5uedvwijcyxvy5xgf7hl4guesi3jsk5ffd5g7jop.py
...
# l__mod___features_denseblock1_denselayer2_norm1 => add_7, convert_element_type_11, mul_10, mul_11, sub_3
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
