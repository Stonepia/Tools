...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/og/cog5wuwwcjqbibylfybrwimcpww525ntzt67dymnzwv6tr7jptab.py
# Source Nodes: [add, add_1, add_2, getitem_140, imul, imul_1, mul, mul_1, mul_2, mul_3, setitem, setitem_1, setitem_2, setitem_3, sub, sub_1, sub_2, sub_3, to, zeros_like], Original ATen: [aten._to_copy, aten.add, aten.copy, aten.mul, aten.select, aten.select_scatter, aten.slice, aten.slice_scatter, aten.sub, aten.zeros_like]
# add => add
# add_1 => add_1
# add_2 => add_2
# getitem_140 => select_151
# imul => mul_4
# imul_1 => mul_5
# mul => mul
# mul_1 => mul_1
