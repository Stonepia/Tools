...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/ea/ceajjfzth2qwifdnotzha67436dt7cyeq7zorowhid2twwovs5lx.py
# Source Nodes: [batch_norm_20, getattr_getattr_l__self___stages___3_____0___conv2_kxk_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.silu]
# batch_norm_20 => add_57, mul_92, mul_93, sub_27
# getattr_getattr_l__self___stages___3_____0___conv2_kxk_bn_act => convert_element_type_151, mul_94, sigmoid_17
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_silu_24(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 6291456
