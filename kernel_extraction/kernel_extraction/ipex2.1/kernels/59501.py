...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/yg/cygupc7yok76mxbvcm6nsyboof7qec6nctahlyn4hw6zep73zcas.py
...
def triton_poi_fused_6(out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tmp0 < tmp5
    tmp7 = -0.5994489789009094
    tmp8 = -0.24845215678215027
    tmp9 = tl.where(tmp6, tmp7, tmp8)
    tmp10 = tl.full([1], 3, tl.int64)
    tmp11 = tmp0 < tmp10
    tmp12 = 0.19254934787750244
    tmp13 = -4.255767345428467
    ...
    tmp19 = tmp0 < tmp18
    tmp20 = -1.9995936155319214
    tmp21 = 3.011502265930176
    tmp22 = tl.where(tmp19, tmp20, tmp21)
    tmp23 = tl.full([1], 7, tl.int64)
    tmp24 = tmp0 < tmp23
    tmp25 = -2.6800942420959473
    tmp26 = -2.02455997467041
