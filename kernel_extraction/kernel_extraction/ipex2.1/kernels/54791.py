...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/aj/cajtgbk45ycpblgxg2tb5txaytzwyit3emcrzhucp2aoh2eedivp.py
...
def triton_poi_fused_copy_new_zeros_select_scatter_slice_slice_scatter_18(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x1 = (xindex // 513) % 256
    x6 = xindex
    tmp3 = tl.load(in_ptr0 + (x4 + (131328*x3)), None, eviction_policy='evict_last')
    tmp10 = tl.load(in_ptr2 + (x4 + (131328*x3)), None, eviction_policy='evict_last')
    tmp0 = x2
    tmp1 = tl.full([1], 0, tl.int32)
    tmp2 = tmp0 == tmp1
    tmp4 = tl.full([1], 1, tl.int64)
    tmp5 = tmp0 >= tmp4
    tmp6 = tl.load(in_ptr1 + ((-131328) + x5 + (393984*x3)), tmp5, other=0.0)
    ...
    tmp19 = tmp17 < tmp18
    tmp20 = tmp19 & tmp16
    tmp21 = tl.load(in_ptr3 + ((256*((((-256) + x0 + (513*x1) + (262656*x2) + (787968*x3)) // 262656) % 3)) + (1024*((((-256) + x0 + (513*x1) + (262656*x2) + (787968*x3)) // 787968) % 4)) + ((((-256) + x0 + (513*x1) + (262656*x2) + (787968*x3)) // 512) % 513)), tmp20, other=0.0)
    tmp22 = tl.load(in_ptr4 + ((256*((((-256) + x0 + (513*x1) + (262656*x2) + (787968*x3)) // 262656) % 3)) + (1024*((((-256) + x0 + (513*x1) + (262656*x2) + (787968*x3)) // 787968) % 4)) + (((-256) + x0 + (513*x1) + (262656*x2) + (787968*x3)) % 512)), tmp20, other=0.0)
    tmp23 = tmp21 * tmp22
