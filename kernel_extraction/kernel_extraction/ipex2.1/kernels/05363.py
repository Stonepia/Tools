...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/wd/cwdiojkhnqfwek56itu4sdngeimwf36md5uqer7uu4nd32mdxwep.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i32', 1: '*fp32', 2: '*bf16', 3: '*bf16', 4: '*fp32', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_embedding_mean_mul_pow_rsqrt_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
