...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/mw/cmwqpyuwlp3gfimg2vw2jzmj5tw5l6jqpnokpfw7dz3cmaedyan6.py
...
def triton_per_fused__to_copy_add_native_dropout_backward_native_layer_norm_native_layer_norm_backward_6(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr2, out_ptr3, xnumel, rnumel):
    ...
    tmp8 = tl.load(in_ptr2 + (r1 + (1024*x0)), rmask & xmask, other=0.0)
    tmp9 = tl.load(in_ptr3 + (r1 + (1024*x0)), rmask & xmask, other=0.0).to(tl.float32)
    tmp12 = tl.load(in_ptr4 + (x0), xmask, eviction_policy='evict_last')
    tmp14 = tl.load(in_ptr5 + (x0), xmask, eviction_policy='evict_last')
    tmp21 = tl.load(in_ptr6 + (r1 + (1024*x0)), rmask & xmask, other=0.0)
    tmp31 = tl.load(in_ptr7 + (r1 + (1024*x0)), rmask & xmask)
