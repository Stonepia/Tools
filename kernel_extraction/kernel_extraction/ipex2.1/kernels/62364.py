...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/em/cemnnvfi6phznpbcubmc6b2ogf3hris252umnah5d6etf7ofl5vv.py
# Source Nodes: [gelu, l__self___lm_head_layer_norm], Original ATen: [aten.gelu, aten.gelu_backward, aten.native_layer_norm, aten.native_layer_norm_backward]
# gelu => add, convert_element_type_3, erf, mul_1
