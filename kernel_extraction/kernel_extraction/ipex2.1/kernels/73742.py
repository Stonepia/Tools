...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/q5/cq5u37uz7624lkh4vpzajsduhpgyriq4teg5byyat2tqg2g7zw36.py
# Source Nodes: [batch_norm_55, l__mod___features_conv4_6_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_55 => add_128, convert_element_type_167, mul_166, mul_167, sub_55
# l__mod___features_conv4_6_c1x1_a_bn_act => relu_55
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_73(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1472*x2) + (288512*y1)), tmp13, xmask)
''')
