...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/dz/cdzinzcq6t5p3unindfmt3sbd5xrf7kntq4wnneojso64xzrqwx4.py
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp16', 1: '*i64', 2: '*fp32', 3: '*fp32', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_bitwise_and_copy_ge_select_scatter_where_59', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
