...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/fa/cfadg5ojzk446tr54zovog6xufcbdq6go6kmncomhdathnaxls42.py
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*i64', 1: '*fp16', 2: '*i1', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_native_dropout_relu_view_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 5), equal_to_1=())]})
@triton.jit
