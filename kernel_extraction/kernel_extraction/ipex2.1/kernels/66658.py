...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/b7/cb7v3c4bub3iwutvl3zdlgetjihmtdhwwkmhatoablvnolcgcotv.py
# Source Nodes: [l__self___features_5], Original ATen: [aten.max_pool2d_with_indices]
# l__self___features_5 => max_pool2d_with_indices_1
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_max_pool2d_with_indices_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
