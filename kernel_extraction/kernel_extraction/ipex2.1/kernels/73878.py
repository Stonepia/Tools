...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/i5/ci5qce5kicf4mtzxu644srcym37n2hbnb4tdt2pbixbeqqywwufm.py
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_61(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1280*x2) + (250880*y1)), tmp9, xmask)
''')
