...
# Original file: ./detectron2_fasterrcnn_r_101_dc5__43_inference_83.23/detectron2_fasterrcnn_r_101_dc5__43_inference_83.23_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/fh/cfhcj4it2k4v4b6p3gnu4pzvspp6x4yqabykualxerdhoaj6gjli.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_abs_all_bitwise_and_eq_mul_ne_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]}
)
@triton.jit
