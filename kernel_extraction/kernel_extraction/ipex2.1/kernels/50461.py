...
# Original file: ./detectron2_fasterrcnn_r_101_fpn__38_inference_78.18/detectron2_fasterrcnn_r_101_fpn__38_inference_78.18_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/6v/c6vn7n46wgczomunvhgeyww5qil6fpi2ejrhsdwnhfbhvlg7cjwu.py
...
def triton_poi_fused_index_0(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.where(tmp0 < 0, tmp0 + 4741, tmp0)
    # tl.device_assert(((0 <= tmp1) & (tmp1 < 4741)) | ~xmask, "index out of bounds: 0 <= tmp1 < 4741")
