...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/y2/cy2qtqn5rjco5gczxybcz7pfavc25gckzjbxlmtkobrja62ukaba.py
# Source Nodes: [exp, logsumexp, sub], Original ATen: [aten.exp, aten.logsumexp, aten.sub]
# exp => exp_1
# logsumexp => abs_1, add_2, amax, convert_element_type_3, convert_element_type_4, eq, exp, full_default_1, log, sub_1, sum_1, where
# sub => sub_2
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_exp_logsumexp_sub_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
