...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/ny/cny5brd4iw6xmjmgdnnrvsczpjvjnrd2c5jvj73q5gl3m2phqpui.py
...
@pointwise(size_hints=[32], filename=__file__, meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_nll_loss_backward_nll_loss_forward_0', 'configs': [AttrsDescriptor(divisible_by_16=(0,), equal_to_1=())]})
@triton.jit
