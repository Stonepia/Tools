...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/t4/ct4z5qvxvzzritiyuqbs2nez3vtxatmkwwvmy53ldpstmzhnl6l2.py
# Source Nodes: [mul_162, to_88], Original ATen: [aten._to_copy, aten.add, aten.mul, aten.sum]
# mul_162 => mul_324
# to_88 => convert_element_type_216
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_mul_sum_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
