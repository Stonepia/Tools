...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/xx/cxxponx7npqmszj4zyjrg5rnoodfkux3nknlewriizaftytpdeji.py
...
# layer_norm_4 => add_17, add_18, convert_element_type_8, convert_element_type_9, mul_16, mul_17, rsqrt_4, sub_4, var_mean_4
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
