...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/6m/c6mwk6zj5etxvehvyictwbkruamvreqglmdkccn2xq2dcbrc64ci.py
...
# getattr_l__mod___features___2___conv_0_2 => clamp_max_2, clamp_min_2, convert_element_type_17
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_hardtanh_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
