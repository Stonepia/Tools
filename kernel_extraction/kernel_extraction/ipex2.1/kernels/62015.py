...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/cd/ccdsvozaoerfv7eovostuy6km354hiacbsctalri4bmnla3cxykz.py
# Source Nodes: [l__self___features_denseblock2_denselayer6_norm1, l__self___features_denseblock2_denselayer6_relu1], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# l__self___features_denseblock2_denselayer6_norm1 => add_49, convert_element_type_99, mul_73, mul_74, sub_24
# l__self___features_denseblock2_denselayer6_relu1 => relu_24
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_25', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
