...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/en/cenq73lft2oe44x6a3vtx4llywywdvibqmu3axxzr2tpemrrqpnk.py
# Source Nodes: [iadd_6, nan_to_num, nan_to_num_5, softmax_5], Original ATen: [aten._softmax, aten.add, aten.nan_to_num]
# iadd_6 => add_39
...
triton_poi_fused__softmax_add_nan_to_num_29 = async_compile.triton('triton_poi_fused__softmax_add_nan_to_num_29', '''
import triton
...
@pointwise(size_hints=[16], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax_add_nan_to_num_29', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused__softmax_add_nan_to_num_29(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 16
