...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/oj/coj3jmxwmrvcjr76ijasspdmwfusxkhqtf4xpmrpak2s4uixwmbt.py
...
@triton.jit
def triton_per_fused__softmax__to_copy_native_dropout_14(in_ptr0, in_ptr1, in_ptr2, out_ptr4, out_ptr5, out_ptr6, load_seed_offset, xnumel, rnumel):
    xnumel = 32768
