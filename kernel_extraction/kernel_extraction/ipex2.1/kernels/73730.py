...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/3m/c3mh6zd6fttae3ozsnbm5q7nwjda2vtdyrtsbdwdyrwo65hcuqai.py
# Source Nodes: [batch_norm_46, l__mod___features_conv4_3_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_46 => add_107, convert_element_type_140, mul_139, mul_140, sub_46
# l__mod___features_conv4_3_c1x1_a_bn_act => relu_46
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_61(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1280*x2) + (250880*y1)), tmp13, xmask)
''')
