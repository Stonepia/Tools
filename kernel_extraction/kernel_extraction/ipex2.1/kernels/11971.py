...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/fa/cfavqrp3qtuc2tk5f53zez5srzv7m7adnmkcaopfqvx3qxgw2csg.py
...
@pointwise(size_hints=[65536], filename=__file__, meta={'signature': {0: '*i64', 1: '*bf16', 2: '*fp32', 3: '*bf16', 4: '*fp32', 5: '*bf16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_add_div_mul_neg_15', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
