...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/gm/cgmlzun5zunadoqnbaeb3stw5mf66zb6dqa3swh3lnutnd7a236i.py
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_embedding_dense_backward_nll_loss_forward_42', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
