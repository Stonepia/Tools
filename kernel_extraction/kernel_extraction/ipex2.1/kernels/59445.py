...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/nf/cnfg26e3mvg4b2d6rhp5zigckjrwlxnm4rcclilcvpbhvrl267sw.py
...
def triton_poi_fused_6(out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tmp0 < tmp5
    tmp7 = -0.599609375
    tmp8 = -0.2484130859375
    tmp9 = tl.where(tmp6, tmp7, tmp8)
    tmp10 = tl.full([1], 3, tl.int64)
    tmp11 = tmp0 < tmp10
    tmp12 = 0.1925048828125
    tmp13 = -4.25390625
