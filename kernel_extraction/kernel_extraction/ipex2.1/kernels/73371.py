...
# Original file: ./DebertaV2ForMaskedLM__0_forward_205.0/DebertaV2ForMaskedLM__0_forward_205.0_1.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/t4/ct4q4ie5seokgoktepedbsggnfd4khnmjz4sbqc2up3ebxo762gh.py
# Source Nodes: [gelu_24, l__mod___cls_predictions_decoder, l__mod___cls_predictions_transform_layer_norm], Original ATen: [aten.gelu, aten.native_layer_norm, aten.view]
# gelu_24 => add_171, convert_element_type_413, convert_element_type_414, erf_24, mul_269, mul_270, mul_271
# l__mod___cls_predictions_decoder => view_530
# l__mod___cls_predictions_transform_layer_norm => add_172, add_173, convert_element_type_415, convert_element_type_416, mul_272, mul_273, rsqrt_49, sub_146, var_mean_49
triton_red_fused_gelu_native_layer_norm_view_8 = async_compile.triton('triton_red_fused_gelu_native_layer_norm_view_8', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp16', 5: '*fp32', 6: '*fp16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_gelu_native_layer_norm_view_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_gelu_native_layer_norm_view_8(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 1024
    rnumel = 1536
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp31 = tl.load(in_ptr1 + (r1), rmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp34 = tl.load(in_ptr2 + (r1), rmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tl.store(out_ptr2 + (r1 + (1536*x0)), tmp37, rmask & xmask)
''')
