...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/mr/cmrj373zkimc7r74cvzsxasqmnihjstvyatgaivapauat4ouhoih.py
...
@triton.jit
def triton_per_fused__to_copy_native_dropout_backward_native_layer_norm_backward_6(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, out_ptr3, xnumel, rnumel):
    xnumel = 8192
