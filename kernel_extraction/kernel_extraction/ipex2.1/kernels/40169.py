...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/ze/czekjm3x7wjhzqankyutmsgbp7mwu5hbaiwzatkiudf2f5e7cufd.py
...
def triton_red_fused_any_isinf_native_layer_norm_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        r2 = (rindex // 512)
        r1 = rindex % 512
        tmp0 = tl.load(in_ptr0 + (r3 + (16384*x0)), xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp2 = tl.load(in_ptr1 + (r2 + (32*x0)), xmask, eviction_policy='evict_last', other=0.0)
        ...
        tl.store(out_ptr0 + (r3 + (16384*x0)), tmp12, xmask)
