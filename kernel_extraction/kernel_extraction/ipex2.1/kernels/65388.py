...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/zd/czdcoesuy3rhqo5gbe25umvkzekubflq3fr5y43kctedgegpkt3o.py
...
# l__mod___blocks_1_norm1_proj => add_32, add_33, clone_27, mul_30, mul_31, rsqrt_9, sub_12, var_mean_9
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: '*fp32', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_23', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
