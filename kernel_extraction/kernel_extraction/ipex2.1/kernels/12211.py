...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/5y/c5ybzgt5tt7qs2hoqsgidcuzi4yhuxxvnl5d7x5u4a3n2fs34eqb.py
# Source Nodes: [abs_7, abs_8, abs_9, add_15, gt_2, lt_3, maximum_6, maximum_7, minimum_4, minimum_5, mul_132, mul_133, mul_134, mul_135, mul_136, mul_139, mul_140, mul_141, sub_40, sub_41, sub_42, sub_43, tensor, tensor_3, tensor_4, truediv_71, truediv_72, where_5, where_8, where_9], Original ATen: [aten.abs, aten.add, aten.div, aten.gt, aten.lift_fresh, aten.lt, aten.maximum, aten.minimum, aten.mul, aten.rsub, aten.scalar_tensor, aten.sub, aten.where]
# abs_7 => abs_7
# abs_8 => abs_8
# abs_9 => abs_9
# add_15 => add_67
...
# where_8 => where_8
# where_9 => where_9
triton_poi_fused_abs_add_div_gt_lift_fresh_lt_maximum_minimum_mul_rsub_scalar_tensor_sub_where_80 = async_compile.triton('triton_poi_fused_abs_add_div_gt_lift_fresh_lt_maximum_minimum_mul_rsub_scalar_tensor_sub_where_80', '''
import triton
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp64', 1: '*fp64', 2: '*fp64', 3: '*fp64', 4: '*fp64', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_abs_add_div_gt_lift_fresh_lt_maximum_minimum_mul_rsub_scalar_tensor_sub_where_80', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused_abs_add_div_gt_lift_fresh_lt_maximum_minimum_mul_rsub_scalar_tensor_sub_where_80(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1000000
    ...
    x2 = (xindex // 5000)
    x4 = xindex
    tmp85 = tl.load(in_ptr3 + (x0), xmask, eviction_policy='evict_last')
    tmp0 = 1 + x0
    ...
    tmp70 = tmp60 * tmp69
    tmp71 = tl.abs(tmp70)
    tmp72 = tl.full([1], 1e-20, tl.float64)
    tmp73 = tmp71 < tmp72
    tmp74 = tl.where(tmp73, tmp72, tmp70)
    tmp75 = tmp59 / tmp74
    tmp76 = tl.full([1], 2.0, tl.float64)
    tmp77 = tmp75 * tmp76
    tmp78 = tl.full([1], 1.0, tl.float64)
    tmp79 = triton_helpers.minimum(tmp78, tmp77)
    tmp80 = triton_helpers.minimum(tmp76, tmp75)
    tmp81 = triton_helpers.maximum(tmp79, tmp80)
    tmp82 = triton_helpers.maximum(tmp8, tmp81)
    tmp83 = tmp78 - tmp82
    tmp84 = tmp9 * tmp78
    tmp86 = tmp84 / tmp85
    tmp87 = tl.abs(tmp86)
