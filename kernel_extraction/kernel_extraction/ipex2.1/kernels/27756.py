...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/sf/csfwfp5k2jgnywfofo23j3zb67komuyxua64tfokxx4bg27tuzch.py
# Source Nodes: [add_8, add_9, clamp_1, clamp_2, l__self___block_1_layer_0_dropout, mean_3, mul_10, mul_9, neg_1, neg_2, pow_4, rsqrt_3, to_10, to_9, where_1, where_2, where_3], Original ATen: [aten._to_copy, aten.add, aten.clamp, aten.clone, aten.mean, aten.mul, aten.neg, aten.pow, aten.rsqrt, aten.scalar_tensor, aten.where]
# add_8 => add_11
# add_9 => add_12
...
# where_2 => where_2
# where_3 => where_3
triton_per_fused__to_copy_add_clamp_clone_mean_mul_neg_pow_rsqrt_scalar_tensor_where_11 = async_compile.triton('triton_per_fused__to_copy_add_clamp_clone_mean_mul_neg_pow_rsqrt_scalar_tensor_where_11', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i1', 2: '*fp16', 3: '*i1', 4: '*fp16', 5: '*fp16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clamp_clone_mean_mul_neg_pow_rsqrt_scalar_tensor_where_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__to_copy_add_clamp_clone_mean_mul_neg_pow_rsqrt_scalar_tensor_where_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, rnumel):
    xnumel = 2048
