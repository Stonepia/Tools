...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/wo/cwowxo6i4q5knm6pmktthk34xix3ai5o4l2js7lyd7ldfiy25fhd.py
# Source Nodes: [interpolate], Original ATen: [aten._unsafe_index, aten.add, aten.floor, aten.mul, aten.rsub, aten.sub]
...
triton_poi_fused__unsafe_index_add_floor_mul_rsub_sub_14 = async_compile.triton('triton_poi_fused__unsafe_index_add_floor_mul_rsub_sub_14', '''
import triton
...
def triton_poi_fused__unsafe_index_add_floor_mul_rsub_sub_14(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp99 = tmp89 * tmp98
    tmp100 = tmp97 + tmp99
    tl.store(out_ptr0 + (y4 + (3*x3) + (150528*y5)), tmp100, xmask & ymask)
''')
