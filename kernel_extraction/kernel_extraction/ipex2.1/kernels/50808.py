...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/bs/cbsqdawk5spc3buit43ifl5y4s2yeyquwcfarhfgvgi5sprvxtog.py
...
@triton.jit
def triton_per_fused_add_clone_native_layer_norm_13(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, xnumel, rnumel):
    xnumel = 64
