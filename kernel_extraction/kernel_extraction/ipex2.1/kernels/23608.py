...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/2w/c2wqfite5m5ddo42gyvoxuto4mye5nhojuvpl3s7mdzp5s7vlq2x.py
# Source Nodes: [add_3, add_4, add_5, add_6, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
# add_3 => add_11
# add_4 => add_14
# add_5 => add_18
# add_6 => add_21
# layer_norm_6 => add_22, add_23, mul_24, mul_25, rsqrt_6, sub_9, var_mean_6
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: '*fp32', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 9), equal_to_1=())]}
)
@triton.jit
