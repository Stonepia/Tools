...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/4j/c4jka347yzp2m2ypf3kzlmqcnjzhghuqfsblpca7goikgiwffb2l.py
...
@pointwise(size_hints=[4], filename=__file__, meta={'signature': {0: '*i64', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_nll_loss_backward_nll_loss_forward_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
