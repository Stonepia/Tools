...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/vi/cviwyzdtflqpp33a2yay24tubu3w2r7ln4gd6ejgqqpquhdbwzpa.py
# Source Nodes: [batch_norm_20, getattr_getattr_l__self___stages___2_____0___conv1_1x1_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.silu]
# batch_norm_20 => add_48, mul_84, mul_85, sub_21
# getattr_getattr_l__self___stages___2_____0___conv1_1x1_bn_act => convert_element_type_142, mul_86, sigmoid_22
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_silu_27(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 16777216
