...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/rj/crjji4z2m62pepjpiphc2tmcaxqza6nkbsv7ovblnbmsh7x42yva.py
# Source Nodes: [iadd_5, nan_to_num, nan_to_num_4, softmax_4], Original ATen: [aten._softmax, aten._to_copy, aten.add, aten.nan_to_num]
# iadd_5 => add_32
...
# softmax_4 => amax_4, convert_element_type_40, exp_4, sub_14, sum_5
triton_poi_fused__softmax__to_copy_add_nan_to_num_25 = async_compile.triton('triton_poi_fused__softmax__to_copy_add_nan_to_num_25', '''
import triton
...
@pointwise(size_hints=[16], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax__to_copy_add_nan_to_num_25', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused__softmax__to_copy_add_nan_to_num_25(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 16
