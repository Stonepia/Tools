...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/js/cjs3wlfhe2amm3vjfuuxwhu2vekf73ws7tfgjzsppjijkwrqnhdw.py
# Source Nodes: [cross_entropy], Original ATen: [aten._log_softmax]
# cross_entropy => amax_6, convert_element_type_38, convert_element_type_39, exp_6, log, sub_19, sub_20, sum_7
...
def triton_red_fused__log_softmax_10(in_ptr0, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r1 + (50257*x0)), tmp17, rmask & xmask)
''')
