...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/ej/cejazfksd3tsa65uqrwawpuhy3a47xyvxxcx2maskmbkp2fywgvi.py
...
@pointwise(size_hints=[134217728], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_constant_pad_nd_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
def triton_poi_fused_constant_pad_nd_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp11 = tmp9 * tmp10
    tmp12 = tl.load(in_ptr3 + (x0), tmp5, eviction_policy='evict_last', other=0.0).to(tl.float32)
    tmp13 = tmp12.to(tl.float32)
    tmp14 = tmp11 * tmp13
    tmp15 = tl.load(in_ptr4 + (x0), tmp5, eviction_policy='evict_last', other=0.0).to(tl.float32)
