...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/fw/cfwtfgb6z7nbnk32ya6rg2gw7vxi4nh5rdlrfxrgdpaagqctcuzh.py
# Source Nodes: [add_5, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm], Original ATen: [aten.add, aten.native_layer_norm]
# add_5 => add_10
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm => add_11, add_12, convert_element_type_20, convert_element_type_21, mul_10, mul_9, rsqrt_2, sub_4, var_mean_2
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*bf16', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0', 'in_out_ptr1'], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_native_layer_norm_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_native_layer_norm_12(in_out_ptr0, in_out_ptr1, in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 2048
    rnumel = 4096
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp0 = tl.load(in_out_ptr0 + (r1 + (4096*x0)), None, eviction_policy='evict_first').to(tl.float32)
        tmp1 = tl.load(in_ptr0 + (r1 + (4096*x0)), None, eviction_policy='evict_first').to(tl.float32)
        tmp2 = tmp0 + tmp1
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr1 + (r1 + (4096*x0)), tmp27, None)
''')
