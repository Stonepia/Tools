...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/a7/ca7xuwtyawhlyf4j3f64lghzbpip2ymlwu75nit7nyvquqymm7hi.py
...
def triton_poi_fused_add_mul_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp7 = tl.load(in_ptr4 + (x0 + (64*x2) + (2048*x1)), None)
    tmp9 = tl.load(in_ptr5 + (x4), None)
    tmp2 = tmp0 * tmp1
    tmp5 = tmp3 * tmp4
    tmp6 = tmp2 + tmp5
    tmp8 = tmp7 * tmp1
