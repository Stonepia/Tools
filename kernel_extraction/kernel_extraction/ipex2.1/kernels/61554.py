...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/3i/c3ix7ywgt4trwxjlthcual5keyxgqdwuhw7g5dnbl2bcxyc5ho4k.py
...
# l__mod___features_denseblock3_denselayer7_norm1 => add_103, convert_element_type_155, mul_154, mul_155, sub_51
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_52', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
