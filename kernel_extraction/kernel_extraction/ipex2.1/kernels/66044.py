...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/xy/cxylu2byrri64vqshexoybs6a4yi6nwbkxn7q2envp4ygf6vlmpx.py
# Source Nodes: [getattr_getattr_l__self___blocks___4_____0___bn2_act, mean_5], Original ATen: [aten.hardswish, aten.mean]
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_hardswish_mean_18', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
