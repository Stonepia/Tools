...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/i2/ci22bck4sikuujmyfl3cmaisykfsd732rkvpi2y6ckjaca7z6ncg.py
...
def triton_per_fused__to_copy_add_clone_embedding_mean_mul_pow_rsqrt_9(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, rnumel):
    ...
    tmp3 = tl.load(in_out_ptr0 + (r1 + (768*x0)), rmask, other=0.0).to(tl.float32)
