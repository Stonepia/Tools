...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/fu/cful2my77edtphmtvdmlzmx5ywlkze45gltzqftzgcszm5jmjjnh.py
# Source Nodes: [add_3, l__self___roberta_encoder_layer_0_attention_self_dropout, matmul_1, softmax, truediv], Original ATen: [aten._softmax, aten._to_copy, aten.add, aten.div, aten.native_dropout]
# add_3 => convert_element_type_default
# l__self___roberta_encoder_layer_0_attention_self_dropout => gt_1, mul_6, mul_7
