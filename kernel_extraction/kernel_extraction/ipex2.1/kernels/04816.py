...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/ye/cyeld5romsjkypcth5cpvsrhwjgwzoo3uwwvsx2nrrwknp5fse2c.py
# Source Nodes: [getattr_getattr_l__self___layers___2___blocks___1___norm2], Original ATen: [aten.native_layer_norm]
# getattr_getattr_l__self___layers___2___blocks___1___norm2 => add_53, add_54, convert_element_type_93, convert_element_type_94, mul_49, mul_50, rsqrt_14, sub_20, var_mean_14
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*fp32', 5: '*fp32', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_layer_norm_40', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
