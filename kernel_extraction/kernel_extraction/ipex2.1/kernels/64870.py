...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/k5/ck56gcdxiphyau65ao6k64bezvtnibbpuu5dam3tumkt2mrptugd.py
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_convolution_glu_relu_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_convolution_glu_relu_7(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x1 = (xindex // 5802) % 256
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x3 + (2970624*x2)), None)
    tmp1 = tl.load(in_ptr1 + (x1), None, eviction_policy='evict_last')
    tmp3 = tl.load(in_ptr0 + (1485312 + x3 + (2970624*x2)), None)
