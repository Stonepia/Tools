...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/bl/cble2tfnysuvtbypwclp5rqeoz7drb27qf5pmxtgatvyv3xzhxtw.py
...
# l__self___layer_stack_0_slf_attn_attention_softmax => amax, convert_element_type_2, convert_element_type_3, div_1, exp, sub_1, sum_1
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*bf16', 2: 'fp64', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_div_masked_fill_repeat_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
