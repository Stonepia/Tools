...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/wd/cwdlmubnx2qyv2kfvn3dav2m24qobit3vuw7vajtea4hje6przya.py
...
@pointwise(size_hints=[2048, 4096], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__unsafe_view_clone_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
