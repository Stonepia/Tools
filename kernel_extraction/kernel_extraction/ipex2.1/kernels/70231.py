...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/to/cto5azvpj2nbogzftqanc3ijl6jlco7lbllmq3sowthlidgvoaxr.py
...
@pointwise(size_hints=[16384], filename=__file__, meta={'signature': {0: '*i64', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_nll_loss_backward_nll_loss_forward_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
