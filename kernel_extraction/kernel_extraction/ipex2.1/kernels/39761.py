...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/mz/cmz2fhr73px4m4fcslthmjrpg6yc5nvehrmzy4vz2pmhgdzbotxf.py
...
# getattr_l__mod___stages___1___downsample_attn_downsample_proj_ln_bn => add_70, convert_element_type_102, mul_84, mul_85, sub_27
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_18', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
