...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/xa/cxaprgk6tmul3cdizdnlv5trroqvnxsgija62eg55errm6jnuq7i.py
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*i1', 2: '*i1', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_native_dropout_backward_nll_loss_forward_threshold_backward_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
