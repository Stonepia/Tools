...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/qi/cqiwzfbbcz7oowr32qcyew2k7yplicu7ojhunkjwxsicqvtnfts6.py
...
def triton_red_fused_any_isnan_0(in_ptr0, out_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp0 = tl.load(in_ptr0 + (r1 + (16384*x0)), xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
