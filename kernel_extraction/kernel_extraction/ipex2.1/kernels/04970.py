...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/xq/cxqfq2oe64o2h77ob4a5x5yqgz34ycqu3nk62zhg73lp56punaso.py
# Source Nodes: [getattr_getattr_l__self___layers___1___blocks___1___norm2], Original ATen: [aten.native_layer_norm]
# getattr_getattr_l__self___layers___1___blocks___1___norm2 => add_34, add_35, convert_element_type_60, convert_element_type_61, mul_31, mul_32, rsqrt_9, sub_13, var_mean_9
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp32', 5: '*fp32', 6: '*fp16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_layer_norm_26', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
