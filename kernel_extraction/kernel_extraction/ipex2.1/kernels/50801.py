...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/cg/ccgjmt3gnc344yrtkl5wyrj2j4pljqrhkixb5apxcpby4dag7eet.py
...
# layer_norm_1 => add_5, add_6, mul_4, mul_5, rsqrt_1, sub_3, var_mean_1
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_embedding_native_layer_norm_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
