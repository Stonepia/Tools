...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/sy/csyskf5kp62xeumfnpqhkefmjeg45u7ug2swpkqvvoiab2cznwxr.py
...
# nan_to_num_15 => convert_element_type_327, eq_62, eq_63, isnan_15, where_46, where_47, where_48
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_57', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
