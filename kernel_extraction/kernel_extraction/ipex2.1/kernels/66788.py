...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/pn/cpn5yphwgsj2rdqu26bn7kjmv3xq5invhng7fk6kfxbskvpqzz64.py
...
@pointwise(size_hints=[16], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax__to_copy_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused__softmax__to_copy_4(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp22 = tl.load(in_ptr1 + (x1), xmask, eviction_policy='evict_last')
    ...
    tmp19 = tl.load(in_ptr0 + (x1 + (8*tmp18)), xmask).to(tl.float32)
    tmp20 = tmp0 + tmp19
