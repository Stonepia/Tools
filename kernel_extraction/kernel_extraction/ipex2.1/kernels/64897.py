...
triton_poi_fused_add_convolution_glu_relu_8 = async_compile.triton('triton_poi_fused_add_convolution_glu_relu_8', '''
import triton
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_convolution_glu_relu_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_convolution_glu_relu_8(in_out_ptr0, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 23769088
    ...
    tmp4 = tl.load(in_ptr1 + (355 + x0 + (23923*x4)), None).to(tl.float32)
    tmp2 = tmp0 + tmp1
