...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/lc/clcm7wzqt56mro3d25lpnbhlfqny5kaaowjtqagmwaz2oig7h4vf.py
# Source Nodes: [getattr_getattr_l__self___stages___1___blocks___1___token_mixer_pool, group_norm_15], Original ATen: [aten.avg_pool2d, aten.native_group_norm]
# getattr_getattr_l__self___stages___1___blocks___1___token_mixer_pool => avg_pool2d_7
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_avg_pool2d_native_group_norm_26', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_avg_pool2d_native_group_norm_26(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        r1 = rindex % 28
        r5 = rindex
        tmp80 = tl.load(in_ptr1 + (r5 + (37632*x0)), rmask & xmask, eviction_policy='evict_last', other=0.0)
        tmp81 = tl.load(in_ptr0 + (r5 + (37632*x0)), rmask & xmask, eviction_policy='evict_last', other=0.0)
        tmp83 = tl.load(in_ptr2 + ((48*x6) + (r5 // 784)), rmask & xmask, eviction_policy='evict_last', other=0.0)
        tmp0 = (-1) + r2
        ...
        tmp9 = tmp7 & tmp8
        tmp10 = tmp5 & tmp9
        tmp11 = tl.load(in_ptr0 + ((-29) + r5 + (37632*x0)), rmask & tmp10 & xmask, eviction_policy='evict_last', other=0.0)
        ...
        tmp16 = tmp14 & tmp15
        tmp17 = tmp5 & tmp16
        tmp18 = tl.load(in_ptr0 + ((-28) + r5 + (37632*x0)), rmask & tmp17 & xmask, eviction_policy='evict_last', other=0.0)
        ...
        tmp24 = tmp22 & tmp23
        tmp25 = tmp5 & tmp24
        tmp26 = tl.load(in_ptr0 + ((-27) + r5 + (37632*x0)), rmask & tmp25 & xmask, eviction_policy='evict_last', other=0.0)
        ...
        tmp32 = tmp30 & tmp31
        tmp33 = tmp32 & tmp9
        tmp34 = tl.load(in_ptr0 + ((-1) + r5 + (37632*x0)), rmask & tmp33 & xmask, eviction_policy='evict_last', other=0.0)
        tmp35 = tl.where(tmp33, tmp34, 0.0)
        tmp36 = tmp35 + tmp28
        tmp37 = tmp32 & tmp16
        tmp38 = tl.load(in_ptr0 + (r5 + (37632*x0)), rmask & tmp37 & xmask, eviction_policy='evict_last', other=0.0)
        tmp39 = tl.where(tmp37, tmp38, 0.0)
        tmp40 = tmp39 + tmp36
        tmp41 = tmp32 & tmp24
        tmp42 = tl.load(in_ptr0 + (1 + r5 + (37632*x0)), rmask & tmp41 & xmask, eviction_policy='evict_last', other=0.0)
        ...
        tmp48 = tmp46 & tmp47
        tmp49 = tmp48 & tmp9
        tmp50 = tl.load(in_ptr0 + (27 + r5 + (37632*x0)), rmask & tmp49 & xmask, eviction_policy='evict_last', other=0.0)
        tmp51 = tl.where(tmp49, tmp50, 0.0)
        tmp52 = tmp51 + tmp44
        tmp53 = tmp48 & tmp16
        tmp54 = tl.load(in_ptr0 + (28 + r5 + (37632*x0)), rmask & tmp53 & xmask, eviction_policy='evict_last', other=0.0)
        tmp55 = tl.where(tmp53, tmp54, 0.0)
        tmp56 = tmp55 + tmp52
        tmp57 = tmp48 & tmp24
        tmp58 = tl.load(in_ptr0 + (29 + r5 + (37632*x0)), rmask & tmp57 & xmask, eviction_policy='evict_last', other=0.0)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r5 = rindex
        tmp90 = tl.load(in_ptr1 + (r5 + (37632*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0)
        tmp91 = tl.load(out_ptr0 + (r5 + (37632*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0)
        tmp92 = tl.load(in_ptr0 + (r5 + (37632*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0)
        tmp94 = tl.load(in_ptr2 + ((48*x6) + (r5 // 784)), rmask & xmask, eviction_policy='evict_last', other=0.0)
        tmp93 = tmp91 - tmp92
        tmp95 = tmp93 * tmp94
        tmp96 = tmp90 + tmp95
