...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/me/cme7bzujri37a2fswzppf65trtc25bz2l4u62xf2vuysjhwvsoxo.py
# Source Nodes: [add_1, getattr_l__mod___model___11___conv_block_6, getattr_l__mod___model___12___conv_block_0], Original ATen: [aten._native_batch_norm_legit, aten.add, aten.reflection_pad2d]
# add_1 => add_8
# getattr_l__mod___model___11___conv_block_6 => add_7, mul_6, rsqrt_6, sub_6, var_mean_6
# getattr_l__mod___model___12___conv_block_0 => reflection_pad2d_5
...
def triton_poi_fused__native_batch_norm_legit_add_reflection_pad2d_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp12 = tl.load(in_ptr1 + (x0 + (256*tmp10) + (16384*tmp5)), xmask)
    tmp14 = tmp12 - tmp13
    tmp16 = 4096.0
    tmp17 = tmp15 / tmp16
    tmp18 = 1e-05
