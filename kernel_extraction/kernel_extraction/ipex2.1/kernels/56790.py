...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/jl/cjlfkwwsq7fwp36cr33tfmllvwwtabl2hscxmmrgcux5p2ugcmtf.py
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*i64', 2: '*fp32', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
