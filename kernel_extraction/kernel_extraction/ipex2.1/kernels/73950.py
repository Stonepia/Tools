...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/og/cogoomb55h5ttxh4uzasd7mde3cw5tkgl7s6m5eqkyxuenq5xso3.py
...
# batch_norm_100 => add_233, mul_301, mul_302, sub_100
# batch_norm_101 => add_235, mul_304, mul_305, sub_101
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_133(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, out_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (2432*x2) + (476672*y1)), tmp9, xmask)
    tl.store(out_ptr1 + (y0 + (2432*x2) + (476672*y1)), tmp14, xmask)
''')
