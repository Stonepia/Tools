...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/hc/chc6zzbsrkedyusqlk6e6kfunpphrnku6wriibvts5fhcewase4x.py
# Source Nodes: [add_10, add_4, add_7, add_9, l__self___decoder_block_0_layer__1__dropout, l__self___decoder_block_1_layer_0_self_attention_q, l__self___decoder_embed_tokens, mean_3, mul_10, mul_11, pow_4, rsqrt_3], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add_10 => add_12
# add_4 => add_5
# add_7 => add_9
# add_9 => add_11
# l__self___decoder_block_0_layer__1__dropout => clone_6
# l__self___decoder_block_1_layer_0_self_attention_q => convert_element_type_29
