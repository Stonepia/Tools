...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/nj/cnj6rgqogyen4bgapp47vq4vsl6p6oh77ahjwddj53clctr5o4mh.py
...
# batch_norm_39 => add_91, mul_118, mul_119, sub_39
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_52(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, out_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1152*x2) + (903168*y1)), tmp9, xmask)
    tl.store(out_ptr1 + (y0 + (1152*x2) + (903168*y1)), tmp14, xmask)
''')
