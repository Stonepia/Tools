...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/s2/cs2ikuz7hzufbrdrkhhj7dgidv3ggql4z6xmvazdvib7lcflwv6o.py
...
triton_poi_fused__native_batch_norm_legit_no_training_avg_pool2d_37 = async_compile.triton('triton_poi_fused__native_batch_norm_legit_no_training_avg_pool2d_37', '''
import triton
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_avg_pool2d_37', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_avg_pool2d_37(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 2097152
