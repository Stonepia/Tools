...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/ch/cchavi5ftbqbxthu5w53fwa3dmyehxsgk4kn4t4vted5eyxsbbfq.py
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_convolution_glu_relu_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_convolution_glu_relu_6(in_out_ptr0, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp4 = tl.load(in_ptr1 + (87 + x0 + (5979*x4)), None)
    tmp2 = tmp0 + tmp1
