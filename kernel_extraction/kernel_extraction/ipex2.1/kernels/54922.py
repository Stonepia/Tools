...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/es/cesw5pkl2st4g45yy6mwj4lufl5so7ihjmdup3vmrd6mlgr3lj6q.py
# Source Nodes: [iadd, softmax], Original ATen: [aten._softmax, aten._to_copy, aten.add]
# iadd => add_5
# softmax => amax, clone_5, convert_element_type_14, div_7, exp, sub_4, sum_1
triton_per_fused__softmax__to_copy_add_21 = async_compile.triton('triton_per_fused__softmax__to_copy_add_21', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp16', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax__to_copy_add_21', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax__to_copy_add_21(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr3, xnumel, rnumel):
    xnumel = 49152
