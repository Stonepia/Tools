...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/nl/cnlk6phsvjf5peji5hvsf4ywebye2wdwatcjo3zrronifsz4ifao.py
...
# getattr_getattr_l__mod___layers___2___blocks___0___norm1 => convert_element_type_38, var_mean_11
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_clone_native_layer_norm_29', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_clone_native_layer_norm_29(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel):
    ...
    tl.store(out_ptr2 + (r1 + (512*x2) + (3584*x4) + (25088*x3) + (50176*x5)), tmp31, rmask & xmask)
''')
