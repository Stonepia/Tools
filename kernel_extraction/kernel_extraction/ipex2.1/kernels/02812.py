...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/tt/cttxowwngn5sheee2jxlmdn2na5ok26eufzhlcjoxx57iuoahbot.py
...
@pointwise(size_hints=[4096, 1024], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_36', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
