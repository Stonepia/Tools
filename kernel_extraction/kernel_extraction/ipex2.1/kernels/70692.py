...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/xx/cxxx33qbovyrv2in3fajdkperpigy3anwdvhf4kpg3ean76x2w2r.py
# Source Nodes: [cross_entropy], Original ATen: [aten.nll_loss_backward, aten.nll_loss_forward]
# cross_entropy => convert_element_type_87, div_12, full_default_12, full_default_13, ne, neg, sum_8, sum_9, where_7
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*i64', 2: '*fp32', 3: '*i1', 4: '*i64', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_nll_loss_backward_nll_loss_forward_21', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 7), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_nll_loss_backward_nll_loss_forward_21(in_out_ptr0, in_ptr0, in_ptr1, out_ptr1, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 1
    rnumel = 8176
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp10 = tl.load(in_ptr1 + (tmp9 + (50257*r0)), rmask, eviction_policy='evict_first', other=0.0)
        tmp11 = -tmp10
        tmp12 = 0.0
