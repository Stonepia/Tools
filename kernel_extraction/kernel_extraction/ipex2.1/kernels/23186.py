...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/yk/cyk63kgm2de7jyau37v27clfb4jh5oj4gucdxw35ckv7zuchak25.py
...
@pointwise(size_hints=[65536, 1024], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*fp32', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_mul_silu_37', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
