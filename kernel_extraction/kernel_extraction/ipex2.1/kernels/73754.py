...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/tx/ctxpl3vbocbzvgh6eaiem2s62pcijw665j4ab3gj2xz5spxwmvgr.py
# Source Nodes: [batch_norm_64, l__mod___features_conv4_9_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_64 => add_149, convert_element_type_194, mul_193, mul_194, sub_64
# l__mod___features_conv4_9_c1x1_a_bn_act => relu_64
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_85(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1664*x2) + (326144*y1)), tmp13, xmask)
''')
