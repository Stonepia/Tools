...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/pp/cppd6ryfg76wzc4hghwp5kzez7dfudjp5mql5dkjdlyeqgxwpxo3.py
...
triton_poi_fused_copy_new_zeros_select_scatter_slice_slice_scatter_12 = async_compile.triton('triton_poi_fused_copy_new_zeros_select_scatter_slice_slice_scatter_12', '''
import triton
...
@pointwise(size_hints=[1024, 4096], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_new_zeros_select_scatter_slice_slice_scatter_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused_copy_new_zeros_select_scatter_slice_slice_scatter_12(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 513
    xnumel = 4096
