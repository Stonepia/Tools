...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/s5/cs5ex6ygtmm7ijfxtvwr4axsiigcfeqrlqngqzpceboeianeotev.py
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*fp16', 2: 'fp64', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_div_masked_fill_repeat_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
