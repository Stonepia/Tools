...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/ru/crud7f2gceqk3ureikj3zcaeptnxljyvg6jzukpfpgnwckveojke.py
...
@pointwise(size_hints=[2048], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*bf16', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_functional_convolution_backward_native_batch_norm_backward_nll_loss_forward_relu_threshold_backward_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]})
@triton.jit
