...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/47/c4747dsva25mxffh7ust7mr5s6gr6hckm4b7bgsk2mrugy5fa5vd.py
# Source Nodes: [softmax], Original ATen: [aten._softmax]
# softmax => clone_1, convert_element_type_4, convert_element_type_5, div, exp, sub_2
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*bf16', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
