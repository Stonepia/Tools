...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/4w/c4woxhv4vsqzgc3s3oyyv4o5yn73dzu6zkhuaa5auxl6qd3r3rou.py
# Source Nodes: [add_14, add_15, add_16, getattr_getattr_getattr_l__self___stages___4_____1___transformer___0___attn_proj_drop, getattr_getattr_getattr_l__self___stages___4_____1___transformer___0___mlp_drop2, getattr_getattr_getattr_l__self___stages___4_____1___transformer___1___attn_proj_drop, getattr_getattr_getattr_l__self___stages___4_____1___transformer___1___norm2], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add_14 => add_102
# add_15 => add_105
# add_16 => add_108
...
# getattr_getattr_getattr_l__self___stages___4_____1___transformer___1___norm2 => add_109, add_110, convert_element_type_288, convert_element_type_289, mul_166, mul_167, rsqrt_17, sub_54, var_mean_17
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*fp32', 5: '*fp32', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_57', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_clone_native_layer_norm_57(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 4096
    rnumel = 240
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (240*x3)), tmp31, rmask)
''')
