...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/ay/caysurktzrhel6ota73ufjt4djrk7vkuj5mrugvup5zvi53kcnnb.py
...
triton_per_fused__softmax_add_mul_31 = async_compile.triton('triton_per_fused__softmax_add_mul_31', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_mul_31', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax_add_mul_31(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 32768
    rnumel = 64
