...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/cm/ccmqrfv36p5jkj5s72sq2bgcjeyy23k2nl2g4eysl53qdwanuslo.py
# Source Nodes: [l__self___encoder_b_encoder], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.native_layer_norm]
# l__self___encoder_b_encoder => add_92, add_93, add_94, clone_64, clone_65, convert_element_type_130, mul_78, mul_79, rsqrt_27, sub_27, var_mean_27
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*fp32', 2: '*fp32', 3: '*bf16', 4: '*fp32', 5: '*fp32', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clone_native_layer_norm_21', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__to_copy_add_clone_native_layer_norm_21(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel):
    xnumel = 2464
