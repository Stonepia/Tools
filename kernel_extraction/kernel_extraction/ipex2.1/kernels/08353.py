...
# Source Nodes: [add_10, add_11, add_6, l__self___block_0_layer_0_dropout, l__self___block_0_layer_1_dropout, l__self___embed_tokens, mean_2, mul_8, mul_9, pow_3, rsqrt_2, to_8, to_9], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add_10 => add_14
# add_11 => add_15
# add_6 => add_9
