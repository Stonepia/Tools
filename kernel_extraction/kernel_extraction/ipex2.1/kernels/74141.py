...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/27/c27lvlepawges4icfjrexdt3pmk7dmszgskxcebc6lbs3jj3iv5b.py
# Source Nodes: [batch_norm_21, l__self___features_conv3_3_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_21 => add_49, convert_element_type_87, mul_64, mul_65, sub_21
# l__self___features_conv3_3_c1x1_a_bn_act => relu_21
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_28(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (768*x2) + (602112*y1)), tmp11, xmask)
''')
