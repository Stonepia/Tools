...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/ex/cexfrkfkhjzbxjskda5mvd5qrnfuayrega7hfhokudvjdepny4kq.py
# Source Nodes: [add, getattr_l__mod___network_0___0___attn_proj, getattr_l__mod___network_0___0___norm2], Original ATen: [aten.add, aten.native_layer_norm]
# add => add_13
# getattr_l__mod___network_0___0___attn_proj => add_12
# getattr_l__mod___network_0___0___norm2 => add_14, add_15, clone_8, convert_element_type_17, convert_element_type_18, mul_12, mul_13, rsqrt_1, sub_5, var_mean_1
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
