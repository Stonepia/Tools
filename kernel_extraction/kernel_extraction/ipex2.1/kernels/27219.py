...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/ex/cexenhfqpsk4dbb32fidq2k7tmx3gnh57kvybj5mqartjteh3pyj.py
# Source Nodes: [iadd_1, nan_to_num, softmax, type_as_2], Original ATen: [aten._softmax, aten._to_copy, aten.add, aten.nan_to_num]
# iadd_1 => add_4
# nan_to_num => convert_element_type_12, eq_2, eq_3, full_default_2, full_default_3, full_default_4, isnan, where_1, where_2, where_3
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
