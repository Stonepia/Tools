...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/4g/c4gqnzibdadbpzj4dzgwuvprnv6c33toxsrr3gax5nn7igkohr4q.py
...
def triton_red_fused_add_native_layer_norm_native_layer_norm_backward_sum_20(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp4 = tl.load(in_ptr1 + (x0 + (768*r2) + (196608*x1)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp6 = tl.load(in_ptr2 + (x0 + (768*r2) + (196608*x1)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp8 = tl.load(in_ptr3 + (x0 + (768*r2) + (196608*x1)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp11 = tl.load(in_ptr4 + (x0 + (768*r2) + (196608*x1)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp13 = tl.load(in_ptr5 + (r2 + (256*x1)), rmask, eviction_policy='evict_last', other=0.0)
        tmp15 = tl.load(in_ptr6 + (r2 + (256*x1)), rmask, eviction_policy='evict_last', other=0.0)
