...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/um/cum4v6xf5pahii3ruxvq57vusw6nzx7pfirxeyy5sg2jqeivltgj.py
# Source Nodes: [add_1, batch_norm_10, getattr_getattr_l__mod___stages___1___blocks___0___conv2_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.leaky_relu]
# add_1 => add_23
# batch_norm_10 => add_22, mul_41, mul_42, sub_10
# getattr_getattr_l__mod___stages___1___blocks___0___conv2_bn_act => convert_element_type_54, gt_10, mul_43, where_10
...
@pointwise(size_hints=[262144, 64], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: '*fp16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_add_leaky_relu_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]})
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_add_leaky_relu_17(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp18 = tl.load(in_ptr5 + (262144 + y2 + (4096*x1) + (524288*y3)), xmask, eviction_policy='evict_last').to(tl.float32)
