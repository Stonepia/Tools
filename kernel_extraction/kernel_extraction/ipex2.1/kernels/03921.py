...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/sn/csnkklejbys4h7dj3rm2h627cqcascklg5eif54azph4tliqnvsl.py
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_new_zeros_scatter_reduce_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
