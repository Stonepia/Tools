...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/lo/clorvysgzvoalhzvczdppzti52ugasw5wjzjautows7ylndz5nqb.py
# Source Nodes: [group_norm_1], Original ATen: [aten.native_group_norm]
# group_norm_1 => add_4, convert_element_type_5, mul_4
...
@triton.jit
def triton_poi_fused_native_group_norm_8(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 19267584
