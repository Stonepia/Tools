...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/nx/cnxxjxhyvvhk6y3lrqbdesa4jqnhwuolh2nanvh7kaiqh7oljjep.py
...
# batch_norm_23 => add_61, convert_element_type_71, mul_70, mul_71, sub_23
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp32', 3: '*fp32', 4: '*fp16', 5: '*fp16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_add_relu_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
