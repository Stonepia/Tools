...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/qn/cqnvoaatbskh3dfizuz265z5rv3rjiax53pt2dfxrc57qfffxvgh.py
...
def triton_poi_fused_clone_61(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp15 = tl.load(in_ptr5 + (((y0 + (2*y1) + (4*x2) + (16*x3)) // 64) % 240), ymask, eviction_policy='evict_last')
    tmp17 = tl.load(in_ptr6 + (((y0 + (2*y1) + (4*x2) + (16*x3)) // 64) % 240), ymask, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tmp4 = tmp2 + tmp3
    ...
    tl.store(out_ptr0 + (y0 + (2*x2) + (8*y1) + (16*x3)), tmp19, ymask)
''')
