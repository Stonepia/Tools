...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/ey/ceypqos3pg3wrhxqldddqctpoou3a5et4ghwo3ytv6h5pbmdzbkh.py
# Source Nodes: [add, dropout_1, l__self___fc1, l__self___self_attn_layer_norm], Original ATen: [aten.add, aten.native_dropout, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
# add => add
# dropout_1 => gt, mul_1, mul_2
# l__self___fc1 => view_16
# l__self___self_attn_layer_norm => add_1, add_2, mul_3, mul_4, rsqrt, sub_1, var_mean
...
def triton_per_fused_add_native_dropout_native_layer_norm_native_layer_norm_backward_view_4(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, out_ptr4, out_ptr5, out_ptr6, load_seed_offset, xnumel, rnumel):
    ...
    tl.store(out_ptr5 + (r1 + (512*x0)), tmp38, rmask)
