...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/sj/csj5ar7p2fxjyd67mw7oyqafuyb6awos7mxnolwnrty3scqtj7cf.py
# Source Nodes: [add, l__mod___tok_embeddings, mean, mul, mul_1, pow_1, rsqrt], Original ATen: [aten.add, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add => add
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_embedding_mean_mul_pow_rsqrt_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_embedding_mean_mul_pow_rsqrt_0(in_ptr0, in_ptr1, in_ptr2, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp14 = tmp8 * tmp13
        tmp16 = tmp14 * tmp15
        tl.store(out_ptr1 + (r1 + (512*x0)), tmp16, rmask & xmask)
''')
