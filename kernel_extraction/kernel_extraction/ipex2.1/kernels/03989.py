...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/ph/cphpju6kpmzqbqrovue77bwilm3536pitmje63encousuwid5od5.py
# Source Nodes: [getattr_getattr_l__self___stages___0___blocks___0___attn_gate, getattr_l__self___stages___1___pool, mul], Original ATen: [aten.hardsigmoid, aten.max_pool2d_with_indices, aten.mul]
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_hardsigmoid_max_pool2d_with_indices_mul_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
