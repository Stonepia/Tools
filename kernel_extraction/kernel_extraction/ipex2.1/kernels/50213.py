...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/mi/cmi6stbzs2zwiwp6gjqu34g54l4ar75g3rmjoy6637oiiqoeuuih.py
...
def triton_per_fused_native_layer_norm_view_0(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, xnumel, rnumel):
    ...
    tl.store(out_ptr1 + (r1 + (768*x0)), tmp31, rmask)
