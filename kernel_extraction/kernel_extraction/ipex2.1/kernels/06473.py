...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/ik/cikdx3k2mk2qm3d6ykef65fgqjutxbv3zakjo6igydx3syuep4lm.py
...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, out_ptr2, out_ptr3, out_ptr4, ks0, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 64
    rnumel = 2
