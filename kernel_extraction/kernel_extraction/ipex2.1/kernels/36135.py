...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/ql/cql7adcgmjrhmsbxn4mnj4xlvarfrosvxx2vwrthz5i2r5vhinfu.py
...
def triton_poi_fused_index_2(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.where(tmp0 < 0, tmp0 + 355, tmp0)
    # tl.device_assert(((0 <= tmp1) & (tmp1 < 355)) | ~xmask, "index out of bounds: 0 <= tmp1 < 355")
