...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/vo/cvo6sl2xgi35fydqszmbq4elv6thvft7nexpusidedh3xoz7nxzl.py
...
@pointwise(size_hints=[524288], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*i1', 4: '*i64', 5: '*fp32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['out_ptr1'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_embedding_dense_backward_native_dropout_backward_native_layer_norm_backward_sum_25', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
