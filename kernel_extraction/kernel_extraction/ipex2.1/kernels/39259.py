...
# Original file: ./detectron2_fasterrcnn_r_101_fpn__44_inference_84.24/detectron2_fasterrcnn_r_101_fpn__44_inference_84.24_2.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/iu/ciu5fh2gow7jkgexvvsly5lfg67e2t2k7jr5swobdchi47nb6st7.py
...
@pointwise(size_hints=[1024], filename=__file__, meta={'signature': {0: '*fp32', 1: '*i64', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_add_clamp_div_floor_log2_mul_sqrt_sub_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
