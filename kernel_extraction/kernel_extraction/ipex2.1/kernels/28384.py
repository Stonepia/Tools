...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/lz/clzfxjtvs32wylo2v3yri6ybirjyxdpopfpt7k54r2jiqgyzc3n4.py
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*i64', 1: '*fp32', 2: '*bf16', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_native_dropout_transpose_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 5), equal_to_1=())]})
@triton.jit
