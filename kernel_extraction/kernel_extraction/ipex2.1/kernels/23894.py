...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/7b/c7bcn5o4mimux7sxvy6l7awivaw6vl4ochenyrcii3tabsfflont.py
# Source Nodes: [softmax_2], Original ATen: [aten._softmax]
# softmax_2 => clone_17, convert_element_type_22, convert_element_type_23, div_2, exp_2, sub_9
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*bf16', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax_27', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
