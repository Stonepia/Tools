...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/6a/c6adw6xvem5yzevbltudq7ddxema5v27mzox3ti5z2nk7no7zexh.py
...
def triton_per_fused__to_copy_add_clone_embedding_mean_mul_pow_rsqrt_9(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, out_ptr2, xnumel, rnumel):
    ...
    tmp9 = tl.load(in_ptr4 + (r1 + (768*x0)), rmask, other=0.0).to(tl.float32)
    ...
    tl.store(out_ptr0 + (r1 + (768*x0)), tmp11, rmask)
