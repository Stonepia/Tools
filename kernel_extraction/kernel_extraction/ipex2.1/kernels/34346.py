...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/yg/cyg6qasbnbo5y7ddjxecqdxm4q3q3jgavr5njvksqgxlkq7tz3n5.py
# Source Nodes: [add_7, add_8, add_9, getattr_l__mod___transformers_1_blocks___0___attn_proj_drop, getattr_l__mod___transformers_1_blocks___0___mlp_drop2, getattr_l__mod___transformers_1_blocks___1___attn_proj_drop, getattr_l__mod___transformers_1_blocks___1___norm2], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add_7 => add_25
# add_8 => add_29
# add_9 => add_32
...
# getattr_l__mod___transformers_1_blocks___1___norm2 => add_33, add_34, convert_element_type_26, convert_element_type_27, mul_30, mul_31, rsqrt_9, sub_9, var_mean_9
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: '*fp16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_22', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_clone_native_layer_norm_22(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel):
    xnumel = 16448
