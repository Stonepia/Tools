...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/5t/c5te62le2t5wdapwjxxv2o7usjrozyk6t7y2c7orioun7xkqhjjr.py
...
@triton.jit
def triton_per_fused_gelu_native_layer_norm_view_13(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 16384
    rnumel = 128
