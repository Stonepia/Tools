...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/ql/cqlkpukjxnm5aidruz7wksoazjcvr5coxsnyqillqqbg3hp42hta.py
# Source Nodes: [getattr_getattr_l__mod___layers___3___blocks___1___norm2], Original ATen: [aten.native_layer_norm]
# getattr_getattr_l__mod___layers___3___blocks___1___norm2 => add_207, add_208, convert_element_type_196, convert_element_type_197, mul_195, mul_196, rsqrt_51, sub_75, var_mean_51
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_layer_norm_53', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_native_layer_norm_53(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel):
    ...
    tl.store(out_ptr2 + (r2 + (1024*x3)), tmp37, rmask & xmask)
''')
