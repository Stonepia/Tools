...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/sp/cspw6j2na23ed3ho6u4t2raesxkbtyvzzticjpvqiyaxh3vh2dx7.py
# Source Nodes: [add_5, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
# add_5 => add_17
# layer_norm_5 => add_18, add_19, convert_element_type_18, convert_element_type_19, mul_20, mul_21, rsqrt_5, sub_7, var_mean_5
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_native_layer_norm_15', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_native_layer_norm_15(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 25088
    rnumel = 256
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp9 = tl.load(in_ptr1 + (r3 + (256*x4)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp19 = tl.load(in_ptr2 + (r3), rmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp22 = tl.load(in_ptr3 + (r3), rmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp10 = tmp8 + tmp9
