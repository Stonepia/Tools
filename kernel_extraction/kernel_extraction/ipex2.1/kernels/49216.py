...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/hd/chdrfshyakaad5wlbc2geylz46h7t6an23lc2d74fww4i2cqevbw.py
# Source Nodes: [batch_norm_42, getattr_getattr_l__mod___blocks___5_____1___bn1_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.hardtanh]
# batch_norm_42 => add_93, mul_127, mul_128, sub_42
# getattr_getattr_l__mod___blocks___5_____1___bn1_act => clamp_max_28, clamp_min_28, convert_element_type_186
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_hardtanh_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
