...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/iz/cizmo63v4yhpjiqypamgnze2xce6ui75yvq2ykouzunhc5miital.py
...
def triton_red_fused_native_layer_norm_1(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp14 = tmp12 * tmp13
        tmp16 = tmp14 + tmp15
        tl.store(out_ptr2 + (r1 + (256*x0)), tmp16, rmask)
''')
