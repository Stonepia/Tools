...
# Original file: ./XGLMForCausalLM__94_forward_279.26/XGLMForCausalLM__94_forward_279.26_1.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/cp/ccpsvlpqqdwd2qzkyikqckoqhoh66ypfrbe7n3cgqlrgr7bficad.py
...
triton_per_fused_clone_copy_new_zeros_nll_loss_forward_select_scatter_slice_slice_scatter_1 = async_compile.triton('triton_per_fused_clone_copy_new_zeros_nll_loss_forward_select_scatter_slice_slice_scatter_1', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i64', 2: '*fp16', 3: '*i64', 4: '*fp16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_clone_copy_new_zeros_nll_loss_forward_select_scatter_slice_slice_scatter_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 6), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_clone_copy_new_zeros_nll_loss_forward_select_scatter_slice_slice_scatter_1(in_out_ptr0, in_ptr0, in_ptr1, out_ptr0, out_ptr2, xnumel, rnumel):
    xnumel = 1
    ...
    tmp20 = tl.load(in_ptr1 + (tmp19 + (256008*r2)), rmask, other=0.0).to(tl.float32)
    tmp21 = -tmp20
    tmp22 = 0.0
