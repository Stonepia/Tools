...
# Original file: ./detectron2_fcos_r_50_fpn__34_inference_74.14/detectron2_fcos_r_50_fpn__34_inference_74.14_3.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/co/ccoya5jiqlpraeypu2pu6tdp3qhwikohdpms3kza76djmy2kmuod.py
# Source Nodes: [add, mul, self____modules__0], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.mul]
# add => add_1
# mul => mul_2
# self____modules__0 => convert_element_type_2, mul_1, sub
