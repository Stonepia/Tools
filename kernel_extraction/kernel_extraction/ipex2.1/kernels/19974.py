...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/md/cmdjynb7jzyxpu6frd3isrqm6oq3ohvni4l5aguhsqlrxhp4f76u.py
...
def triton_red_fused_add_native_layer_norm_native_layer_norm_backward_13(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp3 = tl.load(in_ptr2 + (x0 + (2560*r2) + (327680*x1)), rmask, eviction_policy='evict_first', other=0.0)
        tmp5 = tl.load(in_ptr3 + (x0 + (2560*r2) + (327680*x1)), rmask, eviction_policy='evict_first', other=0.0)
