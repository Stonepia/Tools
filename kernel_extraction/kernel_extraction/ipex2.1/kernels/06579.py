...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/lo/clo3x7i4zxecv7wlq6ur2lb6qvh5oujiczbpsdu4ssbh5fkeay3e.py
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*bf16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__softmax__to_copy_5(in_ptr0, in_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp26 = tl.load(in_ptr1 + (x1 + (12*tmp25)), rmask, eviction_policy='evict_last')
        tmp27 = tmp1 + tmp26
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp33 = tl.load(in_ptr0 + (r2 + (2048*x3)), rmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp59 = tl.load(in_ptr1 + (x1 + (12*tmp58)), rmask, eviction_policy='evict_last')
        tmp60 = tmp34 + tmp59
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp68 = tl.load(in_ptr0 + (r2 + (2048*x3)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        ...
        tmp94 = tl.load(in_ptr1 + (x1 + (12*tmp93)), rmask, eviction_policy='evict_first')
        tmp95 = tmp69 + tmp94
        ...
        tl.store(out_ptr2 + (r2 + (2048*x3)), tmp101, rmask)
''')
