...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/be/cbeojq5s5c6onhvsese5spcubhd2k4uwzz7zy3pwzzmpgbqgmfuq.py
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*i64', 1: '*fp32', 2: '*bf16', 3: '*bf16', 4: '*i1', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_native_dropout_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 7), equal_to_1=())]})
@triton.jit
