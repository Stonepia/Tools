...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/y7/cy7cyymzdmoz3wrxxk75arvijqv5mi5gxgsnarlqnrjdhhf344rs.py
...
@pointwise(size_hints=[1024, 32768], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy__unsafe_index_add_arange_clamp_leaky_relu_mul_rsub_sub_22', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
