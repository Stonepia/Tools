...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/7x/c7xl5dwondwxyr54fllu7w4qzaxgh6bnoevu536dkd4ldnty73go.py
# Source Nodes: [layer_norm_5], Original ATen: [aten.native_layer_norm]
# layer_norm_5 => add_16, add_17, convert_element_type_16, convert_element_type_17, mul_22, mul_23, rsqrt_5, sub_5, var_mean_5
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_layer_norm_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
