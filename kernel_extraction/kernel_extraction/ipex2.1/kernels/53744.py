...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/gd/cgdzyykh37dc54576ioyyqvuuueklyecw7hiuu36tc3lpewnc756.py
# Source Nodes: [batch_norm_1, getattr_l__mod___features___0___act_dw], Original ATen: [aten._native_batch_norm_legit_no_training, aten.hardtanh]
# batch_norm_1 => add_3, mul_5, mul_6, sub_1
# getattr_l__mod___features___0___act_dw => clamp_max, clamp_min, convert_element_type_9
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_hardtanh_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
