...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/rw/crw4ckm7rwsugug3wgwyp5jlfy3qnh7ajs73ptdkq3m2hqnrwj6m.py
# Source Nodes: [l__mod___electra_encoder_layer_11_attention_output_layer_norm], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm, aten.native_layer_norm_backward]
...
@triton.jit
def triton_per_fused_add_native_dropout_backward_native_layer_norm_native_layer_norm_backward_18(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr2, out_ptr3, xnumel, rnumel):
    xnumel = 16384
