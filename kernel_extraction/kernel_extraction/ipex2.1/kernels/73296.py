...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/ab/cabih2kqbvkiw3upngd3j5b5qqyf6l2l2yzugaxnzymgy2tyib4q.py
...
def triton_per_fused__to_copy_add_native_layer_norm_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel):
    ...
    tl.store(out_ptr2 + (r2 + (768*x3)), tmp30, rmask & xmask)
''')
