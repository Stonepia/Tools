...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/ec/ceccooaqrr7a22rv5xs2islmvtcgkf6prrsw4xmqb66ywmgdv6l7.py
# Source Nodes: [add_6, mul, softmax], Original ATen: [aten._softmax, aten.add, aten.mul]
# add_6 => add_50
# mul => mul_66
# softmax => amax, convert_element_type_92, convert_element_type_93, div, exp, sub_22, sum_1
...
@triton.jit
def triton_red_fused__softmax_add_mul_6(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 131072
    rnumel = 256
