...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/yr/cyrpkl7atoel4pktzgk3go2llz24igxcpadthh76smjygvq3coo5.py
# Source Nodes: [group_norm], Original ATen: [aten.native_group_norm]
# group_norm => add_1, convert_element_type_1, mul_1
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_native_group_norm_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
