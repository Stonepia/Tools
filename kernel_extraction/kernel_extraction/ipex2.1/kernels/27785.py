...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/i2/ci2dtqa3jggcq57ze3egmqgh5onpgz53255gxy52fwmkc6un3jn6.py
# Source Nodes: [add_18, add_20, add_22, add_24, add_25, l__self___block_3_layer__1__dropout, l__self___block_4_layer_0_dropout, l__self___block_4_layer__1__dropout, l__self___block_5_layer_0_dropout, mean_11, mul_25, mul_26, pow_12, rsqrt_11, to_25, to_26], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add_18 => add_23
# add_20 => add_26
# add_22 => add_28
# add_24 => add_31
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clone_mean_mul_pow_rsqrt_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
