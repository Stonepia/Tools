...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/jo/cjole7r7zwizowxmf7lq7usv2wthusmb62e43vu2fgra7gpd725s.py
...
@triton.jit
def triton_per_fused__native_batch_norm_legit_functional_native_batch_norm_backward_relu_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel):
    xnumel = 64
