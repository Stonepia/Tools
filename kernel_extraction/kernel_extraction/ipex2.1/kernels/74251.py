...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/ci/ccirikdhhuismumext5ekf6trbzjl2to4nb3fruafhftbutizn4i.py
# Source Nodes: [batch_norm_104, l__self___features_conv5_2_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_104 => add_242, convert_element_type_419, mul_313, mul_314, sub_104
# l__self___features_conv5_2_c1x1_a_bn_act => relu_104
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_138(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (2432*x2) + (119168*y1)), tmp11, xmask)
''')
