...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/dh/cdhzdo32ofv7qoyo7dwbt2vp3mzfrvxj2kgl5dzkv4nyhyce63yb.py
# Source Nodes: [batch_norm_61, l__self___features_conv4_8_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_61 => add_142, convert_element_type_247, mul_184, mul_185, sub_61
# l__self___features_conv4_8_c1x1_a_bn_act => relu_61
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_81(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1600*x2) + (313600*y1)), tmp11, xmask)
''')
