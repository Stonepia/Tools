...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/aq/caqoiczcwbsuufnmmajs4psfoej2yb3katogu2weadmkjofwku4p.py
...
# nan_to_num_21 => convert_element_type_174, eq_86, eq_87, isnan_21, where_64, where_65, where_66
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_75', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
