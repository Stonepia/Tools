...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/ih/ciham3fljxt6svhzjovtkobehc3wd3arer2qmj7mvx6exvtahhvp.py
...
def triton_poi_fused_mul_9(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr0 + (x0 + (2240*x2)), None, eviction_policy='evict_last')
    tmp2 = tmp0 * tmp1
