...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/yx/cyx3b2m2iayyqgs4a3tsofkzsdxlrmp3jg5mzcxelpaaewoartio.py
...
def triton_red_fused_native_layer_norm_native_layer_norm_backward_6(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp2 = tl.load(in_ptr1 + (x0 + (2560*r2) + (327680*x1)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
