...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/j2/cj2c4kofahqxxhtmcdnp4e5csxx46qnsmyru4vcihqokj3scbjxs.py
# Source Nodes: [add_17, add_19, add_20, any_8, clamp_5, clamp_6, clamp_7, isinf_7, l__self___decoder_block_2_layer_0_dropout, l__self___decoder_block_2_layer_1_dropout, mean_8, mul_20, mul_21, neg_6, neg_7, neg_8, pow_9, rsqrt_8, to_20, to_21, where_1, where_6, where_7, where_8], Original ATen: [aten._to_copy, aten.add, aten.any, aten.clamp, aten.clone, aten.isinf, aten.mean, aten.mul, aten.neg, aten.pow, aten.rsqrt, aten.scalar_tensor, aten.where]
# add_17 => add_22
# add_19 => add_25
# add_20 => add_26
# any_8 => any_8
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*i1', 3: '*fp16', 4: '*i1', 5: '*fp16', 6: '*i1', 7: '*fp16', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_any_clamp_clone_isinf_mean_mul_neg_pow_rsqrt_scalar_tensor_where_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 9), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__to_copy_add_any_clamp_clone_isinf_mean_mul_neg_pow_rsqrt_scalar_tensor_where_11(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr2, xnumel, rnumel):
    xnumel = 1
