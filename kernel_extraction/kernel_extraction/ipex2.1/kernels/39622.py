...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/rn/crn24vbsqki77egxlne2jgiuwybc4dnxjisepikfocsr676hlcnz.py
...
triton_per_fused__softmax__to_copy_add_mul_7 = async_compile.triton('triton_per_fused__softmax__to_copy_add_mul_7', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax__to_copy_add_mul_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
