...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/tv/ctvjs2z22z57molykrwys5wcs5xdobpy6m2qiaoqg3uq54xxykkw.py
...
@pointwise(size_hints=[32768], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_33', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
