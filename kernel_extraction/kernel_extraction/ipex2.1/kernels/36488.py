...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/z3/cz3gjrm47mqdrgieyzh5qvat5rs3an3qwxikxhzfvmqqky325pme.py
...
def triton_poi_fused_add_addcmul_mul_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp4 = tl.load(in_ptr4 + (y0 + (196*x2) + (75264*y1)), xmask & ymask, eviction_policy='evict_last')
    tmp5 = tmp3 * tmp4
    tmp6 = tmp2 + tmp5
    tmp7 = tmp1 * tmp6
    tmp8 = tmp0 + tmp7
