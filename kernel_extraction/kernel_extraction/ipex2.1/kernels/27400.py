...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/2g/c2ga2pevzbn63wqfxve75tl2m5uaroo4ccy7rfqayxvuyawi7vln.py
...
# nan_to_num_3 => convert_element_type_30, eq_14, eq_15, isnan_3, where_10, where_11, where_12
# softmax_3 => amax_3, convert_element_type_32, div_3, exp_3, sub_11, sum_4
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_21', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
