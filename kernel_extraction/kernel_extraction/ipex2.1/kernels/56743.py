...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/gf/cgfbx5fbkqlarodckcwkgwnyv4j7urn63buqg3n4ia67vmsmzn5c.py
# Source Nodes: [float_3, softmax_1, type_as_1], Original ATen: [aten._softmax, aten._to_copy]
# float_3 => convert_element_type_21
# softmax_1 => amax_1, div_3, exp_1, sub_4, sum_2
# type_as_1 => convert_element_type_22
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i64', 2: '*fp16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
