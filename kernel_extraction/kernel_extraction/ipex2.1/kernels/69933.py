...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/ya/cya4fjsgpfnkj6nlj7xvkgaptggjlgwsonooeacpzmyt7wx626gu.py
# Source Nodes: [l__mod___encoder_b_encoder], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# l__mod___encoder_b_encoder => add_100, add_103, add_107, add_108, add_109, clone_83, clone_86, clone_90, clone_91, mul_120, mul_121, rsqrt_31, sub_49, var_mean_31
...
@triton.jit
def triton_per_fused_add_clone_native_layer_norm_28(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel):
    xnumel = 2464
