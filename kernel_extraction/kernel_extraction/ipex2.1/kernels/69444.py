...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/4o/c4o3khkxy3b5dzuyetcckollecop323gdnb5b4q5cx6arox2dsuo.py
...
def triton_poi_fused_native_group_norm_14(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp17 = tmp15 * tmp16
    tmp19 = tmp17 + tmp18
    tl.store(out_ptr0 + (y0 + (96*x2) + (301056*y1)), tmp19, xmask)
''')
