...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/52/c52hyijicxrn4ov2bexsngxqs2cli4l5bw4opfl25sdr2zqsjpdx.py
...
@pointwise(size_hints=[262144], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax_div_49', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
