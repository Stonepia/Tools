...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/xo/cxohg2ro2ctda5lonrf5dek3eddwpqoxrwmdjvwxzqtew7jfedg4.py
...
def triton_red_fused_add_any_clone_embedding_isinf_4(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp0 = tl.load(in_ptr0 + ((8*x0) + (r1 // 1024)), xmask, eviction_policy='evict_last', other=0.0)
        ...
        tmp2 = tl.load(in_ptr1 + ((1024*tmp1) + (r1 % 1024)), xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp4 = tmp2 + tmp3
