...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/77/c77no6kw3453oxw3dtostqjsydyij76lv27nirpbwshmpbch5ktj.py
# Source Nodes: [add_10, gelu_47, mul_93, mul_94, mul_95, mul_96, mul__57, mul__58], Original ATen: [aten.add, aten.gelu, aten.mul]
# add_10 => add_109
# gelu_47 => add_110, convert_element_type_243, convert_element_type_244, erf_47, mul_399, mul_400, mul_401
# mul_93 => mul_395
# mul_94 => mul_396
# mul_95 => mul_398
# mul_96 => mul_403
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_gelu_mul_31', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
