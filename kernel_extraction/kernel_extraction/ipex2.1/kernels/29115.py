...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/5h/c5hwb7vmou75tg3epwuyfid76nylxjou5fr3zpxbkodjzkvs2z6t.py
...
# getattr_getattr_getattr_l__mod___stages___3_____1___transformer___3___norm1 => add_80, add_81, mul_123, mul_124, rsqrt_11, sub_39, var_mean_11
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_27', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
