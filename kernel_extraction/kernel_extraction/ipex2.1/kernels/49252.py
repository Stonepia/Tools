...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/d4/cd4hr444coeokfuf2g7xim37d3kkdxfk73e32jewufyboaacfdgd.py
# Source Nodes: [iadd, l__self___deberta_embeddings_layer_norm, l__self___deberta_embeddings_position_embeddings, l__self___deberta_embeddings_word_embeddings, l__self___deberta_encoder_layer_0_attention_self_query_proj, mul, trampoline_autograd_apply], Original ATen: [aten._to_copy, aten.add, aten.bernoulli, aten.embedding, aten.masked_fill, aten.mul, aten.native_layer_norm, aten.native_layer_norm_backward, aten.rsub, aten.view]
# iadd => add
...
def triton_red_fused__to_copy_add_bernoulli_embedding_masked_fill_mul_native_layer_norm_native_layer_norm_backward_rsub_view_0(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr2, out_ptr3, out_ptr4, out_ptr5, out_ptr6, load_seed_offset, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr5 + (r1 + (1536*x0)), tmp41, rmask & xmask)
    tmp42 = 1536.0
    tmp43 = tmp9 / tmp42
    tmp44 = 1e-07
    tmp45 = tmp43 + tmp44
    ...
    tmp47 = tmp46 / tmp42
    tl.store(out_ptr6 + (x0), tmp47, xmask)
''')
