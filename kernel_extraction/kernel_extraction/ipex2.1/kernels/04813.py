...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/xr/cxr2tw5zoamoeq7owlk5hpenp2kpeeyfwn6ynxtuzh5ekzjdwdvd.py
# Source Nodes: [getattr_getattr_l__self___layers___2___blocks___1___norm1], Original ATen: [aten.native_layer_norm]
# getattr_getattr_l__self___layers___2___blocks___1___norm1 => convert_element_type_86, var_mean_13
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_layer_norm_37', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
