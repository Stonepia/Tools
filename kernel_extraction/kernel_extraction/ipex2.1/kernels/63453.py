...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/5o/c5ozehqn7iifuyuqm6kciik3zfnwxbmy6p4t4jnbrltxkqtoyrig.py
...
@pointwise(size_hints=[16384], filename=__file__, meta={'signature': {0: '*fp32', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*bf16', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_clone_16', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]})
@triton.jit
