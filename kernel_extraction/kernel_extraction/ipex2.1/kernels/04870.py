...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/k6/ck6edtk2thkcr4ldq2jb7tp7stat46xsbgwlvl33sxmwjhm2rrwy.py
...
def triton_poi_fused_clone_38(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x8 + (3584*x3) + (25088*x2) + (50176*x9)), tmp21, None)
''')
