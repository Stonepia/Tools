...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/jy/cjyjgx6bplbbru342ftofcab3eolix7eyj7tpxkttscse45trtcg.py
...
@pointwise(size_hints=[2048], filename=__file__, meta={'signature': {0: '*fp16', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_nll_loss_backward_nll_loss_forward_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
