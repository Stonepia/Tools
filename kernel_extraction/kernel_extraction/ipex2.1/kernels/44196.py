...
# Original file: ./BlenderbotSmallForConditionalGeneration__33_forward_106.5/BlenderbotSmallForConditionalGeneration__33_forward_106.5_1.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/sv/csvqptuju5d5t4qd65sxmveqfpx4zfqzsyzmfpsqpky3l2yt4ntr.py
# Source Nodes: [add_1, dropout_3, l__self___final_layer_norm, l__self___self_attn_layer_norm], Original ATen: [aten.add, aten.native_dropout, aten.native_layer_norm, aten.native_layer_norm_backward]
# add_1 => add_4
# dropout_3 => gt_1, mul_8, mul_9
# l__self___final_layer_norm => add_5, add_6, mul_10, mul_11, rsqrt_1, sub_2, var_mean_1
# l__self___self_attn_layer_norm => add_2, mul_4
...
def triton_per_fused_add_native_dropout_native_layer_norm_native_layer_norm_backward_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr1, out_ptr5, out_ptr6, out_ptr7, load_seed_offset, xnumel, rnumel):
    ...
    tl.store(out_ptr6 + (r1 + (512*x0)), tmp44, rmask)
