...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/o3/co3rlmbidxyaz2gn57iottrilzqso6m3idrpbud7fpk5tflfeqa4.py
...
# l__mod___norm => convert_element_type_180, var_mean_60
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
