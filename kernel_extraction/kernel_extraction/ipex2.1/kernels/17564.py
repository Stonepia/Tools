...
# Original file: ./detectron2_fcos_r_50_fpn__73_inference_113.53/detectron2_fcos_r_50_fpn__73_inference_113.53_3.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/4t/c4tyxyo6ykthtliefdd24wc2qozhguzxvg6w4fzjf2wgbbwzoo3b.py
...
def triton_poi_fused__to_copy_add_copy_slice_slice_scatter_sub_zeros_like_1(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp5 = tl.where(tmp4 < 0, tmp4 + 616756, tmp4)
    # tl.device_assert(((0 <= tmp5) & (tmp5 < 616756)) | ~(xmask & tmp2), "index out of bounds: 0 <= tmp5 < 616756")
    ...
    tmp23 = tl.where(tmp22 < 0, tmp22 + 616756, tmp22)
    # tl.device_assert(((0 <= tmp23) & (tmp23 < 616756)) | ~(tmp20 & xmask), "index out of bounds: 0 <= tmp23 < 616756")
    tmp24 = tl.load(in_ptr2 + (tl.broadcast_to(2*tmp23, [XBLOCK])), tmp20 & xmask, other=0.0)
    tmp25 = tl.where(tmp24 < 0, tmp24 + 15200, tmp24)
    # tl.device_assert(((0 <= tmp25) & (tmp25 < 15200)) | ~(tmp20 & xmask), "index out of bounds: 0 <= tmp25 < 15200")
    ...
    tmp40 = tl.where(tmp39 < 0, tmp39 + 616756, tmp39)
    # tl.device_assert(((0 <= tmp40) & (tmp40 < 616756)) | ~(xmask & tmp37), "index out of bounds: 0 <= tmp40 < 616756")
    ...
    tmp57 = tl.where(tmp56 < 0, tmp56 + 616756, tmp56)
    # tl.device_assert(((0 <= tmp57) & (tmp57 < 616756)) | ~(tmp54 & xmask), "index out of bounds: 0 <= tmp57 < 616756")
    tmp58 = tl.load(in_ptr2 + (tl.broadcast_to(2*tmp57, [XBLOCK])), tmp54 & xmask, other=0.0)
    tmp59 = tl.where(tmp58 < 0, tmp58 + 15200, tmp58)
    # tl.device_assert(((0 <= tmp59) & (tmp59 < 15200)) | ~(tmp54 & xmask), "index out of bounds: 0 <= tmp59 < 15200")
