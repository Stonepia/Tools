...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/gr/cgrr65uitffcu65je6ghv5z5uahwp7nnew2sqo3i2ucx7jezugxk.py
...
@triton.jit
def triton_per_fused_any_isinf_7(in_ptr0, out_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 1
    rnumel = 48
