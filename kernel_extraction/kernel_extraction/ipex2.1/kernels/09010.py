...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/rp/crph2crrzr7cqf7dirrh6splwbe3ft7txdbywiukol3uq47lcj7r.py
...
# gelu_24 => add_196, convert_element_type_195, erf_24, mul_318
...
def triton_per_fused_gelu_gelu_backward_native_layer_norm_native_layer_norm_backward_5(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel):
    ...
    tmp27 = tl.load(in_ptr5 + (r1 + (1024*x0)), rmask, other=0.0).to(tl.float32)
    ...
    tl.store(out_ptr2 + (r1 + (1024*x0)), tmp45, rmask)
''')
