...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/xm/cxms7d2sdva6uh3gjakstsg5lpzmss4myteby42ww4hcbcko3tyu.py
...
def triton_poi_fused_clone_mul_4(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 246272)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (64*x2) + (768*x1) + (738816*x3)), None)
