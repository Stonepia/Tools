...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/rs/crsdbosvcfroet7qg225b5zqygafqtwyfv6prm4bjnqolc4vahbu.py
...
@pointwise(size_hints=[512, 131072], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_constant_pad_nd_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
