...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/vn/cvnsicnpt7v6jk6iro4buzjc4osjjrvo3klhny42ey357ds7vcfg.py
...
@pointwise(size_hints=[2048, 512], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
