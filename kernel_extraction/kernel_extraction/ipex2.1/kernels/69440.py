...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/76/c76zzmfvkelbxi7aftdkm457k3qg6x4yk6qibt3x4cqgtwfphuef.py
...
def triton_poi_fused_add_mul_sub_10(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr1 + (x2 + (96*y3)), xmask, eviction_policy='evict_last')
    tmp2 = tl.load(in_ptr2 + (x2 + (96*y3)), xmask, eviction_policy='evict_last')
    tmp4 = tl.load(in_ptr3 + (x2), xmask, eviction_policy='evict_last')
    tmp7 = tl.load(in_ptr4 + (x2 + (96*y3)), xmask, eviction_policy='evict_last')
