...
# Original file: ./doctr_reco_predictor__21_inference_61.1/doctr_reco_predictor__21_inference_61.1.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/v2/cv2ou2v52ypfnimrlyvq2yphnipqtmvnsrarvrumev6rr4l2bpw3.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*i64', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_argmax_max_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
