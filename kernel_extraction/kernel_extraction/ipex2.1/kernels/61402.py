...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/bk/cbkgqich7jhxl375axc2ae7ky6obwxh2ot4rxtv5wv5724p2x6ky.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*i64', 2: '*i64', 3: '*fp16', 4: '*fp16', 5: '*i1', 6: '*fp16', 7: '*fp16', 8: 'i32', 9: 'i32', 10: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_embedding_mean_mul_native_dropout_pow_rsqrt_view_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 9, 10), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__to_copy_add_embedding_mean_mul_native_dropout_pow_rsqrt_view_0(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, out_ptr2, out_ptr3, load_seed_offset, xnumel, rnumel):
    ...
    tmp4 = 0.1
    tmp5 = tmp3 > tmp4
    tmp7 = tl.where(tmp6 < 0, tmp6 + 250112, tmp6)
