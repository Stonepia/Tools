...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/ms/cmsfualwmch6jymfv57u7ix42kk4i775dsry2umab2q5wonqjpdm.py
...
# batch_norm_88 => add_205, mul_265, mul_266, sub_88
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_117(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (2176*x2) + (426496*y1)), tmp9, xmask)
''')
