...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/46/c46aodbf4rcxytqpzjfymr2tv5vxjiqkhpdjorplch67g5wgjnku.py
...
def triton_poi_fused_8(out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tmp0 < tmp5
    tmp7 = 0.47172150015830994
    tmp8 = 1.4283583164215088
    tmp9 = tl.where(tmp6, tmp7, tmp8)
    tmp10 = tl.full([1], 3, tl.int64)
    tmp11 = tmp0 < tmp10
    tmp12 = -0.04577525332570076
    tmp13 = 2.043065309524536
    ...
    tmp19 = tmp0 < tmp18
    tmp20 = 0.13726529479026794
    tmp21 = 1.1331775188446045
    tmp22 = tl.where(tmp19, tmp20, tmp21)
    tmp23 = tl.full([1], 7, tl.int64)
    tmp24 = tmp0 < tmp23
    tmp25 = -0.11772552132606506
    tmp26 = 0.527721107006073
