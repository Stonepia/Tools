...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/4g/c4gghzipew7qxx5ppzxqfdtttb7f4ditycwymzndc5n4vqenmi4k.py
# Source Nodes: [add_33, add_34, l__mod___stage4_0_fuse_act_2, l__mod___stage4_0_fuse_layers_2_3_1, l__mod___stage4_0_fuse_layers_2_3_2], Original ATen: [aten._native_batch_norm_legit_no_training, aten._to_copy, aten._unsafe_index, aten.add, aten.relu]
# add_33 => add_549
# add_34 => add_554
# l__mod___stage4_0_fuse_act_2 => relu_183
# l__mod___stage4_0_fuse_layers_2_3_1 => add_551, mul_679, mul_680, sub_202
# l__mod___stage4_0_fuse_layers_2_3_2 => _unsafe_index_18, convert_element_type_722
...
def triton_poi_fused__native_batch_norm_legit_no_training__to_copy__unsafe_index_add_relu_9(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp24 = tl.load(in_ptr5 + (x0), None, eviction_policy='evict_last').to(tl.float32)
    tmp27 = tl.load(in_ptr6 + (x0), None, eviction_policy='evict_last').to(tl.float32)
    tmp2 = tmp0 + tmp1
    tmp3 = x2
    ...
    tmp31 = tmp2 + tmp30
    tmp32 = triton_helpers.maximum(0, tmp31)
