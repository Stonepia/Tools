...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/th/cth5mnkqufrkbokphqskl6r3e4wsjomdlov5qrr7hffbtdupxxwl.py
...
# batch_norm_104 => add_242, mul_313, mul_314, sub_104
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_138(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (2432*x2) + (119168*y1)), tmp9, xmask)
''')
