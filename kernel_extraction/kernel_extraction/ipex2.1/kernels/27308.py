...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/a4/ca4zg5cxf2dlxmo5l3zlhrcphyc2i37hmwtap2e7cwrzkuqnib7f.py
...
# nan_to_num_1 => convert_element_type_33, eq_6, eq_7, isnan_1, where_4, where_5, where_6
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
