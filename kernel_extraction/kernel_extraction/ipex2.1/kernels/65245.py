...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/pq/cpqy3zxff2qkamlgyotxcadhxh5bhpvpspparbmgaxwec465qokj.py
# Source Nodes: [l__mod___up4_up], Original ATen: [aten._to_copy, aten._unsafe_index, aten.add, aten.mul, aten.rsub, aten.sub]
# l__mod___up4_up => _unsafe_index_14, _unsafe_index_15, add_50, convert_element_type_72, mul_84, mul_85, sub_28, sub_29
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy__unsafe_index_add_mul_rsub_sub_18', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
