...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/2h/c2hygvymvl4kihoa6am22hjrnewo4d4iahwd6ituhmghdbvno543.py
# Source Nodes: [sub_26], Original ATen: [aten.sub]
# sub_26 => sub_26
triton_poi_fused_sub_68 = async_compile.triton('triton_poi_fused_sub_68', '''
import triton
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_sub_68', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_sub_68(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1076712
