...
# Original file: ./detectron2_maskrcnn_r_50_c4__53_inference_93.33/detectron2_maskrcnn_r_50_c4__53_inference_93.33_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/dm/cdmsctmqu3kujsdwadzgv4ovavywyfgveqj6onelxx3ldc6yder6.py
...
def triton_poi_fused_index_2(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.where(tmp0 < 0, tmp0 + 305, tmp0)
    # tl.device_assert(((0 <= tmp1) & (tmp1 < 305)) | ~xmask, "index out of bounds: 0 <= tmp1 < 305")
