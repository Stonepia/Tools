...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/rf/crfvjvczvuhbi6l5zdlp5ynroh2y2d7itewnt4uq44cr45ek7tjl.py
# Source Nodes: [add_7, add_8, getattr_l__self___model___17___conv_block_6, getattr_l__self___model___18___conv_block_6, l__self___model_19, l__self___model_20], Original ATen: [aten._native_batch_norm_legit, aten.add, aten.convolution]
# add_7 => add_26
# add_8 => add_29
...
# l__self___model_20 => convert_element_type_87, var_mean_21
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__native_batch_norm_legit_add_convolution_14', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
