...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/hq/chqfrhu2ektb4h2t5yfh2ujxzeowzzwfivy4xw5u4ugc7muaf3mv.py
...
@pointwise(size_hints=[64], filename=__file__, meta={'signature': {0: '*i64', 1: '*i32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_cumsum_ne_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
