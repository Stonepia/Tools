...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/l2/cl2dvlqlnrm44uueyzdnplmydnzy6qrmxrnlgdckeqb2lggtmue2.py
...
@pointwise(size_hints=[256, 256], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_max_pool2d_with_indices_32', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
