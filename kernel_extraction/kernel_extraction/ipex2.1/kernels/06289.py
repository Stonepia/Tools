...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/it/citzezzzshulbfkzbyawj3erlawrihcls4zyh2ranyefebljpm5g.py
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp16', 1: '*i64', 2: '*fp16', 3: '*i1', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_native_dropout_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 5), equal_to_1=())]})
@triton.jit
