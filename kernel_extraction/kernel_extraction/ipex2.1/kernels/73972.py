...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/yy/cyya5tpm7r3umfry3bvbeba4jkqayyyukr5rzx6ojyayf37gavqx.py
# Source Nodes: [batch_norm_5, l__self___features_conv2_2_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_5 => add_12, convert_element_type_23, mul_16, mul_17, sub_5
# l__self___features_conv2_2_c1x1_a_bn_act => relu_5
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (316*x2) + (990976*y1)), tmp11, xmask & ymask)
''')
