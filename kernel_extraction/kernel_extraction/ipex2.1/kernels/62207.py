...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/fb/cfb372talvlhi542dut27zqhsllz7a23lcvlkwk4uqf5g3iae467.py
...
triton_poi_fused_native_dropout_relu_view_9 = async_compile.triton('triton_poi_fused_native_dropout_relu_view_9', '''
import triton
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*i64', 1: '*fp16', 2: '*i1', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_native_dropout_relu_view_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused_native_dropout_relu_view_9(in_ptr0, in_ptr1, out_ptr1, out_ptr2, load_seed_offset, xnumel, XBLOCK : tl.constexpr):
    xnumel = 8388608
