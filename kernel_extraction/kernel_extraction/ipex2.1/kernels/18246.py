...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/jh/cjhpoldznt5vukquo4wjeujx7ywne3kqa4pcdhb4ok4q535yekwv.py
# Source Nodes: [l__self___cell_0_conv_prev_1x1_final_path_bn], Original ATen: [aten._native_batch_norm_legit_no_training]
# l__self___cell_0_conv_prev_1x1_final_path_bn => add_73, convert_element_type_154, mul_94, mul_95, sub_31
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_24', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
