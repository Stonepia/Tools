...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/bz/cbznos42sl5jw2rcnng6fvylq4xfcqmjgcd4fhnoo7rmdetejxti.py
# Source Nodes: [mul_158, to_84], Original ATen: [aten._to_copy, aten.add, aten.mul, aten.sum]
# mul_158 => mul_312
# to_84 => convert_element_type_204
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_mul_sum_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
