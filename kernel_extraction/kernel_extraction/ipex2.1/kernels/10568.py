...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/s3/cs3g2d2xv2wu7vg77gqaykhlnnzes6wzpfqaypbhnegziygllhzi.py
# Source Nodes: [add, iadd, l__self___electra_embeddings_dropout, l__self___electra_embeddings_layer_norm, l__self___electra_embeddings_position_embeddings, l__self___electra_embeddings_project, l__self___electra_embeddings_token_type_embeddings, l__self___electra_embeddings_word_embeddings], Original ATen: [aten._to_copy, aten.add, aten.embedding, aten.native_dropout, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
# add => add
# iadd => add_1
# l__self___electra_embeddings_dropout => gt, mul_3, mul_4
# l__self___electra_embeddings_layer_norm => add_2, add_3, mul_1, mul_2, rsqrt, sub_1, var_mean
# l__self___electra_embeddings_position_embeddings => embedding_2
# l__self___electra_embeddings_project => convert_element_type, view
# l__self___electra_embeddings_token_type_embeddings => embedding_1
# l__self___electra_embeddings_word_embeddings => embedding
...
@triton.jit
def triton_per_fused__to_copy_add_embedding_native_dropout_native_layer_norm_native_layer_norm_backward_view_0(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, out_ptr4, out_ptr5, out_ptr6, out_ptr7, load_seed_offset, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 32768
    rnumel = 128
    ...
    tl.store(out_ptr6 + (r2 + (128*x3)), tmp47, rmask)
