...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/6h/c6hoxejuv2kdilgsvmb4mym56g5ynu2odctkuo2ypejfvyzaey5j.py
...
# truediv_20 => div_17
triton_poi_fused_add_copy_div_mul_neg_select_scatter_24 = async_compile.triton('triton_poi_fused_add_copy_div_mul_neg_select_scatter_24', '''
import triton
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp64', 1: '*fp64', 2: '*fp64', 3: '*fp64', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_copy_div_mul_neg_select_scatter_24', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_copy_div_mul_neg_select_scatter_24(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1040000
