...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/j3/cj3lnogjhvplkib57qcjuemr4khtwsnzdwhfgb4vrkhl2myohwn5.py
# Source Nodes: [argmax, eq, softmax, sum_1], Original ATen: [aten._softmax, aten.argmax, aten.eq, aten.sum]
# argmax => argmax
# eq => eq
# softmax => amax, convert_element_type_16, convert_element_type_17, div, exp, sub_22, sum_1
# sum_1 => sum_2
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*i64', 2: '*i64', 3: '*i64', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_argmax_eq_sum_15', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
