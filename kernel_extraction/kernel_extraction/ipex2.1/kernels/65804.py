...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/k6/ck6bh7pzunje7jxyqidjv6epimmc4sgishkxtj3incffnxd2gbl6.py
# Source Nodes: [add_21, getattr_l__mod___stage3___2___norm1], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add]
# add_21 => add_87
# getattr_l__mod___stage3___2___norm1 => add_89, convert_element_type_123, mul_136, mul_137, sub_29
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_add_34(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4816896
