...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/aa/caazz23mkidlss3e7pcvvan6f2z3dwzmjs7yjgr3cnhvvcgbgt4p.py
# Source Nodes: [l__self___up4_up], Original ATen: [aten._to_copy, aten._unsafe_index, aten.add, aten.mul, aten.rsub, aten.sub]
# l__self___up4_up => _unsafe_index_12, _unsafe_index_13, add_49, convert_element_type_105, mul_82, mul_83, sub_28, sub_29
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy__unsafe_index_add_mul_rsub_sub_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
