...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/uj/cujbcbu5yjve2fib3tgt2pdz6dwy6xkp2vyfdxd5yixulnrdpt5k.py
# Source Nodes: [iadd_4, nan_to_num, nan_to_num_3, softmax_3], Original ATen: [aten._softmax, aten._to_copy, aten.add, aten.nan_to_num]
# iadd_4 => add_25
...
# softmax_3 => amax_3, convert_element_type_32, exp_3, sub_11, sum_4
triton_poi_fused__softmax__to_copy_add_nan_to_num_21 = async_compile.triton('triton_poi_fused__softmax__to_copy_add_nan_to_num_21', '''
import triton
...
@pointwise(size_hints=[16], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax__to_copy_add_nan_to_num_21', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused__softmax__to_copy_add_nan_to_num_21(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 16
