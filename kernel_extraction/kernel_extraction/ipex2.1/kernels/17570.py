...
# Original file: ./detectron2_fcos_r_50_fpn__73_inference_113.53/detectron2_fcos_r_50_fpn__73_inference_113.53_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/dh/cdhqtodaqpllp4ddbjktqkt6oxc43sbk3pgnwg34uzlpabemck4f.py
...
@pointwise(size_hints=[4096], filename=__file__, meta={'signature': {0: '*fp16', 1: '*i64', 2: '*i64', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: '*fp32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_add_copy_slice_slice_scatter_sub_zeros_like_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]})
@triton.jit
def triton_poi_fused__to_copy_add_copy_slice_slice_scatter_sub_zeros_like_1(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4000
    ...
    tmp5 = tl.where(tmp4 < 0, tmp4 + 616754, tmp4)
    # tl.device_assert(((0 <= tmp5) & (tmp5 < 616754)) | ~(xmask & tmp2), "index out of bounds: 0 <= tmp5 < 616754")
    tmp6 = tl.load(in_ptr2 + (tl.broadcast_to(2*tmp5, [XBLOCK])), tmp2 & xmask, other=0.0)
    tmp7 = tl.where(tmp6 < 0, tmp6 + 15200, tmp6)
    # tl.device_assert(((0 <= tmp7) & (tmp7 < 15200)) | ~(xmask & tmp2), "index out of bounds: 0 <= tmp7 < 15200")
    ...
    tmp23 = tl.where(tmp22 < 0, tmp22 + 616754, tmp22)
    # tl.device_assert(((0 <= tmp23) & (tmp23 < 616754)) | ~(xmask & tmp20), "index out of bounds: 0 <= tmp23 < 616754")
    ...
    tmp40 = tl.where(tmp39 < 0, tmp39 + 616754, tmp39)
    # tl.device_assert(((0 <= tmp40) & (tmp40 < 616754)) | ~(xmask & tmp37), "index out of bounds: 0 <= tmp40 < 616754")
    ...
    tmp57 = tl.where(tmp56 < 0, tmp56 + 616754, tmp56)
    # tl.device_assert(((0 <= tmp57) & (tmp57 < 616754)) | ~(xmask & tmp54), "index out of bounds: 0 <= tmp57 < 616754")
