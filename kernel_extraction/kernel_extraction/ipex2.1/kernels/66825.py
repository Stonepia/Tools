...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/ym/cymbv4nx3uql5bysagr5ofyv3x2nezva74uk5dr7rflrivpfgvpb.py
...
@pointwise(size_hints=[2048], filename=__file__, meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_relu_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
