...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/nz/cnzvcefc5q4kz7oziohkhk3jepsczc7jyeuzmv5y2m2u34qqcqpy.py
...
# batch_norm_33 => add_77, mul_100, mul_101, sub_33
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_44(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1024*x2) + (802816*y1)), tmp9, xmask)
''')
