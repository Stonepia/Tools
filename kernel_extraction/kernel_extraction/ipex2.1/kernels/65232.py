...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/pb/cpbawfvvnvgrpz2qevmr3sdrmjsf4dbqexhew7hddzohenu7n27y.py
# Source Nodes: [l__mod___up1_up], Original ATen: [aten._to_copy, aten._unsafe_index, aten.add, aten.mul, aten.rsub, aten.sub]
# l__mod___up1_up => _unsafe_index, _unsafe_index_1, add_22, convert_element_type_30, mul_34, mul_35, sub_10, sub_11
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy__unsafe_index_add_mul_rsub_sub_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
