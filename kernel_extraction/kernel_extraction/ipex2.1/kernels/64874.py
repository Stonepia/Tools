...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/h7/ch7ovmqm75cebb4edhly3xz64ckfo36vr6x6o4vq54ozqzaokq2d.py
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_convolution_glu_relu_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_convolution_glu_relu_11(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x1 = (xindex // 92842) % 64
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x3 + (11883776*x2)), xmask)
    tmp1 = tl.load(in_ptr1 + (x1), xmask, eviction_policy='evict_last')
    tmp3 = tl.load(in_ptr0 + (5941888 + x3 + (11883776*x2)), xmask)
