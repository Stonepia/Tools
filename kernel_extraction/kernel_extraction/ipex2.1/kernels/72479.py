...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/q6/cq6x3i3hcxh2n3in5eryylstos7hkcup6vrv6nm4uifppxgigmse.py
...
def triton_poi_fused_clone_18(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr1 + (x0 + (361856*x1)), None)
    tmp3 = tl.load(in_ptr2 + (257*x1), None, eviction_policy='evict_last')
    tmp5 = tl.load(in_ptr3 + (257*x1), None, eviction_policy='evict_last')
