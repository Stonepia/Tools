...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/7r/c7rbgd62cze6raj35nuvrkpu4my3pberrwiucihgrqplgctmmfno.py
# Source Nodes: [batch_norm_91, l__mod___features_conv4_18_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_91 => add_212, convert_element_type_275, mul_274, mul_275, sub_91
# l__mod___features_conv4_18_c1x1_a_bn_act => relu_91
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_121(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (2240*x2) + (439040*y1)), tmp13, xmask)
''')
