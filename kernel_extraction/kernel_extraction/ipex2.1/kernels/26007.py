...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/4b/c4byghsletgocpoebkq4xuvqiyfcsh253zgvpxnmpproaxsiplkn.py
...
def triton_red_fused__softmax__to_copy_5(in_ptr0, in_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp59 = tl.load(in_ptr1 + (x1 + (8*tmp58)), rmask, eviction_policy='evict_last')
        tmp60 = tmp34 + tmp59
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp94 = tl.load(in_ptr1 + (x1 + (8*tmp93)), rmask, eviction_policy='evict_first')
        tmp95 = tmp69 + tmp94
