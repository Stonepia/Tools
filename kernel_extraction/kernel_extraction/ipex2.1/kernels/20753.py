...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/u6/cu6voevo2xzuxtdi4n35r3c75zcrfkmbmsu7rlhqh6vkcaborl6m.py
...
@triton.jit
def triton_red_fused_add_native_layer_norm_native_layer_norm_backward_18(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr0, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 2048
    rnumel = 4096
