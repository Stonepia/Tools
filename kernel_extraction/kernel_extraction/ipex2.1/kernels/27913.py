...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/3t/c3to4kirfqkdu5yt42qq3jc6lb4332led33ikqutzjfqf7hm2ru3.py
...
triton_red_fused_nll_loss_forward_11 = async_compile.triton('triton_red_fused_nll_loss_forward_11', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*i64', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_nll_loss_forward_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_nll_loss_forward_11(in_out_ptr0, in_ptr0, in_ptr1, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 1
    rnumel = 8192
