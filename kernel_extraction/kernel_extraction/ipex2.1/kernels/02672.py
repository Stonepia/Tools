...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/r3/cr3tdx225eka2urplcav7nh5jrsniaqv4dscq2ux3uzyssfi5ar4.py
...
@pointwise(size_hints=[8192, 1024], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_22', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
