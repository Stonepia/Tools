...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/pp/cpp3to4hve24qbjayjln63lqpigtkcfufvmy42wqf6ygxbkl6gmc.py
# Source Nodes: [batch_norm_46, l__self___features_conv4_3_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_46 => add_107, convert_element_type_187, mul_139, mul_140, sub_46
# l__self___features_conv4_3_c1x1_a_bn_act => relu_46
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_relu_61(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 40960
    xnumel = 196
    ...
    tl.store(out_ptr0 + (y0 + (1280*x2) + (250880*y1)), tmp11, xmask)
''')
