...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/dn/cdnokhrkkhuxthtdj5vceumyqrzhklzt7lpuzziukyiswehucyll.py
...
# getattr_l__mod___blocks_0_blocks_1___0___norm2 => add_58, add_59, mul_95, mul_96, rsqrt_3, sub_51, var_mean_3
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_23', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
