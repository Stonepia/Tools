...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/cs/ccsycssxdqqio4wvfbxvchcvo5ldcxorrydngcwiw26i73436gxg.py
...
def triton_poi_fused_clone_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    y2 = (yindex // 64)
    y4 = yindex
    tmp0 = tl.load(in_ptr0 + (16 + y0 + (64*y1) + (256*x3) + (50176*y2)), xmask, eviction_policy='evict_last')
