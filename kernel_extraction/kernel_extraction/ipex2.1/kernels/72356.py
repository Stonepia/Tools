...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/by/cby3i7fohvg6hcjokbn6x6424dxsxjslrpasaefwonmmsfloivgc.py
...
triton_per_fused_add_div_embedding_dense_backward_masked_fill_sum_27 = async_compile.triton('triton_per_fused_add_div_embedding_dense_backward_masked_fill_sum_27', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*i64', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['out_ptr1'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_div_embedding_dense_backward_masked_fill_sum_27', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_div_embedding_dense_backward_masked_fill_sum_27(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 393216
    rnumel = 16
