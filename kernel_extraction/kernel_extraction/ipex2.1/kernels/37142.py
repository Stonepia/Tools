...
# Original file: ./detectron2_maskrcnn_r_50_c4__53_inference_93.33/detectron2_maskrcnn_r_50_c4__53_inference_93.33_2.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/mr/cmrra23kddx474briptnb72ezqmqz4tkqgmdls73ekixdevm7qxh.py
...
def triton_poi_fused_index_2(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.where(tmp0 < 0, tmp0 + 314, tmp0)
    # tl.device_assert(((0 <= tmp1) & (tmp1 < 314)) | ~xmask, "index out of bounds: 0 <= tmp1 < 314")
