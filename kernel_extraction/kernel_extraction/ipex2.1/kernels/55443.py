...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/yk/cykpenlksmflk2hoena3sbqdfwt5lko3vf3vuqsoedak3p4n4nqe.py
...
# nan_to_num_11 => convert_element_type_94, eq_46, eq_47, isnan_11, where_34, where_35, where_36
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_45', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
