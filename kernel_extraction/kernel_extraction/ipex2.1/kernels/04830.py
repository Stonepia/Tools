...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/oe/coemn5pe2v5c7n5nlv4arobya4pzkhx63lenzkcngl4v7lmrcdnr.py
# Source Nodes: [add_82, getattr_getattr_l__self___layers___3___blocks___1___mlp_drop2, l__self___norm], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add_82 => add_210
# getattr_getattr_l__self___layers___3___blocks___1___mlp_drop2 => clone_263
# l__self___norm => convert_element_type_374, var_mean_52
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_54', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
