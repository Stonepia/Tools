...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/ih/cih6jh3ykwozsvep3gtbzqy6ww2vss43fydtfqafwcjvzkud63c3.py
...
triton_poi_fused_bitwise_and_copy_ge_mul_select_scatter_slice_scatter_3 = async_compile.triton('triton_poi_fused_bitwise_and_copy_ge_mul_select_scatter_slice_scatter_3', '''
import triton
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp32', 1: '*i64', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_bitwise_and_copy_ge_mul_select_scatter_slice_scatter_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused_bitwise_and_copy_ge_mul_select_scatter_slice_scatter_3(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1040000
