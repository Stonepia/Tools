...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/ru/crujzh3qzo4mo4bxqzih3rihbhznamrpkk4grpn4drwe3kyg4b3a.py
# Source Nodes: [add_2, gelu_15, mul_27, mul_28, mul_29, mul_30, mul__17, mul__18], Original ATen: [aten.add, aten.gelu, aten.mul]
# add_2 => add_35
# gelu_15 => add_36, convert_element_type_66, convert_element_type_67, erf_15, mul_129, mul_130, mul_131
# mul_27 => mul_125
# mul_28 => mul_126
# mul_29 => mul_128
# mul_30 => mul_133
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_gelu_mul_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
