...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/bd/cbdx6afsm3jxbxr4d6ng4ocsc6f6qhwtrekcqkyvwwwphqvze2ps.py
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*i64', 1: '*fp32', 2: '*i1', 3: '*fp16', 4: '*fp16', 5: '*i1', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_native_dropout_view_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 8), equal_to_1=())]})
@triton.jit
