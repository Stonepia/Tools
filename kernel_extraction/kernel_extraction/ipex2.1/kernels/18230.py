...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/iz/cizjfdej534zf5pecyhoowk3yldrnpda35zkjr4oxty5ihdpkpny.py
# Source Nodes: [l__self___cell_stem_1_conv_prev_1x1_final_path_bn], Original ATen: [aten._native_batch_norm_legit_no_training]
# l__self___cell_stem_1_conv_prev_1x1_final_path_bn => add_38, convert_element_type_81, mul_49, mul_50, sub_16
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
