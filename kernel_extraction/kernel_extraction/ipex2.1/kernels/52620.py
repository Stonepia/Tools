...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/kg/ckgf73fld6xfqg2bytusaq3s4snx6mn52mfpm5pdixfhzvy56o7i.py
...
def triton_red_fused__to_copy_add_native_layer_norm_backward_24(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp7 = tl.load(in_ptr3 + (x0 + (768*r2) + (393216*x1)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp10 = tl.load(in_ptr4 + (x0 + (768*r2) + (393216*x1)), rmask, eviction_policy='evict_first', other=0.0)
