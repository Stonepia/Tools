...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/63/c637fmtz4ylnzdx3nxjf4x7u72l6hc4yb4mdsg5tpfnfyiox3gff.py
...
def triton_poi_fused__to_copy_add_copy_slice_slice_scatter_sub_zeros_like_1(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp5 = tl.where(tmp4 < 0, tmp4 + 617295, tmp4)
    # tl.device_assert(((0 <= tmp5) & (tmp5 < 617295)) | ~(xmask & tmp2), "index out of bounds: 0 <= tmp5 < 617295")
    ...
    tmp23 = tl.where(tmp22 < 0, tmp22 + 617295, tmp22)
    # tl.device_assert(((0 <= tmp23) & (tmp23 < 617295)) | ~(xmask & tmp20), "index out of bounds: 0 <= tmp23 < 617295")
    ...
    tmp40 = tl.where(tmp39 < 0, tmp39 + 617295, tmp39)
    # tl.device_assert(((0 <= tmp40) & (tmp40 < 617295)) | ~(xmask & tmp37), "index out of bounds: 0 <= tmp40 < 617295")
    ...
    tmp57 = tl.where(tmp56 < 0, tmp56 + 617295, tmp56)
    # tl.device_assert(((0 <= tmp57) & (tmp57 < 617295)) | ~(xmask & tmp54), "index out of bounds: 0 <= tmp57 < 617295")
