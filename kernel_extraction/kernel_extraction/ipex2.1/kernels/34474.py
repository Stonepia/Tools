...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/j3/cj3kc2nk3mpsktss3vrjkkj7tdiquvxi2ebabbppayxufjuxfn6v.py
...
@pointwise(size_hints=[512], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_view_19', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
