...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/g2/cg2mkan37qiz6ihiv5d24rhn65xhkm24ylfzw546c7ofwu4hvfol.py
# Source Nodes: [getattr_getattr_l__mod___layers___0___blocks___1___attn_softmax], Original ATen: [aten._softmax]
# getattr_getattr_l__mod___layers___0___blocks___1___attn_softmax => amax_1, div_1, exp_1, sub_5, sum_2
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax_11(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_ptr2 + (r3 + (49*x0) + (2401*(x2 % 64))), rmask, eviction_policy='evict_last', other=0.0)
    tmp2 = tmp0 + tmp1
    tmp4 = tmp2 + tmp3
