...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/2u/c2uhoi6kjl4g3iimfvinqxpu463y5oybqasf6tdlwp7kdycaxtnr.py
...
@pointwise(size_hints=[16384], filename=__file__, meta={'signature': {0: '*i64', 1: '*fp16', 2: '*fp16', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_sigmoid_split_with_sizes_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
