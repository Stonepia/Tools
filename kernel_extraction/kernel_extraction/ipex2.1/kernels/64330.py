...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/zs/czsaze7wnglhwekyhhwz6kw34xr5va3njgje6vco4wfa73n6sqdv.py
...
@pointwise(size_hints=[1024], filename=__file__, meta={'signature': {0: '*bf16', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_silu_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
