...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/4l/c4liz6z3woiigpt3x4kh5sp3hyzlm4yegljffdid5pnn4aoy2vqt.py
# Source Nodes: [l__self___norm, mean], Original ATen: [aten.mean, aten.native_layer_norm]
# l__self___norm => add_211, add_212, convert_element_type_374, convert_element_type_375, mul_200, mul_201, rsqrt_52, sub_76, var_mean_52
# mean => mean
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_mean_native_layer_norm_55', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
