...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/4t/c4t4lssclmbp7ewjysddlx57wpmbre23lnjlsd2kp7kxfdtyeaph.py
# Source Nodes: [getattr_getattr_l__self___layers___3___blocks___0___norm2], Original ATen: [aten.native_layer_norm]
# getattr_getattr_l__self___layers___3___blocks___0___norm2 => add_199, add_200, convert_element_type_351, convert_element_type_352, mul_187, mul_188, rsqrt_49, sub_72, var_mean_49
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_layer_norm_50', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
