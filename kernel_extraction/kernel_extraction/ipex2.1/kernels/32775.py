...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/dv/cdvyhh2ohqro4eoffsvydwlwewfeyxdgwv2c3e3ehnmxfmqfk7rf.py
# Source Nodes: [add_1, layer_norm_1], Original ATen: [aten.add, aten.native_layer_norm]
# add_1 => add_4
# layer_norm_1 => add_5, add_6, clone_3, mul_4, mul_5, rsqrt_1, sub_2, var_mean_1
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 8), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_native_layer_norm_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel):
    xnumel = 154
