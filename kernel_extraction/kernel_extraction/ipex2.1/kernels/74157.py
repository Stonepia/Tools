...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/ln/cln7l5anxqyxggccm2nsehmplntvaahrzmxbibbuehu2byqxvbms.py
# Source Nodes: [batch_norm_33, l__self___features_conv3_7_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_33 => add_77, convert_element_type_135, mul_100, mul_101, sub_33
# l__self___features_conv3_7_c1x1_a_bn_act => relu_33
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_44(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1024*x2) + (802816*y1)), tmp11, xmask)
''')
