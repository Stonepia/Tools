...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/ro/cronhom3msf47wco27heurzyqdmkendwyjedc32ivqxr2a7b3moi.py
...
# truediv_35 => div_32
# truediv_37 => div_34
triton_poi_fused_add_copy_div_mul_neg_sub_52 = async_compile.triton('triton_poi_fused_add_copy_div_mul_neg_sub_52', '''
import triton
...
@pointwise(size_hints=[65536], filename=__file__, meta={'signature': {0: '*fp32', 1: '*i64', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: '*fp32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_copy_div_mul_neg_sub_52', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_copy_div_mul_neg_sub_52(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 40000
