...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/f4/cf4gmj3ooe4m6h2qrcefwjaturmg3kmapeetmxmufddfx5yhe2kn.py
# Source Nodes: [batch_norm_3, relu_3, view], Original ATen: [aten._native_batch_norm_legit_functional, aten.relu, aten.view]
# batch_norm_3 => add_12, add_15, convert_element_type_12, convert_element_type_13, mul_21, mul_27, rsqrt_3, sub_6, var_mean_3
# relu_3 => relu_3
# view => view
...
@pointwise(size_hints=[8192], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_functional_relu_view_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 7), equal_to_1=())]})
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_relu_view_12(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ks0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp18 = tl.load(in_ptr4 + (x0), xmask, eviction_policy='evict_last').to(tl.float32)
