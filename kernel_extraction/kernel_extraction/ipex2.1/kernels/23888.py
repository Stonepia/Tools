...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/7o/c7of4i6cee3kbbdqoy6bah5jyrcmdt7qypb7mpqr7yxwkjfqnvmm.py
# Source Nodes: [l__mod___patch_embed2_norm], Original ATen: [aten.native_layer_norm]
# l__mod___patch_embed2_norm => add_20, add_21, clone_16, convert_element_type_18, convert_element_type_19, mul_20, mul_21, rsqrt_5, sub_7, var_mean_5
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_layer_norm_21', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_native_layer_norm_21(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr2 + (r1 + (128*x2) + (100480*x3)), tmp31, rmask)
''')
