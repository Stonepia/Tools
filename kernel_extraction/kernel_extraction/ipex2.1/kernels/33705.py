...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/yh/cyhyer37u3scrknjhuy3faccminxewxxq6m6cni64nolak3u4dch.py
...
# getattr_l__mod___layer2___0___bn1 => add_13, mul_11
...
@pointwise(size_hints=[131072], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_native_group_norm_relu_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
