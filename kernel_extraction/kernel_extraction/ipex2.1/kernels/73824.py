...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/2t/c2tibpv54fwt7rkxclexdartdychm2nm6b4yp34kbxi3qyh3makc.py
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (316*x2) + (990976*y1)), tmp9, xmask & ymask)
''')
