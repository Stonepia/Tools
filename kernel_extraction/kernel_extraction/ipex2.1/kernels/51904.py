...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/xv/cxvzszgiqtsfstgwr3synuqlewnssdy6pek2bnxq5m4jfiplf23o.py
...
# l__mod___model_23 => add_31, mul_22, rsqrt_22, sub_22, var_mean_22
...
def triton_poi_fused__native_batch_norm_legit_add_convolution_reflection_pad2d_relu_18(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp9 = tl.abs(tmp8)
    tmp10 = tmp2 - tmp9
    tmp11 = tl.load(in_ptr0 + (x0 + (64*tmp10) + (16384*tmp5)), xmask)
    tmp13 = tmp11 + tmp12
    tmp15 = tmp13 - tmp14
    tmp17 = 65536.0
    tmp18 = tmp16 / tmp17
