...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/eb/cebi6cfuxf7h3uob2lucaqwf6g2brz37koknvyfrhu3megads3e3.py
# Source Nodes: [l__self___cell_8_comb_iter_1_left_act_1, pad_29], Original ATen: [aten.constant_pad_nd, aten.relu]
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_constant_pad_nd_relu_58', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
