...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/bl/cbltjavz274ih4ssdt6mjmfrlfsiunffowl5lulfsytu6jfr6ohg.py
# Source Nodes: [batch_norm_18, l__mod___features_conv3_2_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_18 => add_42, convert_element_type_56, mul_55, mul_56, sub_18
# l__mod___features_conv3_2_c1x1_a_bn_act => relu_18
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_24(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (704*x2) + (551936*y1)), tmp13, xmask)
''')
