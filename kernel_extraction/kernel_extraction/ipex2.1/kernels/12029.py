...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/ed/cedni76cmztlqzqp4tiyyqfxq5culv3oghqrdvfszpwh5mzywh4w.py
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp32', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_abs_add_div_gt_lift_fresh_lt_maximum_minimum_mul_rsub_scalar_tensor_sub_where_73', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused_abs_add_div_gt_lift_fresh_lt_maximum_minimum_mul_rsub_scalar_tensor_sub_where_73(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, XBLOCK : tl.constexpr):
    ...
    x2 = (xindex // 5000)
    x4 = xindex
    tmp88 = tl.load(in_ptr3 + (x0), xmask, eviction_policy='evict_last').to(tl.float32)
    tmp0 = 1 + x0
    ...
    tmp82 = tmp76.to(tl.float32)
    tmp83 = triton_helpers.minimum(tmp77, tmp82)
    tmp84 = triton_helpers.maximum(tmp81, tmp83)
    tmp85 = triton_helpers.maximum(tmp8, tmp84)
    tmp86 = tmp80 - tmp85
    tmp87 = tmp9 * tmp80
    tmp89 = tmp87 / tmp88
    tmp90 = tl.abs(tmp89)
