...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/5k/c5kw5ht3spqomka2xxds44ypfallx4a32o5fb46xnfbytesh3ppu.py
# Source Nodes: [scaled_dot_product_attention_1], Original ATen: [aten.clone]
# scaled_dot_product_attention_1 => clone_11
...
def triton_poi_fused_clone_21(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 50432)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (512 + x0 + (64*x2) + (768*x1) + (151296*x3)), None)
