...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/cn/ccnntd6xsp4dg24hatvtgcilu3kcyq77fjmoyvbpqfqstmazfyzp.py
# Source Nodes: [add_11, add_12, add_9, any_4, clamp_1, clamp_2, clamp_3, isinf_3, l__self___decoder_block_0_layer__1__dropout, l__self___decoder_block_1_layer_0_dropout, mean_4, mul_12, mul_13, neg_2, neg_3, neg_4, pow_5, rsqrt_4, to_12, to_13, where_1, where_2, where_3, where_4], Original ATen: [aten._to_copy, aten.add, aten.any, aten.clamp, aten.clone, aten.isinf, aten.mean, aten.mul, aten.neg, aten.pow, aten.rsqrt, aten.scalar_tensor, aten.where]
# add_11 => add_14
# add_12 => add_15
# add_9 => add_11
# any_4 => any_4
...
# where_3 => where_3
# where_4 => where_4
triton_per_fused__to_copy_add_any_clamp_clone_isinf_mean_mul_neg_pow_rsqrt_scalar_tensor_where_9 = async_compile.triton('triton_per_fused__to_copy_add_any_clamp_clone_isinf_mean_mul_neg_pow_rsqrt_scalar_tensor_where_9', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i1', 2: '*fp16', 3: '*i1', 4: '*fp16', 5: '*fp16', 6: '*i1', 7: '*fp16', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_any_clamp_clone_isinf_mean_mul_neg_pow_rsqrt_scalar_tensor_where_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 9), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__to_copy_add_any_clamp_clone_isinf_mean_mul_neg_pow_rsqrt_scalar_tensor_where_9(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr2, xnumel, rnumel):
    xnumel = 1
