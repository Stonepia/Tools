...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/y5/cy5yjzfzrggsg5ttidtnq7yjblbyk432fo336vjo4y6seefnkm3s.py
...
# iadd => view_967
triton_red_fused__log_softmax__to_copy_view_33 = async_compile.triton('triton_red_fused__log_softmax__to_copy_view_33', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__log_softmax__to_copy_view_33', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__log_softmax__to_copy_view_33(in_out_ptr0, in_ptr0, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 16384
    rnumel = 30522
