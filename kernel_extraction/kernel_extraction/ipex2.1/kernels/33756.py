...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/so/csoh6gs2t234jujai7ntbbatjvniagqj26mg6cgooefurvu7wx7t.py
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*bf16', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_pow_tanh_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
