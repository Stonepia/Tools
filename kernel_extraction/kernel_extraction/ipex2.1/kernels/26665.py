...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/eu/ceusxrviafbvgyk2rueriszc5ub7onveuf5xmx5on5az67o6dqhy.py
...
def triton_poi_fused_add_9(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp22 = tmp0 + tmp21
    tl.store(out_ptr0 + (x2 + (256*y3)), tmp22, xmask)
''')
