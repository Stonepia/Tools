...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/hb/chb7bm4pke2lzxqedas2tvb5teijzcvwmvgmr4v5dxkwnklcippd.py
# Source Nodes: [add_4, add_5, l__self___encoder_block_0_layer_0_dropout, l__self___encoder_block_0_layer__1__dense_relu_dense_wi_0, l__self___encoder_dropout, mean_1, mul_5, mul_6, pow_2, rsqrt_1], Original ATen: [aten._to_copy, aten.add, aten.mean, aten.mul, aten.native_dropout, aten.pow, aten.rsqrt, aten.view]
# add_4 => add_6
# add_5 => add_7
# l__self___encoder_block_0_layer_0_dropout => gt_3, mul_10, mul_9
# l__self___encoder_block_0_layer__1__dense_relu_dense_wi_0 => convert_element_type_13, view_22
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*i64', 3: '*i1', 4: '*fp32', 5: '*fp32', 6: '*i1', 7: '*bf16', 8: 'i32', 9: 'i32', 10: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0', 'in_out_ptr1'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_mean_mul_native_dropout_pow_rsqrt_view_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 9, 10), equal_to_1=())]}
)
@triton.jit
