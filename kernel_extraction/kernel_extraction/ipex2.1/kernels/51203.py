...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/3u/c3uzabfnvjsyntbnwjciu7ktztgxfhcbuzekairgr7erkosjmjb4.py
# Source Nodes: [setitem_9], Original ATen: [aten.copy, aten.slice_scatter]
# setitem_9 => copy_9, slice_scatter_33, slice_scatter_34
triton_poi_fused_copy_slice_scatter_13 = async_compile.triton('triton_poi_fused_copy_slice_scatter_13', '''
import triton
...
@pointwise(size_hints=[256, 1024], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_slice_scatter_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused_copy_slice_scatter_13(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 256
    xnumel = 513
