...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/vt/cvtuuvvzym2r5oqiqpbxmypnu5j5zan5zrqvjaqxtyf5vcosndnm.py
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    y1 = (yindex // 192)
    y3 = yindex
    tmp0 = tl.load(in_ptr0 + (y0 + (192*x2) + (2408448*y1)), xmask, eviction_policy='evict_last')
    ...
    tl.store(out_ptr0 + (x2 + (12544*y3)), tmp9, xmask)
''')
