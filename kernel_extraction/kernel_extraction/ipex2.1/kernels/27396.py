...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/5c/c5cciesxayv32llwwbvrf4a3ckvdihs4lop2mzhgguvhilt6b2m6.py
...
# nan_to_num_2 => convert_element_type_22, eq_10, eq_11, isnan_2, where_7, where_8, where_9
# softmax_2 => amax_2, convert_element_type_24, div_2, exp_2, sub_8, sum_3
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
