...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/k4/ck4obtn7f5iu2pxv4ifu5rp2muvvboffvfeizu2jhz3i23igoncg.py
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: '*bf16', 7: '*bf16', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_abs_add_copy_div_lift_fresh_maximum_minimum_mul_neg_slice_scatter_sub_tanh_29', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]})
@triton.jit
