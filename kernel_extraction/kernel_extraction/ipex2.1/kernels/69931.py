...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/ku/ckurh2ndw43bubabby7fsl7afjp5l6qumblmqpfj3qklljoorzeo.py
# Source Nodes: [l__mod___encoder_b_encoder], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# l__mod___encoder_b_encoder => add_100, add_101, add_102, clone_83, clone_84, mul_112, mul_113, rsqrt_29, sub_45, var_mean_29
...
@triton.jit
def triton_per_fused_add_clone_native_layer_norm_26(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel):
    xnumel = 2464
