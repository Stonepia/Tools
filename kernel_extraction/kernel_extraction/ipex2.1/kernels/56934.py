...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/pc/cpc7rutxqdcun4cehunjar2w3g4b56xnop5wdbhfxqtaneiffxlf.py
# Source Nodes: [scaled_dot_product_attention_3], Original ATen: [aten.clone]
# scaled_dot_product_attention_3 => clone_16
...
def triton_poi_fused_clone_19(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 6272)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (128 + x0 + (64*x2) + (256*x1) + (12544*x3)), None)
