...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/6w/c6wnkdhjfncykd5p64p5blo75svq72ydknxo6tzo4yl6q3walxzm.py
# Source Nodes: [batch_norm_4, getattr_getattr_l__self___blocks___1_____0___bn2_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_4 => add_10, convert_element_type_23, mul_13, mul_14, sub_4
# getattr_getattr_l__self___blocks___1_____0___bn2_act => relu_3
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x2 + (3136*y3)), tmp11, xmask)
''')
