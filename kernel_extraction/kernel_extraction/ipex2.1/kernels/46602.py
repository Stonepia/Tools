...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/3t/c3tt3k3egjuozr47ebi56zzfyjrni37wngahvsvdrtfnafx7s6nx.py
...
# l__mod___model_layers_3_input_layernorm => add_28, add_29, mul_30, mul_31, rsqrt_3, sub_6, var_mean_3
...
@triton.jit
def triton_red_fused_add_clone_native_layer_norm_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 512
    rnumel = 2048
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp3 = tl.load(in_ptr2 + (r1 + (2048*x0)), rmask & xmask, eviction_policy='evict_last', other=0.0)
        tmp2 = tmp0 + tmp1
        tmp4 = tmp2 + tmp3
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp12 = tl.load(in_ptr2 + (r1 + (2048*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0)
