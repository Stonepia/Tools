...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/6z/c6zif5aqwbo7srcjfkbgjtccv4wehbxffuf2cdoytko6ti23g2gj.py
# Source Nodes: [getattr_getattr_l__mod___layers___0___blocks___0___norm2], Original ATen: [aten.native_layer_norm]
# getattr_getattr_l__mod___layers___0___blocks___0___norm2 => add_6, add_7, convert_element_type_6, convert_element_type_7, mul_5, mul_6, rsqrt_2, sub_3, var_mean_2
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_layer_norm_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_native_layer_norm_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (128*x3)), tmp25, rmask)
''')
