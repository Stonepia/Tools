...
# Original file: ./BlenderbotForCausalLM__52_backward_297.41/BlenderbotForCausalLM__52_backward_297.41_1.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/3x/c3xmxijg5cioqe2ob4ufdo2jkend3bwuvuxaqrb77hwyco5uvagv.py
# Source Nodes: [add_1, l__self___final_layer_norm, l__self___self_attn_layer_norm], Original ATen: [aten._to_copy, aten.add, aten.native_layer_norm, aten.native_layer_norm_backward]
# add_1 => add_3
...
def triton_red_fused__to_copy_add_native_layer_norm_native_layer_norm_backward_12(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, in_ptr9, out_ptr0, out_ptr1, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp2 = tl.load(in_ptr1 + (x0 + (2560*r2) + (327680*x1)), rmask, eviction_policy='evict_first', other=0.0)
        ...
        tmp14 = tl.load(in_ptr5 + (x0 + (2560*r2) + (327680*x1)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp16 = tl.load(in_ptr6 + (x0 + (2560*r2) + (327680*x1)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp19 = tl.load(in_ptr7 + (x0 + (2560*r2) + (327680*x1)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
