...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/t4/ct44xhsaq2sta54foiju2svxgoal2rdsn63f3dlpuvzcvvwnbusp.py
...
# l__mod___blocks_2_2_norm1 => add_90, add_91, convert_element_type_78, convert_element_type_79, mul_87, mul_88, rsqrt_30, sub_30, var_mean_30
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_34', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
