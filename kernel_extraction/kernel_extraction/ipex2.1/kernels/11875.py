...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/2u/c2u4alwjvrug43q3lemclc6rifv4d2jjfgmms73rler4cgxe3ri6.py
...
@pointwise(size_hints=[65536], filename=__file__, meta={'signature': {0: '*i64', 1: '*fp16', 2: '*fp32', 3: '*fp16', 4: '*fp32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_div_mul_neg_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
