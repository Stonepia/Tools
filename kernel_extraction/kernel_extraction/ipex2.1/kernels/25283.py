...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/w2/cw2ahkqxjnsqypkl2unh25stn3cidqwjzj5yejajnibxjk7hqwxt.py
# Source Nodes: [add, l__self___image_encoder_blocks_0_norm1], Original ATen: [aten.add, aten.native_layer_norm]
# add => add
# l__self___image_encoder_blocks_0_norm1 => clone_1, var_mean
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_native_layer_norm_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_native_layer_norm_1(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp2 = tl.load(in_ptr1 + (r1 + (1280*x0)), rmask, eviction_policy='evict_first', other=0.0)
