...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/qt/cqtjv2mkvecrff2j3l4dcfbtbeexlcsx4i6d3j2u5calqxv7msol.py
# Source Nodes: [add_5, l__self___stage3_0_fuse_act_1, l__self___stage3_0_fuse_layers_1_2_1, l__self___stage3_0_fuse_layers_1_2_2], Original ATen: [aten._native_batch_norm_legit_no_training, aten._to_copy, aten._unsafe_index, aten.add, aten.relu]
# add_5 => add_165
# l__self___stage3_0_fuse_act_1 => relu_60
# l__self___stage3_0_fuse_layers_1_2_1 => add_162, mul_202, mul_203, sub_63
# l__self___stage3_0_fuse_layers_1_2_2 => _unsafe_index_3, convert_element_type_280
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training__to_copy__unsafe_index_add_relu_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
