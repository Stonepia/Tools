...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/vu/cvu2e2egol6z3guakefbilxo3ioagyuhcmwes4aix4gecridvwvn.py
# Source Nodes: [l__mod___model_al_out_4], Original ATen: [aten._to_copy, aten._unsafe_index, aten.add, aten.arange, aten.mul, aten.rsub, aten.sub]
# l__mod___model_al_out_4 => _unsafe_index_4, _unsafe_index_5, _unsafe_index_6, _unsafe_index_7, add_89, add_91, add_92, add_93, convert_element_type_119, convert_element_type_120, convert_element_type_122, convert_element_type_126, iota_2, mul_121, mul_123, mul_125, mul_126, mul_127, mul_128, mul_129, mul_130, sub_41, sub_42, sub_43, sub_44
