...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/ao/caoop6quubgiw3h5giwk42axifjb6xffp5dhuavjhpcgojh4eb67.py
# Source Nodes: [getattr_getattr_l__mod___layers___1___blocks___1___attn_softmax], Original ATen: [aten._softmax]
# getattr_getattr_l__mod___layers___1___blocks___1___attn_softmax => amax_3, convert_element_type_30, convert_element_type_31, div_3, exp_3, sub_12, sum_4
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_25', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax_25(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_ptr2 + (r3 + (49*x0) + (2401*(x2 % 16))), rmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
    tmp2 = tmp0 + tmp1
    tmp4 = tmp2 + tmp3
