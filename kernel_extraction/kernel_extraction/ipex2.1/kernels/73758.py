...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/gp/cgpjdz2rr5kkg65mtq6ba56xqs6gj2xbb3ebb4micwrpp7mvn7fi.py
# Source Nodes: [batch_norm_67, l__mod___features_conv4_10_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_67 => add_156, convert_element_type_203, mul_202, mul_203, sub_67
# l__mod___features_conv4_10_c1x1_a_bn_act => relu_67
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_89(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1728*x2) + (338688*y1)), tmp13, xmask)
''')
