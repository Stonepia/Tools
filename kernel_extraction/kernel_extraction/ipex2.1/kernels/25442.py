...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/re/cregt4ev6vt2ff7d6rdn7zuovayukv4tr37jx6mn5ualv3zrjimq.py
...
@pointwise(size_hints=[256], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax_div_28', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
