...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/wp/cwpuqx4pfiytv6abawlsoeua6xwbfab34w2mlk476vanhpku5fod.py
# Source Nodes: [getattr_l__mod___layers___2___downsample_norm], Original ATen: [aten.native_layer_norm]
# getattr_l__mod___layers___2___downsample_norm => add_38, add_39, convert_element_type_36, convert_element_type_37, mul_36, mul_37, rsqrt_10, sub_14, var_mean_10
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_layer_norm_28', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_native_layer_norm_28(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (1024*x3)), tmp21, rmask & xmask)
''')
