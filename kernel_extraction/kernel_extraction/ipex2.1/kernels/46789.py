...
# Original file: ./AllenaiLongformerBase__21_inference_63.1/AllenaiLongformerBase__21_inference_63.1_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/kf/ckft3gcakcbdtc5tcd56gernx6iycsjcge4eao2csne6a5yuzrgq.py
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i1', 2: '*i1', 3: '*i1', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_any_gt_lt_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 5), equal_to_1=())]}
)
@triton.jit
