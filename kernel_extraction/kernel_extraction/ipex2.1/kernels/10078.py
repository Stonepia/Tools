...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/w5/cw55znfgqfpvbzsmfq5u5xtl4zoxpn6ikgijtrz7tqpoln4aeivu.py
...
@pointwise(size_hints=[8], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__log_softmax_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
