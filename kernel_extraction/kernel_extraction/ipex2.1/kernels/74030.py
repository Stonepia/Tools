...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/xs/cxs3mao3pumzux6zphqlkbbmbfnvh3j56n72o2eoexrkpytcbnfl.py
# Source Nodes: [batch_norm_49, l__self___features_conv4_4_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_49 => add_114, convert_element_type_199, mul_148, mul_149, sub_49
# l__self___features_conv4_4_c1x1_a_bn_act => relu_49
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_relu_65(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 43008
    xnumel = 196
    ...
    tl.store(out_ptr0 + (y0 + (1344*x2) + (263424*y1)), tmp11, xmask)
''')
