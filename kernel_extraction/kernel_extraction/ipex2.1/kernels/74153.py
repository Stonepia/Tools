...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/yk/cykyf3lfghql44qmnax4h375ejx6hfaw36n6cch62gnxivc7q23p.py
# Source Nodes: [batch_norm_30, l__self___features_conv3_6_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_30 => add_70, convert_element_type_123, mul_91, mul_92, sub_30
# l__self___features_conv3_6_c1x1_a_bn_act => relu_30
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_40(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (960*x2) + (752640*y1)), tmp11, xmask)
''')
