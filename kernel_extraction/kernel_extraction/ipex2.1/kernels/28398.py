...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/jp/cjpa32moo7zdz4klcxffk35pgku6cfvje3lrgfdbfsp7jca7amix.py
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*i64', 1: '*i64', 2: '*fp32', 3: '*i1', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_native_dropout_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 6), equal_to_1=())]})
@triton.jit
