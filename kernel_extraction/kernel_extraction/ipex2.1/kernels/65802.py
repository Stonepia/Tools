...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/f3/cf33ovu6fhaamyra7aerms7usnxrsahrrm5mspn6k33leunsvpvf.py
# Source Nodes: [add_17, add_18, add_19, getattr_l__mod___stage3___1___norm1], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add]
# add_17 => add_73
# add_18 => add_76
# add_19 => add_80
# getattr_l__mod___stage3___1___norm1 => add_82, convert_element_type_113, mul_126, mul_127, sub_26
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_add_32(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4816896
