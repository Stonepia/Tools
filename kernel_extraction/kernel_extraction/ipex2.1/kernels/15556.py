...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/6q/c6qcu4fiwzmzshru6ul5lqikgdtt7x7ydix4dg4wxkloxpnyicst.py
...
# cat_6850 => cat_5
# iadd => convert_element_type_1
# invert => bitwise_not
# softmax => amax, convert_element_type, div, exp, sub, sum_1
# stack => cat_3428
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*bf16', 2: '*i1', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_bitwise_not_cat_stack_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 6, 7), equal_to_1=())]}
)
@triton.jit
