...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/fb/cfbxbuomk4tkd7gsuz6yulsvcwtakouybacikxpv7hzfpokeme6q.py
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_mean_sum_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]}
)
@triton.jit
