...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/bp/cbpbdcdxtbbzdfmw57bjpf3dgwnbe2ljxzicensdoal3drlqlr34.py
# Source Nodes: [add_8, add_9, getattr_l__mod___stage2___0___norm2], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add]
# add_8 => add_42
# add_9 => add_45
# getattr_l__mod___stage2___0___norm2 => add_47, convert_element_type_65, mul_77, mul_78, sub_12
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_add_16(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 9633792
