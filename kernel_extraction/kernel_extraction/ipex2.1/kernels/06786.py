...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/47/c47kyhzedpzabr37fo7zhl33tntdx3k4nmy42ms62brudr4rv2te.py
...
# cross_entropy => convert_element_type, div_12, full_default_7, ne, neg, sum_8, sum_9, where_7
# cross_entropy_1 => convert_element_type_1, div_13, ne_3, neg_1, sum_11, sum_12, where_9
# truediv_6 => div_14
triton_per_fused_add_clamp_div_nll_loss_forward_15 = async_compile.triton('triton_per_fused_add_clamp_div_nll_loss_forward_15', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*i64', 2: '*fp32', 3: '*i64', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clamp_div_nll_loss_forward_15', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 8), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_clamp_div_nll_loss_forward_15(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr3, out_ptr4, xnumel, rnumel):
    xnumel = 1
    ...
    tmp13 = tl.load(in_ptr1 + (tmp12 + (128*r0)), rmask, other=0.0)
    tmp14 = -tmp13
    tmp15 = 0.0
    ...
    tmp32 = tl.load(in_ptr3 + (tmp31 + (128*r0)), rmask, other=0.0)
    tmp33 = -tmp32
