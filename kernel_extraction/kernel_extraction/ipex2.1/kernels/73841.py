...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/2o/c2ohpe7usve634y52wgaf2uqv22gwnaohdo5angbgnnbizlc67ma.py
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_24(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (704*x2) + (551936*y1)), tmp9, xmask)
''')
