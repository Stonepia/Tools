...
# Original file: ./detectron2_maskrcnn_r_50_fpn__67_inference_107.47/detectron2_maskrcnn_r_50_fpn__67_inference_107.47_1.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/hq/chqstqpfsb7nlumvwhdxgz4smk3flouab3ad2itonoufhii6rkyl.py
...
@pointwise(size_hints=[32], filename=__file__, meta={'signature': {0: '*fp32', 1: '*i64', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_add_clamp_div_floor_log2_mul_sqrt_sub_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
