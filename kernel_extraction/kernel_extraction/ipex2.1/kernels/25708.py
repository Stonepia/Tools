...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/ce/ccedgx5gvzhpmkvshj53fznsnsmyzdxgkv2wsfxprw2p7nh5htor.py
...
def triton_poi_fused_clone_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_ptr2 + (y0 + (768*x2) + (150528*y1)), xmask, eviction_policy='evict_last')
