...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/o3/co36saw262dapc63lmr5gcbt2ykczyy3n7c6ypiklr6lytcdoqt2.py
# Source Nodes: [add_10, add_11, l__self___encoder_block_1_layer__1__dropout, l__self___encoder_block_2_layer_0_self_attention_q, mean_4, mul_11, mul_12, pow_5, rsqrt_4], Original ATen: [aten._to_copy, aten.add, aten.mean, aten.mul, aten.native_dropout, aten.pow, aten.rsqrt, aten.view]
# add_10 => add_13
# add_11 => add_14
# l__self___encoder_block_1_layer__1__dropout => gt_9, mul_27, mul_28
# l__self___encoder_block_2_layer_0_self_attention_q => convert_element_type_33, view_51
# mean_4 => mean_4
# mul_11 => mul_29
# mul_12 => mul_30
# pow_5 => pow_5
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*i64', 3: '*fp32', 4: '*fp32', 5: '*i1', 6: '*bf16', 7: 'i32', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0', 'in_out_ptr1'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_mean_mul_native_dropout_pow_rsqrt_view_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 8, 9), equal_to_1=())]}
)
@triton.jit
