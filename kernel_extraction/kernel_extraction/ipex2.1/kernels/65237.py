...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/ym/cymxwhuob46dclezpyhc3mofclqsxewemtcbdx4amlflzilr2cxe.py
# Source Nodes: [l__mod___up2_up], Original ATen: [aten._to_copy, aten._unsafe_index, aten.add, aten.mul, aten.rsub, aten.sub]
# l__mod___up2_up => _unsafe_index_6, _unsafe_index_7, add_32, convert_element_type_44, mul_52, mul_53, sub_16, sub_17
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy__unsafe_index_add_mul_rsub_sub_10', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
