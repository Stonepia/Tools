...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/wj/cwjzzjmaxakljmki5g4gv4ml3oorwbk3yjrdgkzddrpqsb7fb2ng.py
# Source Nodes: [getattr_l__self___layers___3___downsample_norm], Original ATen: [aten.native_layer_norm]
# getattr_l__self___layers___3___downsample_norm => add_193, add_194, convert_element_type_341, convert_element_type_342, mul_182, mul_183, rsqrt_47, sub_69, var_mean_47
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_layer_norm_43', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_native_layer_norm_43(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (2048*x3)), tmp19, rmask & xmask)
''')
