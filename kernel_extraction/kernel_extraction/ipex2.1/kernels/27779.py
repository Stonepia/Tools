...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/fg/cfgejfzfrcaqr3ghjvpefzz5ay4zxjjjiev2mx57dersoktcesue.py
# Source Nodes: [add_4, add_6, add_7, l__self___block_0_layer_0_dropout, l__self___block_0_layer__1__dropout, l__self___embed_tokens, mean_2, mul_7, mul_8, pow_3, rsqrt_2, to_7, to_8], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add_4 => add_6
# add_6 => add_8
# add_7 => add_9
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clone_embedding_mean_mul_pow_rsqrt_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
