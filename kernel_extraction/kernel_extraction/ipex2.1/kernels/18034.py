...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/36/c36giuq3nsdztjpm73ay76exx2f6lllqpdybqieto3aqenp627ri.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax_add_3(in_ptr0, out_ptr2, xnumel, rnumel):
    xnumel = 6144
