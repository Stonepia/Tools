...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/ow/cowgqha4tuzfokkp4zzijahwv3y4qc7sl6odbkjkrchpta3a3sfp.py
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*i64', 1: '*bf16', 2: '*fp32', 3: '*bf16', 4: '*fp32', 5: '*bf16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_25', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
def triton_poi_fused_cat_25(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp8 = tl.load(in_ptr2 + (x1 + (4096*x2)), None, eviction_policy='evict_last')
