...
# Original file: ./PLBartForCausalLM__40_backward_121.9/PLBartForCausalLM__40_backward_121.9_2.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/s2/cs2227rfu6sqqrleftomguwxxoyqduciqg7jg6znqi4sqxavhrsj.py
...
def triton_red_fused__log_softmax_backward_data_add_nll_loss_backward_nll_loss_forward_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp15 = tl.load(in_ptr4 + (r1 + (50005*x0)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
