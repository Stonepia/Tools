...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/bv/cbvqczd2fuxkad5l4hfhwa3rpc5idswz5uu5wbbl6qc4lmq3h75c.py
# Source Nodes: [add_1, dropout_1, l__self___fc1, l__self___self_attn_layer_norm], Original ATen: [aten._to_copy, aten.add, aten.native_dropout, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
# add_1 => add_1
...
def triton_per_fused__to_copy_add_native_dropout_native_layer_norm_native_layer_norm_backward_view_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, out_ptr4, out_ptr5, out_ptr6, load_seed_offset, xnumel, rnumel):
    ...
    tl.store(out_ptr4 + (r1 + (256*x0)), tmp36, rmask)
    tl.store(out_ptr5 + (r1 + (256*x0)), tmp41, rmask)
