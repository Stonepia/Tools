...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/th/cth5qa2tqbmr54jcbwgj3fyj77bk2xoucz4szkyanhy75rke3vnn.py
...
triton_poi_fused_convolution_glu_relu_8 = async_compile.triton('triton_poi_fused_convolution_glu_relu_8', '''
import triton
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_convolution_glu_relu_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_convolution_glu_relu_8(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 6115328
