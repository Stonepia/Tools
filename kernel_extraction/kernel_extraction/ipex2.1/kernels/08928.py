...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/xw/cxwgwqd2l3xomjx4t2bpnjtty6do7vlfzfsoq7uzmh2ob5sae6yh.py
# Source Nodes: [add_10, getattr_getattr_l__self___levels___2___transformer_encoder___0___attn_qkv, layer_norm_10], Original ATen: [aten._to_copy, aten.add, aten.native_layer_norm]
# add_10 => add_34
# getattr_getattr_l__self___levels___2___transformer_encoder___0___attn_qkv => convert_element_type_69
# layer_norm_10 => add_35, add_36, mul_40, mul_41, rsqrt_10, sub_14, var_mean_10
triton_red_fused__to_copy_add_native_layer_norm_29 = async_compile.triton('triton_red_fused__to_copy_add_native_layer_norm_29', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_native_layer_norm_29', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__to_copy_add_native_layer_norm_29(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 6272
    rnumel = 512
