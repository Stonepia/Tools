...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/l2/cl2uuwxafexx6fe6teo54ttqgolonfh2udjkqej3r6em6jjbrf75.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp32', 3: '*fp32', 4: '*fp16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_convolution_div_gelu_mean_mul_pow_sqrt_sub_62', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
