...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/sd/csd3h3xm5mlpgb4l4rcs3gaxtpwrreqe6gph3bfjiarjijed2rk4.py
...
# truediv_64 => div_61
# zeros_like => full
triton_poi_fused_add_copy_div_mul_select_scatter_slice_slice_scatter_sub_zeros_like_77 = async_compile.triton('triton_poi_fused_add_copy_div_mul_select_scatter_slice_slice_scatter_sub_zeros_like_77', '''
import triton
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_copy_div_mul_select_scatter_slice_slice_scatter_sub_zeros_like_77', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_copy_div_mul_select_scatter_slice_slice_scatter_sub_zeros_like_77(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1082016
