...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/7o/c7ofr7b7cn5if2uynkloinqnuve76x73nxjhild5w6u2eakjrvwd.py
# Source Nodes: [float_15, softmax_12, type_as_12], Original ATen: [aten._softmax, aten._to_copy]
# float_15 => convert_element_type_194
# softmax_12 => amax_12, div_16, exp_12, sub_17, sum_13
# type_as_12 => convert_element_type_195
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__softmax__to_copy_2(in_ptr0, in_ptr1, out_ptr0, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp20 = tl.load(in_ptr1 + (x1 + (12*tmp19)), None, eviction_policy='evict_first')
        tmp21 = r2
        tmp22 = x0
        tmp23 = tmp21 <= tmp22
