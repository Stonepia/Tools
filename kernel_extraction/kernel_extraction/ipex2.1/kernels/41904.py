...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/yh/cyhkru2zg5zggnkz475ckzalp7cpngn5qe2cjw5sl45katmdc7ko.py
...
def triton_poi_fused_clone_7(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x2 = (xindex // 1024)
    x3 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (64*x2) + (96000*x1)), None)
