...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/eb/cebzw77xcuklzwf6zj6u7gsn675jqfqnatdl67huolerpru6xzka.py
# Source Nodes: [batch_norm_64, l__self___features_conv4_9_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_64 => add_149, convert_element_type_259, mul_193, mul_194, sub_64
# l__self___features_conv4_9_c1x1_a_bn_act => relu_64
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_relu_85(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 53248
    xnumel = 196
    ...
    tl.store(out_ptr0 + (y0 + (1664*x2) + (326144*y1)), tmp11, xmask)
''')
