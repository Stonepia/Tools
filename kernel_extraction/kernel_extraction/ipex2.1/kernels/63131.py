...
# Original file: ./detectron2_fasterrcnn_r_101_fpn__36_inference_76.16/detectron2_fasterrcnn_r_101_fpn__36_inference_76.16_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/3t/c3tkeep2wx5khdcjypthy2evtrw7y7h4dnawg5rgppvt7j22yi2l.py
...
def triton_red_fused_max_0(in_ptr0, out_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp2 = tmp0 < tmp1
        tmp3 = tl.load(in_ptr0 + ((r1 + (6322*x0)) % 18964), rmask & tmp2 & xmask, eviction_policy='evict_last', other=0.0)
