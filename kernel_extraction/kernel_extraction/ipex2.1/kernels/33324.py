...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/wv/cwvcuhvu37h2npea3z463varw2tg35h4rs6yzicxg4m4avpgck7b.py
# Source Nodes: [softmax], Original ATen: [aten._softmax]
# softmax => amax, convert_element_type_6, convert_element_type_7, div, exp, sub_1, sum_1
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__softmax_4(in_ptr0, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 72000
    rnumel = 1500
