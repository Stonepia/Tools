...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/el/celdb3xh2s64o3246mt7x3kqtp74zer26xwylncq3nkwbyfjgtb7.py
...
def triton_per_fused__to_copy_add_clone_mean_mul_pow_rsqrt_14(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, rnumel):
    ...
    tmp1 = tl.load(in_out_ptr0 + (r1 + (512*x0)), rmask, other=0.0).to(tl.float32)
