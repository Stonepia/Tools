...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/hc/chcmrwu2rijkmcvmioc3lppoqcwfnh2cyxly5jblf76tedhyh4hl.py
# Source Nodes: [add_19, batch_norm_58, getattr_getattr_l__self___stages___4___blocks___0___conv2_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.leaky_relu]
# add_19 => add_137
# batch_norm_58 => add_136, mul_233, mul_234, sub_58
# getattr_getattr_l__self___stages___4___blocks___0___conv2_bn_act => convert_element_type_354, gt_58, mul_235, where_58
...
def triton_poi_fused__native_batch_norm_legit_no_training_add_leaky_relu_50(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp16 = tl.load(in_ptr5 + (32768 + y2 + (64*x1) + (65536*y3)), xmask, eviction_policy='evict_last').to(tl.float32)
    ...
    tmp17 = tmp15 + tmp16
    tl.store(out_ptr1 + (x1 + (512*y0)), tmp17, xmask)
''')
