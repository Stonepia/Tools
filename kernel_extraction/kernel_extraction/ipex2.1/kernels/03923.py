...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/ai/caibe4thmagksvckhqgbrndvgqv4h57slhi3o4yht6lrqdvovtur.py
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*i64', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_select_sub_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused_index_select_sub_0(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp5 = tl.load(in_ptr1 + (x0 + (64*tmp4)), None).to(tl.float32)
    tmp6 = tmp5 - tmp2
