...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/at/cat5234v6eonojmc7xnm3tad7onqmqnb43gxkwmxhulmpno4pd74.py
...
@pointwise(size_hints=[4, 4194304], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 7), equal_to_1=())]})
@triton.jit
