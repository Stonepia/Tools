...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/6c/c6c7t3oowho33kcuq6pggmnmea6bilvgnh2te7vbmso55tsp2vmc.py
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp64', 1: '*fp64', 2: '*fp64', 3: '*fp64', 4: '*fp64', 5: '*fp64', 6: '*fp64', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_abs_add_div_lift_fresh_maximum_mul_neg_tanh_18', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]})
@triton.jit
def triton_poi_fused_abs_add_div_lift_fresh_maximum_mul_neg_tanh_18(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp36 = tl.abs(tmp35)
    tmp37 = -tmp36
    tmp38 = tl.full([1], 0.001, tl.float64)
    tmp39 = tmp37 + tmp38
    tmp40 = tmp39 / tmp38
    tmp41 = libdevice.tanh(tmp40)
    tmp42 = tl.full([1], 1.0, tl.float64)
    tmp43 = tmp41 + tmp42
    tmp44 = tl.full([1], 0.5, tl.float64)
    tmp45 = tmp43 * tmp44
    tmp46 = tmp34 * tmp45
    tmp47 = tl.full([1], 50.0, tl.float64)
