...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/dn/cdn4ijexwo3z25nwz6mskzjyovlwgfailkyz6l5i6ppn2dla33rs.py
# Source Nodes: [l__mod___module_list_12_activation, l__mod___module_list_12_batch_norm2d], Original ATen: [aten._native_batch_norm_legit_no_training, aten.leaky_relu]
# l__mod___module_list_12_activation => convert_element_type_49, gt_9, mul_39, where_9
# l__mod___module_list_12_batch_norm2d => add_22, mul_37, mul_38, sub_9
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_leaky_relu_8(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 6291456
