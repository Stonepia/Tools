...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/xo/cxop2rwjm75pwjr3ft7viianiaglivvlbitazfeiyuge7b7kg5iv.py
# Source Nodes: [add_1, add_2, getattr_l__self___model___11___conv_block_6, getattr_l__self___model___12___conv_block_6], Original ATen: [aten._native_batch_norm_legit, aten.add]
# add_1 => add_8
# add_2 => add_11
...
# getattr_l__self___model___12___conv_block_6 => add_10, convert_element_type_35, convert_element_type_36, mul_8, rsqrt_8, sub_8, var_mean_8
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*bf16', 5: '*fp32', 6: '*fp32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_add_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]})
@triton.jit
