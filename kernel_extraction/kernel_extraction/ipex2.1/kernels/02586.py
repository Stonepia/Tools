...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/mt/cmtccocitrl7w3inz7ibfl35u3ondhyxz33bzijqgabr6n4ig2au.py
# Source Nodes: [batch_norm_31, getattr_getattr_l__mod___stages___3_____0___self_attn_pool], Original ATen: [aten._native_batch_norm_legit_no_training, aten.avg_pool2d]
# batch_norm_31 => add_77, mul_131, mul_132, sub_34
# getattr_getattr_l__mod___stages___3_____0___self_attn_pool => avg_pool2d
triton_poi_fused__native_batch_norm_legit_no_training_avg_pool2d_48 = async_compile.triton('triton_poi_fused__native_batch_norm_legit_no_training_avg_pool2d_48', '''
import triton
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: '*fp32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_avg_pool2d_48', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_avg_pool2d_48(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 2097152
