...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/67/c677vxs4xoo4g56qiihdkqwbbvx5jsfkbojorjcwv5rfcnu6jep3.py
...
# cross_entropy => convert_element_type_51, div_48, full_default_3, ne, neg, sum_26, sum_27, where_1
# cross_entropy_1 => convert_element_type_54, div_49, ne_3, neg_1, sum_29, sum_30, where_3
# truediv_24 => div_50
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*i64', 2: '*bf16', 3: '*i64', 4: '*bf16', 5: '*bf16', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clamp_div_nll_loss_forward_20', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 8), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_clamp_div_nll_loss_forward_20(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr3, out_ptr4, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 1
    rnumel = 128
