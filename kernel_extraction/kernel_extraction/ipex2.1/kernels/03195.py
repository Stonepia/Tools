...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/bq/cbqu4ca3khu5c5yuzcqp6ih73eohxovlow6tlvn572iiazxrsgwq.py
...
@pointwise(size_hints=[32], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax__to_copy_add_nan_to_num_10', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
