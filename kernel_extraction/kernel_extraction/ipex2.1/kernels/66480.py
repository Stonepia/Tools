...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/pt/cptir5y3gxrgtccmcwuwykuxok6vc2aiqsgx6lhur4yta7gizx55.py
# Source Nodes: [gelu_24, l__mod___cls_predictions_transform_layer_norm], Original ATen: [aten.gelu, aten.native_layer_norm]
# gelu_24 => add_196, erf_24, mul_171, mul_172, mul_173
# l__mod___cls_predictions_transform_layer_norm => add_197, add_198, mul_174, mul_175, rsqrt_49, sub_74, var_mean_49
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_gelu_native_layer_norm_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
