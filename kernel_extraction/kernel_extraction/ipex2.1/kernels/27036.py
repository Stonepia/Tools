...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/64/c64dxntcsmdstcseifey4vtq74d2oclwit27zlrnkund2vikofgp.py
...
@pointwise(size_hints=[8], filename=__file__, meta={'signature': {0: '*fp16', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_23', 'configs': [AttrsDescriptor(divisible_by_16=(0,), equal_to_1=())]})
@triton.jit
def triton_poi_fused_23(out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tmp0 < tmp5
    tmp7 = -9.500980377197266e-05
    tmp8 = 0.002918243408203125
    tmp9 = tl.where(tmp6, tmp7, tmp8)
    tmp10 = -0.0016965866088867188
    tmp11 = tl.where(tmp4, tmp10, tmp9)
    tmp12 = tl.full([1], 4, tl.int64)
    tmp13 = tmp0 < tmp12
    tmp14 = tl.full([1], 5, tl.int64)
    tmp15 = tmp0 < tmp14
    tmp16 = 0.004726409912109375
