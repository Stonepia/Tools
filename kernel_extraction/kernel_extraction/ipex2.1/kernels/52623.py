...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/3e/c3eiqfkxoz6cckye3ict73bewebtnmm3bhz5xfydgmvqn77ghysp.py
...
def triton_red_fused_add_native_layer_norm_native_layer_norm_backward_27(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp4 = tl.load(in_ptr3 + (r2 + (512*x1)), rmask, eviction_policy='evict_last', other=0.0)
        tmp6 = tl.load(in_ptr4 + (r2 + (512*x1)), rmask, eviction_policy='evict_last', other=0.0)
        tmp3 = tmp1 + tmp2
        tmp5 = tmp3 - tmp4
        tmp7 = tmp5 * tmp6
        tmp8 = tmp0 * tmp7
