...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/tp/ctpc3754e67b3hu6wpt2ynpchlyt4noptkgthfvhkworkig5ky46.py
...
# full => full_default
triton_per_fused__softmax_backward_data_div_full_native_dropout_backward_nll_loss_forward_where_13 = async_compile.triton('triton_per_fused__softmax_backward_data_div_full_native_dropout_backward_nll_loss_forward_where_13', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*i1', 2: '*fp32', 3: '*i1', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_backward_data_div_full_native_dropout_backward_nll_loss_forward_where_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax_backward_data_div_full_native_dropout_backward_nll_loss_forward_where_13(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, xnumel, rnumel):
    xnumel = 98304
