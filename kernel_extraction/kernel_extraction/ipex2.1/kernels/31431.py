...
# Original file: ./detectron2_fcos_r_50_fpn__36_inference_76.16/detectron2_fcos_r_50_fpn__36_inference_76.16_2.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/kt/ckt3rim77w2i5wvupqkredvdukwl7sai2fey2lg34jqafiuktlnr.py
# Source Nodes: [add, mul, self____modules__0], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.mul]
# add => add_1
# mul => mul_2
# self____modules__0 => mul_1, sub
