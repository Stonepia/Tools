...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/xc/cxcuav2zvhkqwqyxrczppp25vx27af4xpiuoepemxed77egscamp.py
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_65(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1344*x2) + (263424*y1)), tmp9, xmask)
''')
