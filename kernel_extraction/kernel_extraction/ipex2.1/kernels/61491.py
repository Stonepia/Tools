...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/si/csimccin26f3vy34bynr3jnvbjesjvmliw57e4xef2gdbqeeeoll.py
...
def triton_red_fused__softmax_native_dropout_4(in_ptr0, in_ptr1, in_ptr2, out_ptr2, out_ptr3, out_ptr4, out_ptr5, load_seed_offset, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp25 = tl.load(in_ptr1 + (x1 + (6*tmp24)), rmask, eviction_policy='evict_last')
        tmp26 = 0.0
        tmp27 = tmp25 + tmp26
        tmp28 = tmp0 + tmp27
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r3 = rindex
        tmp32 = tl.load(in_ptr0 + (r3 + (128*x4)), rmask, eviction_policy='evict_last', other=0.0)
        tmp33 = r3 + ((-1)*x0)
        ...
        tmp57 = tl.load(in_ptr1 + (x1 + (6*tmp56)), rmask, eviction_policy='evict_last')
        tmp58 = 0.0
        tmp59 = tmp57 + tmp58
        tmp60 = tmp32 + tmp59
        tmp61 = tmp60 - tmp30
        ...
        tl.store(out_ptr2 + (r3 + (128*x4)), tmp68, rmask)
    tmp64 = tl.sum(_tmp64, 1)[:, None]
    for roffset in range(0, rnumel, RBLOCK):
        rindex = roffset + rbase
        rmask = rindex < rnumel
        r3 = rindex
        tmp69 = tl.load(out_ptr2 + (r3 + (128*x4)), rmask, eviction_policy='evict_first', other=0.0)
        tmp72 = tl.load(in_ptr0 + (r3 + (128*x4)), rmask, eviction_policy='evict_first', other=0.0)
        tmp70 = 0.1
        tmp71 = tmp69 > tmp70
        tmp73 = r3 + ((-1)*x0)
        ...
        tmp97 = tl.load(in_ptr1 + (x1 + (6*tmp96)), rmask, eviction_policy='evict_first')
        tmp98 = 0.0
        tmp99 = tmp97 + tmp98
        tmp100 = tmp72 + tmp99
        tmp101 = tmp100 - tmp30
        ...
        tl.store(out_ptr3 + (r3 + (128*x4)), tmp71, rmask)
        tl.store(out_ptr4 + (r3 + (128*x4)), tmp103, rmask)
        tl.store(out_ptr5 + (r3 + (128*x4)), tmp107, rmask)
''')
