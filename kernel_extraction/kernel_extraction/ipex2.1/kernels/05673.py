...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/xe/cxeayrqrymecri57ljhnu7dmsiejqdz6gwpyzwjmhb2vnd7e3wm5.py
# Source Nodes: [add_12, mul_2, softmax_2], Original ATen: [aten._softmax, aten.add, aten.mul]
# add_12 => add_70
# mul_2 => mul_89
# softmax_2 => amax_2, convert_element_type_128, convert_element_type_129, div_2, exp_2, sub_31, sum_3
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_mul_20', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
