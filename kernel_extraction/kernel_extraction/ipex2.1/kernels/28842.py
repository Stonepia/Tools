...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/f3/cf3kvyzcvqz2su4ttpfvclet4kziuzbf4nkhljiqomevtr7gqpng.py
# Source Nodes: [getattr_getattr_getattr_l__self___stages___3_____1___transformer___0___norm1], Original ATen: [aten.native_layer_norm]
# getattr_getattr_getattr_l__self___stages___3_____1___transformer___0___norm1 => add_62, add_63, convert_element_type_163, convert_element_type_164, mul_102, mul_103, rsqrt_5, sub_30, var_mean_5
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_layer_norm_26', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_native_layer_norm_26(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (192*x1) + (12288*x0)), tmp19, rmask)
''')
