...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/g7/cg74vanswx3cx63et5n26ftdhjo23ubjt2fxqkpdwg563sdpuy4i.py
...
def triton_poi_fused_index_2(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.where(tmp0 < 0, tmp0 + 258, tmp0)
    # tl.device_assert(((0 <= tmp1) & (tmp1 < 258)) | ~xmask, "index out of bounds: 0 <= tmp1 < 258")
