...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/u4/cu4euorl4x4gygtrwku2zb4euegkr7dvjcrstcqugekr5br6x72j.py
...
@pointwise(size_hints=[64], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_stack_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 3), equal_to_1=())]})
@triton.jit
