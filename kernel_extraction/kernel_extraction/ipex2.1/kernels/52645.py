...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/p2/cp2exv47hcngpr2mpvchzp55ayufz4yd2eoqjzz4xgmpur65yyvq.py
...
def triton_red_fused_add_native_layer_norm_backward_sum_19(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp4 = tl.load(in_ptr1 + (x0 + (768*r2) + (393216*x1)), rmask, eviction_policy='evict_first', other=0.0)
        tmp6 = tl.load(in_ptr2 + (x0 + (768*r2) + (393216*x1)), rmask, eviction_policy='evict_first', other=0.0)
        tmp8 = tl.load(in_ptr3 + (x0 + (768*r2) + (393216*x1)), rmask, eviction_policy='evict_first', other=0.0)
