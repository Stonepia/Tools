...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/i5/ci55dinht22x4d7yau7bhnphn6qprdwvj4uvcdwzs2ae753rsqsn.py
# Source Nodes: [group_norm_12], Original ATen: [aten.native_group_norm]
# group_norm_12 => convert_element_type_60, var_mean_12
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_group_norm_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
