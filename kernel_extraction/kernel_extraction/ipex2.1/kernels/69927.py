...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/7n/c7ngup4faktluujtcd66hhhwfam7wynhpn7jztyhkzo7fv4nrmgy.py
# Source Nodes: [l__mod___encoder_b_encoder], Original ATen: [aten.clone]
# l__mod___encoder_b_encoder => clone_75
...
def triton_poi_fused_clone_22(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x2 = (xindex // 16384)
    x3 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (64*x2) + (4928*x1)), None)
