...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/yh/cyhwhzldu7rybjyhsh4ou42yp5fdw2wx3hrad6pjl7tv2vslvqay.py
# Source Nodes: [add_16, add_18, any_8, clamp_5, clamp_6, isinf_7, l__self___block_3_layer_0_dropout, l__self___block_3_layer__1__dropout, neg_5, neg_6, where_1, where_6, where_7], Original ATen: [aten.add, aten.any, aten.clamp, aten.clone, aten.isinf, aten.neg, aten.scalar_tensor, aten.where]
# add_16 => add_21
# add_18 => add_23
# any_8 => any_8
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*i1', 3: '*fp16', 4: '*i1', 5: '*i1', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_any_clamp_clone_isinf_neg_scalar_tensor_where_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_any_clamp_clone_isinf_neg_scalar_tensor_where_13(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 128
    rnumel = 8192
