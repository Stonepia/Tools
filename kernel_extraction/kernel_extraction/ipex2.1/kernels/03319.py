...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/ll/cll34wb7ybcbudoxqyhvwlqpzmybhou6whcqy6mo2z2czzwuurut.py
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*i32', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused_clone_17(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tl.load(in_ptr2 + (x0 + (64*((tmp4 // 64) % 12)) + (768*(x1 % 64)) + (49152*(tmp4 % 64))), None).to(tl.float32)
