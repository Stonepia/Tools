...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/s5/cs5ealpveojurhbp6ecrqq4yfokmloqqtckwq4kmqoogxkt7u2kz.py
# Source Nodes: [add_8, add_9, clamp_1, l__mod___encoder_block_0_layer__1__dropout, l__mod___encoder_block_1_layer_0_self_attention_q, mean_2, mul_12, mul_13, neg_1, pow_4, rsqrt_2, to_7, to_8, where_1, where_2], Original ATen: [aten._to_copy, aten.add, aten.clamp, aten.mean, aten.mul, aten.native_dropout, aten.neg, aten.pow, aten.rsqrt, aten.scalar_tensor, aten.view, aten.where]
# add_8 => add_10
# add_9 => add_11
# clamp_1 => clamp_max_1, clamp_min_1, convert_element_type_12, convert_element_type_13
# l__mod___encoder_block_0_layer__1__dropout => mul_20, mul_21
# l__mod___encoder_block_1_layer_0_self_attention_q => view_28
# mean_2 => mean_2
# mul_12 => mul_22
# mul_13 => mul_23
# neg_1 => neg_1
