...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/li/clivhmrxdcdxdc66gpup5qqzz2wsmcgju27newvpv2epsprp26gd.py
...
def triton_per_fused_add_clone_mean_mul_pow_rsqrt_10(in_ptr0, in_ptr1, in_ptr2, out_ptr1, xnumel, rnumel):
    ...
    tmp14 = tmp2 * tmp13
    tmp15 = tmp8 * tmp14
    tl.store(out_ptr1 + (r1 + (1024*x0)), tmp15, rmask & xmask)
''')
