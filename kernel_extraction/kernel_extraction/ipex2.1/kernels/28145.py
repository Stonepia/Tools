...
# Original file: ./vision_maskrcnn__46_inference_86.26/vision_maskrcnn__46_inference_86.26_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/6c/c6ctd7sa57bsb2d6x4bqs36jbkct4xrdi7l5erpbf3cjz3u3uxke.py
...
@pointwise(size_hints=[64], filename=__file__, meta={'signature': {0: '*fp16', 1: '*i64', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_add_clamp_div_floor_lift_fresh_log2_mul_sqrt_sub_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
