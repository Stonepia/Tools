...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/bg/cbghcrpkgrun4iu3lkbortnm4yhgzrw5jnmidk22yqpytihmb5sk.py
...
def triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, out_ptr3, xnumel, rnumel):
    ...
    tmp22 = tl.load(in_ptr5 + (r1 + (512*x0)), rmask)
    tmp2 = tmp0 + tmp1
    tmp4 = tmp2 * tmp3
    ...
    tmp25 = tmp23 * tmp24
    tmp26 = tmp21 * tmp25
    tl.store(out_ptr2 + (r1 + (512*x0)), tmp21, rmask)
