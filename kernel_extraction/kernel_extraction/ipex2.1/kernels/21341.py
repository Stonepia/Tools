...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/ln/clnrw6b5vn7xxlwo2kxpkof7ddtexpcap7vdgwsyu2zrpuywumwt.py
...
# batch_norm_3 => add_12, convert_element_type_12, rsqrt_3, var_mean_3
# relu_3 => relu_3
...
@pointwise(size_hints=[64], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*bf16', 7: '*bf16', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_functional_native_batch_norm_backward_relu_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]})
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_native_batch_norm_backward_relu_0(in_ptr0, in_ptr1, out_ptr0, out_ptr1, out_ptr2, out_ptr3, out_ptr4, out_ptr5, xnumel, XBLOCK : tl.constexpr):
    xnumel = 64
    ...
    tl.store(out_ptr5 + (x0), tmp64, xmask)
''')
