...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/ra/cra4dxb6vzjkyyi33z47cxlc6xqq2wjp7mknp4gtymo6kdm6yszg.py
# Source Nodes: [float_15, softmax_12, type_as_12], Original ATen: [aten._softmax, aten._to_copy]
# float_15 => convert_element_type_133
# softmax_12 => amax_12, div_16, exp_12, sub_17, sum_13
# type_as_12 => convert_element_type_134
...
def triton_red_fused__softmax__to_copy_2(in_ptr0, in_ptr1, out_ptr1, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp19 = tl.load(in_ptr1 + (x1 + (12*tmp18)), None, eviction_policy='evict_last').to(tl.float32)
        tmp20 = r2
        tmp21 = x0
        tmp22 = tmp20 <= tmp21
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp54 = tl.load(in_ptr1 + (x1 + (12*tmp53)), None, eviction_policy='evict_first').to(tl.float32)
        tmp55 = r2
        tmp56 = x0
        tmp57 = tmp55 <= tmp56
