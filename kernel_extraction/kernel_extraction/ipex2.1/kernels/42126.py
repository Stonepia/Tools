...
# Original file: ./detectron2_fcos_r_50_fpn__48_inference_88.28/detectron2_fcos_r_50_fpn__48_inference_88.28_2.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/bd/cbdepgvwnbpi774rpgyhyg7kc6mid7z4luj7cs3yuddxo2xwxyxu.py
# Source Nodes: [add, mul, self____modules__2], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.mul]
# add => add_1
# mul => mul_2
# self____modules__2 => mul_1, sub
