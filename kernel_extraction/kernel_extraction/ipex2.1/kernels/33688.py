...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/nh/cnho7nbsyyq32mk2ck522ajwnrwpbcf2gt6edn3lzn7iejfz5qdf.py
# Source Nodes: [getattr_l__mod___layer2___1___bn2, getattr_l__mod___layer2___1___relu_1, iadd_3], Original ATen: [aten.add, aten.native_group_norm, aten.relu]
# getattr_l__mod___layer2___1___bn2 => add_22, convert_element_type_37, mul_19
# getattr_l__mod___layer2___1___relu_1 => relu_8
# iadd_3 => add_23
...
@pointwise(size_hints=[131072], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp32', 3: '*fp32', 4: '*fp16', 5: '*fp16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_native_group_norm_relu_10', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
