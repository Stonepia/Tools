...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/t7/ct7a4y57tt6buj4smcvltblxywmpnfdfxmmxns5a42adb3hvv2fx.py
...
@triton.jit
def triton_per_fused__log_softmax_backward_data_cat_div_nll_loss_backward_nll_loss_forward_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, in_ptr9, in_ptr10, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 256
    rnumel = 128
