...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/cq/ccq3f6mt3yivxbpugtqzvvnzrprifqiqji5tkcooaebd34nuipn6.py
...
@pointwise(size_hints=[32768, 256], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_83', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
