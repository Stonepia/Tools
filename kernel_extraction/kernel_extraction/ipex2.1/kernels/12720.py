...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/p3/cp3r6l3pc4u6nzjkmbxtl7ery3gzrcl44tvhu7youy2jl5kvkokc.py
...
# l__self___encoder_layers_3_attention_self_attention_query_key => convert_element_type_45
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*fp32', 5: '*fp32', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_clone_native_layer_norm_33', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
