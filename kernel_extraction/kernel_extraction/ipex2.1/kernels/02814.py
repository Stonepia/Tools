...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/ux/cuxchq5hwiyfi4ht2l5t3owdbv6sjejsasfknup4iqv7hwpfl42w.py
# Source Nodes: [add_10, mul_7, softmax_1], Original ATen: [aten._softmax, aten.add, aten.mul]
# add_10 => add_66
# mul_7 => mul_116
# softmax_1 => amax_1, convert_element_type_136, convert_element_type_137, div_1, exp_1, sub_29, sum_2
triton_red_fused__softmax_add_mul_38 = async_compile.triton('triton_red_fused__softmax_add_mul_38', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*fp32', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_add_mul_38', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__softmax_add_mul_38(in_ptr0, in_ptr1, in_ptr2, out_ptr1, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 65536
    rnumel = 256
