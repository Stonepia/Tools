...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/dt/cdtyeg3rvfsxkmc3mkcj265i3rmxju4voqi55ulf6hxqfvom5f6q.py
...
@triton.jit
def triton_per_fused__to_copy_add_native_dropout_native_layer_norm_native_layer_norm_backward_view_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr1, out_ptr5, out_ptr6, out_ptr7, load_seed_offset, xnumel, rnumel):
    xnumel = 8192
