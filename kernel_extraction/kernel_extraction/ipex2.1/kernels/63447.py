...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/gd/cgdz5a5lq23lu4ng6itayletqdggl4dfxl5fxbcn4j4xmshoebo7.py
...
def triton_per_fused__to_copy_add_clone_native_layer_norm_10(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, out_ptr3, xnumel, rnumel):
    ...
    tmp9 = tl.load(in_ptr4 + (r2 + (384*x3)), rmask & xmask, other=0.0).to(tl.float32)
    ...
    tl.store(out_ptr0 + (r2 + (384*x3)), tmp11, rmask & xmask)
    tl.store(out_ptr3 + (r2 + (384*x3)), tmp39, rmask & xmask)
''')
