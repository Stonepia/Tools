...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/4d/c4dseovg7akzhdvjiurbure3tpnmzblki7ifihs6kwk4zxtmqytk.py
...
def triton_red_fused__softmax_2(in_ptr0, in_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp19 = tl.load(in_ptr1 + (x1 + (12*tmp18)), None, eviction_policy='evict_last')
        tmp20 = r2
        tmp21 = x0
        tmp22 = tmp20 <= tmp21
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp52 = tl.load(in_ptr1 + (x1 + (12*tmp51)), None, eviction_policy='evict_last')
        tmp53 = r2
        tmp54 = x0
        tmp55 = tmp53 <= tmp54
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp87 = tl.load(in_ptr1 + (x1 + (12*tmp86)), None, eviction_policy='evict_first')
        tmp88 = r2
        tmp89 = x0
        tmp90 = tmp88 <= tmp89
