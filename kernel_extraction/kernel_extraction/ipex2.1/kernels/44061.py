...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/gz/cgzrkyzaoyn7c22n6zcoz6zf5nmsxx4wwyra2vpwnwnqymtfu4tq.py
# Source Nodes: [cat_7, l__mod___module_list_78], Original ATen: [aten.cat, aten.max_pool2d_with_indices]
# cat_7 => cat
# l__mod___module_list_78 => max_pool2d_with_indices
triton_poi_fused_cat_max_pool2d_with_indices_9 = async_compile.triton('triton_poi_fused_cat_max_pool2d_with_indices_9', '''
import triton
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_max_pool2d_with_indices_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_cat_max_pool2d_with_indices_9(in_ptr0, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 786432
    ...
    x0 = xindex % 512
    x7 = (xindex // 512)
    tmp142 = tl.load(in_ptr0 + (x6), None)
    tmp0 = (-2) + x2
    ...
    tmp10 = tmp7 & tmp9
    tmp11 = tmp5 & tmp10
    tmp12 = tl.load(in_ptr0 + ((-17408) + x6), tmp11, other=0.0)
    ...
    tmp17 = tmp15 & tmp16
    tmp18 = tmp5 & tmp17
    tmp19 = tl.load(in_ptr0 + ((-16896) + x6), tmp18, other=0.0)
    ...
    tmp25 = tmp23 & tmp24
    tmp26 = tmp5 & tmp25
    tmp27 = tl.load(in_ptr0 + ((-16384) + x6), tmp26, other=0.0)
    ...
    tmp33 = tmp31 & tmp32
    tmp34 = tmp5 & tmp33
    tmp35 = tl.load(in_ptr0 + ((-15872) + x6), tmp34, other=0.0)
    ...
    tmp41 = tmp39 & tmp40
    tmp42 = tmp5 & tmp41
    tmp43 = tl.load(in_ptr0 + ((-15360) + x6), tmp42, other=0.0)
