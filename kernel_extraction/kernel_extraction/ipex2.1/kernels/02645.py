...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/zj/czjn5xjjvsa3oen5syeshrpkutn6fuxktlsfqwlz5nf3l3y2q4ro.py
# Source Nodes: [add_16, mul_9, softmax_3], Original ATen: [aten._softmax, aten.add, aten.mul]
# add_16 => add_86
# mul_9 => mul_145
# softmax_3 => amax_3, div_3, exp_3, sub_38, sum_4
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_mul_44', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax_add_mul_44(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp8 = tmp6 < tmp7
    tmp9 = tmp8 & tmp5
    tmp10 = tl.load(in_ptr1 + ((15*((7 + (15*(x0 // 8)) + (r2 // 8)) // 16)) + (120*(x0 % 8)) + (960*((((8*x1) + (x0 % 8)) // 8) % 256)) + ((7 + (15*(x0 // 8)) + (r2 // 8)) % 16)), rmask & tmp9, other=0.0)
