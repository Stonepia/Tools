...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/2b/c2b2nidnvuona6cjeozc5m3h7667yk6wibj64cn2kbk6ukuo5epm.py
...
# iadd_39 => add_277
# iadd_40 => add_284
# softmax_40 => amax_40, convert_element_type_80, convert_element_type_81, div_40, exp_40, sub_40, sum_41
# stack => cat_3428
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i1', 2: '*fp16', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: '*fp16', 7: '*fp16', 8: '*fp16', 9: '*fp16', 10: 'i32', 11: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_cat_stack_62', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 9, 10), equal_to_1=())]}
)
@triton.jit
