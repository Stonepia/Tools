...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/ys/cysh5utlbxyduqmuxkzhqxcvahbhp6bziyiwjdv2w4pn7iweby5i.py
# Source Nodes: [batch_norm_51, l__mod___bn2_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.hardtanh]
# batch_norm_51 => add_113, mul_154, mul_155, sub_51
# l__mod___bn2_act => clamp_max_34, clamp_min_34, convert_element_type_225
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_hardtanh_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
