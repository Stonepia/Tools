...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/35/c35x72onyiw3kukhi4njer7ply7msh7t53iriascyhdvr3qb23rz.py
# Source Nodes: [batch_norm_36, l__self___features_conv3_8_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_36 => add_84, convert_element_type_147, mul_109, mul_110, sub_36
# l__self___features_conv3_8_c1x1_a_bn_act => relu_36
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_48(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1088*x2) + (852992*y1)), tmp11, xmask)
''')
