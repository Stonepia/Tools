...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/5f/c5foh6juczspqqntdtvwdoxhe5jocfakj5ujg3jtewaj5upo5cwz.py
# Source Nodes: [add, l__mod___encoder_a_encoder, layer_norm], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add => add
# l__mod___encoder_a_encoder => clone, var_mean_1
# layer_norm => add_1, add_2, mul, mul_1, rsqrt, sub, var_mean
triton_per_fused_add_clone_native_layer_norm_3 = async_compile.triton('triton_per_fused_add_clone_native_layer_norm_3', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_clone_native_layer_norm_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, out_ptr5, xnumel, rnumel):
    xnumel = 1600
    ...
    tl.store(out_ptr5 + (r2 + (768*x1) + (24576*x0)), tmp50, rmask & xmask)
''')
