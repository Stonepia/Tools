...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/4g/c4ged7icamb3xtsft5xtda7mxuodssevbq4om7nfjel253tel34r.py
...
# l__mod___mask_decoder_output_upscaling_4 => add_401, convert_element_type_356, convert_element_type_357, erf_33, mul_410, mul_411, mul_412
triton_poi_fused_convolution_gelu_59 = async_compile.triton('triton_poi_fused_convolution_gelu_59', '''
import triton
...
@pointwise(size_hints=[32, 65536], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_convolution_gelu_59', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused_convolution_gelu_59(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 32
    xnumel = 65536
