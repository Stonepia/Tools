...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/go/cgoxckm77bn5ssuex7lwywncvdlfhsnxv3qgrbmpnczjjg44r3jg.py
...
@pointwise(size_hints=[2048, 2048], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_136', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
