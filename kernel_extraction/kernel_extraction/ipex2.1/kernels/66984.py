...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/g6/cg6qu2sgjmwnad4lflbztd46hmkweqhd6vcsyj3e5zcus7ygvqbb.py
...
@triton.jit
def triton_per_fused__to_copy_add_native_dropout_backward_native_layer_norm_backward_21(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr3, out_ptr4, xnumel, rnumel):
    xnumel = 8192
