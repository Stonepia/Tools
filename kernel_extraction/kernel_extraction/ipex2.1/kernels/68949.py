...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/yq/cyqudk7j5dvbxrilg3s3z4f3morxbyrli745gwih3olxsb3ocqas.py
...
@pointwise(size_hints=[1], filename=__file__, meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_convolution_relu_12', 'configs': [AttrsDescriptor(divisible_by_16=(0,), equal_to_1=())]})
@triton.jit
