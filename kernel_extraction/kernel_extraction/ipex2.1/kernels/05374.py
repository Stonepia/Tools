...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/rq/crqmn6nrlhqvhyfnmq7d647zgiv4xxkrd53otpbxooskkgmf5wgy.py
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i32', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_embedding_mean_mul_pow_rsqrt_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
