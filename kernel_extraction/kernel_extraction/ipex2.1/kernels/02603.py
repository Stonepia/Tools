...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/u6/cu66y53f5ie3fcecqeqqjhcya2osprebiq52a5tyidnvf2b6jwdn.py
...
def triton_poi_fused_2(out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tmp0 < tmp5
    tmp7 = -0.3303021788597107
    tmp8 = 0.06354581564664841
    tmp9 = tl.where(tmp6, tmp7, tmp8)
    tmp10 = tl.full([1], 3, tl.int64)
    tmp11 = tmp0 < tmp10
    tmp12 = 1.774228811264038
    tmp13 = 2.1113927364349365
    ...
    tmp19 = tmp0 < tmp18
    tmp20 = 0.32513317465782166
    tmp21 = 1.232210397720337
    tmp22 = tl.where(tmp19, tmp20, tmp21)
    tmp23 = tl.full([1], 7, tl.int64)
    tmp24 = tmp0 < tmp23
    tmp25 = 0.7079262137413025
    tmp26 = 0.2353029102087021
