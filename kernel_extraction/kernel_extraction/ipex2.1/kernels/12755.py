...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/zs/czskr76xmndxnih6huiobbhkekf4yzhmjiegrxmdidtsni54q62m.py
...
# logsumexp_1 => abs_2, add_12, amax_1, convert_element_type_24, convert_element_type_25, eq_1, exp_2, log_1, sub_5, sum_2, where_2
# ne => ne
# sub_1 => sub_6
# where => where_1
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*i64', 2: '*fp16', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_exp_logsumexp_ne_sub_where_28', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
