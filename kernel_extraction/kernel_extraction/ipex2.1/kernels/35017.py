...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/f2/cf2uxtkpw7gbswtd55j6cw7ntjdqol6acnowhk3ia657xmevze5y.py
...
def triton_poi_fused_abs_add_copy_div_mul_neg_select_scatter_slice_scatter_tanh_34(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp37 = tl.load(in_ptr2 + (x0 + (4*x6)), tmp14 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
