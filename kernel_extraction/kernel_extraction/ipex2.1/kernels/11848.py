...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/6i/c6iwew4hg76ic7dqjz7ka6hjwtzinkx7z6imug6lrajv7r6etrjo.py
...
# tensor => full_default
triton_poi_fused_copy_lift_fresh_maximum_select_scatter_66 = async_compile.triton('triton_poi_fused_copy_lift_fresh_maximum_select_scatter_66', '''
import triton
...
@pointwise(size_hints=[131072], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_lift_fresh_maximum_select_scatter_66', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_copy_lift_fresh_maximum_select_scatter_66(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 120000
