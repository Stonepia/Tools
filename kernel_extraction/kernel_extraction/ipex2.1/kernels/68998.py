...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/6w/c6waj4o3ohfpezecvhmr2x6dtmsfggminwiyub7h5rtyyb6hhv62.py
...
@pointwise(size_hints=[32768, 512], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_convolution_relu_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
