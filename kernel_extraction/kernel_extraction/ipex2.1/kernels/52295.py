...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/4i/c4izpvvbr3wrapkmrkqurfgpzpfxypwjuwm57awkpfwwwuqhbkff.py
...
# cat_34 => cat_13
# getattr_getattr_l__mod___blocks___4___block___1___net_0 => add_57, convert_element_type_86, mul_85, mul_86, sub_28
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_cat_relu_29(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 786432
