...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/ka/ckafdfgln4z4u7pjh2qhdrjjvbnaoweyzrfxx24uixf2gqvlv3ch.py
# Source Nodes: [batch_norm_2], Original ATen: [aten._native_batch_norm_legit_no_training]
...
@pointwise(size_hints=[134217728], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: '*fp32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
