...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/bk/cbkddogladu7a47g3ltku7aqom3klp5szwvidlaxb6avovyn2jae.py
# Source Nodes: [add_1, dropout_1, l__self___encoder_attn_q_proj, l__self___self_attn_layer_norm], Original ATen: [aten._to_copy, aten.add, aten.native_dropout, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
# add_1 => add_1
...
def triton_per_fused__to_copy_add_native_dropout_native_layer_norm_native_layer_norm_backward_view_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, out_ptr4, out_ptr5, out_ptr6, load_seed_offset, xnumel, rnumel):
    ...
    tmp8 = tl.load(in_ptr2 + (r1 + (1024*x0)), rmask, other=0.0).to(tl.float32)
    ...
    tl.store(out_ptr4 + (r1 + (1024*x0)), tmp36, rmask)
    tl.store(out_ptr5 + (r1 + (1024*x0)), tmp41, rmask)
