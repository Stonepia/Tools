...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/5u/c5ugsqf5nusirnixezrepvljxrn5qc6dtplk2xcfu5zeiohce7w3.py
...
def triton_poi_fused_clone_transpose_8(in_ptr0, out_ptr0, out_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    y0 = yindex
    x3 = xindex
    tmp0 = tl.load(in_ptr0 + (y0 + (64*x2) + (1024*x1)), ymask, eviction_policy='evict_last').to(tl.float32)
