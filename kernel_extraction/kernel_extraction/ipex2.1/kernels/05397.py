...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/zf/czfhytf3e43u47kjoqjae63lueinricgvczehtgvxjjia6opt5jc.py
# Source Nodes: [add_1, add_2, float_5, l__mod___tok_embeddings, mean_1, mul_4, mul_5, pow_2, rsqrt_1, type_as_5], Original ATen: [aten._to_copy, aten.add, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add_1 => add_1
# add_2 => add_2
...
# pow_2 => pow_2
# rsqrt_1 => rsqrt_1
# type_as_5 => convert_element_type_10
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i32', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_embedding_mean_mul_pow_rsqrt_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
