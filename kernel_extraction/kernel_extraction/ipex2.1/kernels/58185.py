...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/4p/c4phtlxzpo236p4eyewevlyuejhcaeao4mm6wcruhz4j75erwahv.py
...
@pointwise(size_hints=[64, 65536], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
