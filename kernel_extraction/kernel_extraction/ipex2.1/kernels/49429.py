...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/ti/cti2jlmgn6v4u2ul7nkvs5hsc6fuw5c662hzfy5zjdfsdxnedsqg.py
# Source Nodes: [add_6, l__mod___blocks_1_attn_proj, l__mod___blocks_1_norm3, mul_8], Original ATen: [aten.add, aten.mul, aten.native_layer_norm]
# add_6 => add_31
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_mul_native_layer_norm_18', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
