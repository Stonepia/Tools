...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/rl/crlvo3te7mxels6f5dorkzdsagubo4vmhbeex6sdrefkfex7f7bu.py
...
# l__mod___model_al_out_4 => add_89, convert_element_type_120, convert_element_type_122, iota_2, mul_121, mul_123, sub_41, sub_42, sub_43, sub_44
# l__mod___model_fg_out_0 => _unsafe_index_12, _unsafe_index_13, _unsafe_index_14, _unsafe_index_15, add_120, add_121, add_122, convert_element_type_159, convert_element_type_166, mul_169, mul_170, mul_171, mul_172, mul_173, mul_174
...
@pointwise(size_hints=[256, 262144], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy__unsafe_index_add_arange_mul_rsub_sub_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
