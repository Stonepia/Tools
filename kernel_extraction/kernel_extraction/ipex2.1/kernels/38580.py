...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/p3/cp37dknjnu2ccadu5gc2p6voin2fefkajkr7qgzsfag4alfnb74b.py
...
@pointwise(size_hints=[16, 131072], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_35', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 3), equal_to_1=())]})
@triton.jit
