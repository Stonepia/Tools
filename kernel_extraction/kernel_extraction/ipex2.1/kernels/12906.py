...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/ly/clyvdhkyvwf553rq62yp4b6oagldfgkg5c4pdm7avgdsafjoaq35.py
...
# iadd_3 => add_25
# iadd_4 => add_32
# softmax_4 => amax_4, convert_element_type_8, convert_element_type_9, div_4, exp_4, sub_4, sum_5
# stack => cat_3428
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i1', 2: '*fp16', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: '*fp16', 7: '*fp16', 8: '*fp16', 9: '*fp16', 10: 'i32', 11: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_cat_stack_25', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 9, 10), equal_to_1=())]}
)
@triton.jit
