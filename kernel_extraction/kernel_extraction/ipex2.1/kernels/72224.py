...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/n3/cn3uzwhf25begpjh2lrtgzuvzqqs5ca4o6sklmfr6nmhci7klz6p.py
...
def triton_poi_fused_add_convolution_tanh_2(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr1 + (y0 + (857*x2) + (68560*y1)), xmask & ymask, eviction_policy='evict_last')
