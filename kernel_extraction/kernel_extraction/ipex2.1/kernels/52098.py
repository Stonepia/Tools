...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/au/cauquacrp3tlytyq6gq73aqrkcaqdstogat2tetbm2awn43vxfow.py
# Source Nodes: [batch_norm_24, getattr_getattr_l__self___blocks___3_____2___bn1_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.hardswish]
# batch_norm_24 => add_62, mul_81, mul_82, sub_24
# getattr_getattr_l__self___blocks___3_____2___bn1_act => add_63, clamp_max_8, clamp_min_8, convert_element_type_130, div_8, mul_83
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_hardswish_9(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4616192
