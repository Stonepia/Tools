...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/ml/cmles2pzbcfypngsfsowrnnrlnbchhqa4uw5l3r7ecqxam2axixz.py
...
def triton_per_fused_native_layer_norm_view_0(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, xnumel, rnumel):
    ...
    tl.store(out_ptr1 + (r1 + (1024*x0)), tmp31, rmask & xmask)
