...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/c2/cc2qeoiqbxivnqnmuo4guwu4lbh5xkod7d2omrdbfywshqnir4k2.py
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional_native_batch_norm_backward_relu_4(in_ptr0, in_ptr1, out_ptr0, out_ptr1, out_ptr2, out_ptr3, out_ptr4, out_ptr5, xnumel, XBLOCK : tl.constexpr):
    xnumel = 64
