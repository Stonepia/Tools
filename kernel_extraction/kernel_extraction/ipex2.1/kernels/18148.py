...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/fo/cfoh5csamaumxiopx3xqlejt7aelf7cgbd2ndtwvrazpcyrfxixj.py
# Source Nodes: [l__mod___cell_9_comb_iter_0_left_act_1, l__mod___cell_9_comb_iter_0_right], Original ATen: [aten.max_pool2d_with_indices, aten.relu]
# l__mod___cell_9_comb_iter_0_left_act_1 => relu_159
# l__mod___cell_9_comb_iter_0_right => max_pool2d_with_indices_33
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_max_pool2d_with_indices_relu_56', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_max_pool2d_with_indices_relu_56(in_ptr0, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp16 = tmp14 & tmp15
    tmp17 = tmp5 & tmp16
    tmp18 = tl.load(in_ptr0 + ((-9504) + x6), tmp17 & xmask, other=0.0)
    ...
    tmp32 = tmp30 & tmp31
    tmp33 = tmp32 & tmp9
    tmp34 = tl.load(in_ptr0 + ((-864) + x6), tmp33 & xmask, other=0.0)
    ...
    tmp41 = tmp32 & tmp24
    tmp42 = tl.load(in_ptr0 + (864 + x6), tmp41 & xmask, other=0.0)
    ...
    tmp53 = tmp48 & tmp16
    tmp54 = tl.load(in_ptr0 + (9504 + x6), tmp53 & xmask, other=0.0)
    tmp55 = tl.where(tmp53, tmp54, float("-inf"))
    tmp56 = triton_helpers.maximum(tmp55, tmp52)
    tmp57 = tmp48 & tmp24
    tmp58 = tl.load(in_ptr0 + (10368 + x6), tmp57 & xmask, other=0.0)
