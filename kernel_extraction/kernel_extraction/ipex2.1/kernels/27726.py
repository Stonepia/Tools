...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/at/cat2q4rikhhidc6sdmfr4hd6wucy5tfc2rqecfbi6ly5qjrxbsrj.py
# Source Nodes: [add_4, add_6, add_8, add_9, l__self___block_0_layer_0_dropout, l__self___block_0_layer__1__dropout, l__self___block_1_layer_0_dropout, l__self___embed_tokens, mean_3, mul_10, mul_9, pow_4, rsqrt_3], Original ATen: [aten.add, aten.clone, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add_4 => add_6
# add_6 => add_8
# add_8 => add_11
# add_9 => add_12
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*i64', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_embedding_mean_mul_pow_rsqrt_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
