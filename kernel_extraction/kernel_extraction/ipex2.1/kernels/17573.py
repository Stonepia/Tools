...
# Original file: ./detectron2_fcos_r_50_fpn__73_inference_113.53/detectron2_fcos_r_50_fpn__73_inference_113.53_1.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/6h/c6hfxper4h6fgtzisimcf2rxbsldskexa6amqx4cwyxkjlyjegbt.py
...
def triton_poi_fused__to_copy_add_copy_slice_slice_scatter_sub_zeros_like_1(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp5 = tl.where(tmp4 < 0, tmp4 + 617227, tmp4)
    # tl.device_assert(((0 <= tmp5) & (tmp5 < 617227)) | ~(xmask & tmp2), "index out of bounds: 0 <= tmp5 < 617227")
    ...
    tmp23 = tl.where(tmp22 < 0, tmp22 + 617227, tmp22)
    # tl.device_assert(((0 <= tmp23) & (tmp23 < 617227)) | ~(xmask & tmp20), "index out of bounds: 0 <= tmp23 < 617227")
    ...
    tmp40 = tl.where(tmp39 < 0, tmp39 + 617227, tmp39)
    # tl.device_assert(((0 <= tmp40) & (tmp40 < 617227)) | ~(xmask & tmp37), "index out of bounds: 0 <= tmp40 < 617227")
    ...
    tmp57 = tl.where(tmp56 < 0, tmp56 + 617227, tmp56)
    # tl.device_assert(((0 <= tmp57) & (tmp57 < 617227)) | ~(tmp54 & xmask), "index out of bounds: 0 <= tmp57 < 617227")
