...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/r2/cr22uf36aa4zjymklroc34tvpb6s4ayhxtasryar33v6focfswax.py
...
# getattr_getattr_getattr_l__mod___stages___2_____1___transformer___1___norm1 => add_42, add_43, convert_element_type_83, convert_element_type_84, mul_70, mul_71, rsqrt_2, sub_20, var_mean_2
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_16', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_clone_native_layer_norm_16(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 65536
    rnumel = 144
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr3 + (r2 + (144*x3)), tmp29, rmask)
''')
