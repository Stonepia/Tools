...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/le/cleagdnahpxxw3232gb7aghetllg7tasvikksqojwha6ieynecys.py
# Source Nodes: [bool_3, full_like_2, where_2], Original ATen: [aten._to_copy, aten.full_like, aten.where]
# bool_3 => convert_element_type_12
# full_like_2 => full_default_7
# where_2 => where_5
triton_poi_fused__to_copy_full_like_where_14 = async_compile.triton('triton_poi_fused__to_copy_full_like_where_14', '''
import triton
...
@pointwise(size_hints=[256, 512], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_full_like_where_14', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused__to_copy_full_like_where_14(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 256
    xnumel = 257
