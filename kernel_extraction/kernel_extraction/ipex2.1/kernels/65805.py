...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/ud/cud4ouux6msawbndsxjcmdny7sftydmnid5ute5k7yar64xltjph.py
# Source Nodes: [add_21, add_22, getattr_l__mod___stage3___2___norm2], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add]
# add_21 => add_87
# add_22 => add_90
# getattr_l__mod___stage3___2___norm2 => add_92, convert_element_type_128, mul_140, mul_141, sub_31
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*fp32', 4: '*fp32', 5: '*bf16', 6: '*bf16', 7: '*bf16', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_add_35', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]})
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_add_35(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4816896
