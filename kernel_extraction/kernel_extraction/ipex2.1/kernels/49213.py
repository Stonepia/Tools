...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/sh/csh3hnluzhsgmvorfmrgqmexdml7kfyqntzpvoczpvhy6taolshu.py
# Source Nodes: [batch_norm_21, getattr_getattr_l__mod___blocks___3_____1___bn1_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.hardtanh]
# batch_norm_21 => add_46, mul_64, mul_65, sub_21
# getattr_getattr_l__mod___blocks___3_____1___bn1_act => clamp_max_14, clamp_min_14, convert_element_type_95
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_hardtanh_8', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
