...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/nr/cnrfzvgmn2txrv3kxauagsobfrdwatuz375rbeav3lqob42xkynl.py
...
# softmax => amax, convert_element_type_2, convert_element_type_3, div_2, exp, sub_1, sum_1
# truediv_1 => div_1
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*fp16', 2: '*fp16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_div_eq_masked_fill_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
