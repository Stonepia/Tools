...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/wa/cwa54x7x77ae5wnxq3u432yv3s7sf2wwoovsiow45a5kz44drk3h.py
# Source Nodes: [l__mod___blocks_2_0_attn_norm], Original ATen: [aten.native_layer_norm]
# l__mod___blocks_2_0_attn_norm => add_73, add_74, convert_element_type_64, convert_element_type_65, mul_71, mul_72, rsqrt_25, sub_25, var_mean_25
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_layer_norm_26', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
