...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/ui/cuixdqv72vrre7kahflm4yrurjs5smwlfhb5fp6w7sodauk7gaup.py
...
def triton_poi_fused_add_mul_stack_0(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, out_ptr2, out_ptr3, out_ptr4, out_ptr5, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.where(tmp0 < 0, tmp0 + 617227, tmp0)
    # tl.device_assert(((0 <= tmp1) & (tmp1 < 617227)) | ~xmask, "index out of bounds: 0 <= tmp1 < 617227")
