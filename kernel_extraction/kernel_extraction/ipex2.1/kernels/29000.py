...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/tq/ctqcdti5wtzrfk7sfaxkm6xigrb6qzjvde2elantgxguqugdtm63.py
# Source Nodes: [getattr_getattr_getattr_l__self___stages___4_____1___transformer___0___norm1], Original ATen: [aten.native_layer_norm]
# getattr_getattr_getattr_l__self___stages___4_____1___transformer___0___norm1 => add_100, add_101, convert_element_type_264, convert_element_type_265, mul_155, mul_156, rsqrt_14, sub_49, var_mean_14
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_layer_norm_48', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_native_layer_norm_48(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (240*x1) + (3840*x0)), tmp19, rmask)
''')
