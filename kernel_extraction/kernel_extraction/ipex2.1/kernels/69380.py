...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/2w/c2wo2trmap4tltiyfjwhzqb4hg6t7iv3over2v6s5oxrttw6azkg.py
# Source Nodes: [group_norm_2], Original ATen: [aten.native_group_norm]
# group_norm_2 => convert_element_type_10, var_mean_2
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_group_norm_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_native_group_norm_11(in_ptr0, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp0 = tl.load(in_ptr0 + (r1 + (75264*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
