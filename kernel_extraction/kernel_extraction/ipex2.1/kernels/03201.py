...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/b5/cb5wfek5cxeufgurlh5baz7bdhnxpev4th4d2xvtucksgjxnjowe.py
# Source Nodes: [iadd_3, nan_to_num, nan_to_num_2, softmax_2], Original ATen: [aten._softmax, aten._to_copy, aten.add, aten.nan_to_num]
# iadd_3 => add_18
...
# softmax_2 => amax_2, convert_element_type_24, exp_2, sub_8, sum_3
triton_poi_fused__softmax__to_copy_add_nan_to_num_16 = async_compile.triton('triton_poi_fused__softmax__to_copy_add_nan_to_num_16', '''
import triton
...
@pointwise(size_hints=[16], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax__to_copy_add_nan_to_num_16', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused__softmax__to_copy_add_nan_to_num_16(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 16
