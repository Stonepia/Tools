...
# Original file: ./hf_T5_generate__86_inference_126.66/hf_T5_generate__86_inference_126.66.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/jl/cjlejiv5ko33z57bdq7gdrt3dafzuwqhaagfdkbwztrq3pk2oykr.py
# Source Nodes: [float_8, softmax_6, type_as_6], Original ATen: [aten._softmax, aten._to_copy]
# float_8 => convert_element_type_74
# softmax_6 => amax_6, div_8, exp_6, sub_14, sum_7
# type_as_6 => convert_element_type_75
triton_red_fused__softmax__to_copy_16 = async_compile.triton('triton_red_fused__softmax__to_copy_16', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp16', 5: 'i32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_16', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__softmax__to_copy_16(in_ptr0, in_ptr1, in_ptr2, out_ptr1, out_ptr3, ks0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 8
