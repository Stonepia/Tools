...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/mw/cmwairtdz3h5qmkj5f3o5ozs7q2geepikqavnws52eivri2hahhx.py
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*fp32', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_constant_pad_nd_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
