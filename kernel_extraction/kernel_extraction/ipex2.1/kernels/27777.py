...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/hv/chvuxr44u6ybj6o3ps4t2dphwtjcyhd5n4kczfrl7i5n4ieactom.py
# Source Nodes: [add_4, add_5, l__self___block_0_layer_0_dropout, l__self___embed_tokens, mean_1, mul_5, mul_6, pow_2, rsqrt_1, to_5, to_6], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add_4 => add_6
# add_5 => add_7
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clone_embedding_mean_mul_pow_rsqrt_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
