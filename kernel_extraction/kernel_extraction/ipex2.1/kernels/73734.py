...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/77/c77jqgmhxjemk57t6khoz6vjyhbwhbwssturpkc6luv3azoux3wx.py
# Source Nodes: [batch_norm_49, l__mod___features_conv4_4_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_49 => add_114, convert_element_type_149, mul_148, mul_149, sub_49
# l__mod___features_conv4_4_c1x1_a_bn_act => relu_49
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_65(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1344*x2) + (263424*y1)), tmp13, xmask)
''')
