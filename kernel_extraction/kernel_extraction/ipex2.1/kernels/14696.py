...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/v2/cv2gxb2aelyn6n2nuhcrof43o3ld4qaze6lcjnywwzzajn4vnqrx.py
...
def triton_poi_fused_cat_38(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x0 = xindex % 256
    x1 = (xindex // 256)
    tmp0 = tl.load(in_ptr0 + (278528 + x2), None)
