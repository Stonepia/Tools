...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/6z/c6zq5o3mnczwclkplqlatez33bjpnsny2t7epgmgc3wmec7i6yxv.py
...
def triton_per_fused__to_copy_add_clone_mean_mul_pow_rsqrt_13(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, rnumel):
    ...
    tmp10 = tl.load(in_ptr3 + (r1 + (768*x0)), rmask, other=0.0).to(tl.float32)
    ...
    tl.store(out_ptr1 + (r1 + (768*x0)), tmp26, rmask)
''')
