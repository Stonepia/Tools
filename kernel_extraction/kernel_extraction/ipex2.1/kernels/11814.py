...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/fh/cfhhtz4c7honwjujhjbaoe3mxjwbl3f37k4524oymgjbkjfyekih.py
...
# truediv_25 => div_22
# truediv_26 => div_23
triton_poi_fused_add_div_mul_neg_32 = async_compile.triton('triton_poi_fused_add_div_mul_neg_32', '''
import triton
...
@pointwise(size_hints=[65536], filename=__file__, meta={'signature': {0: '*fp32', 1: '*i64', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: '*fp32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_div_mul_neg_32', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_div_mul_neg_32(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, out_ptr2, xnumel, XBLOCK : tl.constexpr):
    xnumel = 40000
