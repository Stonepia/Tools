...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/2l/c2l2l2lus7jvar3n3tl35lcl3tlkq3uflcgv6d7dehciccznxfs4.py
...
def triton_per_fused__to_copy_add_native_dropout_native_layer_norm_view_7(in_out_ptr0, in_out_ptr1, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, out_ptr2, out_ptr3, load_seed_offset, xnumel, rnumel):
    ...
    tmp11 = tl.load(in_ptr1 + (r1 + (1024*x0)), rmask & xmask, other=0.0)
    ...
    tl.store(in_out_ptr0 + (r1 + (1024*x0)), tmp10, rmask & xmask)
    tl.debug_barrier()
    tl.store(in_out_ptr1 + (x0), tmp34, xmask)
    tl.store(out_ptr3 + (r1 + (1024*x0)), tmp41, rmask & xmask)
