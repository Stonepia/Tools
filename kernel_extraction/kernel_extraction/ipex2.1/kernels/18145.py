...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/vo/cvobuc2b5vhnyi6bei5lel4dazxryqyo4hmjfw4akbldem67ytdy.py
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_avg_pool2d_constant_pad_nd_53', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
def triton_poi_fused_avg_pool2d_constant_pad_nd_53(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp9 = tmp8 & tmp6
    tmp10 = tmp9 & tmp7
    tmp11 = tl.load(in_ptr0 + (47520 + x0 + (4320*x1) + (90720*x2) + (952560*x3)), tmp10 & xmask, other=0.0)
