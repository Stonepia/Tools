...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/7f/c7fsneqfdo6mb4evlvdpiiyuv4j5x6eccejrzgptgayssqrwykqd.py
# Source Nodes: [add_17, add_18, getattr_l__mod___stage3___0___norm2], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add]
# add_17 => add_73
# add_18 => add_76
# getattr_l__mod___stage3___0___norm2 => add_78, convert_element_type_108, mul_120, mul_121, sub_25
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*fp32', 4: '*fp32', 5: '*bf16', 6: '*bf16', 7: '*bf16', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_add_30', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]})
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_add_30(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4816896
