...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/kt/cktsnnsumi6qhotl3cjsu66eetotnzzaqs2ahy2dm6o3sfvvzj7q.py
...
def triton_poi_fused_clone_24(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x8 = xindex % 1792
    x9 = (xindex // 50176)
    tmp0 = tl.load(in_ptr0 + (x0 + (256*((3 + x6) % 28)) + (7168*((((28*((3 + x7) % 28)) + ((3 + x6) % 28)) // 28) % 28)) + (200704*x5)), None)
    tmp1 = tl.load(in_ptr1 + (x0 + (256*(((3 + x1 + (7*x2)) % 28) % 7)) + (1792*(((((28*((3 + x3 + (7*x4)) % 28)) + ((3 + x1 + (7*x2)) % 28)) // 28) % 28) % 7)) + (12544*(((3 + x1 + (7*x2)) % 28) // 7)) + (50176*(((((28*((3 + x3 + (7*x4)) % 28)) + ((3 + x1 + (7*x2)) % 28)) // 28) % 28) // 7)) + (200704*x5)), None)
    tmp3 = tl.load(in_ptr2 + (x0 + (256*((3 + x6) % 28)) + (7168*((3 + x7) % 28)) + (200704*x5)), None)
    tmp5 = tl.load(in_ptr3 + ((28*((3 + x7) % 28)) + (784*x5) + ((3 + x6) % 28)), None, eviction_policy='evict_last')
    tmp7 = tl.load(in_ptr4 + ((28*((3 + x7) % 28)) + (784*x5) + ((3 + x6) % 28)), None, eviction_policy='evict_last')
    ...
    tmp15 = tmp13 * tmp14
    tmp17 = tmp15 + tmp16
    tl.store(out_ptr0 + (x8 + (1792*x3) + (12544*x2) + (50176*x9)), tmp17, None)
''')
