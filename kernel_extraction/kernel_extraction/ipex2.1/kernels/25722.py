...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/5a/c5amv3s7zshydmonttezaa6l5vkwyidtzz2tl4vdffki54vqpcma.py
# Source Nodes: [l__mod___norm, mean], Original ATen: [aten.mean, aten.native_layer_norm]
# l__mod___norm => add_108, add_109, convert_element_type_96, convert_element_type_97, mul_120, mul_121, rsqrt_24, sub_24, var_mean_24
# mean => mean
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_mean_native_layer_norm_10', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
