...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/4p/c4pbiegmdrfobe2et4vxckdqtgn6lv2vziuupyedzq4emrsppscy.py
...
# where_2 => where_2
# where_3 => where_3
triton_per_fused__to_copy_add_clamp_clone_mean_mul_neg_pow_rsqrt_scalar_tensor_where_14 = async_compile.triton('triton_per_fused__to_copy_add_clamp_clone_mean_mul_neg_pow_rsqrt_scalar_tensor_where_14', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i1', 2: '*fp16', 3: '*i1', 4: '*fp16', 5: '*fp16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clamp_clone_mean_mul_neg_pow_rsqrt_scalar_tensor_where_14', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__to_copy_add_clamp_clone_mean_mul_neg_pow_rsqrt_scalar_tensor_where_14(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, rnumel):
    xnumel = 2048
    ...
    tmp11 = tl.load(in_ptr2 + (r1 + (768*x0)), rmask, other=0.0).to(tl.float32)
