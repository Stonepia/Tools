...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/ke/ckec2idhj4l4tpmo4afouxgc2i7gxprbyv222jv3irq3hgrx4ilc.py
# Source Nodes: [l__self___encoder_b_encoder], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.native_layer_norm]
# l__self___encoder_b_encoder => add_101, add_104, add_105, add_106, add_98, clone_71, clone_74, clone_78, clone_79, convert_element_type_150, mul_90, mul_91, rsqrt_31, sub_31, var_mean_31
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp32', 5: '*fp32', 6: '*fp16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clone_native_layer_norm_26', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
