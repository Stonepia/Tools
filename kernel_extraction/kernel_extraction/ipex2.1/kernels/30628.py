...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/bt/cbtsbtxxg57e23o7ab55t6s6qdsix5b2k2lacm5cz646xqjaxego.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_min_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 3), equal_to_1=())]}
)
@triton.jit
