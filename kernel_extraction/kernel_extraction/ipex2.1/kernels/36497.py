...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/2z/c2zmxna4tnkk7b2hqgrrpbmglx47nhmsgggtkgefjdfw4563vaej.py
...
# getattr_l__mod___blocks___0___mlp_channels_act => add_4, convert_element_type_8, convert_element_type_9, erf, mul_5, mul_6, mul_7
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_gelu_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
