...
# Original file: ./hf_T5_generate__86_inference_126.66/hf_T5_generate__86_inference_126.66_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/3z/c3zwel3ajdh2mr4hvouwxui67264v52s4mlcurkwuy4jkmzxdujf.py
# Source Nodes: [float_4, softmax_2, type_as_2], Original ATen: [aten._softmax, aten._to_copy]
# float_4 => convert_element_type_32
# softmax_2 => amax_2, div_4, exp_2, sub_10, sum_3
# type_as_2 => convert_element_type_33
triton_red_fused__softmax__to_copy_12 = async_compile.triton('triton_red_fused__softmax__to_copy_12', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*bf16', 5: 'i32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__softmax__to_copy_12(in_ptr0, in_ptr1, in_ptr2, out_ptr1, out_ptr3, ks0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 8
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr1 + (r1 + x0 + (ks0*x0)), tmp65, rmask & xmask)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr3 + (r1 + x0 + (ks0*x0)), tmp73, rmask & xmask)
''')
