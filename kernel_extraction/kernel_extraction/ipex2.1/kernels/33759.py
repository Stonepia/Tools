...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/gf/cgf7ihyvaphulg7hxisiunjtxnmkrjczza2h73yqp3odnsvek5dp.py
# Source Nodes: [add_5, add_8, l__mod___transformer_h_1_attn_resid_dropout, l__mod___transformer_h_1_mlp_dropout, l__mod___transformer_h_2_ln_1], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add_5 => add_11
# add_8 => add_16
# l__mod___transformer_h_1_attn_resid_dropout => clone_7
# l__mod___transformer_h_1_mlp_dropout => clone_8
# l__mod___transformer_h_2_ln_1 => add_17, add_18, convert_element_type_12, convert_element_type_13, mul_16, mul_17, rsqrt_4, sub_6, var_mean_4
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_10', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_clone_native_layer_norm_10(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 1024
    rnumel = 1280
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp10 = tl.load(in_ptr0 + (r1 + (1280*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp11 = tl.load(in_ptr1 + (r1 + (1280*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp13 = tl.load(in_ptr2 + (r1 + (1280*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
