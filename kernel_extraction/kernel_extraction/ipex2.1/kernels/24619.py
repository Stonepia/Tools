...
# Original file: ./XGLMForCausalLM__94_backward_281.27/XGLMForCausalLM__94_backward_281.27_3.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/ow/cowvipjhayn3vkz36kgcgc2mrlna6w3g7pzcg2xcu5yjo3pevg7n.py
...
def triton_red_fused__log_softmax_backward_data_add_nll_loss_backward_nll_loss_forward_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp15 = tl.load(in_ptr4 + (r1 + (256008*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0)
        ...
        tmp30 = tmp26 - tmp29
        tmp31 = tmp15 + tmp30
        tl.store(out_ptr1 + (r1 + (256008*x0)), tmp31, rmask & xmask)
''')
