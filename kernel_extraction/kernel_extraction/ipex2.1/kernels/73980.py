...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/rg/crggf47ismeirgancrihhsw6vlllagjgxgcnxvddz274lkyzhuvb.py
# Source Nodes: [batch_norm_11, l__self___features_conv2_4_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_11 => add_26, convert_element_type_47, mul_34, mul_35, sub_11
# l__self___features_conv2_4_c1x1_a_bn_act => relu_11
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_15(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (356*x2) + (1116416*y1)), tmp11, xmask & ymask)
''')
