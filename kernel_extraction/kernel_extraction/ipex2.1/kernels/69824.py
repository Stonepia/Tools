...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/es/ceszvndzdcslelnwgfwyewhwrkgx2kyktpwz4uvnahxlbklhsoeb.py
# Source Nodes: [l__self___encoder_a_encoder], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.native_layer_norm]
# l__self___encoder_a_encoder => add_13, add_16, add_6, add_9, clone_2, clone_4, clone_7, clone_9, convert_element_type_23, var_mean_5
