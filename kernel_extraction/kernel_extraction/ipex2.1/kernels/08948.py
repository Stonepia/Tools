...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/2j/c2jgycpuholirvd6zqujnuudpezytvy5lqsqziajrbxka344sy5h.py
...
# gelu_24 => add_196, convert_element_type_459, erf_24, mul_318
...
def triton_per_fused_gelu_gelu_backward_native_layer_norm_native_layer_norm_backward_4(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel):
    ...
    tmp26 = tl.load(in_ptr5 + (r1 + (1024*x0)), rmask, other=0.0).to(tl.float32)
    ...
    tl.store(out_ptr2 + (r1 + (1024*x0)), tmp44, rmask)
''')
