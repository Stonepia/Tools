...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/ye/cyeeski24r3gou3uu3u2ftkjzufdsenep64kfhs3brqtpcfa6uzx.py
# Source Nodes: [batch_norm_55, l__self___features_conv4_6_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_55 => add_128, convert_element_type_223, mul_166, mul_167, sub_55
# l__self___features_conv4_6_c1x1_a_bn_act => relu_55
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_relu_73(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 47104
    xnumel = 196
    ...
    tl.store(out_ptr0 + (y0 + (1472*x2) + (288512*y1)), tmp11, xmask)
''')
