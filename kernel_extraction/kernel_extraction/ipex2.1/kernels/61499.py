...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/qp/cqpxmv3ztrjrxmv7z7rutczjq4rs2tl6mfolh55ehvvnip2megkg.py
# Source Nodes: [dropout_9, softmax_9], Original ATen: [aten._softmax, aten.native_dropout]
...
@triton.jit
def triton_per_fused__softmax_native_dropout_12(in_ptr0, in_ptr1, out_ptr3, out_ptr4, out_ptr5, load_seed_offset, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 12288
    rnumel = 128
