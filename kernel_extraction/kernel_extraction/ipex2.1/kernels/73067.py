...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/sr/csr64ozynxcufjvqqwdvisda34by76bgk46kpfzgvehoqwy34trw.py
...
def triton_poi_fused_mul_7(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr0 + (x0 + (896*x2)), None, eviction_policy='evict_last')
    tmp2 = tmp0 * tmp1
