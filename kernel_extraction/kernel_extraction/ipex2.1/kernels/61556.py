...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/vz/cvzn6wodo7g35jzuorokgdl7u4e6b764clv4d7rg4req3pwrvyti.py
...
# l__mod___features_denseblock3_denselayer8_norm1 => add_107, convert_element_type_161, mul_160, mul_161, sub_53
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_54', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
