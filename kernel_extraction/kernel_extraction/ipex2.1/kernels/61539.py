...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/7s/c7scushhp2o4gv37np26s3xlooswutq5lsffoytsdyp7lfbq242n.py
...
# l__mod___features_denseblock2_denselayer12_norm1 => add_73, convert_element_type_110, mul_109, mul_110, sub_36
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_37', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
