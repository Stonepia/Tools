...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/at/catcotkknhrgrkybbi5co2xldkb7hz5yenf5e7j7sepslsakyklu.py
...
# getattr_getattr_getattr_l__mod___stages___2_____1___transformer___0___norm2 => add_39, add_40, convert_element_type_79, convert_element_type_80, mul_67, mul_68, rsqrt_1, sub_19, var_mean_1
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_14', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_clone_native_layer_norm_14(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (144*x3)), tmp25, rmask)
''')
