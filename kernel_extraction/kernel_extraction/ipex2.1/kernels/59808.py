...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/pk/cpkti43qlhwjotnch3sttfcy3nxacgbx2fuu23eifgs255q6uujc.py
# Source Nodes: [mul_45, to_46], Original ATen: [aten._to_copy, aten.add, aten.mul, aten.sum]
# mul_45 => mul_123
# to_46 => convert_element_type_68
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_mul_sum_21', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
