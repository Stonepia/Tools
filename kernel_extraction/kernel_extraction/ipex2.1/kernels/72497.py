...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/3g/c3g6mfqmhqs557ipcsckmhscpzfpibvvsvnr4ntuhgqi4773f3op.py
# Source Nodes: [add_80, getattr_l__mod___blocks___39___mlp_drop2, l__mod___norm], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add_80 => add_280
# getattr_l__mod___blocks___39___mlp_drop2 => clone_280
# l__mod___norm => convert_element_type_320, var_mean_80
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
