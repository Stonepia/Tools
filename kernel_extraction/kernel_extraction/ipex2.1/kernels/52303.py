...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/w4/cw4astxzxyp5pqvh63uq52p33q2lywwhjqyih7zcy55lpzvfwi7d.py
# Source Nodes: [cat_30, getattr_getattr_l__mod___blocks___4___block___5___net_0, getattr_getattr_l__mod___blocks___4___block___5___net_1], Original ATen: [aten._native_batch_norm_legit_no_training, aten.cat, aten.relu]
# cat_30 => cat_17
# getattr_getattr_l__mod___blocks___4___block___5___net_0 => add_73, convert_element_type_110, mul_109, mul_110, sub_36
# getattr_getattr_l__mod___blocks___4___block___5___net_1 => relu_36
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_cat_relu_37(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1310720
