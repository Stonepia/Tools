...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/2c/c2ctnpwcj5medleufqb7b2bi733tdhravhkg2ad2brzeucptx4vv.py
...
@pointwise(size_hints=[32768], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp32', 3: '*fp32', 4: '*fp16', 5: '*fp16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__adaptive_avg_pool2d_add_native_group_norm_relu_18', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
