...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/cd/ccd3yyldxsgk2qkhdleel675gwal4fohmw76vp6eqoycd5pjcir2.py
# Source Nodes: [add_1, add_6, add_8, dropout_11, dropout_3, dropout_7, l__self___encoder_layers_3_attention_layer_norm, l__self___encoder_layers_3_attention_self_attention_query_key], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.native_layer_norm]
# add_1 => add_6
# add_6 => add_16
# add_8 => add_23
# dropout_11 => clone_17
# dropout_3 => clone_6
# dropout_7 => clone_11
# l__self___encoder_layers_3_attention_layer_norm => add_24, add_25, mul_15, mul_16, rsqrt_7, sub_12, var_mean_6
# l__self___encoder_layers_3_attention_self_attention_query_key => convert_element_type_47
triton_red_fused__to_copy_add_clone_native_layer_norm_33 = async_compile.triton('triton_red_fused__to_copy_add_clone_native_layer_norm_33', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp32', 5: '*fp32', 6: '*fp16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_clone_native_layer_norm_33', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__to_copy_add_clone_native_layer_norm_33(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 4096
    rnumel = 256
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp14 = tl.load(in_ptr0 + (r1 + (512*x0)), rmask, eviction_policy='evict_first', other=0.0)
