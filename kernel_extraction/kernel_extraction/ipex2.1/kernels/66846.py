...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/3t/c3tieq6cjcmddfmilfl3j6s3kt3zth7bwijk6c52mnez6ozxeagh.py
# Source Nodes: [add_37, add_39, add_40, any_18, clamp_15, clamp_16, clamp_17, isinf_17, l__self___decoder_block_5_layer_1_dropout, l__self___decoder_block_5_layer__1__dropout, mean_18, mul_40, mul_41, mul_42, neg_16, neg_17, neg_18, pow_19, rsqrt_18, to_40, to_41, where_1, where_16, where_17, where_18], Original ATen: [aten._to_copy, aten.add, aten.any, aten.clamp, aten.clone, aten.isinf, aten.mean, aten.mul, aten.neg, aten.pow, aten.rsqrt, aten.scalar_tensor, aten.where]
# add_37 => add_49
# add_39 => add_51
# add_40 => add_52
# any_18 => any_18
...
# where_1 => full_default_4, full_default_5
# where_16 => where_16
# where_17 => where_17
# where_18 => where_18
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i1', 2: '*fp16', 3: '*i1', 4: '*fp16', 5: '*fp16', 6: '*fp16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_any_clamp_clone_isinf_mean_mul_neg_pow_rsqrt_scalar_tensor_where_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 8), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__to_copy_add_any_clamp_clone_isinf_mean_mul_neg_pow_rsqrt_scalar_tensor_where_12(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel):
    xnumel = 1
