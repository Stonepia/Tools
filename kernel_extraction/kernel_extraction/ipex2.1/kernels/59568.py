...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/b6/cb6hpfcl26vmnu6qvlg22j3bn36fsdmqoaihsn4dii7ya3jek4yn.py
...
def triton_red_fused_add_any_isinf_native_dropout_7(in_out_ptr0, in_ptr0, in_ptr1, out_ptr1, out_ptr2, load_seed_offset, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp6 = tl.load(in_ptr1 + (r1 + (16384*x0)), xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp8 = tl.load(in_out_ptr0 + (r1 + (16384*x0)), xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        ...
        tl.store(out_ptr1 + (r1 + (16384*x0)), tmp5, xmask)
        tl.store(in_out_ptr0 + (r1 + (16384*x0)), tmp12, xmask)
