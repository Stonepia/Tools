...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/vd/cvdppmxddcoryq4rgf7lout32o3ujwkujeaylmr77oaehepirgsw.py
...
@pointwise(size_hints=[4096], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_clone_31', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
