...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/73/c73nogws5q43ks6eb6ka6j7mhksnsqzopqqitgax3kjbtyc4ve45.py
...
@pointwise(size_hints=[2048, 256], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_44', 'configs': [AttrsDescriptor(divisible_by_16=(0, 2), equal_to_1=())]})
@triton.jit
