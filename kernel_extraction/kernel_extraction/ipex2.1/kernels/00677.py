...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/vh/cvhhs6555kg2p3ucyy6wvhjle46qkix7773i45gt6otddgeoudgp.py
...
@pointwise(size_hints=[8192, 512], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__unsafe_view_clone_20', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
