...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/z7/cz7byqqextcoktuxpdwyjibqmyuo7j27dz4dgttskethj5agsgny.py
...
@pointwise(size_hints=[4194304, 16], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*i64', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
