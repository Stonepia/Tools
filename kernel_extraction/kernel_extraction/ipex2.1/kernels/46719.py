...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/kn/cknbhvqcaalb7whijkhbcrfzt26cakfbeifdhhn3rgi5t2df6red.py
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i64', 2: '*fp32', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['out_ptr1'], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_embedding_dense_backward_sum_27', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
