...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/7k/c7kiibwnozta7bsglld7iclovinkjdjblqyti52zxltahwhjzgxx.py
...
def triton_poi_fused_clone_7(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 361856)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (2816 + x0 + (88*x2) + (4224*x1) + (1085568*x3)), None)
