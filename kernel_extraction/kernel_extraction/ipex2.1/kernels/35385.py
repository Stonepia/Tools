...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/er/cerp75764bvu57hmyzsgvyham4owhbx6pppqrdztfnb463bqgxsp.py
...
def triton_poi_fused_add_cat_5(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr1 + (14 + x0 + (112*x1)), None)
    tmp2 = tmp0 + tmp1
