...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/fw/cfwvaujqdtpe2uxqd5emvzvmm3habk7agbyrcyd4xqpavg575aya.py
...
def triton_poi_fused_clone_8(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 151296)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (64*x2) + (12608*x1) + (151296*x3)), None)
