...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/nt/cntz5qwkrahub3iaa45otw3repccd3y63zizlnneuqpodtwnxqq6.py
...
def triton_poi_fused_index_0(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.where(tmp0 < 0, tmp0 + 321, tmp0)
    # tl.device_assert(((0 <= tmp1) & (tmp1 < 321)) | ~xmask, "index out of bounds: 0 <= tmp1 < 321")
