...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/fn/cfnnrbul6la6lrtzgsunzgsrpag43pogbxvok5fsax5eztf2mh2j.py
# Source Nodes: [add_20, batch_norm_60, getattr_getattr_l__self___stages___4___blocks___1___conv2_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.leaky_relu]
# add_20 => add_142
# batch_norm_60 => add_141, mul_241, mul_242, sub_60
# getattr_getattr_l__self___stages___4___blocks___1___conv2_bn_act => convert_element_type_366, gt_60, mul_243, where_60
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_add_leaky_relu_51', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
