...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/mq/cmqs4bm5nuz3wcryunb2fprybk3i2v773wynxvxux5tpwc2x33ly.py
# Source Nodes: [layer_norm], Original ATen: [aten.native_layer_norm]
# layer_norm => add, add_1, clone, convert_element_type, convert_element_type_1, mul, mul_1, rsqrt, sub, var_mean
