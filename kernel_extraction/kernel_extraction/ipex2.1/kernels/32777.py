...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/k5/ck5rqyyy2b7aie7dltksnczpckg2zyxhvbbs74f6widv235eol5o.py
# Source Nodes: [add_1, add_2, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
# add_1 => add_4
# add_2 => add_7
# layer_norm_2 => add_8, add_9, clone_4, mul_8, mul_9, rsqrt_2, sub_3, var_mean_2
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*i64', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: '*fp32', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 9), equal_to_1=())]}
)
@triton.jit
