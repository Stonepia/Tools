...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/xa/cxady5keb7rdswskfcp5gayklh4m5msvij73iteoaf2ei3l6zwws.py
# Source Nodes: [batch_norm_17, getattr_getattr_l__mod___stages___2_____1___conv_proj_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.silu]
# batch_norm_17 => add_51, mul_80, mul_81, sub_24
# getattr_getattr_l__mod___stages___2_____1___conv_proj_bn_act => convert_element_type_97, mul_82, sigmoid_14
...
def triton_poi_fused__native_batch_norm_legit_no_training_silu_21(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr1 + (x0 + (192*x1)), tmp14, None)
''')
