...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/5b/c5bsdlhle5qkroe7bz5ol4lk772vehinilh7swucavcjcgjr2x4n.py
# Source Nodes: [getattr_getattr_l__self___layers___2___blocks___0___norm2], Original ATen: [aten.native_layer_norm]
# getattr_getattr_l__self___layers___2___blocks___0___norm2 => add_44, add_45, convert_element_type_78, convert_element_type_79, mul_41, mul_42, rsqrt_12, sub_17, var_mean_12
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp32', 3: '*fp32', 4: '*fp16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_layer_norm_35', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
