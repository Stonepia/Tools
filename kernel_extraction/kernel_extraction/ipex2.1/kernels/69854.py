...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/nd/cndexqeu3nfaet7wbyyyszyb5zl5wxfweyj2t5i2bzoypgtr7r7y.py
# Source Nodes: [l__mod___encoder_a_encoder], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# l__mod___encoder_a_encoder => add_6, add_9, clone_3, clone_5, clone_6, convert_element_type_8, var_mean_3
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
