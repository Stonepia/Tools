...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/5v/c5vstkdxqbsaua53mkezh4lvbmqfkto5wnfdepkr3wdl3qhbmlvy.py
# Source Nodes: [add_6, gelu_31, mul_60, mul_61, mul_62, mul_63, mul__37, mul__38], Original ATen: [aten.add, aten.gelu, aten.mul]
# add_6 => add_72
# gelu_31 => add_73, convert_element_type_132, convert_element_type_133, erf_31, mul_264, mul_265, mul_266
# mul_60 => mul_260
# mul_61 => mul_261
# mul_62 => mul_263
# mul_63 => mul_268
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_gelu_mul_22', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
