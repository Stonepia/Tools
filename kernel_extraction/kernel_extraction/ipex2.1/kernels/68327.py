...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/3w/c3wub35bmo6vrsyae3kblbksobna7exxo76a7zovhrg2zxidq55z.py
# Source Nodes: [add_3, batch_norm_17], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add]
# add_3 => add_39
# batch_norm_17 => add_38, convert_element_type_71, mul_64, mul_65, sub_17
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_add_39', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_add_39(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, xnumel, XBLOCK : tl.constexpr):
    xnumel = 5619712
