...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/5y/c5yew5qnjbdli4grr6m6z56jnac3georwgx5om5jglskgtvkuoy4.py
# Source Nodes: [l__self___main_5, l__self___main_6], Original ATen: [aten.convolution, aten.relu]
# l__self___main_5 => relu_1
# l__self___main_6 => _convolution_pointwise_default_13
...
def triton_poi_fused_convolution_relu_5(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr1 + (y0 + (128*x2) + (524288*y1)), tmp17, None)
''')
