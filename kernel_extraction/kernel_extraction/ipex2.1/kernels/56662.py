...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/dp/cdpc722evqdjxkxmdwzu5yg7dxymt6jkga2ef76etgrmu6x3cijj.py
...
@pointwise(size_hints=[1024], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
