...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/re/creyeqjqlelfsuw54chdovkihqoy3ultp52bxcp4xypf22u2zhxz.py
...
# getattr_l__mod___features___7___conv_1_2 => clamp_max_13, clamp_min_13, convert_element_type_87
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_hardtanh_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
