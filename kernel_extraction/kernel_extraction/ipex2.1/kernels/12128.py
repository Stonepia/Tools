...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/ce/cceddtepdsf5iu362xhnh5662zfkianq6buhdeifvnnp6f6nhjd5.py
...
# sub_50 => sub_50
triton_poi_fused_add_copy_mul_select_scatter_slice_slice_scatter_sub_88 = async_compile.triton('triton_poi_fused_add_copy_mul_select_scatter_slice_slice_scatter_sub_88', '''
import triton
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*fp64', 1: '*fp64', 2: '*fp64', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_copy_mul_select_scatter_slice_slice_scatter_sub_88', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_copy_mul_select_scatter_slice_slice_scatter_sub_88(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 3246048
    ...
    tmp2 = tmp0 == tmp1
    tmp3 = tmp1 == tmp1
    tmp6 = tl.full([1], 1.6, tl.float64)
    tmp7 = tmp5 * tmp6
    tmp9 = tl.full([1], 0.6, tl.float64)
    tmp10 = tmp8 * tmp9
    tmp11 = tmp7 - tmp10
    tmp12 = tl.full([1], 1.0, tl.float64)
    tmp13 = tmp11 * tmp12
    tmp14 = tmp4 + tmp13
