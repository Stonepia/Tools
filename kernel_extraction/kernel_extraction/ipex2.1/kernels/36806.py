...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/6p/c6p4ppzakmg2o2dx4mghv6zy56a222oxvwibll6eiyx77w2dqgls.py
...
def triton_poi_fused_add_slice_backward_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tmp1 < tmp2
    tmp4 = tl.load(in_ptr1 + (x4 + (15596742*x2)), tmp3, other=0.0).to(tl.float32)
    ...
    tmp15 = tl.load(in_ptr5 + (x4 + (15596742*x2)), tmp3, other=0.0).to(tl.float32)
