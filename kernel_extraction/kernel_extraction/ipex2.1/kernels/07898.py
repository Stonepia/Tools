...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/6b/c6b7drqap3ljp53gbnsrw5pd445zyazdw6jaj2yburtymc6fo52q.py
# Source Nodes: [add, add_2, add_3, l__mod___blocks_0_attn_proj_drop, l__mod___blocks_0_mlp_drop2, layer_norm_2], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add => add
# add_2 => add_5
# add_3 => add_9
# l__mod___blocks_0_attn_proj_drop => clone_9
# l__mod___blocks_0_mlp_drop2 => clone_12
# layer_norm_2 => add_10, add_11, clone_13, mul_10, mul_11, rsqrt_2, sub_5, var_mean_2
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
