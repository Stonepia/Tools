...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/l6/cl6vpofp7gkvk3locnwnlxvlj5nxlprgqwx2x5nzn5dvvxv6th7i.py
# Source Nodes: [add_10, mul_7, softmax_1], Original ATen: [aten._softmax, aten.add, aten.mul]
# add_10 => add_66
# mul_7 => mul_116
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_add_mul_28', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
