...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/ny/cnyagvrwfhgt4mcsf4j2fa5j6zmabgufpiase7z5ujvqfbqf4czt.py
...
@triton.jit
def triton_per_fused__softmax_2(in_ptr0, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 131072
    rnumel = 128
