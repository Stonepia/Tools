...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/pf/cpfsnja2wcpkj7anzqzj4zewvcb6i2zuuyzupiavgj4j24petuhy.py
# Source Nodes: [add_4, add_5, getattr_getattr_l__self___stages___2_____3___act1, mul_44, mul_45, mul_46, mul_52, mul_53, mul_54, mul_55], Original ATen: [aten.add, aten.mul, aten.silu]
# add_4 => add_31
# add_5 => add_36
# getattr_getattr_l__self___stages___2_____3___act1 => convert_element_type_141, convert_element_type_142, mul_144, sigmoid_33
# mul_44 => mul_121
# mul_45 => mul_122
# mul_46 => mul_123
# mul_52 => mul_141
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_silu_21', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
