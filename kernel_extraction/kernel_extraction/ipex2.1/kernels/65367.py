...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/es/cesqcgbouqda5vsauscpmjnpjywjo3rjv54f26vi6d367t3n5ibi.py
# Source Nodes: [l__mod___norm2_proj], Original ATen: [aten.native_layer_norm]
# l__mod___norm2_proj => add_5, add_6, mul_2, mul_3, rsqrt_1, sub_1, var_mean_1
...
def triton_per_fused_native_layer_norm_2(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel):
    ...
    tmp25 = tmp23 * tmp24
    tmp27 = tmp25 + tmp26
    tl.store(out_ptr2 + (r1 + (384*x2) + (75648*x3)), tmp27, rmask & xmask)
''')
