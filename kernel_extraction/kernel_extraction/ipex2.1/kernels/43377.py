...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/gm/cgmu33l5xhkilzz6ckaxkxu47oc52xz3cbjcon45qbypq3ln3ieo.py
# Source Nodes: [add_11, batch_norm_38, getattr_getattr_l__self___stages___3___blocks___0___conv2_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.leaky_relu]
# add_11 => add_89
# batch_norm_38 => add_88, mul_153, mul_154, sub_38
# getattr_getattr_l__self___stages___3___blocks___0___conv2_bn_act => convert_element_type_234, gt_38, mul_155, where_38
...
def triton_poi_fused__native_batch_norm_legit_no_training_add_leaky_relu_39(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp16 = tl.load(in_ptr5 + (65536 + y2 + (256*x1) + (131072*y3)), xmask, eviction_policy='evict_last').to(tl.float32)
    ...
    tmp17 = tmp15 + tmp16
    tl.store(out_ptr1 + (x1 + (256*y0)), tmp17, xmask)
''')
