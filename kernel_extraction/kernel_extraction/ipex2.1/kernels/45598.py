...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/a3/ca362ntof3jg53y62bkawotgwc25h6boabza325j7pogllujs76f.py
# Source Nodes: [add_10, add_12, add_13, l__self___encoder_block_2_layer_0_dropout, l__self___encoder_block_2_layer__1__dense_relu_dense_wi, mean_5, mul_13, mul_14, pow_6, rsqrt_5], Original ATen: [aten._to_copy, aten.add, aten.mean, aten.mul, aten.native_dropout, aten.pow, aten.rsqrt, aten.view]
# add_10 => add_13
# add_12 => add_16
# add_13 => add_17
# l__self___encoder_block_2_layer_0_dropout => gt_11, mul_33, mul_34
# l__self___encoder_block_2_layer__1__dense_relu_dense_wi => convert_element_type_43, view_72
# mean_5 => mean_5
# mul_13 => mul_35
# mul_14 => mul_36
# pow_6 => pow_6
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*i64', 3: '*fp32', 4: '*fp16', 5: '*fp32', 6: '*i1', 7: '*fp16', 8: 'i32', 9: 'i32', 10: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0', 'in_out_ptr1'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_mean_mul_native_dropout_pow_rsqrt_view_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 9, 10), equal_to_1=())]}
)
@triton.jit
