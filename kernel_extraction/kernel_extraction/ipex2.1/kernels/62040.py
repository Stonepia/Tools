...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/5f/c5fwvyhaxkrcmdiyyzprk6lzmidzc3jtw6psoyt4agyn6k32ziue.py
# Source Nodes: [l__self___features_denseblock3_denselayer6_norm1, l__self___features_denseblock3_denselayer6_relu1], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# l__self___features_denseblock3_denselayer6_norm1 => add_99, convert_element_type_199, mul_148, mul_149, sub_49
# l__self___features_denseblock3_denselayer6_relu1 => relu_49
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_50', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
