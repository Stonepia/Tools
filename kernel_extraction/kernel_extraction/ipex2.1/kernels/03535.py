...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/hd/chdkcrfbhq34f7nwuajaq77gigmtnaztzy5s7x5drfylmcfhwsxf.py
# Source Nodes: [mul_67, to_68], Original ATen: [aten._to_copy, aten.mul, aten.sum]
# mul_67 => mul_189
# to_68 => convert_element_type_106
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_mul_sum_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
