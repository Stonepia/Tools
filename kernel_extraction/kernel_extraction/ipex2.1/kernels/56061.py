...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/ez/cezdnsemjih2k37nsicohakk7twoqcumr4j4fbegnpau2wbwvnge.py
...
@pointwise(size_hints=[16384], filename=__file__, meta={'signature': {0: '*fp16', 1: '*i1', 2: '*fp16', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_native_dropout_backward_tanh_tanh_backward_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
