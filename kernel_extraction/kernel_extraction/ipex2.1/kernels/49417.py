...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/bs/cbsasswlcjev2uua4qyfucsqhsnavpchfvsxroziv3orljuwxe5j.py
# Source Nodes: [add_2, l__mod___blocks_0_norm1], Original ATen: [aten.add, aten.native_layer_norm]
# add_2 => add_13
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_native_layer_norm_6(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel):
    xnumel = 3920
