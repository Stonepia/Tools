...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/qf/cqfr4nbigiqfiyczsfkuvabuz6tmxnkajysrhksx7gjjrtaevcwb.py
...
# truediv_31 => div_28
# truediv_32 => div_29
triton_poi_fused_add_div_mul_neg_45 = async_compile.triton('triton_poi_fused_add_div_mul_neg_45', '''
import triton
...
@pointwise(size_hints=[65536], filename=__file__, meta={'signature': {0: '*fp64', 1: '*i64', 2: '*fp64', 3: '*fp64', 4: '*fp64', 5: '*fp64', 6: '*fp64', 7: '*fp64', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_div_mul_neg_45', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_div_mul_neg_45(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, out_ptr2, xnumel, XBLOCK : tl.constexpr):
    xnumel = 40000
