...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/oy/coy77txw7yffb3vkd4ak6frmdctghvbbpgnunzqs2aujqxkfjs6h.py
...
def triton_poi_fused_mul_7(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr0 + (x0 + (56*x2)), None, eviction_policy='evict_last')
    tmp2 = tmp0 * tmp1
