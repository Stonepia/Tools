...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/i3/ci3rryvcoqofnm4otytoox4ywlhkvtxgb5am6iqukdxkiahbrfou.py
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*bf16', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
def triton_poi_fused_12(in_out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp7 = tmp1 < tmp6
    tmp8 = 0.0751953125
    tmp9 = 0.0155029296875
    tmp10 = tl.where(tmp7, tmp8, tmp9)
    tmp11 = tl.full([1], 3, tl.int64)
    tmp12 = tmp1 < tmp11
    tmp13 = -0.12158203125
    tmp14 = 0.0213623046875
