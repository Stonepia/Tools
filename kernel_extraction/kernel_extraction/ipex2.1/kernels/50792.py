...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/4c/c4c4amwlpnrdgsafze63nvbuzdeevnxossz3cptkzavdlyeemj3i.py
# Source Nodes: [add_45, add_48, l__self___transformer_h_11_attn_resid_dropout, l__self___transformer_h_11_mlp_dropout, layer_norm_24], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add_45 => add_91
# add_48 => add_96
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp16', 2: '*fp16', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
