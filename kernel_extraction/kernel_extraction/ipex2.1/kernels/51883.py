...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/i4/ci4wov2cevhyskild6uktir6pfepztap2sjq6qn34zuoyvr2xfan.py
...
# l__mod___model_23 => convert_element_type_44, var_mean_22
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__native_batch_norm_legit_add_convolution_relu_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
