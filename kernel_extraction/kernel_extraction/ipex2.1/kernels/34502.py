...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/mv/cmvm2qxi67qhiwtbiwce5p7kzby7rxs7xhux453gx3mucwotxx7o.py
...
@pointwise(size_hints=[16384], filename=__file__, meta={'signature': {0: '*fp32', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_view_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
