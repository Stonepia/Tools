...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/lh/clhhrkgd2l5ccf2mynqt6yay542zdfjxxxmu5nlutkisptiyj5qe.py
...
# truediv_27 => div_24
triton_poi_fused_add_copy_div_mul_neg_select_scatter_37 = async_compile.triton('triton_poi_fused_add_copy_div_mul_neg_select_scatter_37', '''
import triton
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_copy_div_mul_neg_select_scatter_37', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_copy_div_mul_neg_select_scatter_37(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1040000
