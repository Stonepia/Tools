...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/tz/ctzasp5tkm3hv2lriqpdujhigwi3yevs6e5vrmkp6z6gaa3mn6yh.py
# Source Nodes: [cat_3438, softmax_853], Original ATen: [aten._softmax, aten.cat]
# cat_3438 => cat_3417
# softmax_853 => amax_853, div_853, exp_853, sub_853, sum_854
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_cat_876', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 6), equal_to_1=())]}
)
@triton.jit
