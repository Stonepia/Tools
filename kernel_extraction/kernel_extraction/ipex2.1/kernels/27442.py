...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/5a/c5aokgb6kjki5bz2ceo64gv6cs7q64xdclukl6p62yqflfv5q7ds.py
...
# nan_to_num_17 => convert_element_type_142, eq_70, eq_71, isnan_17, where_52, where_53, where_54
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_63', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
