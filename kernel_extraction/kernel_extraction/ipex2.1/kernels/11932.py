...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/2c/c2cyvsbzh2sc7nmmql7uxopowbohecqxj67o4tfemioi2y4xnzlr.py
...
@pointwise(size_hints=[131072], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_lift_fresh_maximum_select_scatter_60', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
