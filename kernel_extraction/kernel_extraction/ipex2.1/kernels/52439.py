...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/u6/cu6jcffsghabnpedt2qwrmvkrgouxz6dfyshgryu6si4eskiumua.py
...
# cat_42 => cat_5
# getattr_getattr_l__mod___blocks___0___block___5___net_0 => add_21, convert_element_type_32, mul_31, mul_32, sub_10
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_cat_relu_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 14680064
