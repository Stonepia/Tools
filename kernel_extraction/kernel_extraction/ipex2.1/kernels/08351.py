...
# Source Nodes: [add_6, add_7, l__self___block_0_layer_0_dropout, l__self___embed_tokens, mean_1, mul_6, mul_7, pow_2, rsqrt_1, to_6, to_7], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add_6 => add_9
# add_7 => add_10
