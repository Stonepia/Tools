...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/c7/cc7gs6fl4ro6pn3y43fjbodxxbt6bds7ystvyvrg2yhj7ttz6ngk.py
...
def triton_poi_fused_mul_3(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr0 + (x0 + (224*x2)), None, eviction_policy='evict_last')
    tmp2 = tmp0 * tmp1
