...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/ea/ceazhctxxsljx5dahxp6znihfsjbcaj3wxxtj5rfboocetxmcpq2.py
...
@pointwise(size_hints=[16384], filename=__file__, meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_stack_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
