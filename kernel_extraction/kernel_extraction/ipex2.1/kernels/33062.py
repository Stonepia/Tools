...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/pu/cpuja4cruqr7dwvely2or4y2uilz3e7v2zez6szeftfyf2vw7ohs.py
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*i64', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_constant_pad_nd_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused_constant_pad_nd_1(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp5 = tl.load(in_ptr1 + (x0 + (128*tmp4)), tmp2, other=0.0).to(tl.float32)
    ...
    tmp12 = tl.load(in_ptr1 + (x0 + (128*tmp11)), tmp9, other=0.0).to(tl.float32)
