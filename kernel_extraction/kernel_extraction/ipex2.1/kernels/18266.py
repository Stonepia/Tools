...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/o3/co3cw7bdnpm5ofjvgcrvx5xebb7m3xko75xn5dcidk6ujbqoc2po.py
# Source Nodes: [l__self___cell_5_comb_iter_0_left_act_1, l__self___cell_5_comb_iter_0_right], Original ATen: [aten.max_pool2d_with_indices, aten.relu]
# l__self___cell_5_comb_iter_0_left_act_1 => relu_102
# l__self___cell_5_comb_iter_0_right => max_pool2d_with_indices_21
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_max_pool2d_with_indices_relu_44', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_max_pool2d_with_indices_relu_44(in_ptr0, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp9 = tmp7 & tmp8
    tmp10 = tmp5 & tmp9
    tmp11 = tl.load(in_ptr0 + ((-9504) + x6), tmp10 & xmask, other=0.0).to(tl.float32)
    ...
    tmp32 = tmp30 & tmp31
    tmp33 = tmp32 & tmp9
    tmp34 = tl.load(in_ptr0 + ((-432) + x6), tmp33 & xmask, other=0.0).to(tl.float32)
    ...
    tmp41 = tmp32 & tmp24
    tmp42 = tl.load(in_ptr0 + (432 + x6), tmp41 & xmask, other=0.0).to(tl.float32)
    ...
    tmp57 = tmp48 & tmp24
    tmp58 = tl.load(in_ptr0 + (9504 + x6), tmp57 & xmask, other=0.0).to(tl.float32)
