...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/l4/cl4wiy6yvjtj7gipon44dxg5hqypvjeqkonoi6f6rf4he3jasyjb.py
...
# l__mod___features_denseblock4_denselayer10_norm1 => add_213, convert_element_type_320, mul_319, mul_320, sub_106
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_107', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
