...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/jz/cjzleu4oar545lrif4bkb5glre6iur2enwnrtio2zhlyo247lyv4.py
# Source Nodes: [l__mod___main_10, l__mod___main_9], Original ATen: [aten._native_batch_norm_legit_no_training, aten.leaky_relu]
# l__mod___main_10 => convert_element_type_16, gt_3, mul_12, where_3
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_leaky_relu_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_leaky_relu_4(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 2097152
