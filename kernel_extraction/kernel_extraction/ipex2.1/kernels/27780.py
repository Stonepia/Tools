...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/2q/c2qg65pyblh45ldfvbesuqfvmiraitcplgpdn75rfbpbx3oo4ilp.py
# Source Nodes: [add_4, add_6, add_8, add_9, l__self___block_0_layer_0_dropout, l__self___block_0_layer__1__dropout, l__self___block_1_layer_0_dropout, l__self___embed_tokens, mean_3, mul_10, mul_9, pow_4, rsqrt_3, to_10, to_9], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add_4 => add_6
# add_6 => add_8
# add_8 => add_11
# add_9 => add_12
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*i64', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clone_embedding_mean_mul_pow_rsqrt_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__to_copy_add_clone_embedding_mean_mul_pow_rsqrt_7(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, rnumel):
    xnumel = 2048
