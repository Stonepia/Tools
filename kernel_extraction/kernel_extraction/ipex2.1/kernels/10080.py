...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/oe/coewm2rrw2esvnexduqdkxzgiyup77rsvoeyl53fqjomagltz3sc.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*i64', 2: '*bf16', 3: '*i1', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0', 'out_ptr2'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_nll_loss_backward_nll_loss_forward_15', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
