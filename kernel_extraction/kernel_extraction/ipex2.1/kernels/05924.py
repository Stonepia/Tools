...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/4t/c4tc3jmgd6asfyd4wzv2uomrouo3mhm3i4gllgt4jj2grressrt3.py
...
# getattr_l__mod___blocks_0_blocks_1___2___norm1 => add_69, add_70, convert_element_type_24, convert_element_type_25, mul_105, mul_106, rsqrt_6, sub_53, var_mean_6
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_25', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_clone_native_layer_norm_25(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel):
    xnumel = 25216
