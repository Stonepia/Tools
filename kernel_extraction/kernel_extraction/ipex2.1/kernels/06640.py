...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/et/cet5q5u7opdjfb75o4go7l7ygqtsmh7ntikighelifcw3m6pfxzo.py
...
def triton_per_fused_add_clone_mean_mul_pow_rsqrt_10(in_ptr0, in_ptr1, in_ptr2, out_ptr1, xnumel, rnumel):
    ...
    tmp14 = tmp2 * tmp13
    tmp15 = tmp8 * tmp14
    tl.store(out_ptr1 + (r1 + (768*x0)), tmp15, rmask)
''')
