...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/5c/c5clmegehp24tmssdvbjidpzjmlx7zonvygg6yfyo53ytcj5zd7m.py
# Source Nodes: [batch_norm_7, getattr_l__mod___features___2___act_dw], Original ATen: [aten._native_batch_norm_legit_no_training, aten.hardtanh]
# batch_norm_7 => add_15, mul_25, mul_26, sub_7
# getattr_l__mod___features___2___act_dw => clamp_max_2, clamp_min_2, convert_element_type_35
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*bf16', 4: '*bf16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_hardtanh_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
