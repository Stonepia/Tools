...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/df/cdf34qj3zhtukzxf3qu3zui2n2ugu2sylmriqxteyoeapfhbccx4.py
# Source Nodes: [add, add_2, l__self___blocks_0_attn_proj_drop, l__self___blocks_0_mlp_fc1, layer_norm_1], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.native_layer_norm]
# add => add
# add_2 => add_4
# l__self___blocks_0_attn_proj_drop => clone_8
# l__self___blocks_0_mlp_fc1 => convert_element_type_17
# layer_norm_1 => add_5, add_6, clone_9, mul_5, mul_6, rsqrt_1, sub_4, var_mean_1
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*bf16', 3: '*fp32', 4: '*fp32', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clone_native_layer_norm_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
