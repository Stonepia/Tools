...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/nm/cnmaf4xwncbaucza27zapgrd5bwmqmlotg26il6x72qefouvyx5u.py
# Source Nodes: [l__mod___module_list_5_activation, l__mod___module_list_5_batch_norm2d], Original ATen: [aten._native_batch_norm_legit_no_training, aten.leaky_relu]
# l__mod___module_list_5_activation => convert_element_type_24, gt_4, mul_19, where_4
# l__mod___module_list_5_batch_norm2d => add_10, mul_17, mul_18, sub_4
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_leaky_relu_5(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 12582912
