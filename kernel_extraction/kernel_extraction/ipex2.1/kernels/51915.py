...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/32/c326d6zufwdbqlc3r7n5jhdcvosslbe7nd7gvdrtkflcjbyb6bmz.py
# Source Nodes: [add, getattr_l__self___model___10___conv_block_6, l__self___model_8, l__self___model_9], Original ATen: [aten._native_batch_norm_legit, aten.add, aten.relu]
# add => add_5
# getattr_l__self___model___10___conv_block_6 => add_4, convert_element_type_19, convert_element_type_20, mul_4, rsqrt_4, sub_4, var_mean_4
# l__self___model_8 => add_2, convert_element_type_11, convert_element_type_12, mul_2, rsqrt_2, sub_2, var_mean_2
# l__self___model_9 => relu_2
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp32', 5: '*fp32', 6: '*fp16', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_add_relu_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]})
@triton.jit
