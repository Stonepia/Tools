...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/x5/cx53khaf52lv56gfigbfj7tlemrlgpjyc6jkcnljh6whnu43g27p.py
...
# l__self___layer_stack_0_slf_attn_attention_softmax => amax, convert_element_type_10, convert_element_type_9, div_1, exp, sub, sum_1
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*fp16', 2: 'fp64', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_div_masked_fill_repeat_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
