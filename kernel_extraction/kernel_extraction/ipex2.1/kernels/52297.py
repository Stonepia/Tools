...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/65/c654rdoptob65xmhktjw6swytxqt527vh4b3kyho3gteguamkb2z.py
...
# cat_33 => cat_14
# getattr_getattr_l__mod___blocks___4___block___2___net_0 => add_61, convert_element_type_92, mul_91, mul_92, sub_30
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_cat_relu_31(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 917504
