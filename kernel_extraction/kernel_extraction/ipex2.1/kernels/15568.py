...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/vh/cvh5npacckvtklehrr4girhoz3gkbz5qce4mw7pt5isqxfia2szs.py
...
triton_poi_fused_add_mul_sigmoid_tanh_20 = async_compile.triton('triton_poi_fused_add_mul_sigmoid_tanh_20', '''
import triton
...
@pointwise(size_hints=[65536], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_sigmoid_tanh_20', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_mul_sigmoid_tanh_20(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 65536
