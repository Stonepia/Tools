...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/gp/cgpelvl2b7izfzb4srwtatkb65mwftjkr2ubgz67u4qjqoaqnu7n.py
# Source Nodes: [batch_norm_12, getattr_l__self___features___4___conv_exp_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.silu]
# batch_norm_12 => add_28, mul_45, mul_46, sub_13
# getattr_l__self___features___4___conv_exp_bn_act => convert_element_type_77, mul_47, sigmoid_5
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_silu_13(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 30105600
