...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/h2/ch2qskji4ftlxz5cosnult57viwfmmmgxmo4y5jug5s4ozi7w33l.py
# Source Nodes: [add_5, l__mod___roberta_encoder_layer_0_attention_output_layer_norm, l__mod___roberta_encoder_layer_0_output_dropout, l__mod___roberta_encoder_layer_0_output_layer_norm, l__mod___roberta_encoder_layer_1_attention_self_query], Original ATen: [aten.add, aten.native_dropout, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
# add_5 => add_11
# l__mod___roberta_encoder_layer_0_attention_output_layer_norm => add_9, mul_11
# l__mod___roberta_encoder_layer_0_output_dropout => gt_3, mul_15, mul_16
# l__mod___roberta_encoder_layer_0_output_layer_norm => add_12, add_13, mul_17, mul_18, rsqrt_2, sub_4, var_mean_2
# l__mod___roberta_encoder_layer_1_attention_self_query => view_22
