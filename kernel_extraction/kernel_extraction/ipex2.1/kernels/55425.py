...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/vm/cvm2zcvu65nuilfqirerqgaduzgi3xsrwjbsw6xsqokavfudghxt.py
...
# nan_to_num_5 => convert_element_type_46, eq_22, eq_23, isnan_5, where_16, where_17, where_18
# softmax_5 => amax_5, convert_element_type_48, div_5, exp_5, sub_17, sum_6
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_27', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
