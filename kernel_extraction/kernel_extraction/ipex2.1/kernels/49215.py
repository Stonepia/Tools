...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/vx/cvxsbuje72w4otajaw6o7etnruueglywgx7zcrl7o7m3pvu6wob4.py
# Source Nodes: [batch_norm_40, getattr_getattr_l__mod___blocks___5_____0___bn2_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.hardtanh]
# batch_norm_40 => add_89, mul_121, mul_122, sub_40
# getattr_getattr_l__mod___blocks___5_____0___bn2_act => clamp_max_27, clamp_min_27, convert_element_type_178
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_hardtanh_10', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
