...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/ou/couac5ce2ayw3fwu6y3oyhx3l2aepkvnztrmm3cyrlnucpujwi2j.py
# Source Nodes: [mul, softmax], Original ATen: [aten._softmax, aten.mul]
# mul => mul_11
# softmax => amax, clone_2, convert_element_type_13, convert_element_type_14, div, exp, sub_4, sum_1
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_mul_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]}
)
@triton.jit
