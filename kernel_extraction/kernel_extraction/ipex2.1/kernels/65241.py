...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/ck/cckpajd2sq2w7s3xnw6m4s5fqp6yrvojyzte7hsmrj6cis4a5m3b.py
# Source Nodes: [l__mod___up3_up], Original ATen: [aten._to_copy, aten._unsafe_index, aten.add, aten.mul, aten.rsub, aten.sub]
# l__mod___up3_up => _unsafe_index_10, _unsafe_index_11, add_41, convert_element_type_58, mul_68, mul_69, sub_22, sub_23
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy__unsafe_index_add_mul_rsub_sub_14', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
