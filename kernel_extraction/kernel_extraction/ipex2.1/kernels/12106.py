...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/we/cweqtdrapkmiljrixkmzdseqbojn5ibuwqv7uyzytulkryyqq6ua.py
...
# truediv_60 => div_57
# where_2 => where_2
triton_poi_fused_bitwise_and_copy_div_ge_mul_select_scatter_sub_where_66 = async_compile.triton('triton_poi_fused_bitwise_and_copy_div_ge_mul_select_scatter_sub_where_66', '''
import triton
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp64', 1: '*i64', 2: '*fp64', 3: '*fp64', 4: '*fp64', 5: '*fp64', 6: '*fp64', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_bitwise_and_copy_div_ge_mul_select_scatter_sub_where_66', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]})
@triton.jit
def triton_poi_fused_bitwise_and_copy_div_ge_mul_select_scatter_sub_where_66(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1040000
