...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/kz/ckzqsl3cs7wds564qizptpcvfhfx3gbiy3oyntakn645wfu3n34q.py
# Source Nodes: [add_14, add_15, add_16, getattr_getattr_l__mod___levels___2___transformer_encoder___1___mlp_drop2, getattr_getattr_l__mod___levels___2___transformer_encoder___2___attn_proj_drop, getattr_getattr_l__mod___levels___2___transformer_encoder___2___mlp_drop2, layer_norm_16], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add_14 => add_48
# add_15 => add_51
# add_16 => add_55
...
# layer_norm_16 => add_56, add_57, convert_element_type_60, convert_element_type_61, mul_67, mul_68, rsqrt_16, sub_23, var_mean_16
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_41', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_clone_native_layer_norm_41(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel):
    xnumel = 6272
