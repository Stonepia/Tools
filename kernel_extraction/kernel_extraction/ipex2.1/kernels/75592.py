...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/hz/chzo2ujuzyblpngtjnegpbzoom7lbxno6lyc2rdsjreycrmw2ibc.py
# Source Nodes: [add, iadd, l__mod___albert_embeddings_layer_norm, l__mod___albert_embeddings_position_embeddings, l__mod___albert_embeddings_token_type_embeddings, l__mod___albert_embeddings_word_embeddings, l__mod___albert_encoder_embedding_hidden_mapping_in], Original ATen: [aten.add, aten.embedding, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
# add => add
# iadd => add_1
...
@triton.jit
def triton_per_fused_add_embedding_native_layer_norm_native_layer_norm_backward_view_0(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr3, out_ptr4, out_ptr5, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 2048
    rnumel = 128
    ...
    tl.store(out_ptr4 + (r2 + (128*x3)), tmp37, rmask)
