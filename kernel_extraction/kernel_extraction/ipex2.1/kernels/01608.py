...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/eb/cebbvqyvanmsj6dxdmihjlucovsbjpvd5izkb3ury4moe2psrzib.py
...
@pointwise(size_hints=[4096], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy__unsafe_index_add_arange_clamp_mul_rsub_select_sub_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
