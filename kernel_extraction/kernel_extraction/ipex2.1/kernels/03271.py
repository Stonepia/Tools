...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/hi/chisisxwypi3lym7tgcorgwzfxi6tp5bltzg7idck7uwbdaajzx3.py
...
# add => add
# iadd => add_1
# l__mod___bert_embeddings_layer_norm => add_2, add_3, mul_1, mul_2, rsqrt, sub, var_mean
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_embedding_native_layer_norm_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
