...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/qs/cqs7uc42q3bdqrgufuhna6myqlnvor452zormiu7rglisqckdd7b.py
...
def triton_poi_fused_abs_add_copy_div_lift_fresh_maximum_mul_neg_slice_scatter_tanh_17(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp31 = tl.abs(tmp30)
    tmp32 = -tmp31
    tmp33 = tl.full([1], 0.001, tl.float64)
    tmp34 = tmp32 + tmp33
    tmp35 = tmp34 / tmp33
    tmp36 = libdevice.tanh(tmp35)
    tmp37 = tl.full([1], 1.0, tl.float64)
    tmp38 = tmp36 + tmp37
    tmp39 = tl.full([1], 0.5, tl.float64)
    tmp40 = tmp38 * tmp39
    tmp41 = tmp29 * tmp40
    tmp42 = tl.full([1], 50.0, tl.float64)
