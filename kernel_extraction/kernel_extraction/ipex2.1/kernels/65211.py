...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/sq/csqlf4comzsdqrlftgawpur7rq2k2e7z7q4te73qn7func5cdi6o.py
# Source Nodes: [l__self___up1_up], Original ATen: [aten._to_copy, aten._unsafe_index, aten.add, aten.mul, aten.rsub, aten.sub]
# l__self___up1_up => _unsafe_index_2, _unsafe_index_3, add_23, convert_element_type_51, mul_36, mul_37, sub_10, sub_11
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*bf16', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy__unsafe_index_add_mul_rsub_sub_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
