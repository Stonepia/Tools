...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/em/cemwz4xkni3rzmjwvzdmsivofq4uuhgoalzgulz4srmcfvopudbg.py
# Source Nodes: [getattr_l__mod___features___14___act_dw, mul_11], Original ATen: [aten.hardtanh, aten.mul]
# getattr_l__mod___features___14___act_dw => clamp_max_14, clamp_min_14, convert_element_type_226, convert_element_type_227
# mul_11 => mul_194
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_hardtanh_mul_69', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
