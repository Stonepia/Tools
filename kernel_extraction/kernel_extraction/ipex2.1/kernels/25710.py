...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/3c/c3c53tnzcfz2chkr6ov3476a6xrmabnfy3ssynst7oj7p3loc2df.py
...
def triton_per_fused_add_clone_native_layer_norm_9(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, rnumel):
    ...
    tmp1 = tl.load(in_ptr1 + (x0 + (196*r2) + (150528*x1)), rmask & xmask, other=0.0)
    tmp3 = tl.load(in_ptr2 + (r2 + (768*x3)), rmask & xmask, other=0.0)
    tmp5 = tl.load(in_ptr3 + (x0 + (196*r2) + (150528*x1)), rmask & xmask, other=0.0)
