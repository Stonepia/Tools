...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/h3/ch3qqvq6agdrpvkq6hffawmyyaer472rzpbcrf6qqrav5ilppqr6.py
# Source Nodes: [softmax], Original ATen: [aten._softmax]
# softmax => amax, clone_1, convert_element_type_12, exp, sub_2, sum_1
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__softmax_7(in_ptr0, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 8192
    rnumel = 3137
