...
# Original file: ./Speech2Text2ForCausalLM__34_forward_105.6/Speech2Text2ForCausalLM__34_forward_105.6_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/56/c56wdc7yepgxkevun3hamlt3chpqyxou526mtzyjxnelbffuhmjm.py
# Source Nodes: [add_1, dropout_1, l__self___fc1, l__self___self_attn_layer_norm], Original ATen: [aten.add, aten.native_dropout, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
# add_1 => add_1
...
def triton_per_fused_add_native_dropout_native_layer_norm_native_layer_norm_backward_view_4(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, out_ptr4, out_ptr5, out_ptr6, load_seed_offset, xnumel, rnumel):
    ...
    r1 = rindex
    x0 = xindex
    tmp5 = tl.load(in_ptr1 + (r1 + (256*x0)), rmask, other=0.0)
