...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/cl/ccluunefvw4kqcsieqv7sdtwh7deeegolmtz7fkloi4gsvohpdr3.py
...
triton_red_fused__to_copy_masked_fill_mul_native_layer_norm_backward_11 = async_compile.triton('triton_red_fused__to_copy_masked_fill_mul_native_layer_norm_backward_11', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*i1', 5: '*fp32', 6: '*fp16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_masked_fill_mul_native_layer_norm_backward_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__to_copy_masked_fill_mul_native_layer_norm_backward_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 1024
    rnumel = 1536
