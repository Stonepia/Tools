...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/55/c55gjecapwsr3klvdy4gxkns3wkp4rvbnwyc4feeonwerhkzp5b3.py
# Source Nodes: [batch_norm_8, l__self___features_conv2_3_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_8 => add_19, convert_element_type_35, mul_25, mul_26, sub_8
# l__self___features_conv2_3_c1x1_a_bn_act => relu_8
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (336*x2) + (1053696*y1)), tmp11, xmask & ymask)
''')
