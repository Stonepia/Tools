...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/u6/cu6p3elwaao3dutyw3gi3k5ts2auhq4v3n56me6orl4nbsfonwl3.py
# Source Nodes: [add, l__mod___distilbert_embeddings_layer_norm, l__mod___distilbert_embeddings_word_embeddings], Original ATen: [aten.add, aten.embedding, aten.native_layer_norm]
# add => add
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_embedding_native_layer_norm_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_embedding_native_layer_norm_0(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel):
    xnumel = 512
