...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/n6/cn6rb4djxqhcvchc27v4ms5lk2oaswhhrj55zlyq4crugpgqaes4.py
# Source Nodes: [getattr_l__mod___features___10___act_dw, mul_7], Original ATen: [aten.hardtanh, aten.mul]
# getattr_l__mod___features___10___act_dw => clamp_max_10, clamp_min_10, convert_element_type_162, convert_element_type_163
# mul_7 => mul_138
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_hardtanh_mul_48', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
