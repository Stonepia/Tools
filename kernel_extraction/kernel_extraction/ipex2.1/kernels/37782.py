...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/pe/cpekwwz45zobjqbyib52a3lzbuooebs2qgqwxob42a5npmi5s2ph.py
...
@triton.jit
def triton_per_fused_native_dropout_backward_native_layer_norm_native_layer_norm_backward_5(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, out_ptr3, xnumel, rnumel):
    xnumel = 32768
