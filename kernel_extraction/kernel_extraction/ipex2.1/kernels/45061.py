...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/rg/crgwazquthkf3tpuu7j2xgur74a6anw7llspqammr45siesj5vut.py
# Source Nodes: [add_12, mul_7, softmax_2], Original ATen: [aten._softmax, aten.add, aten.mul]
# add_12 => add_70
# mul_7 => mul_119
# softmax_2 => amax_2, convert_element_type_186, convert_element_type_187, div_2, exp_2, sub_31, sum_3
...
@triton.jit
def triton_red_fused__softmax_add_mul_47(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 65536
    rnumel = 144
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (144*x3)), tmp83, rmask)
''')
