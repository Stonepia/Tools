...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/vt/cvt3m34hllkpczv7zdd3hyyrd722of2cvqjvafvxyzw6sebobgnv.py
...
triton_poi_fused_copy_new_zeros_select_scatter_slice_slice_scatter_6 = async_compile.triton('triton_poi_fused_copy_new_zeros_select_scatter_slice_slice_scatter_6', '''
import triton
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_new_zeros_select_scatter_slice_slice_scatter_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
def triton_poi_fused_copy_new_zeros_select_scatter_slice_slice_scatter_6(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 25214976
