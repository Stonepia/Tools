...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/gl/cglnprtb4dm5xxj6qjlnixthdeoik2w2bqqpdeli6nyaoh7ctle3.py
...
@triton.jit
def triton_per_fused__softmax__to_copy_native_dropout_12(in_ptr0, in_ptr1, out_ptr3, out_ptr4, out_ptr5, load_seed_offset, xnumel, rnumel):
    xnumel = 32768
