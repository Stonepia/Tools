...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/ev/cevio2jbdeedyfbz6ywikrsuokoodlrnz6odp7jqtiztm7wrgaen.py
...
# add_2 => add_4
# dropout_3 => gt_1, mul_5, mul_6
# l__self___final_layer_norm => add_5, add_6, mul_7, mul_8, rsqrt_1, sub_2, var_mean_1
...
def triton_per_fused_add_native_dropout_native_layer_norm_native_layer_norm_backward_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr1, out_ptr5, out_ptr6, out_ptr7, load_seed_offset, xnumel, rnumel):
    ...
    tmp12 = tl.load(in_ptr4 + (r1 + (256*x0)), rmask, other=0.0).to(tl.float32)
    ...
    tl.store(out_ptr5 + (r1 + (256*x0)), tmp40, rmask)
    tl.store(out_ptr6 + (r1 + (256*x0)), tmp44, rmask)
