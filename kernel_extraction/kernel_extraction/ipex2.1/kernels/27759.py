...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/nh/cnhmjeomzsngxkmvqv3dnny5jbsegv5q25nb3uktnbl75fyhh2g4.py
# Source Nodes: [add, l__self___block_0_layer_0_self_attention_q, l__self___embed_tokens, mean, mul_1, mul_2, pow_1, rsqrt], Original ATen: [aten._to_copy, aten.add, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add => add
# l__self___block_0_layer_0_self_attention_q => convert_element_type_1
