...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/kw/ckwwcb7diuwuzkjpy5utgwli5akakho65ck2t5wfgtzwd3rb7ynh.py
...
# nan_to_num_7 => convert_element_type_62, eq_30, eq_31, isnan_7, where_22, where_23, where_24
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_33', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
