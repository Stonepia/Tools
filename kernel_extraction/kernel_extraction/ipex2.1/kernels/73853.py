...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/m7/cm7dgmmxupdzv4tbh7dve7mrzs4pqhpxgorjp7b2354ktxqpd5tr.py
...
# batch_norm_27 => add_63, mul_82, mul_83, sub_27
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_36(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (896*x2) + (702464*y1)), tmp9, xmask)
''')
