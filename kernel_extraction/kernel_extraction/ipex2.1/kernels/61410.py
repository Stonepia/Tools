...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/5p/c5p2uqrxzak2vzlz4qcdqnwbicq5vz6vtdblastuis67ceb2fcvl.py
# Source Nodes: [add_4, add_5, clamp, l__mod___encoder_block_0_layer_0_dropout, l__mod___encoder_block_0_layer__1__dense_relu_dense_wi_0, l__mod___encoder_dropout, mean_1, mul_5, mul_6, neg, pow_2, rsqrt_1, to_5, to_6, where_1], Original ATen: [aten._to_copy, aten.add, aten.clamp, aten.mean, aten.mul, aten.native_dropout, aten.neg, aten.pow, aten.rsqrt, aten.scalar_tensor, aten.view, aten.where]
# add_4 => add_6
# add_5 => add_7
