...
# Original file: ./vision_maskrcnn__33_inference_73.13/vision_maskrcnn__33_inference_73.13_2.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/mg/cmg4jagthkz6yohjhf3ggdespga2rejmq5nvtgapvd7pcbjbnfe3.py
...
@pointwise(size_hints=[1024], filename=__file__, meta={'signature': {0: '*bf16', 1: '*i64', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_add_clamp_div_floor_lift_fresh_log2_mul_sqrt_sub_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
