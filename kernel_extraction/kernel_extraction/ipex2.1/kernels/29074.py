...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/sd/csdz7yd34obfbutul5wnx33n7mytkg3t43ti436ejilxu3qxzhtu.py
...
# getattr_getattr_getattr_l__mod___stages___4_____1___transformer___0___norm2 => add_103, add_104, convert_element_type_187, convert_element_type_188, mul_159, mul_160, rsqrt_15, sub_51, var_mean_15
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_54', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_clone_native_layer_norm_54(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (240*x3)), tmp25, rmask)
''')
