...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/6v/c6vojuqgsm67c3zy3js4jfipiua77pmhchhseozgzstpitckulch.py
# Source Nodes: [add, dropout_1, l__self___encoder_layers_0_feed_forward_layer_norm], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add => add_3
# dropout_1 => clone_4
# l__self___encoder_layers_0_feed_forward_layer_norm => add_4, add_5, convert_element_type_5, convert_element_type_6, mul_2, mul_3, rsqrt_1, sub_3, var_mean_1
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_clone_native_layer_norm_12(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 4096
    rnumel = 256
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp8 = tl.load(in_ptr0 + (256 + r1 + (512*x0)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
