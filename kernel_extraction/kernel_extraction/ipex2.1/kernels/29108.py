...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/qj/cqjeinjrbstxy35xqtfpew3a3dv3xfyhr7fp2bdo3aqj626xkppj.py
...
def triton_poi_fused_clone_20(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 12288)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (48*x2) + (3072*x1) + (12288*x3)), None)
