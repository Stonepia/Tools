...
# Original file: ./speech_transformer__22_inference_62.2/speech_transformer__22_inference_62.2_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/ge/cgeigraoim2tjb26k22ftdzw3yu7tsft7gomnf4b3s6uqpxaasae.py
...
# l__self___layer_stack_0_slf_attn_layer_norm => add_4, add_5, convert_element_type_4, convert_element_type_5, mul_2, mul_3, rsqrt_1, sub_2, var_mean_1
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_mul_native_layer_norm_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 7), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_clone_mul_native_layer_norm_4(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel):
    ...
    tmp34 = tl.load(in_ptr4 + (x0), xmask, eviction_policy='evict_last').to(tl.float32)
    tmp2 = tmp0 + tmp1
