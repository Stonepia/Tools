...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/ll/cllwioefmkyauormffdbukttp6tq3rqwg65vytaofnetvl3cceeg.py
...
def triton_poi_fused_clone_7(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 246272)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (512 + x0 + (64*x2) + (768*x1) + (738816*x3)), None)
