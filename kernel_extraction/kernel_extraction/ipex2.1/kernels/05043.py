...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/l2/cl22ebl6anfl6e5hxjzemh225vmqmc65qxeur55z3asn6r4i4urn.py
# Source Nodes: [getattr_l__mod___layers___3___downsample_norm], Original ATen: [aten.native_layer_norm]
# getattr_l__mod___layers___3___downsample_norm => add_193, add_194, mul_182, mul_183, rsqrt_47, sub_69, var_mean_47
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_layer_norm_43', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
