...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/wy/cwyxiudmljmwq7viq2deehzdktfjp5k7avsabgflhp7xgwzxuiu7.py
...
@pointwise(size_hints=[32], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*i64', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: '*fp32', 7: '*fp16', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__log_softmax_backward_data_add_nll_loss_backward_nll_loss_forward_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]})
@triton.jit
