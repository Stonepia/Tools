...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/nq/cnqkrtqtyunbqeqr2vuxtcaah3qp7l5d42tlwgg4gf7o7nkavku7.py
...
@pointwise(size_hints=[32768], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax_div_54', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
