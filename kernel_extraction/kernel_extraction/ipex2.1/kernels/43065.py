...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/gu/cgurn2qvyerokxhb4tbz4auimscjx2fvoolqlv6julxjhjk4kpdv.py
...
def triton_poi_fused_stack_2(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 33280)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + ((2*x0) + (64*x2) + (512*x1) + (133120*x3)), xmask)
    tmp1 = 16.0
    tmp2 = tmp0 * tmp1
    tl.store(out_ptr0 + (2*x4), tmp2, xmask)
''')
