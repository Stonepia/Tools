...
# Original file: ./detectron2_fasterrcnn_r_101_fpn__61_inference_101.41/detectron2_fasterrcnn_r_101_fpn__61_inference_101.41_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/or/corqxw4d6rpk3lwtlbgcb2xucu45nyrfick4yokudlk5x253hcso.py
...
def triton_poi_fused_index_2(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.where(tmp0 < 0, tmp0 + 309, tmp0)
    # tl.device_assert(((0 <= tmp1) & (tmp1 < 309)) | ~xmask, "index out of bounds: 0 <= tmp1 < 309")
