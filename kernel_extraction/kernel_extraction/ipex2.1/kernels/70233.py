...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/l5/cl5xz62lbuuv2v2cesfg6zphfbvhakhoxkmxysoiqsohl66afojm.py
...
@pointwise(size_hints=[536870912], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_copy_view_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
