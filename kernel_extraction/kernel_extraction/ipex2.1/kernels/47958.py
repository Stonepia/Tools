...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/nf/cnfsdqxwp4s3fgbcbilhgysw3qdri7uxidfjr337kizgl2dnpjsf.py
...
@triton.jit
def triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, out_ptr3, xnumel, rnumel):
    xnumel = 8192
