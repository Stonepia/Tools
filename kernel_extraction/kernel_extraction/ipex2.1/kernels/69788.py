...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/3a/c3auibbng3rmn75nu55e7pnbcdbwnglj6zwq7ju2gbbnurrgbt2v.py
# Source Nodes: [l__self___encoder_a_encoder], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.native_layer_norm]
# l__self___encoder_a_encoder => add_6, add_7, add_8, clone_2, convert_element_type_8, mul_4, mul_5, rsqrt_2, sub_2, var_mean_2
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp16', 2: '*fp32', 3: '*fp32', 4: '*fp16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clone_native_layer_norm_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
