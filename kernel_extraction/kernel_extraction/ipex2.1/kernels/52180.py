...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/vl/cvlhwtdiaxh3bz7uvlilz6geippdiqj2hwjyvrqf6hgsjv2d3bow.py
# Source Nodes: [batch_norm_30, getattr_getattr_l__self___blocks___4_____0___bn1_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.hardswish]
# batch_norm_30 => add_80, mul_103, mul_104, sub_30
# getattr_getattr_l__self___blocks___4_____0___bn1_act => add_81, clamp_max_12, clamp_min_12, convert_element_type_162, div_12, mul_105
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_hardswish_10(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 12042240
