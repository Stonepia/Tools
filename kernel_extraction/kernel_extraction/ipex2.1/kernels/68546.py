...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/w7/cw7pftncniyc6j5wmtpjksrs5mnzge4k7jlimbn2pyoyeue4qdj3.py
# Source Nodes: [layer_norm_8], Original ATen: [aten.native_layer_norm]
# layer_norm_8 => add_28, add_29, mul_40, mul_41, rsqrt_8, sub_8, var_mean_8
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_layer_norm_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
