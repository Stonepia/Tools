...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/el/celcyw3oz2shpjud2ojdc6whibdivhoj5jfmp4wzsqaqhtydvsei.py
...
@pointwise(size_hints=[512], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_mul_slice_slice_scatter_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
