...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/jh/cjhzksfpkjazpkwoi2pwb4qmpg7y64yps4pwxqp3qat3y637lyvv.py
# Source Nodes: [l__mod___cell_8_comb_iter_1_left_act_1, pad_32], Original ATen: [aten.constant_pad_nd, aten.relu]
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_constant_pad_nd_relu_59', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
