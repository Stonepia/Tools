...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/ey/ceye7ulmsntyenxxqpaw3ix4dcsuigkt3lwxjftdev4x63kdjfsf.py
# Source Nodes: [batch_norm_25], Original ATen: [aten._native_batch_norm_legit_no_training]
...
def triton_poi_fused__native_batch_norm_legit_no_training_38(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 32768)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + ((64*(x1 % 4)) + (256*(x2 % 4)) + (1024*(x1 // 4)) + (2048*(x2 // 4)) + (4096*(x0 // 64)) + (32768*x3) + (x0 % 64)), None).to(tl.float32)
