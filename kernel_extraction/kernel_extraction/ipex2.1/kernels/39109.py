...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/t5/ct5wvp3vye264rgulu37gcpoqos2kgvkwptumunpsb3xzr5bpt47.py
...
@pointwise(size_hints=[1024, 2048], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__unsafe_view_clone_22', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
