...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/da/cdaryo3wjwf3vigwzljlazw2kjvleycxekhvljyevutlxy2cpfgd.py
# Source Nodes: [add, l__self___layer_norm_in], Original ATen: [aten.add, aten.native_layer_norm]
# add => add_2
# l__self___layer_norm_in => add, add_1, mul, mul_1, rsqrt, sub, var_mean
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 6), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_native_layer_norm_0(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel):
    ...
    tmp28 = tl.load(in_ptr3 + (r1 + (512*x2)), rmask & xmask, eviction_policy='evict_last', other=0.0)
