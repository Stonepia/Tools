...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/cd/ccdzxbwsphxomzezx4ljjrrx5dyhl6ki5fozy3suna2v3fbza4g3.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_div_mean_mul_pow_sqrt_sub_40', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
