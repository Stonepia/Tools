...
# Original file: ./opacus_cifar10___60.0/opacus_cifar10___60.0_1.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/7m/c7max5qe746jlfwohl73dpfkrnispz4blpt5yv6lezjjugvlmaqs.py
...
@pointwise(size_hints=[262144], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_max_pool2d_with_indices_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
def triton_poi_fused_max_pool2d_with_indices_0(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp9 = tmp7 & tmp8
    tmp10 = tmp5 & tmp9
    tmp11 = tl.load(in_ptr0 + ((-17) + (2*x0) + (32*x3)), tmp10, other=0.0)
    ...
    tmp17 = tmp15 & tmp16
    tmp18 = tmp5 & tmp17
    tmp19 = tl.load(in_ptr0 + ((-16) + (2*x0) + (32*x3)), tmp18, other=0.0)
    ...
    tmp26 = tmp24 & tmp25
    tmp27 = tmp5 & tmp26
    tmp28 = tl.load(in_ptr0 + ((-15) + (2*x0) + (32*x3)), tmp27, other=0.0)
