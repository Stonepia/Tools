...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/ur/cur7oughfcsxoouazg4ofgmge5ss4bo4feyytjeckqgfncpjnkno.py
# Source Nodes: [getattr_getattr_l__self___stages___1___blocks___0___token_mixer_pool], Original ATen: [aten.avg_pool2d]
# getattr_getattr_l__self___stages___1___blocks___0___token_mixer_pool => avg_pool2d_6
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_avg_pool2d_19', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
