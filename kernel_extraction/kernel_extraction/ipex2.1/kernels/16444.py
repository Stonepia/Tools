...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/fh/cfhez6mskxewzo74232u27ny4sisn3mtdkisiu6s333uw7osm7wj.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*fp16', 2: '*i1', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: '*fp16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_bitwise_not_cat_stack_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 6, 7), equal_to_1=())]}
)
@triton.jit
