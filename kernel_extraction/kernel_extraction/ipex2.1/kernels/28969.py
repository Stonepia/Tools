...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/ty/ctym7fcv5j2acnstpuhjnxqspnlnfg4witlijtlz5a7csiw4ktjs.py
# Source Nodes: [add_2, add_3, add_4, getattr_getattr_getattr_l__self___stages___2_____1___transformer___0___attn_proj_drop, getattr_getattr_getattr_l__self___stages___2_____1___transformer___0___mlp_drop2, getattr_getattr_getattr_l__self___stages___2_____1___transformer___1___attn_proj_drop, getattr_getattr_getattr_l__self___stages___2_____1___transformer___1___norm2], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add_2 => add_38
# add_3 => add_41
# add_4 => add_44
...
# getattr_getattr_getattr_l__self___stages___2_____1___transformer___1___norm2 => add_45, add_46, convert_element_type_118, convert_element_type_119, mul_74, mul_75, rsqrt_3, sub_22, var_mean_3
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp32', 5: '*fp32', 6: '*fp16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_clone_native_layer_norm_17(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 65536
    rnumel = 144
