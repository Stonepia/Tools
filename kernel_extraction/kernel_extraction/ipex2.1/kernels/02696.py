...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/q4/cq4gexufy6gjwqq3lzlk3b3xfokkqutlrfhdlmctvpias3nyobmo.py
# Source Nodes: [add_13, mul_8, softmax_2], Original ATen: [aten._softmax, aten.add, aten.mul]
# add_13 => add_75
# mul_8 => mul_129
# softmax_2 => amax_2, convert_element_type_216, convert_element_type_217, div_2, exp_2, sub_33, sum_3
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_add_mul_46', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__softmax_add_mul_46(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 65536
    rnumel = 256
