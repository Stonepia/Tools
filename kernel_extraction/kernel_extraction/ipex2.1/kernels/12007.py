...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/wr/cwrgqvmr3laxjsluvlw2nysgffswjldmvo2eqd626ss7eirpycbs.py
# Source Nodes: [setitem_66, setitem_67, setitem_68, setitem_69, truediv_47], Original ATen: [aten.copy, aten.div, aten.select_scatter]
...
# truediv_47 => div_44
triton_poi_fused_copy_div_select_scatter_51 = async_compile.triton('triton_poi_fused_copy_div_select_scatter_51', '''
import triton
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_div_select_scatter_51', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused_copy_div_select_scatter_51(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1040000
