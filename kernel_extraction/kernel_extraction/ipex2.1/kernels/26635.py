...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/et/cetxfhs5a7z4fsqwmodxypvmqt7mf3gmcfpeze22an54ybgai424.py
...
def triton_poi_fused_convolution_relu_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x2 + (1024*y3)), tmp15, xmask)
    tl.store(out_ptr1 + (y0 + (256*x2) + (262144*y1)), tmp15, xmask)
''')
