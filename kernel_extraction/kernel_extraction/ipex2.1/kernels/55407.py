...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/hm/chmwmrf4q4be56lavcdeh7bmq7rq3gjflxobfak47od3r5gyguyw.py
# Source Nodes: [add_2, l__self___layers_1_self_attn_layer_norm], Original ATen: [aten.add, aten.native_layer_norm]
# add_2 => add_8
# l__self___layers_1_self_attn_layer_norm => add_10, add_9, convert_element_type_12, convert_element_type_13, mul_7, mul_8, rsqrt_2, sub_4, var_mean_2
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_native_layer_norm_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 6), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_native_layer_norm_9(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 1
    rnumel = 1536
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp22 = tl.load(in_ptr3 + (r0), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp10 = tmp8 + tmp9
