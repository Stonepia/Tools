...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/mt/cmt24ajilcumcdpd4hb2ayhmz2fhae3tcasezmg7sr3iwdtz6zie.py
...
# l__mod___features_transition2_norm => add_77, convert_element_type_116, mul_115, mul_116, sub_38
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_39', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
