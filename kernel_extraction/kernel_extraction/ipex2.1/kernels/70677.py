...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/b2/cb236furpsrkygrephegthpgfxjyw2e4qp33lhxw264la3wtr675.py
# Source Nodes: [full, full_1, l__self___transformer_h_0_attn_attn_dropout, softmax, truediv, where], Original ATen: [aten._softmax, aten.div, aten.full, aten.native_dropout, aten.where]
# full => full_default
# full_1 => full_default_1
# l__self___transformer_h_0_attn_attn_dropout => gt_1, mul_4, mul_5
# softmax => amax, convert_element_type_3, convert_element_type_4, div_1, exp, sub_1, sum_1
# truediv => div
# where => where
triton_red_fused__softmax_div_full_native_dropout_where_6 = async_compile.triton('triton_red_fused__softmax_div_full_native_dropout_where_6', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*bf16', 2: '*i64', 3: '*fp32', 4: '*i1', 5: '*bf16', 6: '*bf16', 7: 'i32', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_div_full_native_dropout_where_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 8, 9), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__softmax_div_full_native_dropout_where_6(in_ptr0, in_ptr1, in_ptr2, out_ptr2, out_ptr3, out_ptr4, out_ptr5, load_seed_offset, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 98304
    rnumel = 512
