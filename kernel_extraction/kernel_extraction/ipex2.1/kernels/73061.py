...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/ca/ccamjmundep3hxska3it3m6adlzvl3ucnv5q24ifhnfvhbvqvec7.py
...
def triton_red_fused_mean_1(in_out_ptr0, in_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + (x0 + (224*r2) + (702464*x1)), rmask & xmask, eviction_policy='evict_first', other=0.0)
