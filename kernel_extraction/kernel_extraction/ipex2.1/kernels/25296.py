...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/kq/ckq7ogjzhifvdehdcwtnab4o4xskerdldthuglleqqa3twtxonlb.py
# Source Nodes: [add_12, l__self___image_encoder_blocks_2_norm1], Original ATen: [aten.add, aten.native_layer_norm]
# add_12 => add_22
# l__self___image_encoder_blocks_2_norm1 => clone_17, var_mean_4
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_native_layer_norm_15', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_native_layer_norm_15(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 4096
    rnumel = 1280
