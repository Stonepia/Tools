...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/o6/co6g3ykfl5mnljfgdjpl5ykwik36ze5fafwz5izxwj6uwije4dpy.py
...
# float_12 => convert_element_type_99
# softmax_9 => amax_9, div_13, exp_9, sub_14, sum_10
# type_as_9 => convert_element_type_100
...
@triton.jit
def triton_per_fused__softmax__to_copy_native_dropout_15(in_ptr0, in_ptr1, out_ptr3, out_ptr4, out_ptr5, load_seed_offset, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 12288
    rnumel = 128
