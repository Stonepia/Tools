...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/oa/coak56eddpsekc4bqiebzde3pknmzgjj6mof4ghoy5auub3uwvcj.py
# Source Nodes: [l__mod___module_list_6_activation, l__mod___module_list_6_batch_norm2d], Original ATen: [aten._native_batch_norm_legit_no_training, aten.leaky_relu]
# l__mod___module_list_6_activation => convert_element_type_29, gt_5, mul_23, where_5
# l__mod___module_list_6_batch_norm2d => add_12, mul_21, mul_22, sub_5
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_leaky_relu_6(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 6291456
