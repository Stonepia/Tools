...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/hy/chyhkc232ukhfqy273uq43v4acqurvjgem2ptr453sbefgvminic.py
...
triton_poi_fused_add_cat_mul_sigmoid_tanh_21 = async_compile.triton('triton_poi_fused_add_cat_mul_sigmoid_tanh_21', '''
import triton
...
@pointwise(size_hints=[65536], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_cat_mul_sigmoid_tanh_21', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_cat_mul_sigmoid_tanh_21(in_out_ptr0, in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 65536
