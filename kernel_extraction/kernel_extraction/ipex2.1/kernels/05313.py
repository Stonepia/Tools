...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/ks/ckspastfg3l5zmfbuhirlfyycgh5dbk5plk6k7cx3ixbhsczqf62.py
...
@pointwise(size_hints=[8], filename=__file__, meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_4', 'configs': [AttrsDescriptor(divisible_by_16=(0,), equal_to_1=())]})
@triton.jit
