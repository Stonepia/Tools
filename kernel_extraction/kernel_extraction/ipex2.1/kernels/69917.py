...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/b7/cb7wgvykqcxgocoamg3yzqfeq7fvaxf6l7khxkcvymovhakh7nim.py
# Source Nodes: [l__mod___encoder_a_encoder], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# l__mod___encoder_a_encoder => add_6, add_9, clone_3, clone_5, clone_6, var_mean_3
...
def triton_per_fused_add_clone_native_layer_norm_12(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel):
    ...
    tmp29 = tmp27 * tmp28
    tmp31 = tmp29 + tmp30
    tl.store(out_ptr2 + (r2 + (768*x1) + (24576*x0)), tmp31, rmask & xmask)
''')
