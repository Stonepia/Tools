...
# Original file: ./vision_maskrcnn__46_inference_86.26/vision_maskrcnn__46_inference_86.26.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/3q/c3qd3bjmsxsrxgmf2eszhmhkyvywdsrobvg2gdc5u6t5mz4xv5dm.py
...
@pointwise(size_hints=[64], filename=__file__, meta={'signature': {0: '*fp32', 1: '*i64', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_add_clamp_div_floor_lift_fresh_log2_mul_sqrt_sub_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
