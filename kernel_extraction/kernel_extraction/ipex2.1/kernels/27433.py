...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/4n/c4nkecgpjiucgdrodkjepoygxdsd5asmplmx5e6pz2jgebjjgoer.py
...
# nan_to_num_14 => convert_element_type_118, eq_58, eq_59, isnan_14, where_43, where_44, where_45
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_54', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
