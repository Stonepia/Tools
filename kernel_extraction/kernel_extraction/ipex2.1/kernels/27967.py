...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/qy/cqyw5oe6er7tnw6g3jfwb4j53rsqikqcn4b3n5bokm3sx4o6n25m.py
# Source Nodes: [argmax, eq, softmax, sum_1], Original ATen: [aten._softmax, aten.argmax, aten.eq, aten.sum]
# argmax => argmax
# eq => eq
# softmax => amax, convert_element_type_19, convert_element_type_20, div, exp, sub_4, sum_1
# sum_1 => sum_2
triton_per_fused__softmax_argmax_eq_sum_16 = async_compile.triton('triton_per_fused__softmax_argmax_eq_sum_16', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i64', 2: '*i64', 3: '*i64', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_argmax_eq_sum_16', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax_argmax_eq_sum_16(in_ptr0, in_ptr1, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 1
    rnumel = 75
