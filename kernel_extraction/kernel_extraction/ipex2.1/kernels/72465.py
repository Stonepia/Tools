...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/nk/cnkrpelslutuu56eghfn6erh7jzb5t53znsyfubbuqn6qsgrj7ve.py
...
def triton_poi_fused_clone_mul_4(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 361856)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (88*x2) + (4224*x1) + (1085568*x3)), None)
