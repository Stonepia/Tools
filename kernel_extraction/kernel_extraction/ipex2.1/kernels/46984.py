...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/ea/ceav5qqfby6x6vxmeegfnz7lasmapqwwyqik3qr47yvquappnlxp.py
# Source Nodes: [add, add_1, getattr_l__self___network_0___0___attn_proj, getattr_l__self___network_0___0___mlp_drop2, getattr_l__self___network_0___1___norm1], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add => add_13
# add_1 => add_17
# getattr_l__self___network_0___0___attn_proj => add_12
# getattr_l__self___network_0___0___mlp_drop2 => clone_10
# getattr_l__self___network_0___1___norm1 => add_18, add_19, clone_11, convert_element_type_36, convert_element_type_37, mul_17, mul_18, rsqrt_2, sub_6, var_mean_2
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp32', 5: '*fp32', 6: '*fp16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
