...
# Original file: ./detectron2_fcos_r_50_fpn__46_inference_86.26/detectron2_fcos_r_50_fpn__46_inference_86.26_3.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/hw/chwfnljb34r2qat54nbktyku7ndc3a3rr2ngd2eoa7o6mmkgb33c.py
# Source Nodes: [add, mul, self____modules__2], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.mul]
# add => add_1
# mul => mul_2
# self____modules__2 => convert_element_type_2, mul_1, sub
...
@pointwise(size_hints=[262144], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_add_mul_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
