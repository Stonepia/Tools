...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/fw/cfw2jodgkgkidzj6et23ffp2z3qykfwo7q3ei2wty3jqduoqpmck.py
...
def triton_per_fused__to_copy_native_dropout_backward_native_layer_norm_backward_0(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, out_ptr3, xnumel, rnumel):
    ...
    tmp21 = tl.load(in_ptr4 + (r1 + (1024*x0)), rmask)
    tmp2 = tmp0 * tmp1
