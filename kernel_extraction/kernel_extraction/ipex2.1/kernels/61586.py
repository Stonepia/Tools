...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/j6/cj6jxaxzw46qmjjnndwxb7dg2lxgkev6ap4nr2v6kmswgu5hoc6x.py
...
# l__mod___features_denseblock3_denselayer23_norm1 => add_167, convert_element_type_251, mul_250, mul_251, sub_83
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_84', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
