...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/fw/cfwrxiyba6sldz3ccuxrpchcnpleeea26pweudrs3war25oqwmrf.py
...
def triton_per_fused__log_softmax_backward_data_cat_div_nll_loss_backward_nll_loss_forward_4(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, in_ptr9, in_ptr10, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp35 = tl.load(in_ptr7 + (r1 + (128*x0)), rmask & xmask, other=0.0)
    tmp36 = tl.load(in_ptr8 + (r1 + (128*x0)), rmask & xmask, other=0.0)
    tmp41 = tl.load(in_ptr9 + (r1 + (128*x0)), rmask & xmask, other=0.0)
    tmp42 = tl.load(in_ptr10 + (r1 + (128*x0)), rmask & xmask, other=0.0)
    ...
    tmp45 = tmp16 - tmp44
    tmp46 = tmp41 + tmp45
    tl.store(out_ptr2 + ((2*r1) + (256*x0)), tmp40, rmask & xmask)
