...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/qs/cqsbx7s2ja53lxmp7lxleoejtitqf4hghlk3xun2b5b2iv5ykf6h.py
# Source Nodes: [l__self___features_denseblock3_denselayer17_norm1, l__self___features_denseblock3_denselayer17_relu1], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# l__self___features_denseblock3_denselayer17_norm1 => add_143, convert_element_type_287, mul_214, mul_215, sub_71
# l__self___features_denseblock3_denselayer17_relu1 => relu_71
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_72', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
