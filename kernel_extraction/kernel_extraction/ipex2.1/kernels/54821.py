...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/ql/cql5vxcyau4qs4n6sn6okrliqfnbcnu6ejtznmvjtxuci6u3mvhz.py
...
@triton.jit
def triton_poi_fused_copy_slice_scatter_16(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 3072
    xnumel = 513
