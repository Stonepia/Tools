...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/fv/cfv4uvy6oi7umoqh67f5ckgqhcm3e2ufwchcmpnl2cqxrgzkqxi6.py
# Source Nodes: [group_norm_62], Original ATen: [aten.native_group_norm]
# group_norm_62 => convert_element_type_310, var_mean_62
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_group_norm_54', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]}
)
@triton.jit
