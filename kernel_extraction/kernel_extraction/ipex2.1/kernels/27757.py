...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/cn/ccnvarxaqilzotreyaz3wgyt5grczt3ow2eg4hfw7ux2yikrcjdw.py
# Source Nodes: [add_10, add_8, any_4, clamp_1, clamp_2, isinf_3, l__self___block_1_layer_0_dropout, l__self___block_1_layer__1__dropout, neg_1, neg_2, where_1, where_2, where_3], Original ATen: [aten.add, aten.any, aten.clamp, aten.clone, aten.isinf, aten.neg, aten.scalar_tensor, aten.where]
# add_10 => add_13
# add_8 => add_11
# any_4 => any_4
...
# where_2 => where_2
# where_3 => where_3
triton_red_fused_add_any_clamp_clone_isinf_neg_scalar_tensor_where_12 = async_compile.triton('triton_red_fused_add_any_clamp_clone_isinf_neg_scalar_tensor_where_12', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i1', 2: '*fp16', 3: '*i1', 4: '*fp16', 5: '*i1', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_any_clamp_clone_isinf_neg_scalar_tensor_where_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_any_clamp_clone_isinf_neg_scalar_tensor_where_12(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 128
    rnumel = 8192
