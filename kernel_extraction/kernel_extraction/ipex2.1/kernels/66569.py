...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/ap/capzrmb33oyxdmuyffsl4ceyx2zgxjpw2zf3u2hxkkrzkln6wjos.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_mul_native_layer_norm_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 7), equal_to_1=())]}
)
@triton.jit
