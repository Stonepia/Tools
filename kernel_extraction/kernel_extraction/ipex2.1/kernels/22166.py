...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/z4/cz4o3jmeywjif7g3f7l6da3arnd7eo3lsilmtiptnmrchi7n7wr5.py
# Source Nodes: [add, getattr_l__self___blocks___0___mlp_channels_drop2, getattr_l__self___blocks___1___norm], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add => add_6
# getattr_l__self___blocks___0___mlp_channels_drop2 => clone_3
# getattr_l__self___blocks___1___norm => add_7, add_8, clone_4, convert_element_type_15, convert_element_type_16, mul_8, mul_9, rsqrt_2, sub_2, var_mean_2
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
