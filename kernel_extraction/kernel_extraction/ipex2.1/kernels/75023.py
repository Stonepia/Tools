...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/3h/c3htrshtsytrjrvpoeedzngaxtbqurtpuzaa6cdnwnwemhwp6vgg.py
# Source Nodes: [getattr_l__self___stages___2___pool], Original ATen: [aten.max_pool2d_with_indices]
...
@pointwise(size_hints=[4194304], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_max_pool2d_with_indices_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
