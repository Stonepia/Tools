...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/oi/coizve2umewdx3kaoppuvz257sddofj6xi3i5uenkqqwuvirayyq.py
...
# add => add
# l__mod___transformer_h_0_ln_1 => add_1, add_2, mul, mul_1, rsqrt, sub, var_mean
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_embedding_native_layer_norm_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
