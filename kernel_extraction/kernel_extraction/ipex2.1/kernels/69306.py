...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/jn/cjnbevzaxxjphzvbkylqzlu76ou3y6gc4f52aqrf26uxflmpgm4f.py
...
@pointwise(size_hints=[65536, 64], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*bf16', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_sub_59', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
