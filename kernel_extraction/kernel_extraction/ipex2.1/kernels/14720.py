...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/aq/caqsndvpr3bfqc5voljtqf7feqipieierxalrqqyru65yfldudyv.py
...
# iadd_39 => add_277
# iadd_40 => add_284
# softmax_40 => amax_40, div_40, exp_40, sub_40, sum_41
# stack => cat_3428
triton_per_fused__softmax_add_cat_stack_62 = async_compile.triton('triton_per_fused__softmax_add_cat_stack_62', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*i1', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: '*fp32', 8: '*fp32', 9: '*fp32', 10: 'i32', 11: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_cat_stack_62', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 9, 10), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax_add_cat_stack_62(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, out_ptr3, out_ptr4, out_ptr5, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 64
    rnumel = 168
