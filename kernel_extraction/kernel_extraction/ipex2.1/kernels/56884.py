...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/7o/c7onmhyf2jxnhmyzzkddvnam6fgxxsrkhueg7e4iyhpsuflsj7o4.py
...
# l__mod___blocks_1_0_norm2 => add_37, add_38, convert_element_type_32, convert_element_type_33, mul_35, mul_36, rsqrt_13, sub_13, var_mean_13
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_18', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
