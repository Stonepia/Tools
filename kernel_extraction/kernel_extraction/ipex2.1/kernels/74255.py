...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/gm/cgmxg6slpcs3vbxv7i645pxvropoivuqvchfrstc6z5hwblogr2m.py
# Source Nodes: [batch_norm_107, l__self___features_conv5_3_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_107 => add_249, convert_element_type_431, mul_322, mul_323, sub_107
# l__self___features_conv5_3_c1x1_a_bn_act => relu_107
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_142(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (2560*x2) + (125440*y1)), tmp11, xmask)
''')
