...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/qu/cqut64cum6y5jaomqqntz2rcous6uvu2kakx34msbp5m6v3lvfub.py
...
def triton_poi_fused__unsafe_view_clone_mul_2(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_ptr2 + (x1 + (384*y0)), xmask, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tmp4 = tmp2 * tmp3
