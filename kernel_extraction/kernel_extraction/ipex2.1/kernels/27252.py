...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/32/c32hsyp5rju5xl2l5vx3a6s6is7ivvuvbqh2zrcxeq4aluxr2qt4.py
...
# nan_to_num_9 => convert_element_type_201, eq_38, eq_39, isnan_9, where_28, where_29, where_30
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_39', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
