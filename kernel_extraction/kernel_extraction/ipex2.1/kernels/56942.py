...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/kr/ckrkmjrmtegrj7icynb655n3o2knknadyh7rkfbm2w65zyl45fbs.py
...
# l__mod___blocks_1_2_mlp_drop2 => clone_34
# l__mod___blocks_1_3_norm1 => add_60, add_61, mul_70, mul_71, rsqrt_20, sub_26, var_mean_20
...
@triton.jit
def triton_per_fused_add_clone_native_layer_norm_27(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 50176
    rnumel = 128
    ...
    tmp7 = tl.load(in_out_ptr0 + (r1 + (128*x0)), rmask & xmask, other=0.0)
