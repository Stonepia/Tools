...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/z2/cz2tkht6h7hqmzajdq5jtjszht5h6wk7axell2bfwhdvd4hrsmek.py
# Source Nodes: [getattr_getattr_l__mod___stages___0___blocks___0___attn_gate, mul], Original ATen: [aten.hardsigmoid, aten.mul]
...
@pointwise(size_hints=[268435456], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_hardsigmoid_mul_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
