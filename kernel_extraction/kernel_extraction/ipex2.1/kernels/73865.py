...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/nm/cnmx3sar2p67nqdimmppq5ilfzvxhj77p6q4dh344pufu4kc4tue.py
...
# batch_norm_36 => add_84, mul_109, mul_110, sub_36
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_48(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1088*x2) + (852992*y1)), tmp9, xmask)
''')
