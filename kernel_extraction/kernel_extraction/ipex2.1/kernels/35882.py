...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/me/cme3ma3gspr5wqvleyp6n537ov7zg2pkgm4kk3ckhqoza7urcvbc.py
...
# getattr_l__self___blocks___1___norm2 => add_11, add_12, clone_9, convert_element_type_27, convert_element_type_28, mul_12, mul_13, rsqrt_3, sub_3, var_mean_3
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*fp32', 5: '*fp32', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
