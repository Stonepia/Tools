...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/au/cauahpg7cehagk2w6pkt45u5mlzofy5wa7ycvxr7ds2wpvmppnrz.py
# Source Nodes: [l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_1, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_10, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_11, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_2, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_3, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_4, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_5, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_6, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_7, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_8, l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_9], Original ATen: [aten._to_copy, aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.sum]
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm => convert_element_type_12
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_1 => convert_element_type_31
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_10 => convert_element_type_202
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_11 => convert_element_type_221
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_2 => convert_element_type_50
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_3 => convert_element_type_69
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_4 => convert_element_type_88
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_5 => convert_element_type_107
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_6 => convert_element_type_126
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_7 => convert_element_type_145
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_8 => convert_element_type_164
# l__self___albert_encoder_albert_layer_groups_0_albert_layers_0_attention_layer_norm_9 => convert_element_type_183
triton_red_fused__to_copy_add_native_layer_norm_native_layer_norm_backward_sum_20 = async_compile.triton('triton_red_fused__to_copy_add_native_layer_norm_native_layer_norm_backward_sum_20', '''
import triton
...
def triton_red_fused__to_copy_add_native_layer_norm_native_layer_norm_backward_sum_20(in_out_ptr0, in_out_ptr1, in_out_ptr2, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, in_ptr9, in_ptr10, in_ptr11, in_ptr12, in_ptr13, in_ptr14, in_ptr15, in_ptr16, in_ptr17, in_ptr18, in_ptr19, in_ptr20, in_ptr21, in_ptr22, in_ptr23, in_ptr24, in_ptr25, in_ptr26, in_ptr27, in_ptr28, in_ptr29, in_ptr30, in_ptr31, in_ptr32, in_ptr33, in_ptr34, in_ptr35, in_ptr36, in_ptr37, in_ptr38, in_ptr39, in_ptr40, in_ptr41, in_ptr42, in_ptr43, in_ptr44, in_ptr45, in_ptr46, in_ptr47, in_ptr48, in_ptr49, in_ptr50, in_ptr51, in_ptr52, in_ptr53, in_ptr54, in_ptr55, in_ptr56, in_ptr57, in_ptr58, in_ptr59, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    tmp242 = tmp241 + tmp75
    tmp243 = tmp242 + tmp95
    tmp244 = tmp243 + tmp115
    tmp245 = tmp244 + tmp155
    tmp246 = tmp245 + tmp195
    tmp247 = tmp246 + tmp235
    tmp248 = tmp247 + tmp135
    tmp249 = tmp248 + tmp175
    tmp250 = tmp249 + tmp215
    tmp251 = tmp18 + tmp38
    tmp252 = tmp251 + tmp58
    tmp253 = tmp252 + tmp78
    tmp254 = tmp253 + tmp98
    tmp255 = tmp254 + tmp118
    tmp256 = tmp255 + tmp158
    tmp257 = tmp256 + tmp198
    tmp258 = tmp257 + tmp238
    tmp259 = tmp258 + tmp138
    tmp260 = tmp259 + tmp178
    tmp261 = tmp260 + tmp218
    tmp262 = tmp2.to(tl.float32)
    tmp263 = tmp22.to(tl.float32)
    tmp264 = tmp262 + tmp263
    tmp265 = tmp42.to(tl.float32)
    tmp266 = tmp264 + tmp265
    tmp267 = tmp62.to(tl.float32)
    tmp268 = tmp266 + tmp267
    tmp269 = tmp82.to(tl.float32)
    tmp270 = tmp268 + tmp269
    tmp271 = tmp102.to(tl.float32)
    tmp272 = tmp270 + tmp271
    tmp273 = tmp142.to(tl.float32)
    tmp274 = tmp272 + tmp273
    tmp275 = tmp182.to(tl.float32)
    tmp276 = tmp274 + tmp275
    tmp277 = tmp222.to(tl.float32)
    tmp278 = tmp276 + tmp277
    tmp279 = tmp122.to(tl.float32)
    tmp280 = tmp278 + tmp279
    tmp281 = tmp162.to(tl.float32)
    tmp282 = tmp280 + tmp281
    tmp283 = tmp202.to(tl.float32)
    tmp284 = tmp282 + tmp283
    tl.debug_barrier()
    tl.store(in_out_ptr0 + (x0), tmp250, None)
    tl.debug_barrier()
    tl.store(in_out_ptr1 + (x0), tmp261, None)
    tl.debug_barrier()
    tl.store(in_out_ptr2 + (x0), tmp284, None)
''')
