...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/hd/chdsm2wxib266vehqyf7pcqjhvkppgryubc5rj6mj5faz4sn6wb4.py
...
# batch_norm_3 => add_12, add_15, convert_element_type_15, convert_element_type_16, mul_21, mul_27, rsqrt_3, sub_3, var_mean_3
...
# relu_2 => relu_2
# relu_3 => relu_3
triton_poi_fused__native_batch_norm_legit_functional__to_copy_convolution_relu_13 = async_compile.triton('triton_poi_fused__native_batch_norm_legit_functional__to_copy_convolution_relu_13', '''
import triton
...
@pointwise(size_hints=[8192], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*bf16', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_functional__to_copy_convolution_relu_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]})
@triton.jit
def triton_poi_fused__native_batch_norm_legit_functional__to_copy_convolution_relu_13(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4800
