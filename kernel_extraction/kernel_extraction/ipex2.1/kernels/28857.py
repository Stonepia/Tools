...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/mp/cmptzl3hpx5mycdem5x2tvahastbuev3i5uol7j3abwz2rek7uij.py
...
def triton_poi_fused_clone_41(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp11 = tl.load(in_ptr3 + (((y0 + (2*y1) + (4*x2) + (32*x3)) // 256) % 192), ymask, eviction_policy='evict_last')
    tmp13 = tl.load(in_ptr4 + (((y0 + (2*y1) + (4*x2) + (32*x3)) // 256) % 192), ymask, eviction_policy='evict_last')
    ...
    tl.store(out_ptr0 + (y0 + (2*x2) + (16*y1) + (32*x3)), tmp15, ymask)
''')
