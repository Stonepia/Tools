...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/jc/cjc5wm2cj6fhs5ywdv3swxfmmot7zs6ywexawbbp46kqthtunueb.py
...
@pointwise(size_hints=[536870912], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*i1', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: '*fp32', 7: '*fp16', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_slice_backward_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_slice_backward_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tmp1 < tmp2
    tmp4 = tl.load(in_ptr1 + (x4 + (25685415*x2)), tmp3, other=0.0).to(tl.float32)
    ...
    tmp15 = tl.load(in_ptr5 + (x4 + (25685415*x2)), tmp3, other=0.0).to(tl.float32)
