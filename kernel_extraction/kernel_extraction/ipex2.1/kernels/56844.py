...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/z7/cz7bxfwccwckmca32pmnywogmmry345qiippfk2zm7u2grhnlvrj.py
# Source Nodes: [], Original ATen: [aten.col2im]

triton_poi_fused_col2im_24 = async_compile.triton('triton_poi_fused_col2im_24', '''
import triton
...
@pointwise(size_hints=[65536, 512], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*i64', 1: '*i64', 2: '*bf16', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_col2im_24', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused_col2im_24(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 55296
    xnumel = 512
