...
# Original file: ./detectron2_maskrcnn__65_inference_105.45/detectron2_maskrcnn__65_inference_105.45.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/ql/cqlv2kjt4kjcpmfvklfnvta65miptfv4aylgnylw3jfdoycpy2jy.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_split_with_sizes_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]}
)
@triton.jit
