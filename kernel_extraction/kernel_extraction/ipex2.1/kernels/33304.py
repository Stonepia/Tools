...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/4i/c4injrbyh27rnjuhib7anp3n6wxio522jaspi2hqxxqhrcyzy4r6.py
# Source Nodes: [gelu, l__self___encoder_conv1], Original ATen: [aten._to_copy, aten.convolution, aten.gelu]
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_convolution_gelu_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
