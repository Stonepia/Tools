...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/hk/chknpiwhvlmg6w633l75lhdlsktou36ciu5rnwtuwa4ywixkkoqt.py
# Source Nodes: [gelu_16, mul__19, pad_3], Original ATen: [aten.constant_pad_nd, aten.gelu, aten.mul]
# gelu_16 => add_39, convert_element_type_72, convert_element_type_73, erf_16, mul_140, mul_141, mul_142
# mul__19 => mul_143
...
@pointwise(size_hints=[134217728], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_constant_pad_nd_gelu_mul_14', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
