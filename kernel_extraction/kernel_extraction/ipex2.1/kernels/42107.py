...
# Original file: ./detectron2_fcos_r_50_fpn__65_inference_105.45/detectron2_fcos_r_50_fpn__65_inference_105.45_3.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/2x/c2xub2v5a4hrnujuqbjoisxo73f3dgkh355xs4tgsmvbypo3x6fx.py
# Source Nodes: [add_1, mul, sub___stack0], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.mul]
# add_1 => add_1
# mul => mul_2
...
@pointwise(size_hints=[32768], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_add_mul_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]})
@triton.jit
