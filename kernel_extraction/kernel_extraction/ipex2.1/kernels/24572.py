...
# Original file: ./detectron2_fasterrcnn_r_101_fpn__61_inference_101.41/detectron2_fasterrcnn_r_101_fpn__61_inference_101.41.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/q2/cq2msxzxk5a7zolo2lfzuvsglvdzno4otzmq6nz4ncdfgyaqspmu.py
...
def triton_poi_fused_index_0(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.where(tmp0 < 0, tmp0 + 297, tmp0)
    # tl.device_assert(((0 <= tmp1) & (tmp1 < 297)) | ~xmask, "index out of bounds: 0 <= tmp1 < 297")
