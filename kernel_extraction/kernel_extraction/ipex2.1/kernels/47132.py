...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/q7/cq74je7nfc5mvtcztdlemvjkwyql5jmqsg2aqc7apmj5omxxevct.py
...
# getattr_l__mod___network_2___1___norm1 => add_62, add_63, clone_55, convert_element_type_65, convert_element_type_66, mul_49, mul_50, rsqrt_10, sub_18, var_mean_10
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_25', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
