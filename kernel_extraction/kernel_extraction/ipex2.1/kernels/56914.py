...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/xn/cxnrweaanrkasvx77cvk2v2isdfxtocz47byohxpdgewsa7eslbl.py
# Source Nodes: [l__mod___norm, mean], Original ATen: [aten.mean, aten.native_layer_norm]
# l__mod___norm => add_258, add_259, convert_element_type_226, convert_element_type_227, mul_254, mul_255, rsqrt_85, sub_85, var_mean_85
# mean => mean
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_mean_native_layer_norm_48', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
