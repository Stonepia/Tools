...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/xu/cxueng427f3nychqtjikmnn4ugqppirtndej6knwz5ufivhc7jbf.py
# Source Nodes: [softmax_24], Original ATen: [aten._softmax]
...
def triton_red_fused__softmax_2(in_ptr0, in_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp19 = tl.load(in_ptr1 + (x1 + (16*tmp18)), None, eviction_policy='evict_last')
        tmp20 = r2
        tmp21 = x0
        tmp22 = tmp20 <= tmp21
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp33 = tl.load(in_ptr0 + (r2 + (512*x3)), rmask, eviction_policy='evict_last', other=0.0)
        ...
        tmp52 = tl.load(in_ptr1 + (x1 + (16*tmp51)), None, eviction_policy='evict_last')
        tmp53 = r2
        tmp54 = x0
        tmp55 = tmp53 <= tmp54
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp68 = tl.load(in_ptr0 + (r2 + (512*x3)), rmask, eviction_policy='evict_first', other=0.0)
        ...
        tmp87 = tl.load(in_ptr1 + (x1 + (16*tmp86)), None, eviction_policy='evict_first')
        tmp88 = r2
        tmp89 = x0
        tmp90 = tmp88 <= tmp89
        ...
        tmp99 = tl.exp(tmp98)
        tmp100 = tmp99 / tmp66
        tl.store(out_ptr2 + (r2 + (512*x3)), tmp100, rmask)
''')
