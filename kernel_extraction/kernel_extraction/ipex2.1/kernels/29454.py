...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/uw/cuw6mfygwla7n54escd37uc4wh5ptenx6yhy4tjoplbxuufybyeh.py
...
def triton_poi_fused_index_0(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.where(tmp0 < 0, tmp0 + 281, tmp0)
    # tl.device_assert(((0 <= tmp1) & (tmp1 < 281)) | ~xmask, "index out of bounds: 0 <= tmp1 < 281")
