...
# Source Nodes: [add, l__self___decoder_embed_tokens, mean, mul_3, mul_4, pow_1, rsqrt, to_3, to_4], Original ATen: [aten._to_copy, aten.add, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add => add
