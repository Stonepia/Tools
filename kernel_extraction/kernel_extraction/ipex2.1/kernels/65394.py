...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/jc/cjcfgazjosvq4idvsfgk2cbc46jbwnugvxenwnkg57rakm4xyhv7.py
...
# l__mod___blocks_3_norm_mlp_in => add_62, add_63, clone_54, mul_61, mul_62, rsqrt_18, sub_25, var_mean_18
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: '*fp32', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_29', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_clone_native_layer_norm_29(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp7 = tl.load(in_out_ptr0 + (r1 + (24*x0)), rmask, other=0.0)
