...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/6s/c6shgd2a4uktw4j7xdlclcowbssquvhqmsf6eogh4lerqj6l63fp.py
# Source Nodes: [add_14, getattr_getattr_l__mod___layers___2___blocks___0___attn_softmax], Original ATen: [aten._softmax, aten.add]
# add_14 => add_42
# getattr_getattr_l__mod___layers___2___blocks___0___attn_softmax => amax_4, div_4, exp_4, sub_16, sum_5
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_32', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
