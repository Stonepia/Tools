...
# Original file: ./PLBartForConditionalGeneration__72_forward_213.16/PLBartForConditionalGeneration__72_forward_213.16.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/ab/cabnt6ziczwisazuspgauuj4jadghlc7k7hri5pqrcnywreeyzkd.py
...
def triton_red_fused__log_softmax_add_0(in_out_ptr0, in_ptr0, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp0 = tl.load(in_out_ptr0 + (r1 + (50005*x0)), rmask, eviction_policy='evict_first', other=0.0)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp6 = tl.load(in_out_ptr0 + (r1 + (50005*x0)), rmask, eviction_policy='evict_last', other=0.0)
        tmp7 = tmp6 - tmp4
        tmp8 = tl.exp(tmp7)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp12 = tl.load(in_out_ptr0 + (r1 + (50005*x0)), rmask, eviction_policy='evict_first', other=0.0)
        tmp13 = tmp12 - tmp4
        tmp14 = tl.log(tmp10)
        tmp15 = tmp13 - tmp14
        tl.store(out_ptr2 + (r1 + (50005*x0)), tmp15, rmask)
''')
