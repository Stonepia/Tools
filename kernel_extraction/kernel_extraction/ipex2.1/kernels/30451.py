...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/lw/clwsj6jjl2vhkupfgqrkfaw5zemc2d7c4usw7qepqhuizgq6q4eb.py
...
def triton_poi_fused_nll_loss_backward_nll_loss_forward_1(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp5 = tl.where(tmp4 < 0, tmp4 + 32000, tmp4)
    # tl.device_assert((0 <= tmp5) & (tmp5 < 32000), "index out of bounds: 0 <= tmp5 < 32000")
    tmp6 = -1.0
    tl.store(out_ptr0 + (tmp5 + (32000*x0)), tmp6, None)
''')
