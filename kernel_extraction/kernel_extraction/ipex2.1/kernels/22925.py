...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/ar/caro43lzi22gosjgl4m6th4yjaqdpj62zv33ohl4q4t5nn4fzcbs.py
# Source Nodes: [batch_norm_3, getattr_getattr_l__self___blocks___1_____0___bn1_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_3 => add_8, convert_element_type_17, mul_10, mul_11, sub_3
# getattr_getattr_l__self___blocks___1_____0___bn1_act => relu_2
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x2 + (12544*y3)), tmp11, xmask)
''')
