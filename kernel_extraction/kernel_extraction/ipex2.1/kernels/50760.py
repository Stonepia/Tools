...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/si/csivphns4r6luw73b4didsags26kctpf7jepd7dzl377au26ypdq.py
# Source Nodes: [add_5, l__self___transformer_h_1_attn_resid_dropout, l__self___transformer_h_1_mlp_c_fc, layer_norm_3], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.native_layer_norm]
# add_5 => add_11
# l__self___transformer_h_1_attn_resid_dropout => clone_3
# l__self___transformer_h_1_mlp_c_fc => convert_element_type_17
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clone_native_layer_norm_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
