...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/uo/cuosr2ivyeaj7mnb7gcha3ertlak5ehfuoc6y2suskic45c3m4iq.py
...
@pointwise(size_hints=[4194304, 8], tile_hint=TileHint.DEFAULT,filename=__file__, meta={'signature': {0: '*i1', 1: '*fp16', 2: '*fp16', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_native_dropout_12', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
