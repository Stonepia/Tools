...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/y2/cy27g4znb4ckwt6x745aa7o4tjpersxcjyb7nyup7kbywgh3tcxu.py
# Source Nodes: [add_11, add_13, add_15, add_16, l__self___decoder_block_1_layer_0_dropout, l__self___decoder_block_1_layer_1_dropout, l__self___decoder_block_1_layer__1__dropout, mean_6, mul_16, mul_17, pow_7, rsqrt_6, to_16, to_17], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add_11 => add_14
# add_13 => add_17
# add_15 => add_19
# add_16 => add_20
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clone_mean_mul_pow_rsqrt_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 7), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__to_copy_add_clone_mean_mul_pow_rsqrt_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, rnumel):
    xnumel = 1
