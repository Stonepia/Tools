...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/ju/cjud6xaj7kwddfjumekgqgunytakdd6ihc4nxognkfulp4ndqd4h.py
...
# getattr_l__mod___blocks_0_blocks_1___1___attn_proj_drop => clone_20
# getattr_l__mod___blocks_0_blocks_1___1___norm2 => add_65, add_66, mul_104, mul_105, rsqrt_5, sub_54, var_mean_5
...
def triton_per_fused_add_clone_native_layer_norm_26(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel):
    ...
    tmp7 = tl.load(in_out_ptr0 + (r2 + (256*x3)), rmask & xmask, other=0.0)
