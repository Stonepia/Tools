...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/ub/cub5h54cudmvydevzyurofzjvkswtylz3hxe77gdl7iktov5u6ms.py
...
# batch_norm_30 => add_70, mul_91, mul_92, sub_30
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_40(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (960*x2) + (752640*y1)), tmp9, xmask)
''')
