...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/3i/c3ij4lnuajcsimd3hguba66xj4x46a3i5a4etun6kc7hzmy2hrm5.py
...
# nan_to_num_12 => convert_element_type_102, eq_50, eq_51, isnan_12, where_37, where_38, where_39
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_48', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
