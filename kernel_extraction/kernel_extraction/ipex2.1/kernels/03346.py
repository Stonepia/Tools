...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/bs/cbs52hgkzxthjxvi4edrsb4to5v6rj3izw6amzzyhcfyfeaoqrbq.py
# Source Nodes: [mul_4, softmax_1], Original ATen: [aten._softmax, aten.mul]
# mul_4 => mul_8
# softmax_1 => amax_1, convert_element_type_10, convert_element_type_default_95, div_3, exp_1, sub_4, sum_2
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_mul_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
