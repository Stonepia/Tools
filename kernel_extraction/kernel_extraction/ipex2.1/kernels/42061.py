...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/xy/cxyudlhx433lddg2pewkkiokwj2hxyld3qsm6eppjbuvvm2vtb66.py
# Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward, aten.sum]

triton_red_fused_add_native_layer_norm_backward_sum_14 = async_compile.triton('triton_red_fused_add_native_layer_norm_backward_sum_14', '''
import triton
