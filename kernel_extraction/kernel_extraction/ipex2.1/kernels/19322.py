...
# Original file: ./detectron2_fasterrcnn_r_50_fpn__63_inference_103.43/detectron2_fasterrcnn_r_50_fpn__63_inference_103.43_1.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/ub/cubsm55o7furbpsa45j2zetkibcl4bao2ys765femblbgnh24vkq.py
...
@pointwise(size_hints=[128], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_mul_slice_slice_scatter_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
