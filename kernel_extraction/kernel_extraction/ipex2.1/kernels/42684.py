...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/sb/csba3r5eyl4eu4gnsrn6r2haaskmzbah6gkzayzvb3idysgo7k33.py
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_clone_sum_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 3), equal_to_1=())]}
)
@triton.jit
