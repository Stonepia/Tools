...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/6t/c6tuv7tvn5uy75tqx226hekk273bv5cuf5xwuq4fowqzdfqazxpt.py
# Source Nodes: [l__mod___encoder_b_encoder], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# l__mod___encoder_b_encoder => add_101, add_102, add_103, add_98, clone_82, clone_85, clone_86, convert_element_type_64, convert_element_type_65, mul_88, mul_89, rsqrt_30, sub_30, var_mean_30
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_25', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
