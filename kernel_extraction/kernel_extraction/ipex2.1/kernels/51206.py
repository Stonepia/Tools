...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/hd/chdldg7avl77tdkuv4rcwg7f3vf5ifj6qzjo6rwxbn3zwh3pilwb.py
# Source Nodes: [iadd, softmax], Original ATen: [aten._softmax, aten._to_copy, aten.add]
# iadd => add_2
# softmax => amax, clone_2, convert_element_type_14, exp, sub_4, sum_1
triton_per_fused__softmax__to_copy_add_16 = async_compile.triton('triton_per_fused__softmax__to_copy_add_16', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax__to_copy_add_16', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax__to_copy_add_16(in_ptr0, in_ptr1, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel):
    xnumel = 49152
