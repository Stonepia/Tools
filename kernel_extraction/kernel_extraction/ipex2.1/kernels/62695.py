...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/wi/cwisksibq3hmscqyn54umf5ci27c2mhmuvnzb4ssmqgw2qwvfk3o.py
...
# trampoline_autograd_apply_1 => amax, div_2, exp, full_default_3, full_default_4, sub_3, sum_1, where_1, where_2
# trampoline_autograd_apply_2 => convert_element_type_3, convert_element_type_4, lt_1, mul_5, sub_4, where_3
triton_per_fused__softmax__to_copy_bernoulli_bitwise_not_lift_fresh_masked_fill_mul_rsub_4 = async_compile.triton('triton_per_fused__softmax__to_copy_bernoulli_bitwise_not_lift_fresh_masked_fill_mul_rsub_4', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*i64', 2: '*i1', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax__to_copy_bernoulli_bitwise_not_lift_fresh_masked_fill_mul_rsub_4', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax__to_copy_bernoulli_bitwise_not_lift_fresh_masked_fill_mul_rsub_4(in_ptr0, in_ptr1, out_ptr3, out_ptr4, out_ptr5, load_seed_offset, xnumel, rnumel):
    xnumel = 98304
