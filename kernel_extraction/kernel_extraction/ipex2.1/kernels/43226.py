...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/tf/ctfk6zohnlbyo3vyn5wetwg43i2ts3hhzjrm5hd6diar373dihj3.py
# Source Nodes: [batch_norm_15, getattr_l__self___stages___2___conv_down_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.leaky_relu]
# batch_norm_15 => add_34, mul_61, mul_62, sub_15
# getattr_l__self___stages___2___conv_down_bn_act => convert_element_type_96, gt_15, mul_63, where_15
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_leaky_relu_23(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 16777216
