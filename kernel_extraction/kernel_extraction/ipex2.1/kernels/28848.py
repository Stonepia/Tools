...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/ga/cgantcixjrcv2ucusuzknwvq6zqwmwhbjwil3koxyi6uc77vat6k.py
# Source Nodes: [add_6, getattr_getattr_getattr_l__self___stages___3_____1___transformer___0___attn_proj_drop, getattr_getattr_getattr_l__self___stages___3_____1___transformer___0___norm2], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add_6 => add_64
# getattr_getattr_getattr_l__self___stages___3_____1___transformer___0___attn_proj_drop => clone_24
# getattr_getattr_getattr_l__self___stages___3_____1___transformer___0___norm2 => add_65, add_66, convert_element_type_171, convert_element_type_172, mul_106, mul_107, rsqrt_6, sub_32, var_mean_6
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_32', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_clone_native_layer_norm_32(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (192*x3)), tmp23, rmask)
''')
