...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/et/cetysskjs2ciz5kg2mnvnwbqctlewnsufa4o5afjnz7qtadqdoev.py
...
@pointwise(size_hints=[16384], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*bf16', 5: '*bf16', 6: '*bf16', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_16', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]})
@triton.jit
