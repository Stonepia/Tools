...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/q7/cq7icbij5ad263axhm6rciwxzu4skc3a4jhppmeebfgy5pi5yvjy.py
# Source Nodes: [cat_32, getattr_getattr_l__mod___blocks___4___block___3___net_0, getattr_getattr_l__mod___blocks___4___block___3___net_1], Original ATen: [aten._native_batch_norm_legit_no_training, aten.cat, aten.relu]
# cat_32 => cat_15
# getattr_getattr_l__mod___blocks___4___block___3___net_0 => add_65, convert_element_type_98, mul_97, mul_98, sub_32
# getattr_getattr_l__mod___blocks___4___block___3___net_1 => relu_32
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_cat_relu_33(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1048576
