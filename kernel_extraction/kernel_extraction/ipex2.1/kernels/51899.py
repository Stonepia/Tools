...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/4j/c4jj66faa3vj4f67j47rjytawbxaor5do6r55uuffcks2ygs2tzj.py
...
@pointwise(size_hints=[32768, 16], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_add_convolution_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
