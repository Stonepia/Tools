...
# Original file: ./hf_Bart__28_inference_68.8/hf_Bart__28_inference_68.8.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/5h/c5h5ir6s6p2tp5y56f7hordbnctk4ndg6qmgkeknkbbf6xyjqgom.py
# Source Nodes: [add_1, add_2, embedding, l__self___decoder_embed_tokens, l__self___decoder_layernorm_embedding, mul], Original ATen: [aten.add, aten.embedding, aten.mul, aten.native_layer_norm]
# add_1 => add_1
# add_2 => add_2
# embedding => embedding_1
# l__self___decoder_embed_tokens => embedding
# l__self___decoder_layernorm_embedding => add_3, add_4, convert_element_type_1, convert_element_type_2, mul_1, mul_2, rsqrt, sub, var_mean
# mul => mul
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_embedding_mul_native_layer_norm_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
