...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/jw/cjwfzawbhcw6tu4s63mp4qyyp6qkjspfgso5xwxoc5wnqkjn2oik.py
...
def triton_poi_fused_clone_8(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 246272)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (64*x2) + (61568*x1) + (246272*x3)), None)
