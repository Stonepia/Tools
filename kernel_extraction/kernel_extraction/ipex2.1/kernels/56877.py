...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/3x/c3x7ah5q73v7xno2osvhhfi7vuucxjhwpb4op4upy6cqfjae6alj.py
...
# l__mod___blocks_0_2_norm2 => add_26, add_27, convert_element_type_22, convert_element_type_23, mul_24, mul_25, rsqrt_9, sub_9, var_mean_9
...
def triton_per_fused_add_clone_native_layer_norm_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr2 + (r1 + (64*x0)), tmp37, rmask)
''')
