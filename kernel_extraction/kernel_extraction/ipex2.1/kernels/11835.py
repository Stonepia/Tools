...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/dc/cdc6j65pz3en3j5q4nhnupzpvh4hykvj4efc45e74fifwnyhsawp.py
...
# truediv_36 => div_33
# truediv_37 => div_34
triton_poi_fused_copy_div_mul_select_scatter_sub_53 = async_compile.triton('triton_poi_fused_copy_div_mul_select_scatter_sub_53', '''
import triton
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_div_mul_select_scatter_sub_53', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused_copy_div_mul_select_scatter_sub_53(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1040000
