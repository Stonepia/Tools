...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/dj/cdjnnifyrfiyywgxcbyjd36oaauwktvrzvgjog2ai4drerppl6di.py
# Source Nodes: [gelu_40, mul__49, pad_4], Original ATen: [aten.constant_pad_nd, aten.gelu, aten.mul]
# gelu_40 => add_94, convert_element_type_170, convert_element_type_171, erf_40, mul_341, mul_342, mul_343
# mul__49 => mul_344
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_constant_pad_nd_gelu_mul_25', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
