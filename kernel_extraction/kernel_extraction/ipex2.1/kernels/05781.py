...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/ps/cps7bgcrottc34s73vb5kvr7avojxfe7q6m2pse5izjjnqxmhmhb.py
...
def triton_poi_fused_clone_8(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 51328)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (32*x2) + (12832*x1) + (51328*x3)), None)
