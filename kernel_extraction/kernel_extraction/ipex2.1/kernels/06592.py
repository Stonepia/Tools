...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/sq/csq6qq7fzi4bdypkanlvb67goqmr4g4be6pdt3eev7fxyvpcbqdf.py
# Source Nodes: [add_52, l__mod___model_encoder_embed_tokens_1, mean_25, mul_56, mul_57, pow_26, rsqrt_25, to_56, to_57], Original ATen: [aten._to_copy, aten.add, aten.embedding, aten.mean, aten.mul, aten.pow, aten.rsqrt]
# add_52 => add_65
...
# pow_26 => pow_26
# rsqrt_25 => rsqrt_25
# to_56 => convert_element_type_129
# to_57 => convert_element_type_130
...
def triton_red_fused__to_copy_add_embedding_mean_mul_pow_rsqrt_0(in_ptr0, in_ptr1, in_ptr2, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp10 = tl.load(in_ptr1 + (r1 + (768*tmp9)), rmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
