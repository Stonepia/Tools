...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/5p/c5pmqhfmnyof6wq77asyctg4cjeq6e5qjr2mu3sbhhjksjauv37r.py
# Source Nodes: [add_4, add_6, any_2, clamp, isinf_1, l__mod___model_encoder_block_0_layer_0_dropout, l__mod___model_encoder_block_0_layer__1__dropout, l__mod___model_encoder_embed_tokens, neg, where_1], Original ATen: [aten.add, aten.any, aten.clamp, aten.clone, aten.embedding, aten.isinf, aten.neg, aten.scalar_tensor, aten.where]
# add_4 => add_6
# add_6 => add_8
# any_2 => any_2
...
triton_red_fused_add_any_clamp_clone_embedding_isinf_neg_scalar_tensor_where_10 = async_compile.triton('triton_red_fused_add_any_clamp_clone_embedding_isinf_neg_scalar_tensor_where_10', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i64', 2: '*fp16', 3: '*i1', 4: '*fp16', 5: '*i1', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_any_clamp_clone_embedding_isinf_neg_scalar_tensor_where_10', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_any_clamp_clone_embedding_isinf_neg_scalar_tensor_where_10(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 64
    rnumel = 8192
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        r1 = rindex % 1024
        r3 = rindex
        tmp0 = tl.load(in_ptr0 + (r2 + (8*x0)), xmask, eviction_policy='evict_last', other=0.0)
        ...
        tmp2 = tl.load(in_ptr1 + (r1 + (1024*tmp1)), xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp4 = tmp2 + tmp3
