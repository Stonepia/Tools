...
# Original file: ./detectron2_fasterrcnn_r_50_dc5__54_inference_94.34/detectron2_fasterrcnn_r_50_dc5__54_inference_94.34_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/4a/c4a7xcnjb5i6lkv6oe6t2ettloxy5g4c7k6cq4nm34s66icps7te.py
...
@pointwise(size_hints=[512], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_mul_slice_slice_scatter_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
