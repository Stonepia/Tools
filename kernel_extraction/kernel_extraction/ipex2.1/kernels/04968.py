...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/r4/cr4d3iaqjio5yem74f2wczgtqfrj7oetoptjzyivqbjn2ns3ip75.py
...
def triton_poi_fused_clone_24(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x8 + (1792*x3) + (12544*x2) + (50176*x9)), tmp19, None)
''')
