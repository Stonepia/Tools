...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/gs/cgsvq3pee3jhnjxgziuohymp66zwlbupibvslxt6ya6g4t6cy47i.py
# Source Nodes: [add, getattr_l__mod___blocks___0___norm1], Original ATen: [aten.add, aten.native_layer_norm]
# add => add
# getattr_l__mod___blocks___0___norm1 => add_1, add_2, clone_1, convert_element_type, convert_element_type_1, mul, mul_1, rsqrt, sub, var_mean
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
