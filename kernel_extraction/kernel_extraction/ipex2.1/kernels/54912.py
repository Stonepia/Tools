...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/7a/c7akqwsv7i6zrnejgmatjxtav3yo6i726m574h2jcgea4pdczbsr.py
# Source Nodes: [setitem_4], Original ATen: [aten.copy, aten.slice_scatter]
# setitem_4 => copy_4, slice_scatter_14
triton_poi_fused_copy_slice_scatter_11 = async_compile.triton('triton_poi_fused_copy_slice_scatter_11', '''
import triton
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_slice_scatter_11', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
def triton_poi_fused_copy_slice_scatter_11(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 6303744
