...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/i7/ci7eapagsvkjrrrsdqn66ar4wqkypjwaci2qlkixqlq7dxyyvlfs.py
# Source Nodes: [l__mod___bert_encoder_layer_10_output_layer_norm], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward]
# l__mod___bert_encoder_layer_10_output_layer_norm => convert_element_type_89
triton_red_fused_add_native_layer_norm_native_layer_norm_backward_20 = async_compile.triton('triton_red_fused_add_native_layer_norm_native_layer_norm_backward_20', '''
import triton
...
@triton.jit
def triton_red_fused_add_native_layer_norm_native_layer_norm_backward_20(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 49152
    rnumel = 128
