...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/cv/ccveawbrvwwb3ju3vcxdxwc7hcqt4ykpxxoy3zlb3sshvppurx2j.py
# Source Nodes: [l__mod___layoutlm_encoder_layer_10_output_layer_norm], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm, aten.native_layer_norm_backward]
...
@triton.jit
def triton_per_fused_add_native_dropout_backward_native_layer_norm_native_layer_norm_backward_20(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, out_ptr3, out_ptr4, xnumel, rnumel):
    xnumel = 8192
