...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/wf/cwf7iufwcfdb6xfe5hr6uh2bdlgy42fgymjbop5q4k7gqeavyqb7.py
...
@pointwise(size_hints=[64], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax__to_copy_add_nan_to_num_22', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
