...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/6f/c6fxz3dqaxdv4y6gwwhs6scc2advtoosgvnkuce7fm4rtqyolcio.py
...
# sigmoid_2 => sigmoid_4
triton_poi_fused_add_clone_copy_exp_mul_sigmoid_slice_scatter_15 = async_compile.triton('triton_poi_fused_add_clone_copy_exp_mul_sigmoid_slice_scatter_15', '''
import triton
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_clone_copy_exp_mul_sigmoid_slice_scatter_15', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_clone_copy_exp_mul_sigmoid_slice_scatter_15(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 6266880
