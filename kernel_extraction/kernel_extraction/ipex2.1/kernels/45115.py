...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/bk/cbkl3tvr5bxczolmadahvgj6t2nwgmycmqlladgtdavdkikfrmft.py
...
# getattr_getattr_l__mod___stages___3_____1___post_attn_act => convert_element_type_147, mul_123, sigmoid_30
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_silu_49(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 4194304
    ...
    x2 = (xindex // 32768)
    x3 = xindex
    tmp0 = tl.load(in_ptr0 + ((64*x1) + (4096*(x0 // 64)) + (32768*x2) + (x0 % 64)), None).to(tl.float32)
