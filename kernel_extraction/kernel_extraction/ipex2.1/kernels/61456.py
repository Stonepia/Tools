...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/mk/cmkkbrtvllhv6qh5lfxaic3rgl336lp2wdvwz6qbyvuoxhx53wfd.py
# Source Nodes: [add_8, add_9, l__mod___encoder_block_0_layer__1__dropout, l__mod___encoder_block_1_layer_0_self_attention_q, mean_2, mul_12, mul_13, pow_4, rsqrt_2, to_7, to_8], Original ATen: [aten._to_copy, aten.add, aten.mean, aten.mul, aten.native_dropout, aten.pow, aten.rsqrt, aten.view]
# add_8 => add_10
# add_9 => add_11
# l__mod___encoder_block_0_layer__1__dropout => gt_5, mul_20, mul_21
