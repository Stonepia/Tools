...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/rw/crwgi55ymzwgfwqqt6tc4u3emwlfniz3npzry5jsyncdzdkuvisz.py
# Source Nodes: [batch_norm_27, l__mod___features_conv3_5_c1x1_a_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# batch_norm_27 => add_63, convert_element_type_83, mul_82, mul_83, sub_27
# l__mod___features_conv3_5_c1x1_a_bn_act => relu_27
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_36(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (896*x2) + (702464*y1)), tmp13, xmask)
''')
