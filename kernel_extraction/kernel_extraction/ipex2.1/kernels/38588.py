...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/k2/ck2z7uafck4y6pmwrudnwy5t3dmvb6czu52scov22smma3m2rdgf.py
...
@pointwise(size_hints=[1048576], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_stack_43', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 4), equal_to_1=())]})
@triton.jit
