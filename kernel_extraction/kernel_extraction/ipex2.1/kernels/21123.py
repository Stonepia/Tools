...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/zs/czsab4klaipv2rdfahw4mbsfzndro2xgh4tzcwjlcxavabqrqp2e.py
...
@pointwise(size_hints=[256], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_copy_mul_select_scatter_slice_slice_scatter_sub_zeros_like_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
