...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_bf16/pr/cprzvznz5hb2ieo2e7o6zhumv7y4e2wzhk6darvgpqxr3p5ut36c.py
# Source Nodes: [batch_norm_5, getattr_getattr_l__self___stages___1_____0___conv2_kxk_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.silu]
# batch_norm_5 => add_11, mul_20, mul_21, sub_5
# getattr_getattr_l__self___stages___1_____0___conv2_kxk_bn_act => convert_element_type_34, mul_22, sigmoid_4
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_silu_4(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 33554432
