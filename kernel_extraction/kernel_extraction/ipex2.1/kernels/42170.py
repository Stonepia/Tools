...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/jz/cjznauawzuw74glf2qzo7rot3ahn422t6iq24jkixo4nifadscnv.py
...
# add_8 => add_51
# getattr_getattr_l__mod___stages___3_____0___act1 => convert_element_type_164, convert_element_type_165, mul_204, sigmoid_48
# mul_76 => mul_201
# mul_77 => mul_202
# mul_78 => mul_203
# mul_79 => mul_205
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_silu_24', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
