...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/vp/cvpp4kdb3hqeyab52iuzm62yxwr6xur3lfet5fjxtrn2byjhsymf.py
# Source Nodes: [batch_norm_18, getattr_l__self___features___6___conv_exp_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.silu]
# batch_norm_18 => add_45, mul_73, mul_74, sub_21
# getattr_l__self___features___6___conv_exp_bn_act => convert_element_type_123, mul_75, sigmoid_9
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_silu_22(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 10838016
