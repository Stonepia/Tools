...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/dp/cdpfopcoclrmkrxw5kei6a6hsrl366lh7tfda2ubxm4ggab73n4u.py
# Source Nodes: [l__self___model_al_out_0], Original ATen: [aten._to_copy, aten._unsafe_index, aten.add, aten.arange, aten.mul, aten.rsub, aten.sub]
# l__self___model_al_out_0 => _unsafe_index, _unsafe_index_1, _unsafe_index_2, _unsafe_index_3, add_82, add_84, add_85, add_86, convert_element_type_180, convert_element_type_181, convert_element_type_183, convert_element_type_187, iota, mul_108, mul_110, mul_112, mul_113, mul_114, mul_115, mul_116, mul_117, sub_36, sub_37, sub_38, sub_39
