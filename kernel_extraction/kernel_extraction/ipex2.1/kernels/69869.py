...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/qr/cqrj3rybcaluxzy22udlexa63gilzumzznjw2242eaf3drwlfv2q.py
# Source Nodes: [l__mod___encoder_b_encoder], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# l__mod___encoder_b_encoder => add_101, add_104, add_105, add_106, add_98, clone_82, clone_85, clone_89, clone_90, convert_element_type_66, convert_element_type_67, mul_90, mul_91, rsqrt_31, sub_31, var_mean_31
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: '*bf16', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_26', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
