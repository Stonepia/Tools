...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/ck/ccknay6r7eu3qhrldr7a5b4jofkvzaz3xajwk5olqpgi272cab4i.py
# Source Nodes: [l__mod___module_list_63_activation, l__mod___module_list_63_batch_norm2d], Original ATen: [aten._native_batch_norm_legit_no_training, aten.leaky_relu]
# l__mod___module_list_63_activation => convert_element_type_224, gt_44, mul_179, where_44
# l__mod___module_list_63_batch_norm2d => add_108, mul_177, mul_178, sub_44
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_leaky_relu_17(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 786432
