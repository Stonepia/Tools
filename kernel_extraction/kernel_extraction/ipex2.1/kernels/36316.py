...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/rz/crzejjoobb6z4iuqvy3lp54h6epqzwdeff2cf6casd24bsf6c6cp.py
...
@pointwise(size_hints=[128], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_stack_2', 'configs': [AttrsDescriptor(divisible_by_16=(0,), equal_to_1=())]})
@triton.jit
