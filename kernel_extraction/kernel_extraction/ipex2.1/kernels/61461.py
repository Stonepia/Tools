...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/ca/cca5ozl75twstipxowp5r5tcy5pcr2bhxxetdbblx4udq4shqicq.py
# Source Nodes: [cross_entropy], Original ATen: [aten._log_softmax]
# cross_entropy => amax_24, convert_element_type_141, convert_element_type_142, exp_24, log_2, sub_29, sub_30, sum_25
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__log_softmax_13', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
