...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/2n/c2n3o7hvbk3eio6eftdgoq76tv4ozhvsqmzaknlx3iqe5zdr54pz.py
...
# getattr_getattr_getattr_l__mod___stages___3_____1___transformer___1___norm1 => add_68, add_69, convert_element_type_129, convert_element_type_130, mul_109, mul_110, rsqrt_7, sub_33, var_mean_7
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_34', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_clone_native_layer_norm_34(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (192*x3)), tmp29, rmask)
''')
