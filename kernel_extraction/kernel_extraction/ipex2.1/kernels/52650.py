...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/lm/clmztfrsvkmbvbcliyt75if65iot2louxyi7tcumuh3qqnhfpglg.py
# Source Nodes: [add, cross_entropy, l__mod___distilbert_embeddings_layer_norm], Original ATen: [aten.add, aten.embedding_dense_backward, aten.native_dropout_backward, aten.native_layer_norm, aten.native_layer_norm_backward, aten.nll_loss_forward]
# add => add
