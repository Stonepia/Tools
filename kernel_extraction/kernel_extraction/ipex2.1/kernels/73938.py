...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/ck/cckvmp7zodsj67ktcnhosnr5wdu5jjyk3asommhxdnitswbw4qje.py
...
# batch_norm_91 => add_212, mul_274, mul_275, sub_91
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_121(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (2240*x2) + (439040*y1)), tmp9, xmask)
''')
