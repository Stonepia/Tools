...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/qb/cqb7faw5nikyrx7mdmqwawn57dnuwd7jkpp6sdqxz6ahgud6zalh.py
...
@pointwise(size_hints=[2], filename=__file__, meta={'signature': {0: '*fp32', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_28', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
