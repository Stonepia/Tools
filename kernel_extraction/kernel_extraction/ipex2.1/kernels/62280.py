...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/qo/cqo266w4jspwssscfcl3wvrv2ydb7cevz366viotabk3zaeu24pg.py
# Source Nodes: [add_4, add_5, l__mod___encoder_block_0_layer_0_dropout, l__mod___encoder_block_0_layer__1__dense_relu_dense_wi, l__mod___encoder_dropout, mean_1, mul_5, mul_6, pow_2, rsqrt_1], Original ATen: [aten.add, aten.mean, aten.mul, aten.native_dropout, aten.pow, aten.rsqrt, aten.view]
# add_4 => add_6
# add_5 => add_7
