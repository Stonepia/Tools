...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/vz/cvzmrizue6akacfjzbu3kzpvoo6ocueyru2w5ismv72qjp2cqy7x.py
# Source Nodes: [l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm, l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_1, l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_10, l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_11, l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_2, l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_3, l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_4, l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_5, l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_6, l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_7, l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_8, l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_9], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.sum]
# l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm => convert_element_type_7
# l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_1 => convert_element_type_13
...
# l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_2 => convert_element_type_19
# l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_3 => convert_element_type_25
# l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_4 => convert_element_type_31
# l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_5 => convert_element_type_37
# l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_6 => convert_element_type_43
# l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_7 => convert_element_type_49
# l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_8 => convert_element_type_55
# l__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm_9 => convert_element_type_61
triton_red_fused_add_native_layer_norm_native_layer_norm_backward_sum_17 = async_compile.triton('triton_red_fused_add_native_layer_norm_native_layer_norm_backward_sum_17', '''
import triton
...
def triton_red_fused_add_native_layer_norm_native_layer_norm_backward_sum_17(in_out_ptr0, in_out_ptr1, in_out_ptr2, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, in_ptr9, in_ptr10, in_ptr11, in_ptr12, in_ptr13, in_ptr14, in_ptr15, in_ptr16, in_ptr17, in_ptr18, in_ptr19, in_ptr20, in_ptr21, in_ptr22, in_ptr23, in_ptr24, in_ptr25, in_ptr26, in_ptr27, in_ptr28, in_ptr29, in_ptr30, in_ptr31, in_ptr32, in_ptr33, in_ptr34, in_ptr35, in_ptr36, in_ptr37, in_ptr38, in_ptr39, in_ptr40, in_ptr41, in_ptr42, in_ptr43, in_ptr44, in_ptr45, in_ptr46, in_ptr47, in_ptr48, in_ptr49, in_ptr50, in_ptr51, in_ptr52, in_ptr53, in_ptr54, in_ptr55, in_ptr56, in_ptr57, in_ptr58, in_ptr59, in_ptr60, in_ptr61, in_ptr62, in_ptr63, in_ptr64, in_ptr65, in_ptr66, in_ptr67, in_ptr68, in_ptr69, in_ptr70, in_ptr71, in_ptr72, in_ptr73, in_ptr74, in_ptr75, in_ptr76, in_ptr77, in_ptr78, in_ptr79, in_ptr80, in_ptr81, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    tmp283 = tmp14.to(tl.float32)
    tmp284 = tmp38.to(tl.float32)
    tmp285 = tmp283 + tmp284
    tmp286 = tmp62.to(tl.float32)
    tmp287 = tmp285 + tmp286
    tmp288 = tmp86.to(tl.float32)
    tmp289 = tmp287 + tmp288
    tmp290 = tmp110.to(tl.float32)
    tmp291 = tmp289 + tmp290
    tmp292 = tmp134.to(tl.float32)
    tmp293 = tmp291 + tmp292
    tmp294 = tmp182.to(tl.float32)
    tmp295 = tmp293 + tmp294
    tmp296 = tmp230.to(tl.float32)
    tmp297 = tmp295 + tmp296
    tmp298 = tmp278.to(tl.float32)
    tmp299 = tmp297 + tmp298
    tmp300 = tmp158.to(tl.float32)
    tmp301 = tmp299 + tmp300
    tmp302 = tmp206.to(tl.float32)
    tmp303 = tmp301 + tmp302
    tmp304 = tmp254.to(tl.float32)
    tmp305 = tmp303 + tmp304
    tmp306 = tmp17.to(tl.float32)
    tmp307 = tmp41.to(tl.float32)
    tmp308 = tmp306 + tmp307
    tmp309 = tmp65.to(tl.float32)
    tmp310 = tmp308 + tmp309
    tmp311 = tmp89.to(tl.float32)
    tmp312 = tmp310 + tmp311
    tmp313 = tmp113.to(tl.float32)
    tmp314 = tmp312 + tmp313
    tmp315 = tmp137.to(tl.float32)
    tmp316 = tmp314 + tmp315
    tmp317 = tmp185.to(tl.float32)
    tmp318 = tmp316 + tmp317
    tmp319 = tmp233.to(tl.float32)
    tmp320 = tmp318 + tmp319
    tmp321 = tmp281.to(tl.float32)
    tmp322 = tmp320 + tmp321
    tmp323 = tmp161.to(tl.float32)
    tmp324 = tmp322 + tmp323
    tmp325 = tmp209.to(tl.float32)
    tmp326 = tmp324 + tmp325
    tmp327 = tmp257.to(tl.float32)
    tmp328 = tmp326 + tmp327
    tmp329 = tmp21 + tmp45
    tmp330 = tmp329 + tmp69
    tmp331 = tmp330 + tmp93
    tmp332 = tmp331 + tmp117
    tmp333 = tmp332 + tmp165
    tmp334 = tmp333 + tmp213
    tmp335 = tmp334 + tmp261
    tmp336 = tmp335 + tmp141
    tmp337 = tmp336 + tmp189
    tmp338 = tmp337 + tmp237
    tmp339 = tmp338 + tmp2
    tl.debug_barrier()
    tl.store(in_out_ptr0 + (x0), tmp305, None)
    tl.debug_barrier()
    tl.store(in_out_ptr1 + (x0), tmp328, None)
    tl.debug_barrier()
    tl.store(in_out_ptr2 + (x0), tmp339, None)
''')
