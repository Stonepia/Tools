...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/qh/cqh7m37tohnsnsfhh5ybpchvo7foydpybbs2kgdpf325jvratkzb.py
# Source Nodes: [add_4, gelu_23, mul_44, mul_45, mul_46, mul_47, mul__27, mul__28], Original ATen: [aten.add, aten.gelu, aten.mul]
# add_4 => add_54
# gelu_23 => add_55, convert_element_type_121, convert_element_type_122, erf_23, mul_198, mul_199, mul_200
# mul_44 => mul_194
# mul_45 => mul_195
# mul_46 => mul_197
# mul_47 => mul_202
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_gelu_mul_20', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
