...
# Original file: ./detectron2_maskrcnn_r_101_c4__66_inference_106.46/detectron2_maskrcnn_r_101_c4__66_inference_106.46.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/x3/cx3dz2ljbmuhjqbtbc667jn76efc44xe7ry4vkxswxyvn7kbnp3v.py
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*i1', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_ge_grid_sampler_2d_index_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
def triton_poi_fused_ge_grid_sampler_2d_index_2(in_ptr0, in_ptr1, out_ptr8, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp26 = tl.load(in_ptr1 + (tmp25 + (14*tmp22) + (196*x1)), xmask)
    tmp27 = 1.0
    tmp28 = tmp5 + tmp27
    tmp29 = tmp28 - tmp4
    tmp30 = tmp13 + tmp27
    ...
    tmp39 = tl.where(tmp38 < 0, tmp38 + 14, tmp38)
    # tl.device_assert((0 <= tmp39) & (tmp39 < 14), "index out of bounds: 0 <= tmp39 < 14")
    tmp40 = tmp28.to(tl.int64)
    tmp41 = tl.where(tmp37, tmp40, tmp20)
    tmp42 = tl.where(tmp41 < 0, tmp41 + 14, tmp41)
    # tl.device_assert((0 <= tmp42) & (tmp42 < 14), "index out of bounds: 0 <= tmp42 < 14")
    tmp43 = tl.load(in_ptr1 + (tmp42 + (14*tmp39) + (196*x1)), xmask)
    tmp44 = tmp4 - tmp5
    tmp45 = tmp44 * tmp31
    ...
    tmp54 = tl.where(tmp53 < 0, tmp53 + 14, tmp53)
    # tl.device_assert((0 <= tmp54) & (tmp54 < 14), "index out of bounds: 0 <= tmp54 < 14")
    ...
    tmp57 = tl.load(in_ptr1 + (tmp56 + (14*tmp54) + (196*x1)), xmask)
    tmp58 = tmp12 - tmp13
    tmp59 = tmp29 * tmp58
    ...
    tmp70 = tmp57 * tmp60
    tmp71 = tmp69 + tmp70
    tmp72 = tl.where(tmp63 < 0, tmp63 + 14, tmp63)
    # tl.device_assert((0 <= tmp72) & (tmp72 < 14), "index out of bounds: 0 <= tmp72 < 14")
    tmp73 = tl.where(tmp64 < 0, tmp64 + 14, tmp64)
    # tl.device_assert((0 <= tmp73) & (tmp73 < 14), "index out of bounds: 0 <= tmp73 < 14")
    tmp74 = tl.load(in_ptr1 + (tmp73 + (14*tmp72) + (196*x1)), xmask)
    tmp75 = tmp74 * tmp66
    tmp76 = tmp71 + tmp75
    tmp77 = 0.5
    tmp78 = tmp76 >= tmp77
