...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/wa/cwa6ivx32fclzpsr6dzdkb7dgjyrjrlkr6j4lqhlgfn7o3s5skfi.py
# Source Nodes: [l__mod___features_denseblock2_denselayer2_norm1, l__mod___features_denseblock2_denselayer2_relu1], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
# l__mod___features_denseblock2_denselayer2_norm1 => add_33, convert_element_type_50, mul_49, mul_50, sub_16
...
@pointwise(size_hints=[8388608], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_17', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
