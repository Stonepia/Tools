...
# Original file: ./detectron2_fasterrcnn_r_101_dc5__52_inference_92.32/detectron2_fasterrcnn_r_101_dc5__52_inference_92.32_0.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/go/cgokk3vzncyxonsgjcyjxohphpolvz3cxshofont2byzhdhqeofp.py
...
def triton_poi_fused_index_2(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.where(tmp0 < 0, tmp0 + 256, tmp0)
    # tl.device_assert(((0 <= tmp1) & (tmp1 < 256)) | ~xmask, "index out of bounds: 0 <= tmp1 < 256")
