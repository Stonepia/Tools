...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/y5/cy5dp7ei7ykanwwfg6dqa5lfyzgfdwuhmhhebmix45c5jedn2vew.py
...
def triton_poi_fused__native_batch_norm_legit_no_training_relu_85(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (y0 + (1664*x2) + (326144*y1)), tmp9, xmask)
''')
