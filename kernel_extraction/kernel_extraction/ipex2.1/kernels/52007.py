...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/3k/c3k75ut6o6hj2vxamwxdrfo33l55nzmv35rplr5mngxasgktqrcg.py
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*i64', 2: '*i64', 3: '*i64', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_argmax_eq_sum_15', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
