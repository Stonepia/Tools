...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/3o/c3oygbt2ezhkyb7nvyvaldrtnq5eiemumkamhs72frsbmaecbzqe.py
# Source Nodes: [add_14, add_15, getattr_getattr_getattr_l__self___stages___4_____1___transformer___0___attn_proj_drop, getattr_getattr_getattr_l__self___stages___4_____1___transformer___0___mlp_drop2, getattr_getattr_getattr_l__self___stages___4_____1___transformer___1___norm1], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add_14 => add_102
# add_15 => add_105
...
# getattr_getattr_getattr_l__self___stages___4_____1___transformer___1___norm1 => add_106, add_107, convert_element_type_280, convert_element_type_281, mul_162, mul_163, rsqrt_16, sub_52, var_mean_16
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp32', 4: '*fp32', 5: '*fp16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_clone_native_layer_norm_56', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]}
)
@triton.jit
def triton_red_fused_add_clone_native_layer_norm_56(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(out_ptr2 + (r2 + (240*x3)), tmp27, rmask)
''')
