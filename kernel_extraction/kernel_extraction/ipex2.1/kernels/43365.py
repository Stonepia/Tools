...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/4g/c4ge7xgv7uivgeiek4vijhm2quufcqnxyxrh74ndvjkrwjaqci45.py
# Source Nodes: [batch_norm_17, getattr_getattr_l__self___stages___2___blocks___0___conv1_bn_act], Original ATen: [aten._native_batch_norm_legit_no_training, aten.leaky_relu]
# batch_norm_17 => add_38, mul_69, mul_70, sub_17
# getattr_getattr_l__self___stages___2___blocks___0___conv1_bn_act => convert_element_type_108, gt_17, mul_71, where_17
...
@triton.jit
def triton_poi_fused__native_batch_norm_legit_no_training_leaky_relu_27(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    xnumel = 8388608
