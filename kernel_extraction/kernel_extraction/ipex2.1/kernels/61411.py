...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float16/p2/cp2pcxiuvmsjdr5dagtd2nfqa3s5cgxnnmf6dhtgosg5ko4m3cww.py
...
# pow_3 => pow_3
# tanh => tanh
triton_poi_fused_add_mul_native_dropout_pow_tanh_view_9 = async_compile.triton('triton_poi_fused_add_mul_native_dropout_pow_tanh_view_9', '''
import triton
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*i64', 1: '*fp16', 2: '*fp16', 3: '*i1', 4: '*fp16', 5: '*fp16', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_native_dropout_pow_tanh_view_9', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 7), equal_to_1=())]})
@triton.jit
def triton_poi_fused_add_mul_native_dropout_pow_tanh_view_9(in_ptr0, in_ptr1, in_ptr2, out_ptr1, out_ptr2, out_ptr3, load_seed_offset, xnumel, XBLOCK : tl.constexpr):
    xnumel = 2097152
