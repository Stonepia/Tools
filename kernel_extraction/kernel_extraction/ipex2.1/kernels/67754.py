...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/pv/cpv2iposbjg4itk36qvjle6xoueybgcnezgnvyunvwcbu2ujpln7.py
...
# mul_185 => mul_231
triton_red_fused__to_copy_add_clone_mul_sum_15 = async_compile.triton('triton_red_fused__to_copy_add_clone_mul_sum_15', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_clone_mul_sum_15', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__to_copy_add_clone_mul_sum_15(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 65536
    rnumel = 128
