...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/yl/cyldo4djtqdmy2rveolthcklklexbhvpa27y2e55mkrarnxv6bkm.py
...
def triton_per_fused__to_copy_add_clamp_clone_embedding_mean_mul_neg_pow_rsqrt_scalar_tensor_where_8(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, rnumel):
    ...
    tmp29 = tmp21 * tmp28
    tl.store(out_ptr1 + (r1 + (1024*x0)), tmp29, rmask & xmask)
''')
