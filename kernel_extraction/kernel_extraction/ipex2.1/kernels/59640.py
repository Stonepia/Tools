...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/h2/ch2rx6okceesfihc7evzrucvhij5y5y4ocqosgk6dafau6bbnjvf.py
...
def triton_poi_fused_clone_mul_4(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 151296)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (64*x2) + (2304*x1) + (453888*x3)), None)
