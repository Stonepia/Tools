...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/kf/ckfukd4aont3lscrsc6464rgzitwmbkl2cyygajdhtwzvbaeva5s.py
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*i64', 1: '*bf16', 2: '*bf16', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_embedding_2', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
