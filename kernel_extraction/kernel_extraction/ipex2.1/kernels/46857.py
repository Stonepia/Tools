...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/g3/cg3dhcgxmf3o4edvsjzgsr5ujz7mcdnysp4aqj3efz55ygemnyov.py
...
@pointwise(size_hints=[128], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_stack_2', 'configs': [AttrsDescriptor(divisible_by_16=(0,), equal_to_1=())]})
@triton.jit
