...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/pg/cpgw723be5vzc36rz4yeksryggbx4ndrcgzcq27hfe5prg5faz6s.py
...
@pointwise(size_hints=[256], filename=__file__, meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_embedding_dense_backward_nll_loss_forward_27', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
