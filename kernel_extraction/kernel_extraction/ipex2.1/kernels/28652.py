...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/amp_fp16/l4/cl4y3ygibmaxftctintkovzm7jg5pdgnbmmjcb3iwqljfasfyggw.py
# Source Nodes: [add_8, gelu_39, mul_76, mul_77, mul_78, mul_79, mul__47, mul__48], Original ATen: [aten.add, aten.gelu, aten.mul]
# add_8 => add_90
# gelu_39 => add_91, convert_element_type_201, convert_element_type_202, erf_39, mul_330, mul_331, mul_332
# mul_76 => mul_326
# mul_77 => mul_327
# mul_78 => mul_329
# mul_79 => mul_334
...
@pointwise(size_hints=[67108864], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_gelu_mul_24', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]})
@triton.jit
