...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/ih/cih27u7yvlbo74rnvyzftfoizbl3mftemmvwuozkcu7pvh5hxn3a.py
...
def triton_poi_fused_add_mul_sub_29(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp7 = tl.load(in_out_ptr0 + (y0 + (192*x2) + (150528*y1)), xmask, eviction_policy='evict_last')
