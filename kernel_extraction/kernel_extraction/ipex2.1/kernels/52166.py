...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/pg/cpg4ye5ohrigd2pvnt5zypqqrlqpuflr47hairaq7xhnegryogvr.py
# Source Nodes: [getattr_getattr_l__mod___blocks___5_____1___bn2_act, mean_6], Original ATen: [aten.hardswish, aten.mean]
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_hardswish_mean_23', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]}
)
@triton.jit
