...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/wo/cwozfbkpknxatsrtntgkij3hyjoye3tsadylbhvmphtcjewncz6k.py
...
def triton_per_fused__to_copy_add_clamp_clone_mean_mul_neg_pow_rsqrt_scalar_tensor_where_13(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, rnumel):
    ...
    tmp11 = tl.load(in_ptr2 + (r1 + (1024*x0)), rmask & xmask, other=0.0).to(tl.float32)
    ...
    tmp35 = tmp27 * tmp34
    tl.store(out_ptr1 + (r1 + (1024*x0)), tmp35, rmask & xmask)
''')
