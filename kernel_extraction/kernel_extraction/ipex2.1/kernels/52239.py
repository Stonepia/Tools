...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/up/cup4th5wzgunjlmpja4wxgoz2s62yu3e2qvfxlqqnjr5o6ayikz7.py
...
@pointwise(size_hints=[32768], filename=__file__, meta={'signature': {0: '*fp32', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_t_5', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
