...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/3d/c3dsnbqdxm2oivunsispd23dyvvpuo2hdqudwk3jj3a3725agej5.py
# Source Nodes: [add_6, mul_5, softmax], Original ATen: [aten._softmax, aten.add, aten.mul]
# add_6 => add_50
# mul_5 => mul_90
# softmax => amax, convert_element_type_104, convert_element_type_105, div, exp, sub_22, sum_1
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_add_mul_28', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__softmax_add_mul_28(in_ptr0, in_ptr1, in_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 131072
    rnumel = 256
