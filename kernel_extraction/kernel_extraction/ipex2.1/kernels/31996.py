...
# Original file: ./detectron2_fasterrcnn_r_101_c4__23_inference_63.3/detectron2_fasterrcnn_r_101_c4__23_inference_63.3_2.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/br/cbrhdxcwr6e7lbo3mievkqhnf3nnnla6li3np67tg4swwzqcg25i.py
...
def triton_poi_fused_max_pool2d_with_indices_1(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp10 = tmp7 & tmp9
    tmp11 = tmp5 & tmp10
    tmp12 = tl.load(in_ptr0 + ((-38464) + x0 + (128*x1) + (76800*x2)), tmp11, other=0.0)
    ...
    tmp17 = tmp15 & tmp16
    tmp18 = tmp5 & tmp17
    tmp19 = tl.load(in_ptr0 + ((-38400) + x0 + (128*x1) + (76800*x2)), tmp18, other=0.0)
    ...
    tmp25 = tmp23 & tmp24
    tmp26 = tmp5 & tmp25
    tmp27 = tl.load(in_ptr0 + ((-38336) + x0 + (128*x1) + (76800*x2)), tmp26, other=0.0)
    ...
    tmp33 = tmp31 & tmp32
    tmp34 = tmp33 & tmp10
    tmp35 = tl.load(in_ptr0 + ((-64) + x0 + (128*x1) + (76800*x2)), tmp34, other=0.0)
    tmp36 = tl.where(tmp34, tmp35, float("-inf"))
    tmp37 = triton_helpers.maximum(tmp36, tmp29)
    tmp38 = tmp33 & tmp17
    tmp39 = tl.load(in_ptr0 + (x0 + (128*x1) + (76800*x2)), tmp38, other=0.0)
    tmp40 = tl.where(tmp38, tmp39, float("-inf"))
    tmp41 = triton_helpers.maximum(tmp40, tmp37)
    tmp42 = tmp33 & tmp25
    tmp43 = tl.load(in_ptr0 + (64 + x0 + (128*x1) + (76800*x2)), tmp42, other=0.0)
    ...
    tmp49 = tmp47 & tmp48
    tmp50 = tmp49 & tmp10
    tmp51 = tl.load(in_ptr0 + (38336 + x0 + (128*x1) + (76800*x2)), tmp50, other=0.0)
    tmp52 = tl.where(tmp50, tmp51, float("-inf"))
    tmp53 = triton_helpers.maximum(tmp52, tmp45)
    tmp54 = tmp49 & tmp17
    tmp55 = tl.load(in_ptr0 + (38400 + x0 + (128*x1) + (76800*x2)), tmp54, other=0.0)
    tmp56 = tl.where(tmp54, tmp55, float("-inf"))
    tmp57 = triton_helpers.maximum(tmp56, tmp53)
    tmp58 = tmp49 & tmp25
    tmp59 = tl.load(in_ptr0 + (38464 + x0 + (128*x1) + (76800*x2)), tmp58, other=0.0)
