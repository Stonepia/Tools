...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_fp16/r6/cr6tzcd3ihafvewuxaoexhbxl2d5yn7ofip46mbvj4uwn7xzu2l3.py
# Source Nodes: [add_50, add_51, l__self___decoder_block_0_layer_1_enc_dec_attention_k, l__self___encoder_block_7_layer__1__dropout, l__self___encoder_dropout_1, mean_16, mul_75, mul_76, pow_25, rsqrt_16], Original ATen: [aten._to_copy, aten.add, aten.mean, aten.mul, aten.native_dropout, aten.pow, aten.rsqrt, aten.view]
# add_50 => add_59
# add_51 => add_60
# l__self___decoder_block_0_layer_1_enc_dec_attention_k => convert_element_type_155, view_242
# l__self___encoder_block_7_layer__1__dropout => gt_33, mul_139, mul_140
# l__self___encoder_dropout_1 => gt_34, mul_143, mul_144
# mean_16 => mean_16
# mul_75 => mul_141
# mul_76 => mul_142
# pow_25 => pow_25
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*i64', 3: '*fp32', 4: '*fp32', 5: '*i1', 6: '*i1', 7: '*fp32', 8: '*fp16', 9: 'i32', 10: 'i32', 11: 'i32', 12: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0', 'in_out_ptr1'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_mean_mul_native_dropout_pow_rsqrt_view_16', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8, 11, 12), equal_to_1=())]}
)
@triton.jit
