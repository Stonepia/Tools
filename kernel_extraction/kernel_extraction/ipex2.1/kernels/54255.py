...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float32/my/cmy634zpfjkxi6q2ieiunabzzlahrsi3fjo2eob56qr2is42tlzk.py
...
def triton_poi_fused_2(out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tmp0 < tmp5
    tmp7 = 0.6094141006469727
    tmp8 = 3.4808707237243652
    tmp9 = tl.where(tmp6, tmp7, tmp8)
    tmp10 = tl.full([1], 3, tl.int64)
    tmp11 = tmp0 < tmp10
    tmp12 = 40.806785583496094
    tmp13 = 6.4403486251831055
    ...
    tmp19 = tmp0 < tmp18
    tmp20 = 1.0264595746994019
    tmp21 = 2.143465757369995
    tmp22 = tl.where(tmp19, tmp20, tmp21)
    tmp23 = tl.full([1], 7, tl.int64)
    tmp24 = tmp0 < tmp23
    tmp25 = 2.778682231903076
    tmp26 = 0.22158050537109375
