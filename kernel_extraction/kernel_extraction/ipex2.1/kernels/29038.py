...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/sf/csfnmcj3fwe6kr52w6qhrfbusxoivh7lyr5mwpnny4nifnjay53u.py
...
# getattr_getattr_l__mod___stages___2_____1___norm => convert_element_type_91, var_mean_4
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_18', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]}
)
@triton.jit
