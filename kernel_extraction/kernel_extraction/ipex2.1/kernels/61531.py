...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/eo/ceo4ne6iuxwvdwy47kdedvgkw777jzsm4xftg2vto7wevwyfmogw.py
...
# l__mod___features_denseblock2_denselayer8_norm1 => add_57, convert_element_type_86, mul_85, mul_86, sub_28
...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp16', 4: '*fp16', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_relu_29', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]})
@triton.jit
