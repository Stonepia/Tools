...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/cq/ccq642vkmaiwjkkvxepchuxjltfx4qz5xs5lupwbrvlzh4gddlxr.py
...
def triton_poi_fused_clone_10(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x8 + (896*x3) + (6272*x2) + (50176*x9)), tmp21, None)
''')
