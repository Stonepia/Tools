...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/amp_bf16/d5/cd5zex3gjnywzll43ttavehdq3jipvwmhafb2b3wqikapenimym3.py
# Source Nodes: [l__self___distilbert_transformer_layer_0_attention_dropout, masked_fill, softmax], Original ATen: [aten._softmax, aten.masked_fill, aten.native_dropout]
# l__self___distilbert_transformer_layer_0_attention_dropout => gt_1, mul_4, mul_5
# masked_fill => full_default, where
# softmax => amax, convert_element_type_10, convert_element_type_11, div_1, exp, sub_1, sum_1
triton_red_fused__softmax_masked_fill_native_dropout_7 = async_compile.triton('triton_red_fused__softmax_masked_fill_native_dropout_7', '''
import triton
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i1', 1: '*bf16', 2: '*i64', 3: '*fp32', 4: '*i1', 5: '*bf16', 6: '*bf16', 7: 'i32', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_masked_fill_native_dropout_7', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 8, 9), equal_to_1=())]}
)
@triton.jit
