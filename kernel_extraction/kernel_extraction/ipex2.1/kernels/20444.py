...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/h2/ch2xaw3xspdbvznlt4llmuzjywsnblug4ydvpe6o5cs3x5ty6lno.py
...
# triu => full_default_1
triton_per_fused__softmax_add_nan_to_num_triu_6 = async_compile.triton('triton_per_fused__softmax_add_nan_to_num_triu_6', '''
import triton
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_nan_to_num_triu_6', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]}
)
@triton.jit
def triton_per_fused__softmax_add_nan_to_num_triu_6(in_ptr0, in_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 16
    rnumel = 25
    ...
    tmp25 = tmp20 / tmp24
    tl.store(out_ptr2 + (r1 + (25*x0)), tmp25, rmask & xmask)
''')
