...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/bfloat16/wk/cwk6pz43tyb2na63l2j55fqwzo2lvmx5omx5jyeo6d5jekbo64da.py
# Source Nodes: [add, getattr_l__mod___blocks___0___mlp_channels_drop2, getattr_l__mod___blocks___1___norm], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# add => add_6
# getattr_l__mod___blocks___0___mlp_channels_drop2 => clone_4
# getattr_l__mod___blocks___1___norm => add_7, add_8, clone_5, convert_element_type_6, convert_element_type_7, mul_8, mul_9, rsqrt_2, sub_2, var_mean_2
