...
# Original file: ./detectron2_fasterrcnn_r_101_fpn__63_inference_103.43/detectron2_fasterrcnn_r_101_fpn__63_inference_103.43_1.py
...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float16/xy/cxy7f2zgwljb22sgb7u5qfxhee3t6rlspdrd3egesng7p5gqga6o.py
...
@pointwise(size_hints=[256], filename=__file__, meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_copy_mul_slice_slice_scatter_0', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]})
@triton.jit
