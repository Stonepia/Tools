...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/vm/cvmpzjpd5rkgp7dfiwkhham7ktyhuq7zjfxx243jjnuerhhrmtac.py
...
triton_poi_fused_div_lt_mul_neg_scalar_tensor_where_89 = async_compile.triton('triton_poi_fused_div_lt_mul_neg_scalar_tensor_where_89', '''
import triton
...
@pointwise(size_hints=[65536], filename=__file__, meta={'signature': {0: '*fp64', 1: '*fp64', 2: '*fp64', 3: '*fp64', 4: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_div_lt_mul_neg_scalar_tensor_where_89', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]})
@triton.jit
def triton_poi_fused_div_lt_mul_neg_scalar_tensor_where_89(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 40000
    ...
    tmp23 = tmp21 < tmp22
    tmp24 = -tmp21
    tmp25 = tl.full([1], 0.5, tl.float64)
    tmp26 = tmp24 * tmp25
    tmp29 = tmp26 * tmp28
    tmp30 = tl.full([1], 1.0, tl.float64)
    tmp31 = tmp29 / tmp30
