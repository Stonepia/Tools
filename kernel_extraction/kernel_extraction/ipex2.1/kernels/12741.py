...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_fp16/37/c37d2ymoc7is5v4e2xl3mlcnjeh4mthsgdksddnn5tsmnokkh5aj.py
# Source Nodes: [add_1, dropout_3, l__self___encoder_layers_1_attention_layer_norm, l__self___encoder_layers_1_attention_self_attention_query_key], Original ATen: [aten._to_copy, aten.add, aten.clone, aten.native_layer_norm]
# add_1 => add_6
# dropout_3 => clone_6
# l__self___encoder_layers_1_attention_layer_norm => add_7, add_8, mul_4, mul_5, rsqrt_2, sub_4, var_mean_2
# l__self___encoder_layers_1_attention_self_attention_query_key => convert_element_type_15
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp16', 2: '*fp32', 3: '*fp32', 4: '*fp16', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_clone_native_layer_norm_14', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_red_fused__to_copy_add_clone_native_layer_norm_14(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 4096
    rnumel = 256
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp8 = tl.load(in_ptr0 + (r1 + (512*x0)), rmask, eviction_policy='evict_first', other=0.0)
