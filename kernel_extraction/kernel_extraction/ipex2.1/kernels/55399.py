...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/bfloat16/xt/cxtwvzz4jcnbkyhqxbreslzmgjpck6huca7rrw4iv57hb75ls2vh.py
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*i64', 1: '*bf16', 2: '*i64', 3: '*bf16', 4: '*bf16', 5: '*bf16', 6: '*bf16', 7: 'i32', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused_native_layer_norm_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 9), equal_to_1=())]}
)
@triton.jit
