...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/4y/c4ykyc7gmjfikjvsbrwml76agf4vxrs7lz6xa7umb7zouwvoooev.py
# Source Nodes: [l__mod___encoder_a_encoder], Original ATen: [aten.add, aten.clone, aten.native_layer_norm]
# l__mod___encoder_a_encoder => add_6, add_7, add_8, clone_3, mul_6, mul_7, rsqrt_2, sub_3, var_mean_2
...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_clone_native_layer_norm_10', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]}
)
@triton.jit
def triton_per_fused_add_clone_native_layer_norm_10(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel):
    xnumel = 1600
