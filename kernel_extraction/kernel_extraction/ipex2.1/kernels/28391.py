...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/kh/ckhl4ifzlhwfwudxui4f7nasq6hmdltzrkpgp4662nxkaqajuadh.py
...
@pointwise(size_hints=[16777216], filename=__file__, meta={'signature': {0: '*i64', 1: '*bf16', 2: '*i1', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_gelu_native_dropout_view_10', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 5), equal_to_1=())]})
@triton.jit
