...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/float32/s4/cs4pssevwd22yak2qvh43ohzezpm3jh7ypmve2tqvzk5wrvdlche.py
...
@triton.jit
def triton_red_fused_add_mul_sum_18(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, out_ptr1, out_ptr2, out_ptr3, out_ptr4, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 16384
    rnumel = 128
