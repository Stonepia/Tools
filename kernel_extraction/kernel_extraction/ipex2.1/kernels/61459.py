...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/huggingface/bfloat16/m5/cm56jic2mrdn2tiouzsujh5woubyfjfef5howe5dcyljasf5p3p7.py
...
# type_as_8 => convert_element_type_62
...
@triton.jit
def triton_per_fused__softmax__to_copy_native_dropout_11(in_ptr0, in_ptr1, in_ptr2, out_ptr4, out_ptr5, out_ptr6, load_seed_offset, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 12288
    rnumel = 128
