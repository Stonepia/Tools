...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/amp_bf16/la/clau2gfarrfutkuj4yntdpsu4zainplhmnyzbtgdxl2qywmf6ioh.py
...
# nan_to_num_6 => convert_element_type_138, eq_26, eq_27, isnan_6, where_19, where_20, where_21
# softmax_6 => amax_6, div_6, exp_6, sub_20, sum_7
# type_as_8 => convert_element_type_142
...
@reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax__to_copy_add_nan_to_num_30', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4), equal_to_1=())]}
)
@triton.jit
