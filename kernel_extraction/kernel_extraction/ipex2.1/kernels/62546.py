...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/timm_models/float16/23/c23nvmdthweyqliqm3xo5nbkbkdhilzvuoj4qhl5a2jbimabuet2.py
...
@pointwise(size_hints=[32768, 2048], tile_hint=TileHint.SQUARE,filename=__file__, meta={'signature': {0: '*fp16', 1: '*fp16', 2: 'i32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_avg_pool2d_3', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
