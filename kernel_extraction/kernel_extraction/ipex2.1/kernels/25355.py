...
# kernel path: /home/sdp/tongsu/pytorch/inductor_log/torchbench/float32/2v/c2vowjhfp7yuw6rzi6ne47e2obelgibkc3oxvcydy6lzgbpfbrgb.py
...
def triton_poi_fused_clone_8(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 250880)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (80*x2) + (15680*x1) + (250880*x3)), xmask)
